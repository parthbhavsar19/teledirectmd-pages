        ...
        <div className="tdmd-footer-inner">
          ...
          <div className="tdmd-footer-brand">
            ...
            <p className="tdmd-footer-desc">
              Board-certified family medicine physician. $79 flat-fee virtual visits across 42 states + D.C. Insurance accepted in select states. Employer plans available.
            </p>
