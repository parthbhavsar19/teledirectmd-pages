...
export async function generateStaticParams() {
  ...
  for (const state of states) {
    for (const slug of conditionSlugs) {
      params.push({ stateSlug: state.slug, conditionSlug: slug });
    }
  }
  return params;
}
...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    openGraph: {
      ...
      description: condition.metaDescription,
      url: pageUrl,
      images: [{ url: `${baseUrl}/assets/social/tdmd-${stateSlug}-${conditionSlug}-og.png`, alt: condition.ogImageAlt }],
    },
    twitter: {
      card: 'summary_large_image',
      title: condition.pageTitle,
      description: condition.metaDescription,
      images: [`${baseUrl}/assets/social/tdmd-${stateSlug}-${conditionSlug}-og.png`],
    },
          ...
          <div className="tdmd-hero-grid">
            <div className="tdmd-hero-copy">
              ...
              <div className="tdmd-hero-ctas">
                ...
                <a href={`/${stateSlug}`} className="tdmd-btn tdmd-btn-outline">Explore {state.name} Pages</a>
          ...
          <div className="tdmd-inline-links">
            ...
            <p className="tdmd-link-cloud">
              {condition.inlineLinks.map((link, i) => (
                <a key={i} href={`/${stateSlug}/${link.slug}`}>{link.label}</a>
              ))}
            </p>
          </div>
