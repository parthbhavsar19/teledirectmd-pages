  ...
  const jsonLd = {
    ...
    "@graph": [
      ...
      },
      {
        ...
        "description": "TeleDirectMD fills TRICARE gaps for military families during separation, PCS moves, and Reserve/Guard transitions. $79 flat-fee telehealth in 44 states near every major installation. No insurance required.",
    ...
    <>
          ...
          <div className="tdmd-hero-grid">
            <div className="tdmd-hero-copy">
              ...
              <p className="tdmd-hero-sub">
                TRICARE is excellent — when it's active. But separation, PCS moves, and Reserve/Guard transitions create real coverage gaps. TeleDirectMD provides $79 flat-fee telehealth visits in 44 states — prescription bridge refills, acute care, no insurance required.
              </p>
              <p>
                Military families face unique healthcare gaps that civilians rarely encounter: 200,000+ service members separate each year, PCS moves create provider waitlists of 6–10 weeks, and Reserve/Guard members cycle in and out of coverage between activation periods. TeleDirectMD exists for exactly these moments — board-certified Family Medicine, same-day availability, and prescription capability from anywhere in 44 states.
              </p>
              ...
              <ul className="tdmd-hero-benefits">
                ...
                <li>Licensed in 44 states — every major installation location covered</li>
          ...
          <div className="tdmd-decision-flow">
            ...
            <div className="tdmd-decision-step tdmd-decision-step-good">
              ...
              <div className="tdmd-decision-content">
                ...
                <p>Bring your current medication list. Fill out the intake form and connect via secure video from your phone, anywhere in 44 states. Dr. Bhavsar reviews your history and conducts the evaluation.</p>
              </div>
            </div>
            <div className="tdmd-decision-step tdmd-decision-step-good">
      ...
      <section id={`${pid}-tricare-gap`} className="tdmd-section">
        <div className="tdmd-container">
          ...
          <p><strong>TeleDirectMD doesn't replace TRICARE. It bridges the gap</strong> — $79 flat-fee telehealth with a board-certified Family Medicine physician, available same-day in 44 states, no insurance required.</p>
        </div>
      </section>
      ...
      <section id={`${pid}-gap-table`} className="tdmd-section tdmd-section-highlight">
        <div className="tdmd-container">
            ...
            <table className="tdmd-table">
              ...
              <tbody>
                <tr>
                  ...
                  <td>$79 direct-pay visits in 44 states, no insurance</td>
                </tr>
                <tr>
          ...
          <p className="tdmd-comparison-note">In every transition scenario, TeleDirectMD provides what TRICARE cannot in that moment: immediate access to a board-certified physician and prescriptions, from anywhere in 44 states.</p>
        </div>
      </section>
      ...
      <section id={`${pid}-gap-overview`} className="tdmd-section">
        <div className="tdmd-container">
          ...
          <p>TeleDirectMD was built for exactly this: board-certified Family Medicine, 44 states, $79 flat fee, and prescription capability the day you need it. Not a replacement for TRICARE — a bridge to keep you stable until TRICARE catches up.</p>
        </div>
      </section>
        ...
        <div className="tdmd-container">
          ...
          <div className="tdmd-bottom-cta">
            <div className="tdmd-bottom-cta-copy">
              ...
              <p>$79 flat-fee visits. Same-day availability. 44 states. No insurance required.</p>
            </div>
      ...
      <section id={`${pid}-states`} className="tdmd-section tdmd-section-highlight">
        <div className="tdmd-container">
          ...
          <p>TeleDirectMD is licensed in 44 states — covering every major installation and the surrounding communities where military families live. Whether you're at Fort Moore in Georgia, Fort Bragg in North Carolina, Fort Hood in Texas, or JBLM in Washington, we're licensed where you are.</p>
        ...
        <div className="tdmd-container">
          ...
          <div className="tdmd-related-grid">
            ...
            <div className="tdmd-related-card">
              ...
              <p className="tdmd-related-desc">Same doctor across every assignment, 44 states.</p>
