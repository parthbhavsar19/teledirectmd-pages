export default function TravelNursesPage() {
  ...
  const conditions = [
    ...
    { name: 'Hypertension / High Blood Pressure', slug: 'hypertension-refills-online', desc: 'Blood pressure medication refills across all 44 states we serve — no lapse in your regimen when you start a new assignment in a new state.' },
  ...
  const faqItems = [
    ...
    },
    {
      ...
      a: 'Yes, that\'s one of the primary advantages TeleDirectMD offers travel nurses. Dr. Parth Bhavsar, MD, is board-certified in Family Medicine and licensed in 44 states. That means the same physician who treated your sinus infection in Texas can manage your prescription refill when you\'re on assignment in Florida three months later — without requiring you to repeat your health history or re-establish care with a new provider. Continuity of care is rare for travel nurses, and TeleDirectMD is one of the few options that makes it possible.'
    },
    {
  ...
  const jsonLd = {
    ...
    "@graph": [
      ...
      },
      {
        ...
        "description": "TeleDirectMD offers telehealth for travel nurses across 44 states — same board-certified physician regardless of your assignment location. Prescription refills, acute care, and chronic condition management. Same-day visits, evenings & weekends. Starting at $79.",
        "inLanguage": "en-US",
    ...
    <>
        ...
        <div className="tdmd-container">
          <div className="tdmd-hero-grid">
            <div className="tdmd-hero-copy">
              ...
              <p className="tdmd-hero-sub">Board-certified physician in 44 states. One consistent doctor — regardless of which assignment you're on. Same-day visits, evenings &amp; weekends.</p>
              <p>
                There are more than 175,000 travel nurses actively on assignment across the United States, cycling through 13-week contracts that take them from Texas to Florida to North Carolina and back. Travel nurses spend their careers taking care of patients — but struggle to access consistent care for themselves. Every new assignment means a new city, a new state, and no established physician. Finding a new primary care doctor every quarter isn't practical. TeleDirectMD provides a consistent, board-certified physician licensed across 44 states — so the same doctor who treated your sinus infection in Georgia is the same one who refills your prescription in Arizona three months later.
              </p>
              <ul className="tdmd-hero-benefits">
                <li>Board-certified Family Medicine physician — not a PA, not an NP, not an algorithm</li>
                <li>Licensed in 44 states — the same physician follows you across every assignment</li>
            ...
            <div className="tdmd-hero-side">
              <div className="tdmd-hero-card">
                ...
                <ul>
                  <li>One physician, 44 states — continuity of care across every assignment</li>
        ...
        <div className="tdmd-container">
          ...
          <div className="tdmd-grid tdmd-grid-2">
            <div className="tdmd-card tdmd-card-good">
              <h3>One Physician Across 44 States</h3>
              <p>Dr. Parth Bhavsar, MD, is board-certified in Family Medicine and licensed in 44 states — including the most common travel nurse assignment destinations: Texas, California, Florida, North Carolina, Georgia, Tennessee, and Arizona. The same physician who knows your health history can see you whether you're starting your next assignment or wrapping up your current one.</p>
            </div>
            <div className="tdmd-card tdmd-card-good">
        ...
        <div className="tdmd-container">
          <div className="tdmd-bottom-cta">
            <div className="tdmd-bottom-cta-copy">
              <h3>The same doctor. Every assignment. All 44 states.</h3>
      ...
      <section className="tdmd-section" id="travel-nurses-states">
        <div className="tdmd-container">
          ...
          <p>TeleDirectMD is licensed in 44 states, including the most popular travel nurse assignment destinations. Here are high-demand states where we can see you today:</p>
