...
export const metadata = {
  ...
  description:
    'Side-by-side comparisons of TeleDirectMD ($79 flat, MD-only, 42 states) vs. Teladoc, MDLIVE, Amwell, Doctor on Demand, Sesame, K Health, HealthTap, and Walgreens Virtual. Sourced, honest, updated May 2026.',
      ...
      <div className="cmp-hero">
        <div className="cmp-hero-inner">
          ...
          <p className="cmp-lead">
            ...
            NPI&nbsp;1104323203), 42 states + DC, no membership required, select Aetna / BCBS / UHC insurance accepted, same-day
          ...
          <div className="cmp-badge-row">
            ...
            <span className="cmp-badge">42 States + DC</span>
          ...
          <div className="cmp-two-col">
            <div className="cmp-info-box cmp-info-box--teal">
              ...
              <ul className="cmp-list">
                ...
                <li>You are in one of the 42 states + DC TeleDirectMD serves</li>
