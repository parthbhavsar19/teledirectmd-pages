...
export const metadata = {
  ...
  description:
    'Find answers about TeleDirectMD\'s telehealth services, insurance acceptance, $79 self-pay pricing, appointments, prescriptions, and virtual urgent care in 42 states + D.C.',
  alternates: { canonical: 'https://teledirectmd.com/faq' },
  openGraph: {
    title: 'Frequently Asked Questions | TeleDirectMD',
    description:
      'Find answers about TeleDirectMD\'s telehealth services, insurance acceptance, pricing, and virtual urgent care in 42 states + D.C.',
  ...
  return {
    ...
    '@graph': [
      ...
      },
      {
        ...
        description: "Answers to common questions about TeleDirectMD's telehealth services, insurance acceptance, $79 self-pay pricing, prescriptions, scope of care, and virtual urgent care in 42 states + D.C.",
        inLanguage: 'en-US',
      ...
      },
      {
        ...
        description: 'Physician-led telemedicine practice. $79 flat-fee video visits with a board-certified MD across 42 states + DC. Select Aetna, Blue Cross Blue Shield, and UnitedHealthcare commercial plans accepted.',
...
export default function FAQPage() {
  ...
  return (
    <>
      <CitableSummaryBlock summary={citableSummary_AI} jsonLd={citableJsonLd_AI} idSuffix="faq" visualMode="hidden" />
      <script
