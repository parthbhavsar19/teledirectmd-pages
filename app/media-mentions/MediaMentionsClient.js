      ...
      <div className="tdmd-media">
        ...
        <section className="tdmd-media__hero">
          ...
          <p className="tdmd-media__lede">
            Dr.&nbsp;Parth Bhavsar, board-certified family medicine physician and founder of TeleDirectMD, has been quoted in <strong>30+ major national and international publications</strong> including TIME, Newsweek, British GQ, HuffPost, FOX News Digital, New York Post, Daily Mail, U.S.&nbsp;News &amp; World Report, Healthline, and Yahoo Health — providing expert commentary on evidence-based wellness, nutrition science, infectious disease, and medication safety.
          </p>
        </section>
