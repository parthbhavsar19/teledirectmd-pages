...
const STATE_CONTEXT = {
  CO:{cities:['Denver','Aurora','Colorado Springs','Boulder','Fort Collins'],note:"Colorado enacted telehealth payment parity in 2015 under CRS § 10-16-123 — the earliest of any state in TeleDirectMD's network — expanded the statute in 2021, and operationalized requirements through Colorado DOI Revised Bulletin B-4.89 (August 18, 2021), which requires commercial insurers to cover audio-only (telephone) visits at parity with in-person care. UnitedHealthcare Colorado commercial plans include UHC Doctors Plan (which carries a confirmed $0 telehealth copay per the UHC 2025 Summary of Benefits and Coverage), Choice Plus, Navigate Plus, Core, Select, and the Advantage HMO. Colorado's dual clinical telehealth drivers are altitude illness — approximately 25% of visitors above 8,000 feet develop acute mountain sickness per CDC Yellow Book guidance — and rural access gaps: 77% of Colorado is rural or frontier, and all but two counties are federally designated mental health shortage areas (Rocky Mountain Health Plans). The Denver–Aurora Front Range corridor holds approximately 75% of Colorado's commercially insured population, while eastern plains and western slope residents depend heavily on telehealth for primary care continuity."},
  ...
  WA:{cities:['Seattle','Spokane','Tacoma','Bellevue','Everett'],note:"Washington requires telehealth payment parity under RCW 48.43.735 (effective January 1, 2021) and explicitly prohibits rural-vs-urban originating-site distinctions — commercial insurers cannot reimburse rural and urban telehealth visits at different rates. Audio-only coverage with an established patient relationship is required following Office of the Insurance Commissioner rulemaking effective January 1, 2023. UnitedHealthcare Washington commercial plans include Choice Plus, Navigate Plus, Select Plus, Core, Compass (a Washington-specific product), and Community Plan Exchange. Washington's dominant clinical driver for telehealth volume is Seasonal Affective Disorder: 59% of Washington residents report SAD-like effects during the overcast season (NAMI Eastside), and Washington's clinical SAD rate of 5–7% materially exceeds the national 1–2% average. King and Snohomish counties (Seattle metro) hold approximately 55% of Washington's commercially insured Puget Sound population, while eastern Washington's rural–urban divide — Spokane and the Tri-Cities particularly — reinforces telehealth demand statewide. Major Washington employers carrying UHC commercial plans include Amazon, Microsoft, Boeing, and Costco."},
};
...
export default function UHCStateClient({ stateSlug }) {
  ...
  const FAQS = [
    ...
    { q:`What UnitedHealthcare plans are NOT accepted at TeleDirectMD in ${stateName}?`, a:`The following UHC plan types are not accepted: UHC Community Plan (Medicaid), UHC Medicare Advantage plans, and Medicare fee-for-service. If you are unsure about your plan type, self-pay is available for $79 flat — same physician and care quality, no insurance required.` },
    { q:`Can I use my UHC FSA or HSA for a TeleDirectMD visit in ${stateName}?`, a:`Yes. Telehealth visits with a licensed physician are qualified medical expenses eligible for FSA and HSA payment. If your UHC plan applies your deductible before covering the visit, your FSA or HSA card can be used to pay your cost-sharing. The $79 self-pay option is also FSA/HSA eligible.` },
  ...
  // ── Citable summary for AI extractors (United Healthcare × State landing)
  ...
  const pageUrl_AI = `https://teledirectmd.com/insurance/united-healthcare/${stateSlug}/`;
  ...
  return (
    <div style={{ fontFamily:B.fb, background:B.bg, color:B.navy }}>
      ...
      <CitableSummaryBlock summary={citableSummary_AI} jsonLd={citableJsonLd_AI} idSuffix={`united-healthcare-${stateSlug}`} />
      ...
      <div style={{ maxWidth:880, margin:"0 auto", padding:"0 24px" }}>
        ...
        <section style={{ marginBottom:40, padding:"20px 24px", background:"#F9FAFB", border:`1px solid ${B.border}`, borderRadius:B.r }} data-speakable="true">
          ...
          <p style={{ fontSize:14, color:B.text, margin:"0 0 12px", lineHeight:1.6 }}>No UHC plan or uninsured? TeleDirectMD offers $79 self-pay video visits for the same conditions in {stateName}. Browse self-pay options:</p>
