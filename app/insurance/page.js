...
const INSURANCE_FAQS = [
  { q: 'Does TeleDirectMD accept insurance?', a: 'Yes. TeleDirectMD accepts select commercial plans from Aetna, Blue Cross Blue Shield, and UnitedHealthcare in a growing list of states. If your plan is not in-network, you can still see a board-certified physician for a flat $79 self-pay video visit.' },
  ...
  { q: 'Does TeleDirectMD accept Medicaid?', a: 'No. TeleDirectMD does not currently accept any state Medicaid plans (including managed Medicaid products like Aetna Better Health or UnitedHealthcare Community Plan). Patients with Medicaid can book as self-pay for $79.' },
