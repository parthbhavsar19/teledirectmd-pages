...
export const metadata = {
  ...
  description: 'TeleDirectMD accepts Blue Cross Blue Shield plans in AZ, FL, GA, IL, MI, PA & TX. Board-certified physician. Same-day video visits for UTI, sinus infection, hypertension & more.',
  alternates: { canonical: 'https://teledirectmd.com/insurance/blue-cross-blue-shield' },
  openGraph: {
    title: 'Online Doctor That Accepts Blue Cross Blue Shield | TeleDirectMD',
    description: 'In-network with BCBS affiliates in Arizona, Florida, Georgia, Illinois, Michigan, Pennsylvania, and Texas.',
