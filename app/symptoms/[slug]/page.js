    ...
    <>
          ...
          <div className="tdmd-hero-grid">
            <div className="tdmd-hero-copy">
              ...
              <ul className="tdmd-hero-benefits">
                ...
                <li>44 states — same-day, evenings & weekends</li>
      ...
      <section className="tdmd-section" id={`${pid}-insurance`}>
        <div className="tdmd-container" data-speakable="true">
          ...
          <p>The $79 flat rate applies to all 44 states. If you have insurance, TeleDirectMD is in-network with Aetna, BCBS, and UnitedHealthcare in select states — your standard telehealth copay applies in place of the $79.</p>
          <div className="tdmd-related-grid">
        ...
        <div className="tdmd-container">
          <div className="tdmd-bottom-cta">
            <div className="tdmd-bottom-cta-copy">
              ...
              <p>Same-day, evenings & weekends. Board-certified MD. 44 states. Last reviewed {today}.</p>
            </div>
      ...
      <section className="tdmd-section tdmd-footnote" id={`${pid}-disclaimer`}>
        <div className="tdmd-container">
          ...
          <p>
            This page is informational and is not a diagnosis or substitute for medical care. <strong>Last reviewed {today} by Parth Bhavsar, MD (NPI 1104323203), board-certified Family Medicine.</strong> Telehealth services are for non-emergency conditions in adults 18+ physically located in one of TeleDirectMD&apos;s 44 licensed states at the time of the visit. We do not prescribe controlled substances. If you are experiencing a medical emergency — including any of the red-flag scenarios above — call 911 or go to the nearest emergency room.
          </p>
        </div>
      </section>
    </>
