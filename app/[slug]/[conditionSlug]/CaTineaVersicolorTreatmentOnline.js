/**
 * CaTineaVersicolorTreatmentOnline.js — production California × Tinea Versicolor condition page (v3)
 *
 * Rendered by app/[slug]/[conditionSlug]/page.js when slug === 'ca' and
 * conditionSlug === 'tinea-versicolor-treatment-online'.
 *
 ...
 *
 * Authority: AAD
 * Guideline: CDC Tinea Versicolor Guidance + AAD Skin Infection Guidelines
 *
...
const PAGE_URL = 'https://teledirectmd.com/ca/tinea-versicolor-treatment-online/';
const PAGE_TITLE = 'Tinea Versicolor (Pityriasis Versicolor) Online in California | TeleDirectMD';
...
const FAQ_ITEMS = [
  {
    id: 'ca-tinea-versicolor-treatment-online-faq-0',
    question: 'Can I get tinea versicolor treatment online in California?',
    answer: (
      <p>
        Yes. California Business and Professions Code Section 2290.5 permits California-licensed physicians to evaluate and treat tinea versicolor by secure video visit. TeleDirectMD physicians follow CDC and AAD guidelines, prescribing ketoconazole 2% shampoo, selenium sulfide 2.5% lotion, and oral fluconazole for widespread disease. Adults 18+ in California can book same-day. Self pay is $79. Aetna is in-network as of April 30, 2026.
      </p>
    ),
  },
  {
    id: 'ca-tinea-versicolor-treatment-online-faq-1',
    question: 'What causes tinea versicolor?',
    answer: (
      <p>
        Tinea versicolor is caused by Malassezia yeast (primarily M. globosa and M. furfur) — a normal skin commensal that overgrows under warm, humid conditions, disrupting melanin production. This causes characteristic hypopigmented or hyperpigmented macules with fine scale. Factors that promote overgrowth include sweating, hot/humid weather, oily skin, immunosuppression, and malnutrition. California's warm climate makes tinea versicolor more common, especially in summer.
      </p>
    ),
  },
  {
    id: 'ca-tinea-versicolor-treatment-online-faq-2',
    question: 'What tinea versicolor medications can a California telehealth doctor prescribe?',
    answer: (
      <p>
        A California-licensed telehealth physician can prescribe: ketoconazole 2% shampoo (body wash application), selenium sulfide 2.5% lotion, oral fluconazole 150–300 mg weekly for 2–3 weeks for widespread disease. OTC ketoconazole 1% (Nizoral A-D) and zinc pyrithione products are recommended for maintenance. Prescriptions are transmitted electronically under AB 2789.
      </p>
    ),
  },
  {
    id: 'ca-tinea-versicolor-treatment-online-faq-3',
    question: 'Does California require an in-person visit before tinea versicolor telehealth?',
    answer: (
      <p>
        No. California B&P Code §2290.5 does not require a prior in-person visit. Classic tinea versicolor presentation — hypopigmented or hyperpigmented macules with fine scale on trunk, shoulders, or upper arms — is appropriately evaluated by video in California adults 18+.
      </p>
    ),
  },
  {
    id: 'ca-tinea-versicolor-treatment-online-faq-4',
    question: 'When does tinea versicolor require in-person care?',
    answer: (
      <p>
        Seek in-person dermatology if tinea versicolor does not respond to 2+ courses of topical antifungals (KOH prep or dermatoscopy may be needed for confirmation), if widespread pigment changes suggest an alternative diagnosis (vitiligo, post-inflammatory pigmentation), or if the condition occurs in an immunocompromised patient.
      </p>
    ),
  },
  {
    id: 'ca-tinea-versicolor-treatment-online-faq-5',
    question: 'Is Aetna in-network for tinea versicolor treatment at TeleDirectMD in California?',
    answer: (
      <p>
  ...
  {
    id: 'ca-tinea-versicolor-treatment-online-faq-6',
    question: 'What is the cost of tinea versicolor treatment in California?',
    answer: (
      <p>
        TeleDirectMD charges $79 self-pay. Generic oral fluconazole costs ~$5–$15 per dose. Prescription ketoconazole 2% shampoo ~$15–$35. Selenium sulfide 2.5% ~$10–$20. OTC options are $8–$15 at California pharmacies. Prescription cost is separate from the $79 TeleDirectMD visit fee.
      </p>
    ),
  },
  {
    id: 'ca-tinea-versicolor-treatment-online-faq-7',
    question: 'Why does the skin stay discolored after tinea versicolor treatment?',
    answer: (
      <p>
        Tinea versicolor causes pigment changes because Malassezia yeast produces azelaic acid, which inhibits melanocytes (pigment-producing cells) in affected areas. After antifungal treatment kills the yeast, pigmentation takes months to normalize — hypopigmented patches may remain pale for 1–3 months as melanocytes gradually recover. This is not treatment failure. TeleDirectMD physicians counsel patients on this expected timeline under California B&P §2290.5 standard of care.
      </p>
    ),
  },
  {
    id: 'ca-tinea-versicolor-treatment-online-faq-8',
    question: 'Does tinea versicolor recur after treatment?',
    answer: (
      <p>
        Yes. Tinea versicolor has a high recurrence rate — approximately 80% within 2 years without maintenance therapy per AAD data. Malassezia yeast is a normal skin commensal and cannot be permanently eradicated. Monthly maintenance application of ketoconazole 2% shampoo or selenium sulfide 2.5% lotion significantly reduces recurrence. Annual prophylactic oral fluconazole before California's hot season is another validated strategy.
      </p>
    ),
  },
  {
    id: 'ca-tinea-versicolor-treatment-online-faq-9',
    question: 'Does California\'s AB 744 parity law cover tinea versicolor telehealth?',
    answer: (
      <p>
  ...
  {
    id: 'ca-tinea-versicolor-treatment-online-faq-10',
    question: 'Will my prescription be sent electronically to a California pharmacy?',
    answer: (
      <p>
  ...
  {
    id: 'ca-tinea-versicolor-treatment-online-faq-11',
    question: 'Is tinea versicolor contagious?',
    answer: (
      <p>
        Tinea versicolor is generally not considered contagious in the traditional sense — Malassezia yeast is a normal skin commensal present on almost all adults. Contact with an affected person does not predictably cause tinea versicolor in others. The condition develops when Malassezia overgrows due to individual factors (sweating, sebaceous activity, immune state) — not through direct transmission.
      </p>
    ),
  },
];

const SCHEMAS = [{"@context": "https://schema.org", "@type": "MedicalWebPage", "name": "Tinea Versicolor (Pityriasis Versicolor) Online in California | TeleDirectMD", "url": "https://teledirectmd.com/ca/tinea-versicolor-treatment-online/", "description": "Tinea versicolor (pityriasis versicolor) treatment online for California adults. Board-certified Family Medicine MD. CDC + AAD guideline-based. Self pay $79. Aetna in-network. Same-day video visits.", "datePublished": "2026-05-20", "dateModified": "2026-05-20", "inLanguage": "en-US", "about": {"@type": "MedicalCondition", "name": "Tinea Versicolor", "code": {"@type": "MedicalCode", "code": "B36.0", "codingSystem": "ICD-10-CM"}}, "medicalAudience": {"@type": "MedicalAudience", "audienceType": "Patient", "geographicArea": {"@type": "AdministrativeArea", "name": "California"}}, "reviewedBy": {"@type": "Physician", "@id": "https://teledirectmd.com/about/#physician-parth-bhavsar", "name": "Parth Bhavsar, MD", "identifier": {"@type": "PropertyValue", "propertyID": "NPI", "value": "1104323203"}, "medicalSpecialty": "Family Medicine", "hasCredential": [{"@type": "EducationalOccupationalCredential", "credentialCategory": "degree", "name": "Doctor of Medicine (MD)"}, {"@type": "EducationalOccupationalCredential", "credentialCategory": "certification", "name": "Board Certification \u2014 American Board of Family Medicine"}], "licensedIn": "California", "worksFor": {"@type": "MedicalOrganization", "name": "TeleDirectMD", "url": "https://teledirectmd.com"}, "sameAs": ["https://npiregistry.cms.hhs.gov/provider-view/1104323203", "https://teledirectmd.com/about/"]}, "speakable": {"@type": "SpeakableSpecification", "cssSelector": ["#ca-tinea-versicolor-treatment-online-opening", "#ca-tinea-versicolor-treatment-online-opening p", ".tdmd-ca-tinea-versicolor-treatment-online__byline", "#ca-tinea-versicolor-treatment-online-faq"]}}, {"@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [{"@type": "Question", "name": "Can I get tinea versicolor treatment online in California?", "acceptedAnswer": {"@type": "Answer", "text": "Yes. California Business and Professions Code Section 2290.5 permits California-licensed physicians to evaluate and treat tinea versicolor by secure video visit. TeleDirectMD physicians follow CDC and AAD guidelines, prescribing ketoconazole 2% shampoo, selenium sulfide 2.5% lotion, and oral fluconazole for widespread disease. Adults 18+ in California can book same-day. Self pay is $79. Aetna is in-network as of April 30, 2026."}}, {"@type": "Question", "name": "What causes tinea versicolor?", "acceptedAnswer": {"@type": "Answer", "text": "Tinea versicolor is caused by Malassezia yeast (primarily M. globosa and M. furfur) \u2014 a normal skin commensal that overgrows under warm, humid conditions, disrupting melanin production. This causes characteristic hypopigmented or hyperpigmented macules with fine scale. Factors that promote overgrowth include sweating, hot/humid weather, oily skin, immunosuppression, and malnutrition. California's warm climate makes tinea versicolor more common, especially in summer."}}, {"@type": "Question", "name": "What tinea versicolor medications can a California telehealth doctor prescribe?", "acceptedAnswer": {"@type": "Answer", "text": "A California-licensed telehealth physician can prescribe: ketoconazole 2% shampoo (body wash application), selenium sulfide 2.5% lotion, oral fluconazole 150\u2013300 mg weekly for 2\u20133 weeks for widespread disease. OTC ketoconazole 1% (Nizoral A-D) and zinc pyrithione products are recommended for maintenance. Prescriptions are transmitted electronically under AB 2789."}}, {"@type": "Question", "name": "Does California require an in-person visit before tinea versicolor telehealth?", "acceptedAnswer": {"@type": "Answer", "text": "No. California B&P Code \u00a72290.5 does not require a prior in-person visit. Classic tinea versicolor presentation \u2014 hypopigmented or hyperpigmented macules with fine scale on trunk, shoulders, or upper arms \u2014 is appropriately evaluated by video in California adults 18+."}}, {"@type": "Question", "name": "When does tinea versicolor require in-person care?", "acceptedAnswer": {"@type": "Answer", "text": "Seek in-person dermatology if tinea versicolor does not respond to 2+ courses of topical antifungals (KOH prep or dermatoscopy may be needed for confirmation), if widespread pigment changes suggest an alternative diagnosis (vitiligo, post-inflammatory pigmentation), or if the condition occurs in an immunocompromised patient."}}, {"@type": "Question", "name": "Is Aetna in-network for tinea versicolor treatment at TeleDirectMD in California?", "acceptedAnswer": {"@type": "Answer", "text": "Yes. Aetna became an active in-network payor for TeleDirectMD in California effective April 30, 2026. UnitedHealthcare Commercial is approved effective May 29, 2026. Self pay is $79."}}, {"@type": "Question", "name": "What is the cost of tinea versicolor treatment in California?", "acceptedAnswer": {"@type": "Answer", "text": "TeleDirectMD charges $79 self-pay. Generic oral fluconazole costs ~$5\u2013$15 per dose. Prescription ketoconazole 2% shampoo ~$15\u2013$35. Selenium sulfide 2.5% ~$10\u2013$20. OTC options are $8\u2013$15 at California pharmacies. Prescription cost is separate from the $79 TeleDirectMD visit fee."}}, {"@type": "Question", "name": "Why does the skin stay discolored after tinea versicolor treatment?", "acceptedAnswer": {"@type": "Answer", "text": "Tinea versicolor causes pigment changes because Malassezia yeast produces azelaic acid, which inhibits melanocytes (pigment-producing cells) in affected areas. After antifungal treatment kills the yeast, pigmentation takes months to normalize \u2014 hypopigmented patches may remain pale for 1\u20133 months as melanocytes gradually recover. This is not treatment failure. TeleDirectMD physicians counsel patients on this expected timeline under California B&P \u00a72290.5 standard of care."}}, {"@type": "Question", "name": "Does tinea versicolor recur after treatment?", "acceptedAnswer": {"@type": "Answer", "text": "Yes. Tinea versicolor has a high recurrence rate \u2014 approximately 80% within 2 years without maintenance therapy per AAD data. Malassezia yeast is a normal skin commensal and cannot be permanently eradicated. Monthly maintenance application of ketoconazole 2% shampoo or selenium sulfide 2.5% lotion significantly reduces recurrence. Annual prophylactic oral fluconazole before California's hot season is another validated strategy."}}, {"@type": "Question", "name": "Does California's AB 744 parity law cover tinea versicolor telehealth?", "acceptedAnswer": {"@type": "Answer", "text": "Yes, for in-network commercial plans. California AB 744 (2019) requires commercial health plans to reimburse telehealth on the same basis as in-person services. Aetna and UHC Commercial are in-network for TeleDirectMD in California."}}, {"@type": "Question", "name": "Will my prescription be sent electronically to a California pharmacy?", "acceptedAnswer": {"@type": "Answer", "text": "Yes. California AB 2789 (effective January 1, 2022) requires all prescriptions to be issued electronically. TeleDirectMD sends e-prescriptions to your chosen California pharmacy \u2014 CVS, Walgreens, Rite Aid, Walmart, Safeway \u2014 during or after your visit."}}, {"@type": "Question", "name": "Is tinea versicolor contagious?", "acceptedAnswer": {"@type": "Answer", "text": "Tinea versicolor is generally not considered contagious in the traditional sense \u2014 Malassezia yeast is a normal skin commensal present on almost all adults. Contact with an affected person does not predictably cause tinea versicolor in others. The condition develops when Malassezia overgrows due to individual factors (sweating, sebaceous activity, immune state) \u2014 not through direct transmission."}}]}, {"@context": "https://schema.org", "@type": "HowTo", "name": "How to Get Tinea Versicolor (Pityriasis Versicolor) Online in California", "description": "Three steps to receive tinea versicolor (pityriasis versicolor) evaluation and, if appropriate, a prescription from a California-licensed board-certified physician.", "totalTime": "PT30M", "estimatedCost": {"@type": "MonetaryAmount", "currency": "USD", "value": "79"}, "step": [{"@type": "HowToStep", "position": 1, "name": "Book your video visit", "text": "Visit teledirectmd.com and select California Tinea Versicolor treatment. No referral needed. Self pay $79. Many visits available same day.", "url": "https://teledirectmd.com/book-online"}, {"@type": "HowToStep", "position": 2, "name": "See a California-licensed MD by secure video", "text": "Connect with a board-certified Family Medicine physician licensed in California. The physician reviews your symptoms, history, and red-flag screening. Consent per CA B&P Section 2290.5 confirmed.", "url": "https://teledirectmd.com/ca/tinea-versicolor-treatment-online/"}, {"@type": "HowToStep", "position": 3, "name": "Receive your treatment plan and e-prescription", "text": "If medication is appropriate, a California-compliant e-prescription is sent to your chosen pharmacy during or after the visit.", "url": "https://teledirectmd.com/ca/tinea-versicolor-treatment-online/"}]}, {"@context": "https://schema.org", "@type": "BreadcrumbList", "itemListElement": [{"@type": "ListItem", "position": 1, "name": "TeleDirectMD", "item": "https://teledirectmd.com"}, {"@type": "ListItem", "position": 2, "name": "California", "item": "https://teledirectmd.com/ca/"}, {"@type": "ListItem", "position": 3, "name": "Tinea Versicolor (Pityriasis Versicolor) Online in California", "item": "https://teledirectmd.com/ca/tinea-versicolor-treatment-online/"}]}];
...
export default function CaTineaVersicolorTreatmentOnline() {
  const pid = 'ca-tinea-versicolor-treatment-online';
      ...
      <div className="tdmd-ca-cond">
        ...
        <nav className="tdmd-breadcrumbs" aria-label="Breadcrumb">
          <div className="tdmd-container" style={{ paddingTop: '0.5rem', paddingBottom: 0 }}>
            ...
            <span className="tdmd-bc-sep" aria-hidden="true">/</span>
            <span aria-current="page">Tinea Versicolor (Pityriasis Versicolor) Online</span>
          </div>
        </nav>
          ...
          <div className="tdmd-container">
            <div className="tdmd-hero-grid">
              <div className="tdmd-hero-copy">
                ...
                <p className="tdmd-icd"><strong>ICD-10 commonly used:</strong> B36.0 (Pityriasis versicolor)</p>
              </div>

              <div className="tdmd-hero-side">
                <div className="tdmd-hero-card">
                  <h2>Online MD-Only Tinea Versicolor Care in California</h2>
                  <ul>
                    <li>Fast evaluation for tinea versicolor (pityriasis versicolor) symptoms</li>
        ...
        <section className="tdmd-section" id={`${pid}-eligibility`}>
          <div className="tdmd-container">
            <h2>Tinea Versicolor (Pityriasis Versicolor) Telehealth Eligibility Checklist for California</h2>
            ...
            <div className="tdmd-ca-cond__dual">
              <div className="tdmd-ca-cond__dual-card tdmd-ca-cond__dual-card--good">
                ...
                <ul>
                  ...
                  <li>Classic tinea versicolor — hypopigmented or hyperpigmented macules on trunk, shoulders, upper arms with fine scale</li>
                  <li>Recurrent tinea versicolor requiring maintenance therapy</li>
                  <li>Tinea versicolor appearing seasonally (summer flare) in California</li>
                  <li>Post-treatment hypopigmentation counseling (pigmentation takes months to normalize)</li>
                  <li>Known tinea versicolor seeking prescription-strength topical or oral antifungal</li>
                </ul>
              </div>
              <div className="tdmd-ca-cond__dual-card tdmd-ca-cond__dual-card--alert">
                <h3>&#10007; Seek In-Person or Emergency Care If</h3>
                <ul>
                  <li>Tinea versicolor not responding to 2+ courses of topical antifungals — in-person dermatology for KOH prep confirmation</li>
                  <li>Widespread pigment changes without clear history of tinea versicolor — rule out vitiligo or other pigmentation disorder in-person</li>
                  <li>Hypopigmentation after treatment that does not repigment over several months — in-person dermatology</li>
                  <li>Tinea versicolor in immunocompromised patient — broader evaluation needed</li>
                  <li>Rash extending to scalp or mucous membranes — alternative diagnosis must be evaluated in person</li>
                </ul>
        ...
        <section className="tdmd-section tdmd-section-highlight" id={`${pid}-ca-law`}>
          <div className="tdmd-container">
            <h2>California Telehealth Law and Your Tinea Versicolor (Pityriasis Versicolor) Visit</h2>
            ...
            <h3>Are tinea versicolor (pityriasis versicolor) medications controlled substances under California law?</h3>
            <p>
              Ketoconazole 2% shampoo/cream, selenium sulfide 2.5% lotion, and oral fluconazole are not controlled substances. They can be prescribed via California telehealth and transmitted electronically to any California pharmacy under Assembly Bill 2789. California requires all prescriptions to be issued electronically under Assembly Bill 2789 (effective January 1, 2022), per the <a href="https://www.mbc.ca.gov/News/" rel="noopener" target="_blank">Medical Board of California</a>. TeleDirectMD does not prescribe controlled substances in any state.
            </p>
          </div>
        </section>
        ...
        <section className="tdmd-section" id={`${pid}-how-it-works`} itemScope itemType="https://schema.org/HowTo">
          <div className="tdmd-container">
            <h2 itemProp="name">How Online Tinea Versicolor (Pityriasis Versicolor) Works in California</h2>
        ...
        <section className="tdmd-section tdmd-section-highlight" id={`${pid}-cost`}>
          <div className="tdmd-container">
            <h2>Tinea Versicolor (Pityriasis Versicolor) Cost &amp; Insurance in California</h2>
            ...
            <div className="tdmd-price-grid">
              ...
              <div className="tdmd-price-chart" role="group" aria-label="Typical Tinea Versicolor cost comparison">
                <h3>Typical Tinea Versicolor Visit Cost in California</h3>
        ...
        <section className="tdmd-section" id={`${pid}-medications`}>
          <div className="tdmd-container">
            <h2>Tinea Versicolor (Pityriasis Versicolor) Medication Options and Costs in California</h2>
            <p>
              Medications for tinea versicolor (pityriasis versicolor) are selected based on current guidelines from <a href="https://www.aad.org/public/diseases/a-z/tinea-versicolor-overview" rel="noopener" target="_blank">AAD</a>, patient history, allergies, and relevant contraindications assessed at the visit. GoodRx-verified pricing is shown below.
            </p>
            <div className="tdmd-table-wrap">
              <table className="tdmd-table" aria-label="Tinea Versicolor (Pityriasis Versicolor) medication options and GoodRx prices">
                <caption style={{ captionSide: 'bottom', textAlign: 'left', padding: '0.5rem 0', fontSize: '0.85rem', color: 'var(--tdmd-muted)' }}>
                ...
                <tbody>
                  ...
                  <tr className="tdmd-ca-uti__med-firstline">
                    <td><strong>Selenium sulfide 2.5% lotion/shampoo</strong> · First-line</td>
                    <td>Apply to affected areas daily for 1 week, leave on 10 min, rinse — then monthly for maintenance</td>
                    <td><a href="https://www.goodrx.com/selenium-sulfide" target="_blank" rel="noopener">~$10–$20 / 120 mL</a></td>
                    <td>First-line topical per AAD. Reduces Malassezia density. Can temporarily discolor light-colored hair and fabrics. Apply at night, rinse in AM.</td>
                  </tr>
                  <tr className="tdmd-ca-uti__med-firstline">
                    <td><strong>Fluconazole 150–300 mg oral (single dose or weekly ×2–4)</strong> · First-line</td>
                    <td>300 mg weekly for 2–3 weeks, or 150 mg single dose (for localized disease)</td>
                    <td><a href="https://www.goodrx.com/fluconazole" target="_blank" rel="noopener">~$5–$15 / dose</a></td>
                    <td>Oral first-line for extensive or recurrent tinea versicolor per AAD. Single 300–400 mg dose with exercise to enhance sweating (distributes drug to skin) is a validated approach.</td>
                  </tr>
                  <tr>
        ...
        <section className="tdmd-section" id={`${pid}-dual-path`}>
          <div className="tdmd-container">
            ...
            <p>For most adults with mild to moderate tinea versicolor (pityriasis versicolor) without red-flag symptoms, a video visit is appropriate and convenient. Some situations require in-person evaluation. Use the comparison below to determine the right care pathway for you.</p>
            <div className="tdmd-ca-cond__dual">
              <div className="tdmd-ca-cond__dual-card tdmd-ca-cond__dual-card--good">
        ...
        <section className="tdmd-section tdmd-faq" id={`${pid}-faq`}>
          <div className="tdmd-container">
            <FaqAccordion
              sectionTitle="Frequently Asked Questions — Tinea Versicolor (Pityriasis Versicolor) in California"
              items={FAQ_ITEMS}
            />
          ...
          <div className="tdmd-container">
            ...
            <div className="tdmd-ca-cond__sibling-grid">
              <a key="tinea-treatment-online" className="tdmd-ca-uti__sibling" href="/ca/tinea-treatment-online/">
                  <span className="tdmd-ca-uti__sibling-label">Tinea (Ringworm) Treatment in CA</span>
                  <span className="tdmd-ca-uti__sibling-why">Related fungal skin conditions — different causative organism.</span>
                </a>
              <a key="dandruff-treatment-online" className="tdmd-ca-uti__sibling" href="/ca/dandruff-treatment-online/">
                  ...
                  <span className="tdmd-ca-uti__sibling-why">Malassezia species — same yeast implicated in seborrheic dermatitis.</span>
                </a>
              <a key="eczema-treatment-online" className="tdmd-ca-uti__sibling" href="/ca/eczema-treatment-online/">
                  ...
                  <span className="tdmd-ca-uti__sibling-why">Inflammatory rash — differential from tinea versicolor.</span>
                </a>
              <a key="acne-treatment-online" className="tdmd-ca-uti__sibling" href="/ca/acne-treatment-online/">
                  ...
                  <span className="tdmd-ca-uti__sibling-why">Trunk rash — differential from tinea versicolor.</span>
                </a>
              <a key="contact-dermatitis-treatment-online" className="tdmd-ca-uti__sibling" href="/ca/contact-dermatitis-treatment-online/">
                  ...
                  <span className="tdmd-ca-uti__sibling-why">Body rash — differential from tinea versicolor.</span>
                </a>
              <a key="melasma-treatment-online" className="tdmd-ca-uti__sibling" href="/ca/melasma-treatment-online/">
                  ...
                  <span className="tdmd-ca-uti__sibling-why">Pigmentation disorder — differential from post-tinea hypopigmentation.</span>
                </a>
            </div>
          </div>
        </section>
        ...
        <section className="tdmd-section" id={`${pid}-related`}>
          <div className="tdmd-container">
            ...
            <p>This page sits at the intersection of the <a href="/ca/">California state hub</a> and the <a href="/tinea-versicolor-treatment-online/">Tinea Versicolor national condition page</a>. Use the links below to explore insurance details, book a visit, or review other conditions.</p>
            <div className="tdmd-ca-cond__related-links" aria-label="Related resources">
              <a href="/">Home</a>
              <a href="/ca/">California (state pillar)</a>
              <a href="/tinea-versicolor-treatment-online/">National Tinea Versicolor page</a>
              <a href="/health-guides/">Tinea Versicolor health guides</a>
        ...
        <WhatDoesThisCostBlock conditionSlug="tinea-versicolor-treatment-online" conditionName="Tinea Versicolor (Pityriasis Versicolor)" stateName="California" />
        <CompareTeleDirectMDLinkRow conditionSlug="tinea-versicolor-treatment-online" />
        <CommonSymptomsBlock conditionSlug="tinea-versicolor-treatment-online" conditionName="Tinea Versicolor (Pityriasis Versicolor)" />
      </div>
    </>
  );
}
