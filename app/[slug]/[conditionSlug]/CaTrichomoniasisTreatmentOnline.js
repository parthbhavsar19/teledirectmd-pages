/**
 * CaTrichomoniasisTreatmentOnline.js — production California × Trichomoniasis condition page (v3)
 *
 * Rendered by app/[slug]/[conditionSlug]/page.js when slug === 'ca' and
 * conditionSlug === 'trichomoniasis-treatment-online'.
 *
 ...
 * Guideline: CDC STI Treatment Guidelines 2021 — Trichomoniasis
 *
...
const PAGE_URL = 'https://teledirectmd.com/ca/trichomoniasis-treatment-online/';
const PAGE_TITLE = 'Trichomoniasis Treatment Online in California | TeleDirectMD';
...
const FAQ_ITEMS = [
  {
    id: 'ca-trichomoniasis-treatment-online-faq-0',
    question: 'Can I get trichomoniasis treatment online in California?',
    answer: (
      <p>
        Yes, when a confirmed positive test result is available. California B&P Code §2290.5 permits California-licensed physicians to treat trichomoniasis by synchronous video visit. Per the CDC STI Treatment Guidelines 2021, the recommended regimen for women is metronidazole 500 mg orally twice daily × 7 days — preferred over single-dose therapy for higher cure rates. TeleDirectMD requires a confirmed positive trichomoniasis NAAT or wet prep result before prescribing. Self pay is $79. Aetna is in-network as of April 30, 2026.
      </p>
    ),
  },
  {
    id: 'ca-trichomoniasis-treatment-online-faq-1',
    question: 'How common is trichomoniasis in California?',
    answer: (
      <p>
        Trichomoniasis is the most common non-viral STI in the US — affecting an estimated 2.6 million Americans annually per the CDC STI Treatment Guidelines 2021. It is not reportable in California, so precise state-level case counts are not tracked by CDPH, but California's large reproductive-age population suggests a significant burden. Black women have a trichomoniasis prevalence approximately 6× higher than white women, making equitable STI access a CDPH programmatic priority.
      </p>
    ),
  },
  {
    id: 'ca-trichomoniasis-treatment-online-faq-2',
    question: 'What medications treat trichomoniasis in California?',
    answer: (
      <p>
        Per the CDC STI Treatment Guidelines 2021, first-line treatments include: for women — metronidazole 500 mg orally twice daily × 7 days (preferred, approximately $12 / 14 tablets with GoodRx); for men — metronidazole 2 g single dose. Alternative: tinidazole 2 g single dose (approximately $15–$25 with GoodRx). Medication costs at the pharmacy are separate from the $79 TeleDirectMD visit fee.
      </p>
    ),
  },
  {
    id: 'ca-trichomoniasis-treatment-online-faq-3',
    question: 'Do both partners need trichomoniasis treatment?',
    answer: (
      <p>
        Yes. All sexual contacts should be evaluated and treated simultaneously to prevent reinfection, per CDC STI Treatment Guidelines 2021. California allows expedited partner therapy (EPT) for trichomoniasis under Health & Safety Code §120582. Abstain from sexual contact until both partners have completed treatment and symptoms have fully resolved — typically 7 days after completing the 7-day regimen.
      </p>
    ),
  },
  {
    id: 'ca-trichomoniasis-treatment-online-faq-4',
    question: 'Can trichomoniasis be treated during pregnancy?',
    answer: (
      <p>
        Symptomatic trichomoniasis should be treated in pregnancy — however, treatment during pregnancy requires OB/GYN-coordinated care. Metronidazole is considered safe after the first trimester per CDC STI Treatment Guidelines 2021. TeleDirectMD does not manage trichomoniasis in pregnancy — pregnant patients must be seen in person by their OB/GYN for appropriate evaluation and monitoring.
      </p>
    ),
  },
  {
    id: 'ca-trichomoniasis-treatment-online-faq-5',
    question: 'Is Aetna in-network with TeleDirectMD in California for trichomoniasis treatment?',
    answer: (
      <p>
        Aetna became in-network for TeleDirectMD in California effective April 30, 2026. Verify plan eligibility before your visit. Self pay ($79) is available regardless of insurance. UnitedHealthcare Commercial is also approved effective May 29, 2026, covering commercial and Medicare Advantage plans.
      </p>
    ),
  },
  {
    id: 'ca-trichomoniasis-treatment-online-faq-6',
    question: 'Will Medi-Cal cover trichomoniasis treatment at TeleDirectMD?',
    answer: (
      <p>
        TeleDirectMD is not currently enrolled as a Medi-Cal rendering provider. California DHCS confirms Medi-Cal covers telehealth for enrolled providers. For free or low-cost trichomoniasis care, contact Planned Parenthood California or California Family PACT. TeleDirectMD self-pay is $79.
      </p>
    ),
  },
  {
    id: 'ca-trichomoniasis-treatment-online-faq-7',
    question: 'Can trichomoniasis increase HIV risk in California?',
    answer: (
      <p>
        Yes. Trichomoniasis increases HIV acquisition in women approximately 2-fold, per CDC STI Treatment Guidelines 2021, likely through genital inflammation that disrupts mucosal defenses. The CDC recommends HIV testing whenever trichomoniasis is diagnosed. California's HIV prevention programs through CDPH track STI/HIV co-infection patterns as a public health priority.
      </p>
    ),
  },
  {
    id: 'ca-trichomoniasis-treatment-online-faq-8',
    question: 'Does California AB 744 parity apply to trichomoniasis treatment visits?',
    answer: (
      <p>
  ...
  {
    id: 'ca-trichomoniasis-treatment-online-faq-9',
    question: 'What is the difference between trichomoniasis, BV, and yeast infection?',
    answer: (
      <p>
        All three cause vaginal symptoms but are distinct. Trichomoniasis: frothy yellow-green discharge with fishy odor; STI requiring partner treatment; may cause strawberry cervix; treated with metronidazole. BV: thin gray/white discharge with fishy odor; polymicrobial flora disruption; not always sexually transmitted; treated with metronidazole or clindamycin. Yeast infection: thick white odorless discharge; intense itching; fungal (Candida) cause; treated with antifungals. Per ACOG Practice Bulletin 215, in-person wet prep, pH testing, and NAAT most reliably differentiate these diagnoses.
      </p>
    ),
  },
  {
    id: 'ca-trichomoniasis-treatment-online-faq-10',
    question: 'Does California require an in-person visit before telehealth for trichomoniasis treatment?',
    answer: (
      <p>
        No. California B&P Code §2290.5 does not require a prior in-person visit before telehealth services. TeleDirectMD requires a confirmed positive trichomoniasis test result before prescribing. At-home trichomoniasis NAAT testing is available in California through platforms such as Nurx, Let'sGetChecked, and Planned Parenthood online ordering; results can be shared with TeleDirectMD at booking.
      </p>
    ),
  },
  {
    id: 'ca-trichomoniasis-treatment-online-faq-11',
    question: 'How quickly will my trichomoniasis prescription reach a California pharmacy?',
    answer: (
      <p>
        California requires all prescriptions to be issued electronically under Assembly Bill 2789 (effective January 1, 2022). If metronidazole or tinidazole is appropriate, TeleDirectMD sends an e-prescription to your chosen California pharmacy during or after your visit — most pharmacies fill within 1–4 hours. Metronidazole and tinidazole are not controlled substances.
      </p>
    ),
  },
];

const SCHEMAS = [{"@context": "https://schema.org", "@type": "MedicalWebPage", "name": "Trichomoniasis Treatment Online in California | TeleDirectMD", "url": "https://teledirectmd.com/ca/trichomoniasis-treatment-online/", "description": "Trichomoniasis treatment online for California adults. Board-certified MD. Metronidazole or tinidazole per CDC 2021 guidelines. Confirmed test required. Self pay $79. Aetna in-network. Same-day video visits.", "datePublished": "2026-05-20", "dateModified": "2026-05-20", "inLanguage": "en-US", "about": {"@type": "MedicalCondition", "name": "Trichomoniasis", "code": {"@type": "MedicalCode", "code": "A59.00", "codingSystem": "ICD-10-CM"}}, "medicalAudience": {"@type": "MedicalAudience", "audienceType": "Patient", "geographicArea": {"@type": "AdministrativeArea", "name": "California"}}, "reviewedBy": {"@type": "Physician", "@id": "https://teledirectmd.com/about/#physician-parth-bhavsar", "name": "Parth Bhavsar, MD", "identifier": {"@type": "PropertyValue", "propertyID": "NPI", "value": "1104323203"}, "medicalSpecialty": "Family Medicine", "hasCredential": [{"@type": "EducationalOccupationalCredential", "credentialCategory": "degree", "name": "Doctor of Medicine (MD)"}, {"@type": "EducationalOccupationalCredential", "credentialCategory": "certification", "name": "Board Certification \u2014 American Board of Family Medicine"}], "licensedIn": "California", "worksFor": {"@type": "MedicalOrganization", "name": "TeleDirectMD", "url": "https://teledirectmd.com"}, "sameAs": ["https://npiregistry.cms.hhs.gov/provider-view/1104323203", "https://teledirectmd.com/about/"]}, "speakable": {"@type": "SpeakableSpecification", "cssSelector": ["#ca-trichomoniasis-treatment-online-opening", "#ca-trichomoniasis-treatment-online-opening p", ".tdmd-ca-trichomoniasis-treatment-online__byline", "#ca-trichomoniasis-treatment-online-faq"]}}, {"@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [{"@type": "Question", "name": "Can I get trichomoniasis treatment online in California?", "acceptedAnswer": {"@type": "Answer", "text": "Yes, when a confirmed positive test result is available. California B&P Code \u00a72290.5 permits California-licensed physicians to treat trichomoniasis by synchronous video visit. Per the CDC STI Treatment Guidelines 2021, the recommended regimen for women is metronidazole 500 mg orally twice daily \u00d7 7 days \u2014 preferred over single-dose therapy for higher cure rates. TeleDirectMD requires a confirmed positive trichomoniasis NAAT or wet prep result before prescribing. Self pay is $79. Aetna is in-network as of April 30, 2026."}}, {"@type": "Question", "name": "How common is trichomoniasis in California?", "acceptedAnswer": {"@type": "Answer", "text": "Trichomoniasis is the most common non-viral STI in the US \u2014 affecting an estimated 2.6 million Americans annually per the CDC STI Treatment Guidelines 2021. It is not reportable in California, so precise state-level case counts are not tracked by CDPH, but California's large reproductive-age population suggests a significant burden. Black women have a trichomoniasis prevalence approximately 6\u00d7 higher than white women, making equitable STI access a CDPH programmatic priority."}}, {"@type": "Question", "name": "What medications treat trichomoniasis in California?", "acceptedAnswer": {"@type": "Answer", "text": "Per the CDC STI Treatment Guidelines 2021, first-line treatments include: for women \u2014 metronidazole 500 mg orally twice daily \u00d7 7 days (preferred, approximately $12 / 14 tablets with GoodRx); for men \u2014 metronidazole 2 g single dose. Alternative: tinidazole 2 g single dose (approximately $15\u2013$25 with GoodRx). Medication costs at the pharmacy are separate from the $79 TeleDirectMD visit fee."}}, {"@type": "Question", "name": "Do both partners need trichomoniasis treatment?", "acceptedAnswer": {"@type": "Answer", "text": "Yes. All sexual contacts should be evaluated and treated simultaneously to prevent reinfection, per CDC STI Treatment Guidelines 2021. California allows expedited partner therapy (EPT) for trichomoniasis under Health & Safety Code \u00a7120582. Abstain from sexual contact until both partners have completed treatment and symptoms have fully resolved \u2014 typically 7 days after completing the 7-day regimen."}}, {"@type": "Question", "name": "Can trichomoniasis be treated during pregnancy?", "acceptedAnswer": {"@type": "Answer", "text": "Symptomatic trichomoniasis should be treated in pregnancy \u2014 however, treatment during pregnancy requires OB/GYN-coordinated care. Metronidazole is considered safe after the first trimester per CDC STI Treatment Guidelines 2021. TeleDirectMD does not manage trichomoniasis in pregnancy \u2014 pregnant patients must be seen in person by their OB/GYN for appropriate evaluation and monitoring."}}, {"@type": "Question", "name": "Is Aetna in-network with TeleDirectMD in California for trichomoniasis treatment?", "acceptedAnswer": {"@type": "Answer", "text": "Aetna became in-network for TeleDirectMD in California effective April 30, 2026. Verify plan eligibility before your visit. Self pay ($79) is available regardless of insurance. UnitedHealthcare Commercial is also approved effective May 29, 2026, covering commercial and Medicare Advantage plans."}}, {"@type": "Question", "name": "Will Medi-Cal cover trichomoniasis treatment at TeleDirectMD?", "acceptedAnswer": {"@type": "Answer", "text": "TeleDirectMD is not currently enrolled as a Medi-Cal rendering provider. California DHCS confirms Medi-Cal covers telehealth for enrolled providers. For free or low-cost trichomoniasis care, contact Planned Parenthood California or California Family PACT. TeleDirectMD self-pay is $79."}}, {"@type": "Question", "name": "Can trichomoniasis increase HIV risk in California?", "acceptedAnswer": {"@type": "Answer", "text": "Yes. Trichomoniasis increases HIV acquisition in women approximately 2-fold, per CDC STI Treatment Guidelines 2021, likely through genital inflammation that disrupts mucosal defenses. The CDC recommends HIV testing whenever trichomoniasis is diagnosed. California's HIV prevention programs through CDPH track STI/HIV co-infection patterns as a public health priority."}}, {"@type": "Question", "name": "Does California AB 744 parity apply to trichomoniasis treatment visits?", "acceptedAnswer": {"@type": "Answer", "text": "California Insurance Code \u00a710123.85 (AB 744, 2019) requires commercial health plans to reimburse telehealth on the same basis as in-person services when TeleDirectMD is in-network. Aetna (active April 30, 2026) and UnitedHealthcare Commercial (approved May 29, 2026) are in-network in California."}}, {"@type": "Question", "name": "What is the difference between trichomoniasis, BV, and yeast infection?", "acceptedAnswer": {"@type": "Answer", "text": "All three cause vaginal symptoms but are distinct. Trichomoniasis: frothy yellow-green discharge with fishy odor; STI requiring partner treatment; may cause strawberry cervix; treated with metronidazole. BV: thin gray/white discharge with fishy odor; polymicrobial flora disruption; not always sexually transmitted; treated with metronidazole or clindamycin. Yeast infection: thick white odorless discharge; intense itching; fungal (Candida) cause; treated with antifungals. Per ACOG Practice Bulletin 215, in-person wet prep, pH testing, and NAAT most reliably differentiate these diagnoses."}}, {"@type": "Question", "name": "Does California require an in-person visit before telehealth for trichomoniasis treatment?", "acceptedAnswer": {"@type": "Answer", "text": "No. California B&P Code \u00a72290.5 does not require a prior in-person visit before telehealth services. TeleDirectMD requires a confirmed positive trichomoniasis test result before prescribing. At-home trichomoniasis NAAT testing is available in California through platforms such as Nurx, Let'sGetChecked, and Planned Parenthood online ordering; results can be shared with TeleDirectMD at booking."}}, {"@type": "Question", "name": "How quickly will my trichomoniasis prescription reach a California pharmacy?", "acceptedAnswer": {"@type": "Answer", "text": "California requires all prescriptions to be issued electronically under Assembly Bill 2789 (effective January 1, 2022). If metronidazole or tinidazole is appropriate, TeleDirectMD sends an e-prescription to your chosen California pharmacy during or after your visit \u2014 most pharmacies fill within 1\u20134 hours. Metronidazole and tinidazole are not controlled substances."}}]}, {"@context": "https://schema.org", "@type": "HowTo", "name": "How to Get Trichomoniasis Treatment Online in California", "description": "Three steps to receive trichomoniasis treatment evaluation and, if appropriate, a prescription from a California-licensed board-certified physician.", "totalTime": "PT30M", "estimatedCost": {"@type": "MonetaryAmount", "currency": "USD", "value": "79"}, "step": [{"@type": "HowToStep", "position": 1, "name": "Book your video visit", "text": "Visit teledirectmd.com and select California Trichomoniasis treatment. No referral needed. Self pay $79. Many visits available same day.", "url": "https://teledirectmd.com/book-online"}, {"@type": "HowToStep", "position": 2, "name": "See a California-licensed MD by secure video", "text": "Connect with a board-certified Family Medicine physician licensed in California. The physician reviews your symptoms, history, and red-flag screening. Consent per CA B&P Section 2290.5 confirmed.", "url": "https://teledirectmd.com/ca/trichomoniasis-treatment-online/"}, {"@type": "HowToStep", "position": 3, "name": "Receive your treatment plan and e-prescription", "text": "If medication is appropriate, a California-compliant e-prescription is sent to your chosen pharmacy during or after the visit.", "url": "https://teledirectmd.com/ca/trichomoniasis-treatment-online/"}]}, {"@context": "https://schema.org", "@type": "BreadcrumbList", "itemListElement": [{"@type": "ListItem", "position": 1, "name": "TeleDirectMD", "item": "https://teledirectmd.com"}, {"@type": "ListItem", "position": 2, "name": "California", "item": "https://teledirectmd.com/ca/"}, {"@type": "ListItem", "position": 3, "name": "Trichomoniasis Treatment Online in California", "item": "https://teledirectmd.com/ca/trichomoniasis-treatment-online/"}]}];
...
export default function CaTrichomoniasisTreatmentOnline() {
  const pid = 'ca-trichomoniasis-treatment-online';
      ...
      <div className="tdmd-ca-cond">
        ...
        <nav className="tdmd-breadcrumbs" aria-label="Breadcrumb">
          <div className="tdmd-container" style={{ paddingTop: '0.5rem', paddingBottom: 0 }}>
            ...
            <span className="tdmd-bc-sep" aria-hidden="true">/</span>
            <span aria-current="page">Trichomoniasis Treatment Online</span>
          </div>
        </nav>
          ...
          <div className="tdmd-container">
            <div className="tdmd-hero-grid">
              <div className="tdmd-hero-copy">
                <h1 data-speakable="true">Trichomoniasis Treatment Online in California</h1>
                ...
                <p className="tdmd-icd"><strong>ICD-10 commonly used:</strong> A59.00 (Trichomoniasis, unspecified; actual code assigned at visit)</p>
              </div>

              <div className="tdmd-hero-side">
                <div className="tdmd-hero-card">
                  <h2>Online MD-Only Trichomoniasis Care in California</h2>
                  <ul>
                    <li>Fast evaluation for trichomoniasis treatment symptoms</li>
        ...
        <section className="tdmd-section" id={`${pid}-eligibility`}>
          <div className="tdmd-container">
            <h2>Trichomoniasis Treatment Telehealth Eligibility Checklist for California</h2>
            ...
            <div className="tdmd-ca-cond__dual">
              <div className="tdmd-ca-cond__dual-card tdmd-ca-cond__dual-card--good">
                ...
                <ul>
                  ...
                  <li>Confirmed positive trichomoniasis NAAT or wet prep test result available</li>
                  <li>Classic trichomoniasis symptoms: frothy yellow-green discharge, vulvar irritation, dyspareunia (women) or urethral discharge (men)</li>
                  <li>Not pregnant</li>
                  <li>No pelvic pain, fever, or adnexal tenderness suggesting PID</li>
                  <li>Willing to ensure partner evaluation and treatment to prevent reinfection</li>
                </ul>
              </div>
              <div className="tdmd-ca-cond__dual-card tdmd-ca-cond__dual-card--alert">
                <h3>&#10007; Seek In-Person or Emergency Care If</h3>
                <ul>
                  <li>Trichomoniasis confirmed in pregnancy — requires in-person OB/GYN management due to adverse pregnancy outcome risk</li>
                  <li>Pelvic pain, fever, or adnexal tenderness alongside trichomoniasis (possible PID co-infection)</li>
                  <li>Trichomoniasis with known or suspected HIV co-infection — trich increases HIV acquisition risk 2-fold</li>
                  <li>Treatment failure after confirmed adequate metronidazole course — possible metronidazole-resistant Trichomonas</li>
                  <li>Severe vaginal bleeding or ulceration not explained by typical trichomoniasis presentation</li>
                </ul>
        ...
        <section className="tdmd-section tdmd-section-highlight" id={`${pid}-ca-law`}>
          <div className="tdmd-container">
            <h2>California Telehealth Law and Your Trichomoniasis Treatment Visit</h2>
            ...
            <h3>Are trichomoniasis treatment medications controlled substances under California law?</h3>
            <p>
              Metronidazole and tinidazole — the antibiotics used to treat trichomoniasis — are not controlled substances and can be prescribed via California telehealth and transmitted electronically to any California pharmacy under Assembly Bill 2789. California requires all prescriptions to be issued electronically under Assembly Bill 2789 (effective January 1, 2022), per the <a href="https://www.mbc.ca.gov/News/" rel="noopener" target="_blank">Medical Board of California</a>. TeleDirectMD does not prescribe controlled substances in any state.
            </p>
          </div>
        </section>
        ...
        <section className="tdmd-section" id={`${pid}-how-it-works`} itemScope itemType="https://schema.org/HowTo">
          <div className="tdmd-container">
            <h2 itemProp="name">How Online Trichomoniasis Treatment Works in California</h2>
        ...
        <section className="tdmd-section" id={`${pid}-epidemiology`}>
          <div className="tdmd-container">
            <h2>How Common Is Trichomoniasis in California?</h2>
            <p>
              Trichomoniasis is the most common non-viral STI in the United States, affecting an estimated 2.6 million Americans annually per the CDC STI Treatment Guidelines 2021. Trichomoniasis is not reportable in California — the CDPH STI surveillance program does not publish statewide case counts — but national prevalence estimates suggest hundreds of thousands of Californians are affected. Black women experience a trichomoniasis prevalence approximately 6× higher than white women, making equitable STI access a CDPH programmatic priority. — <a href="https://www.cdph.ca.gov/Programs/CID/DCDC/Pages/InfectiousDiseases/SexuallyTransmittedDiseases.aspx" rel="noopener" target="_blank">CDPH — STI Surveillance Program</a>.
            </p>
            <p>
              Clinical guidance for trichomoniasis treatment is provided by <a href="https://www.cdc.gov/std/treatment-guidelines/trichomoniasis.htm" rel="noopener" target="_blank">Centers for Disease Control and Prevention (CDC)</a> through the CDC STI Treatment Guidelines 2021 — Trichomoniasis. TeleDirectMD follows these guidelines on every patient visit.
            </p>
            <h3>What causes trichomoniasis and who is most at risk in California?</h3>
            <p>
              Trichomoniasis affects California adults across all demographics, though certain populations face higher risk based on the specific condition. The physician reviews your individual risk factors at each visit. Telehealth is appropriate for adults 18 and older with mild to moderate presentations who do not have red-flag symptoms requiring immediate in-person evaluation.
            </p>
          </div>
        </section>
        ...
        <section className="tdmd-section tdmd-section-highlight" id={`${pid}-cost`}>
          <div className="tdmd-container">
            <h2>Trichomoniasis Treatment Cost &amp; Insurance in California</h2>
            ...
            <div className="tdmd-price-grid">
              ...
              <div className="tdmd-price-chart" role="group" aria-label="Typical Trichomoniasis cost comparison">
                <h3>Typical Trichomoniasis Visit Cost in California</h3>
        ...
        <section className="tdmd-section" id={`${pid}-medications`}>
          <div className="tdmd-container">
            <h2>Trichomoniasis Treatment Medication Options and Costs in California</h2>
            <p>
              Medications for trichomoniasis treatment are selected based on current guidelines from <a href="https://www.cdc.gov/std/treatment-guidelines/trichomoniasis.htm" rel="noopener" target="_blank">Centers for Disease Control and Prevention (CDC)</a>, patient history, allergies, and relevant contraindications assessed at the visit. GoodRx-verified pricing is shown below.
            </p>
            <div className="tdmd-table-wrap">
              <table className="tdmd-table" aria-label="Trichomoniasis Treatment medication options and GoodRx prices">
                <caption style={{ captionSide: 'bottom', textAlign: 'left', padding: '0.5rem 0', fontSize: '0.85rem', color: 'var(--tdmd-muted)' }}>
                ...
                <tbody>
                  <tr className="tdmd-ca-uti__med-firstline">
                    <td><strong>Metronidazole 500 mg oral (preferred for women)</strong> · First-line</td>
                    <td>500 mg orally twice daily × 7 days</td>
                    <td><a href="https://www.goodrx.com/metronidazole" target="_blank" rel="noopener">~$12 / 14 tablets with GoodRx</a></td>
                    <td>Preferred regimen for women per CDC 2021 — highest cure rate (approximately 95%). Avoid alcohol during treatment and for 24 hours after. Not for use in first trimester of pregnancy.</td>
                  </tr>
                  <tr className="tdmd-ca-uti__med-firstline">
                    <td><strong>Metronidazole 2 g oral single dose (preferred for men; alternative for women)</strong> · First-line</td>
                    <td>2 g orally as a single dose</td>
                    <td><a href="https://www.goodrx.com/metronidazole" target="_blank" rel="noopener">~$12–$15 with GoodRx</a></td>
                    <td>Preferred for men; alternative for women. Single-dose convenience but lower cure rate for women than 7-day course per CDC 2021. Avoid alcohol during use.</td>
                  </tr>
                  <tr>
                    <td><strong>Tinidazole 2 g oral single dose (alternative)</strong></td>
                    <td>2 g orally as a single dose</td>
                    <td><a href="https://www.goodrx.com/tinidazole" target="_blank" rel="noopener">~$15–$25 with GoodRx</a></td>
                    <td>Alternative to metronidazole per CDC 2021 with similar efficacy and possibly better tolerability. Avoid alcohol during use and for 72 hours after.</td>
                  </tr>
                </tbody>
              </table>
            </div>
        ...
        <section className="tdmd-section" id={`${pid}-dual-path`}>
          <div className="tdmd-container">
            ...
            <p>For most adults with mild to moderate trichomoniasis treatment without red-flag symptoms, a video visit is appropriate and convenient. Some situations require in-person evaluation. Use the comparison below to determine the right care pathway for you.</p>
            <div className="tdmd-ca-cond__dual">
              <div className="tdmd-ca-cond__dual-card tdmd-ca-cond__dual-card--good">
        ...
        <section className="tdmd-section tdmd-faq" id={`${pid}-faq`}>
          <div className="tdmd-container">
            <FaqAccordion
              sectionTitle="Frequently Asked Questions — Trichomoniasis Treatment in California"
              items={FAQ_ITEMS}
            />
          ...
          <div className="tdmd-container">
            ...
            <div className="tdmd-ca-cond__sibling-grid">
              <a key="bv-treatment-online" className="tdmd-ca-uti__sibling" href="/ca/bv-treatment-online/">
                  ...
                  <span className="tdmd-ca-uti__sibling-why">BV and trichomoniasis share overlapping vaginal discharge symptoms — accurate differential diagnosis is essential.</span>
                </a>
              <a key="chlamydia-treatment-online" className="tdmd-ca-uti__sibling" href="/ca/chlamydia-treatment-online/">
                  ...
                  <span className="tdmd-ca-uti__sibling-why">STI co-infection is common — chlamydia testing is recommended when trichomoniasis is confirmed.</span>
                </a>
              <a key="yeast-infection-treatment-online" className="tdmd-ca-uti__sibling" href="/ca/yeast-infection-treatment-online/">
                  ...
                  <span className="tdmd-ca-uti__sibling-why">Vaginal discharge and irritation are shared symptoms — trichomoniasis and VVC require different treatments.</span>
                </a>
              <a key="doxypep-sti-prevention-online" className="tdmd-ca-uti__sibling" href="/ca/doxypep-sti-prevention-online/">
                  ...
                  <span className="tdmd-ca-uti__sibling-why">STI prevention strategy relevant for high-risk adults evaluated for trichomoniasis.</span>
                </a>
              <a key="genital-warts-treatment-online" className="tdmd-ca-uti__sibling" href="/ca/genital-warts-treatment-online/">
                  ...
                  <span className="tdmd-ca-uti__sibling-why">STI co-infection screening recommended when any sexually transmitted infection is confirmed.</span>
                </a>
            </div>
          </div>
        </section>
        ...
        <section className="tdmd-section" id={`${pid}-related`}>
          <div className="tdmd-container">
            ...
            <p>This page sits at the intersection of the <a href="/ca/">California state hub</a> and the <a href="/trichomoniasis-treatment-online/">Trichomoniasis national condition page</a>. Use the links below to explore insurance details, book a visit, or review other conditions.</p>
            <div className="tdmd-ca-cond__related-links" aria-label="Related resources">
              <a href="/">Home</a>
              <a href="/ca/">California (state pillar)</a>
              <a href="/trichomoniasis-treatment-online/">National Trichomoniasis page</a>
              <a href="/health-guides/">Trichomoniasis health guides</a>
        ...
        <section className="tdmd-section" id={`${pid}-references`}>
          <div className="tdmd-container">
            ...
            <ol className="tdmd-ref-list">
              ...
              <li><a href="https://www.cdc.gov/std/treatment-guidelines/trichomoniasis.htm" rel="noopener" target="_blank">CDC STI Treatment Guidelines 2021 — Trichomoniasis. Retrieved May 2026.</a></li>
              ...
              <li><a href="https://www.acog.org/clinical/clinical-guidance/practice-bulletin/articles/2020/01/vaginitis-in-nonpregnant-patients" rel="noopener" target="_blank">ACOG Practice Bulletin 215 — Vaginitis in Nonpregnant Patients. Retrieved May 2026.</a></li>
              <li><a href="https://www.goodrx.com/metronidazole" rel="noopener" target="_blank">GoodRx — Metronidazole Prices. Retrieved May 2026.</a></li>
        ...
        <WhatDoesThisCostBlock conditionSlug="trichomoniasis-treatment-online" conditionName="Trichomoniasis Treatment" stateName="California" />
        <CompareTeleDirectMDLinkRow conditionSlug="trichomoniasis-treatment-online" />
        <CommonSymptomsBlock conditionSlug="trichomoniasis-treatment-online" conditionName="Trichomoniasis Treatment" />
      </div>
    </>
  );
}
