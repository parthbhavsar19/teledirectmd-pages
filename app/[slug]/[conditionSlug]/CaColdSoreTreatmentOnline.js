...
const FAQ_ITEMS = [
  ...
  { question: 'Is Aetna in-network with TeleDirectMD in California for cold sore treatment?', answer: (<p dangerouslySetInnerHTML={{ __html: "Aetna became in-network for TeleDirectMD in California effective April 30, 2026. Verify plan eligibility with Aetna before your visit. Self pay ($49) is available regardless of insurance. See <a href='/insurance'>all insurance options</a>." }} />) },
  { question: 'Will Medi-Cal cover cold sore treatment at TeleDirectMD?', answer: (<p dangerouslySetInnerHTML={{ __html: "TeleDirectMD is not currently enrolled as a Medi-Cal rendering provider. <a href='https://www.dhcs.ca.gov/provgovpart/Pages/TelehealthFAQ.aspx' rel='noopener' target='_blank'>California DHCS</a> confirms Medi-Cal covers telehealth for enrolled providers. If you have Medi-Cal, use the $49 self-pay option or seek a Medi-Cal-enrolled telehealth provider." }} />) },
          ...
          <div className="tdmd-container">
            ...
            <div className="tdmd-decision-flow">
              <div className="tdmd-decision-step tdmd-decision-step-check">
                ...
                <div className="tdmd-decision-content"><h3>Book your California video visit</h3><p>No referral or insurance required. Self pay $49. Before your visit, note your symptoms, prior diagnoses, medications, and allergies.</p></div>
              </div>
              <div className="tdmd-decision-step tdmd-decision-step-check">
        ...
        <section className="tdmd-section tdmd-section-highlight" id={`${pid}-cost`}>
          <div className="tdmd-container">
            ...
            <div className="tdmd-price-grid">
              <div className="tdmd-price-card"><h3>TeleDirectMD Video Visit</h3><p className="tdmd-price-big">$49</p><p className="tdmd-price-sub">Self-pay flat fee — no subscription</p><ul className="tdmd-price-includes"><li>Board-certified MD evaluation</li><li>Guideline-based treatment plan</li><li>e-Prescription to your CA pharmacy</li><li>Follow-up instructions and prevention guidance</li></ul></div>
          ...
          <div className="tdmd-container">
            ...
            <div className='tdmd-ca-cold-sore__dual'>
              <div className='tdmd-ca-cold-sore__dual-card tdmd-ca-cold-sore__dual-card--good'>
                ...
                <ul dangerouslySetInnerHTML={{ __html: '<li>Classic recurrent cold sore symptoms: familiar tingling prodrome, then labial blisters</li><li>Prior confirmed cold sore history</li><li>No fever or systemic illness</li><li>Adult 18+, located in California</li><li>Aetna or UHC Commercial (in-network), or self pay $49</li>' }} />
              </div>
