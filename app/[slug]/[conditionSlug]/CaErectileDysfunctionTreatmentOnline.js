/**
 * CaErectileDysfunctionTreatmentOnline.js — production California × Erectile Dysfunction (ED) condition page (v3)
 *
 ...
 *
 * Authority: American Urological Association (AUA)
 * Guideline: AUA Erectile Dysfunction Guideline (2018)
 *
...
const PAGE_URL = 'https://teledirectmd.com/ca/erectile-dysfunction-treatment-online/';
const PAGE_TITLE = 'Erectile Dysfunction Treatment Online in California | TeleDirectMD';
...
const FAQ_ITEMS = [
  {
    id: 'ca-erectile-dysfunction-treatment-online-faq-0',
    question: 'Can I get erectile dysfunction treatment online in California?',
    answer: (
      <p>
        Yes. California Business and Professions Code Section 2290.5 permits California-licensed physicians to evaluate and treat erectile dysfunction by synchronous video visit. Per the AUA ED guideline (2018), first-line treatment for ED is a PDE5 inhibitor — sildenafil or tadalafil. TeleDirectMD performs cardiovascular screening and contraindication review — particularly the nitrate absolute contraindication — before prescribing. Self pay is $79. Aetna is in-network as of April 30, 2026.
      </p>
    ),
  },
  {
    id: 'ca-erectile-dysfunction-treatment-online-faq-1',
    question: 'What are PDE5 inhibitors and how do they work for ED?',
    answer: (
      <p>
        PDE5 inhibitors — sildenafil (Viagra generic) and tadalafil (Cialis generic) — are the first-line pharmacological treatment for ED per the AUA 2018 ED guideline. They inhibit the enzyme PDE5, increasing cyclic GMP levels and enhancing smooth muscle relaxation and blood flow to the corpus cavernosum during sexual stimulation. CRITICAL: PDE5 inhibitors are absolutely contraindicated with any nitrate medication (nitroglycerin, isosorbide mononitrate/dinitrate, amyl nitrite/poppers) — the combination can cause severe, potentially fatal hypotension. TeleDirectMD always screens for nitrate use before prescribing.
      </p>
    ),
  },
  {
    id: 'ca-erectile-dysfunction-treatment-online-faq-2',
    question: 'How much does sildenafil (Viagra generic) cost in California with GoodRx?',
    answer: (
      <p>
        Generic sildenafil costs approximately $11 for 10 × 100 mg tablets with a GoodRx coupon at goodrx.com as of May 2026 — a fraction of brand-name Viagra's retail price. Generic tadalafil is similarly affordable at approximately $11 / 10 tablets. Prescription costs at the pharmacy are separate from the TeleDirectMD $79 visit fee.
      </p>
    ),
  },
  {
    id: 'ca-erectile-dysfunction-treatment-online-faq-3',
    question: 'What are the contraindications for ED medications in California?',
    answer: (
      <p>
        Per the AUA ED guideline, ABSOLUTE contraindications to PDE5 inhibitors include: any organic nitrate or nitric oxide donor (nitroglycerin, isosorbide mononitrate, isosorbide dinitrate, amyl nitrite/poppers); recent (within 90 days) MI or stroke; unstable angina; uncontrolled blood pressure; and severe hepatic impairment. TeleDirectMD reviews your complete medication list and cardiovascular history at every visit before prescribing.
      </p>
    ),
  },
  {
    id: 'ca-erectile-dysfunction-treatment-online-faq-4',
    question: 'How common is erectile dysfunction in California men?',
    answer: (
      <p>
        ED affects approximately 30 million American men per the AUA. Prevalence increases with age: approximately 40% at age 40, rising to approximately 70% at age 70. With California's approximately 15 million adult men, an estimated 4–5 million California men may experience ED. Vascular risk factors — hypertension, type 2 diabetes, hyperlipidemia, smoking, obesity — are the most common underlying causes. Psychological factors, including performance anxiety, account for a significant proportion in younger men under 40.
      </p>
    ),
  },
  {
    id: 'ca-erectile-dysfunction-treatment-online-faq-5',
    question: 'Does ED need evaluation for underlying cardiovascular disease in California?',
    answer: (
      <p>
        ED can be a signal of underlying cardiovascular disease. Per the AUA ED guideline, new-onset ED in men under 40 or in men with cardiovascular risk factors warrants evaluation for coronary artery disease — ED and coronary artery disease share the same pathophysiology (endothelial dysfunction). TeleDirectMD takes a thorough cardiovascular history and recommends in-person evaluation when cardiovascular disease is suspected.
      </p>
    ),
  },
  {
    id: 'ca-erectile-dysfunction-treatment-online-faq-6',
    question: 'Is Aetna in-network with TeleDirectMD in California for ED treatment?',
    answer: (
      <p>
        Aetna became in-network for TeleDirectMD in California effective April 30, 2026. Verify plan eligibility before your visit. Self pay ($79) is available regardless of insurance status. UnitedHealthcare Commercial is also approved effective May 29, 2026.
      </p>
    ),
  },
  {
    id: 'ca-erectile-dysfunction-treatment-online-faq-7',
    question: 'Will Medi-Cal cover ED treatment at TeleDirectMD?',
    answer: (
      <p>
        TeleDirectMD is not currently enrolled as a Medi-Cal rendering provider. California DHCS confirms Medi-Cal covers telehealth for enrolled providers. If you have Medi-Cal, use the $79 self-pay option or seek a Medi-Cal-enrolled telehealth provider at dhcs.ca.gov.
      </p>
    ),
  },
  {
    id: 'ca-erectile-dysfunction-treatment-online-faq-8',
    question: 'Does California AB 744 parity apply to ED treatment telehealth visits?',
    answer: (
      <p>
  ...
  {
    id: 'ca-erectile-dysfunction-treatment-online-faq-9',
    question: 'What is the difference between sildenafil and tadalafil for ED in California?',
    answer: (
      <p>
        Both sildenafil (Viagra generic) and tadalafil (Cialis generic) are FDA-approved PDE5 inhibitors for ED. Sildenafil: onset 30–60 minutes; duration 4–6 hours; food may delay absorption; starting dose 50 mg. Tadalafil: onset 30 minutes; duration up to 36 hours; food does not significantly affect absorption; available in daily dosing (2.5–5 mg) for spontaneity. Both share the ABSOLUTE contraindication with nitrate medications. A physician can help determine which fits your lifestyle and health history.
      </p>
    ),
  },
  {
    id: 'ca-erectile-dysfunction-treatment-online-faq-10',
    question: 'When should ED require in-person evaluation in California?',
    answer: (
      <p>
        Seek in-person evaluation if: new-onset severe ED under age 40; cardiovascular symptoms such as chest pain or shortness of breath; never been screened for diabetes or hypertension; possible testosterone deficiency; PDE5 inhibitors have not been effective; or you may need intraurethral therapy, penile injections, vacuum erection devices, or penile prosthesis. California urologists and primary care physicians provide comprehensive ED evaluation and management.
      </p>
    ),
  },
  {
    id: 'ca-erectile-dysfunction-treatment-online-faq-11',
    question: 'Does California require an in-person visit before telehealth for ED treatment?',
    answer: (
      <p>
        No. California B&P Code §2290.5 does not require a prior in-person visit before telehealth services. A California-licensed physician can prescribe PDE5 inhibitors via video visit after cardiovascular screening and contraindication review. PDE5 inhibitors — sildenafil and tadalafil — are not controlled substances.
      </p>
    ),
  },
];

const SCHEMAS = [{"@context": "https://schema.org", "@type": "MedicalWebPage", "name": "Erectile Dysfunction Treatment Online in California | TeleDirectMD", "url": "https://teledirectmd.com/ca/erectile-dysfunction-treatment-online/", "description": "Erectile dysfunction treatment online for California adult men. Board-certified MD. AUA guideline PDE5 inhibitors. Cardiovascular and nitrate screening. Self pay $79. Aetna in-network. Same-day video visits.", "datePublished": "2026-05-20", "dateModified": "2026-05-20", "inLanguage": "en-US", "about": {"@type": "MedicalCondition", "name": "Erectile Dysfunction (ED)", "code": {"@type": "MedicalCode", "code": "N52.9", "codingSystem": "ICD-10-CM"}}, "medicalAudience": {"@type": "MedicalAudience", "audienceType": "Patient", "geographicArea": {"@type": "AdministrativeArea", "name": "California"}}, "reviewedBy": {"@type": "Physician", "@id": "https://teledirectmd.com/about/#physician-parth-bhavsar", "name": "Parth Bhavsar, MD", "identifier": {"@type": "PropertyValue", "propertyID": "NPI", "value": "1104323203"}, "medicalSpecialty": "Family Medicine", "hasCredential": [{"@type": "EducationalOccupationalCredential", "credentialCategory": "degree", "name": "Doctor of Medicine (MD)"}, {"@type": "EducationalOccupationalCredential", "credentialCategory": "certification", "name": "Board Certification \u2014 American Board of Family Medicine"}], "licensedIn": "California", "worksFor": {"@type": "MedicalOrganization", "name": "TeleDirectMD", "url": "https://teledirectmd.com"}, "sameAs": ["https://npiregistry.cms.hhs.gov/provider-view/1104323203", "https://teledirectmd.com/about/"]}, "speakable": {"@type": "SpeakableSpecification", "cssSelector": ["#ca-erectile-dysfunction-treatment-online-opening", "#ca-erectile-dysfunction-treatment-online-opening p", ".tdmd-ca-erectile-dysfunction-treatment-online__byline", "#ca-erectile-dysfunction-treatment-online-faq"]}}, {"@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [{"@type": "Question", "name": "Can I get erectile dysfunction treatment online in California?", "acceptedAnswer": {"@type": "Answer", "text": "Yes. California Business and Professions Code Section 2290.5 permits California-licensed physicians to evaluate and treat erectile dysfunction by synchronous video visit. Per the AUA ED guideline (2018), first-line treatment for ED is a PDE5 inhibitor \u2014 sildenafil or tadalafil. TeleDirectMD performs cardiovascular screening and contraindication review \u2014 particularly the nitrate absolute contraindication \u2014 before prescribing. Self pay is $79. Aetna is in-network as of April 30, 2026."}}, {"@type": "Question", "name": "What are PDE5 inhibitors and how do they work for ED?", "acceptedAnswer": {"@type": "Answer", "text": "PDE5 inhibitors \u2014 sildenafil (Viagra generic) and tadalafil (Cialis generic) \u2014 are the first-line pharmacological treatment for ED per the AUA 2018 ED guideline. They inhibit the enzyme PDE5, increasing cyclic GMP levels and enhancing smooth muscle relaxation and blood flow to the corpus cavernosum during sexual stimulation. CRITICAL: PDE5 inhibitors are absolutely contraindicated with any nitrate medication (nitroglycerin, isosorbide mononitrate/dinitrate, amyl nitrite/poppers) \u2014 the combination can cause severe, potentially fatal hypotension. TeleDirectMD always screens for nitrate use before prescribing."}}, {"@type": "Question", "name": "How much does sildenafil (Viagra generic) cost in California with GoodRx?", "acceptedAnswer": {"@type": "Answer", "text": "Generic sildenafil costs approximately $11 for 10 \u00d7 100 mg tablets with a GoodRx coupon at goodrx.com as of May 2026 \u2014 a fraction of brand-name Viagra's retail price. Generic tadalafil is similarly affordable at approximately $11 / 10 tablets. Prescription costs at the pharmacy are separate from the TeleDirectMD $79 visit fee."}}, {"@type": "Question", "name": "What are the contraindications for ED medications in California?", "acceptedAnswer": {"@type": "Answer", "text": "Per the AUA ED guideline, ABSOLUTE contraindications to PDE5 inhibitors include: any organic nitrate or nitric oxide donor (nitroglycerin, isosorbide mononitrate, isosorbide dinitrate, amyl nitrite/poppers); recent (within 90 days) MI or stroke; unstable angina; uncontrolled blood pressure; and severe hepatic impairment. TeleDirectMD reviews your complete medication list and cardiovascular history at every visit before prescribing."}}, {"@type": "Question", "name": "How common is erectile dysfunction in California men?", "acceptedAnswer": {"@type": "Answer", "text": "ED affects approximately 30 million American men per the AUA. Prevalence increases with age: approximately 40% at age 40, rising to approximately 70% at age 70. With California's approximately 15 million adult men, an estimated 4\u20135 million California men may experience ED. Vascular risk factors \u2014 hypertension, type 2 diabetes, hyperlipidemia, smoking, obesity \u2014 are the most common underlying causes. Psychological factors, including performance anxiety, account for a significant proportion in younger men under 40."}}, {"@type": "Question", "name": "Does ED need evaluation for underlying cardiovascular disease in California?", "acceptedAnswer": {"@type": "Answer", "text": "ED can be a signal of underlying cardiovascular disease. Per the AUA ED guideline, new-onset ED in men under 40 or in men with cardiovascular risk factors warrants evaluation for coronary artery disease \u2014 ED and coronary artery disease share the same pathophysiology (endothelial dysfunction). TeleDirectMD takes a thorough cardiovascular history and recommends in-person evaluation when cardiovascular disease is suspected."}}, {"@type": "Question", "name": "Is Aetna in-network with TeleDirectMD in California for ED treatment?", "acceptedAnswer": {"@type": "Answer", "text": "Aetna became in-network for TeleDirectMD in California effective April 30, 2026. Verify plan eligibility before your visit. Self pay ($79) is available regardless of insurance status. UnitedHealthcare Commercial is also approved effective May 29, 2026."}}, {"@type": "Question", "name": "Will Medi-Cal cover ED treatment at TeleDirectMD?", "acceptedAnswer": {"@type": "Answer", "text": "TeleDirectMD is not currently enrolled as a Medi-Cal rendering provider. California DHCS confirms Medi-Cal covers telehealth for enrolled providers. If you have Medi-Cal, use the $79 self-pay option or seek a Medi-Cal-enrolled telehealth provider at dhcs.ca.gov."}}, {"@type": "Question", "name": "Does California AB 744 parity apply to ED treatment telehealth visits?", "acceptedAnswer": {"@type": "Answer", "text": "California Insurance Code \u00a710123.85 (AB 744, 2019) requires commercial health plans to reimburse telehealth on the same basis as in-person services when TeleDirectMD is in-network. Aetna (active April 30, 2026) and UnitedHealthcare Commercial (approved May 29, 2026) are in-network in California."}}, {"@type": "Question", "name": "What is the difference between sildenafil and tadalafil for ED in California?", "acceptedAnswer": {"@type": "Answer", "text": "Both sildenafil (Viagra generic) and tadalafil (Cialis generic) are FDA-approved PDE5 inhibitors for ED. Sildenafil: onset 30\u201360 minutes; duration 4\u20136 hours; food may delay absorption; starting dose 50 mg. Tadalafil: onset 30 minutes; duration up to 36 hours; food does not significantly affect absorption; available in daily dosing (2.5\u20135 mg) for spontaneity. Both share the ABSOLUTE contraindication with nitrate medications. A physician can help determine which fits your lifestyle and health history."}}, {"@type": "Question", "name": "When should ED require in-person evaluation in California?", "acceptedAnswer": {"@type": "Answer", "text": "Seek in-person evaluation if: new-onset severe ED under age 40; cardiovascular symptoms such as chest pain or shortness of breath; never been screened for diabetes or hypertension; possible testosterone deficiency; PDE5 inhibitors have not been effective; or you may need intraurethral therapy, penile injections, vacuum erection devices, or penile prosthesis. California urologists and primary care physicians provide comprehensive ED evaluation and management."}}, {"@type": "Question", "name": "Does California require an in-person visit before telehealth for ED treatment?", "acceptedAnswer": {"@type": "Answer", "text": "No. California B&P Code \u00a72290.5 does not require a prior in-person visit before telehealth services. A California-licensed physician can prescribe PDE5 inhibitors via video visit after cardiovascular screening and contraindication review. PDE5 inhibitors \u2014 sildenafil and tadalafil \u2014 are not controlled substances."}}]}, {"@context": "https://schema.org", "@type": "HowTo", "name": "How to Get Erectile Dysfunction Treatment Online in California", "description": "Three steps to receive erectile dysfunction treatment evaluation and, if appropriate, a prescription from a California-licensed board-certified physician.", "totalTime": "PT30M", "estimatedCost": {"@type": "MonetaryAmount", "currency": "USD", "value": "79"}, "step": [{"@type": "HowToStep", "position": 1, "name": "Book your video visit", "text": "Visit teledirectmd.com and select California Erectile Dysfunction (ED) treatment. No referral needed. Self pay $79. Many visits available same day.", "url": "https://teledirectmd.com/book-online"}, {"@type": "HowToStep", "position": 2, "name": "See a California-licensed MD by secure video", "text": "Connect with a board-certified Family Medicine physician licensed in California. The physician reviews your symptoms, history, and red-flag screening. Consent per CA B&P Section 2290.5 confirmed.", "url": "https://teledirectmd.com/ca/erectile-dysfunction-treatment-online/"}, {"@type": "HowToStep", "position": 3, "name": "Receive your treatment plan and e-prescription", "text": "If medication is appropriate, a California-compliant e-prescription is sent to your chosen pharmacy during or after the visit.", "url": "https://teledirectmd.com/ca/erectile-dysfunction-treatment-online/"}]}, {"@context": "https://schema.org", "@type": "BreadcrumbList", "itemListElement": [{"@type": "ListItem", "position": 1, "name": "TeleDirectMD", "item": "https://teledirectmd.com"}, {"@type": "ListItem", "position": 2, "name": "California", "item": "https://teledirectmd.com/ca/"}, {"@type": "ListItem", "position": 3, "name": "Erectile Dysfunction Treatment Online in California", "item": "https://teledirectmd.com/ca/erectile-dysfunction-treatment-online/"}]}];
...
export default function CaErectileDysfunctionTreatmentOnline() {
  const pid = 'ca-erectile-dysfunction-treatment-online';
      ...
      <div className="tdmd-ca-cond">
        ...
        <nav className="tdmd-breadcrumbs" aria-label="Breadcrumb">
          <div className="tdmd-container" style={{ paddingTop: '0.5rem', paddingBottom: 0 }}>
            ...
            <span className="tdmd-bc-sep" aria-hidden="true">/</span>
            <span aria-current="page">Erectile Dysfunction Treatment Online</span>
          </div>
        </nav>
          ...
          <div className="tdmd-container">
            <div className="tdmd-hero-grid">
              <div className="tdmd-hero-copy">
                ...
                <p className="tdmd-icd"><strong>ICD-10 commonly used:</strong> N52.9 (Male erectile dysfunction, unspecified; actual code assigned at visit)</p>
              </div>

              <div className="tdmd-hero-side">
                <div className="tdmd-hero-card">
                  <h2>Online MD-Only Erectile Dysfunction (ED) Care in California</h2>
                  <ul>
                    <li>Fast evaluation for erectile dysfunction treatment symptoms</li>
                    <li>Red-flag screening for serious complications requiring in-person care</li>
                    <li>Guideline-based treatment per American Urological Association (AUA)</li>
        ...
        <section className="tdmd-section" id={`${pid}-eligibility`}>
          <div className="tdmd-container">
            <h2>Erectile Dysfunction Treatment Telehealth Eligibility Checklist for California</h2>
            ...
            <div className="tdmd-ca-cond__dual">
              <div className="tdmd-ca-cond__dual-card tdmd-ca-cond__dual-card--good">
                ...
                <ul>
                  <li>Adult male 18+ located in California at time of visit</li>
                  <li>No current nitrate medication use (nitroglycerin, isosorbide, amyl nitrite/poppers)</li>
                  <li>No recent MI, stroke, or unstable angina within 90 days</li>
                  <li>Willing to provide honest cardiovascular history including blood pressure, diabetes, and medications</li>
                  <li>Seeking first-line PDE5 inhibitor evaluation (sildenafil or tadalafil)</li>
                  <li>Not requiring testosterone therapy, penile injection, or surgical options (in-person urology)</li>
                </ul>
              </div>
        ...
        <section className="tdmd-section tdmd-section-highlight" id={`${pid}-ca-law`}>
          <div className="tdmd-container">
            <h2>California Telehealth Law and Your Erectile Dysfunction Treatment Visit</h2>
            ...
            <h3>Are erectile dysfunction treatment medications controlled substances under California law?</h3>
            <p>
              PDE5 inhibitors used for erectile dysfunction — sildenafil (generic Viagra) and tadalafil (generic Cialis) — are not controlled substances and can be prescribed via California telehealth and transmitted electronically to any California pharmacy under Assembly Bill 2789. California requires all prescriptions to be issued electronically under Assembly Bill 2789 (effective January 1, 2022), per the <a href="https://www.mbc.ca.gov/News/" rel="noopener" target="_blank">Medical Board of California</a>. TeleDirectMD does not prescribe controlled substances in any state.
            </p>
          </div>
        </section>
        ...
        <section className="tdmd-section" id={`${pid}-how-it-works`} itemScope itemType="https://schema.org/HowTo">
          <div className="tdmd-container">
            <h2 itemProp="name">How Online Erectile Dysfunction Treatment Works in California</h2>
        ...
        <section className="tdmd-section" id={`${pid}-epidemiology`}>
          <div className="tdmd-container">
            <h2>How Common Is Erectile Dysfunction (ED) in California?</h2>
            <p>
              Erectile dysfunction affects approximately 30 million American men per the American Urological Association. Prevalence increases sharply with age — approximately 40% at age 40, rising to approximately 70% at age 70. With California's approximately 15 million adult men, an estimated 4–5 million California men may experience ED. Vascular risk factors — hypertension, type 2 diabetes, hyperlipidemia, obesity, and smoking — are the most common underlying causes. — <a href="https://www.auanet.org/guidelines-and-quality/guidelines/erectile-dysfunction-guideline" rel="noopener" target="_blank">AUA Erectile Dysfunction Guideline (2018)</a>.
            </p>
            <p>
              Clinical guidance for erectile dysfunction treatment is provided by <a href="https://www.auanet.org/guidelines-and-quality/guidelines/erectile-dysfunction-guideline" rel="noopener" target="_blank">American Urological Association (AUA)</a> through the AUA Erectile Dysfunction Guideline (2018). TeleDirectMD follows these guidelines on every patient visit.
            </p>
            <h3>What causes erectile dysfunction (ed) and who is most at risk in California?</h3>
            <p>
              Erectile Dysfunction (ED) affects California adults across all demographics, though certain populations face higher risk based on the specific condition. The physician reviews your individual risk factors at each visit. Telehealth is appropriate for adults 18 and older with mild to moderate presentations who do not have red-flag symptoms requiring immediate in-person evaluation.
            </p>
          </div>
        </section>
        ...
        <section className="tdmd-section tdmd-section-highlight" id={`${pid}-cost`}>
          <div className="tdmd-container">
            <h2>Erectile Dysfunction Treatment Cost &amp; Insurance in California</h2>
            ...
            <div className="tdmd-price-grid">
              ...
              <div className="tdmd-price-chart" role="group" aria-label="Typical Erectile Dysfunction (ED) cost comparison">
                <h3>Typical Erectile Dysfunction (ED) Visit Cost in California</h3>
        ...
        <section className="tdmd-section" id={`${pid}-medications`}>
          <div className="tdmd-container">
            <h2>Erectile Dysfunction Treatment Medication Options and Costs in California</h2>
            <p>
              Medications for erectile dysfunction treatment are selected based on current guidelines from <a href="https://www.auanet.org/guidelines-and-quality/guidelines/erectile-dysfunction-guideline" rel="noopener" target="_blank">American Urological Association (AUA)</a>, patient history, allergies, and relevant contraindications assessed at the visit. GoodRx-verified pricing is shown below.
            </p>
            <div className="tdmd-table-wrap">
              <table className="tdmd-table" aria-label="Erectile Dysfunction Treatment medication options and GoodRx prices">
                <caption style={{ captionSide: 'bottom', textAlign: 'left', padding: '0.5rem 0', fontSize: '0.85rem', color: 'var(--tdmd-muted)' }}>
                ...
                <tbody>
                  <tr className="tdmd-ca-uti__med-firstline">
                    <td><strong>Sildenafil (generic Viagra) 50–100 mg</strong> · First-line</td>
                    <td>25–100 mg orally 30–60 minutes before sexual activity as needed</td>
                    <td><a href="https://www.goodrx.com/sildenafil" target="_blank" rel="noopener">~$11 / 10 × 100 mg tablets with GoodRx</a></td>
                    <td>First-line PDE5 inhibitor per AUA ED guideline. ABSOLUTE CONTRAINDICATION with any nitrate medication. Take on empty stomach for faster onset. Starting dose typically 50 mg adjusted based on response and tolerability.</td>
                  </tr>
                  <tr className="tdmd-ca-uti__med-firstline">
                  ...
                  <tr>
                    <td><strong>Vardenafil (generic Levitra) 10 mg</strong></td>
                    <td>5–20 mg orally 25–60 minutes before sexual activity as needed; max 1 dose/24 h</td>
                    <td><a href="https://www.goodrx.com/vardenafil" target="_blank" rel="noopener">~$25 / 10 tablets with GoodRx</a></td>
                    <td>Third FDA-approved PDE5 inhibitor per AUA ED guideline. Onset 25–60 min, duration 4–5 h. May be effective in patients with suboptimal response to sildenafil. ABSOLUTE CONTRAINDICATION with nitrates and Class IA/III antiarrhythmics. High-fat meal delays absorption. Adjust dose in hepatic impairment.</td>
                  </tr>
                </tbody>
              </table>
            </div>
        ...
        <section className="tdmd-section" id={`${pid}-dual-path`}>
          <div className="tdmd-container">
            ...
            <p>For most adults with mild to moderate erectile dysfunction treatment without red-flag symptoms, a video visit is appropriate and convenient. Some situations require in-person evaluation. Use the comparison below to determine the right care pathway for you.</p>
            <div className="tdmd-ca-cond__dual">
              <div className="tdmd-ca-cond__dual-card tdmd-ca-cond__dual-card--good">
        ...
        <section className="tdmd-section tdmd-faq" id={`${pid}-faq`}>
          <div className="tdmd-container">
            <FaqAccordion
              sectionTitle="Frequently Asked Questions — Erectile Dysfunction Treatment in California"
              items={FAQ_ITEMS}
            />
          ...
          <div className="tdmd-container">
            ...
            <div className="tdmd-ca-cond__sibling-grid">
              <a key="performance-anxiety-treatment-online" className="tdmd-ca-uti__sibling" href="/ca/performance-anxiety-treatment-online/">
                  ...
                  <span className="tdmd-ca-uti__sibling-why">Performance anxiety is a major psychological contributor to ED — the two conditions are frequently evaluated together.</span>
                </a>
              <a key="genital-herpes-treatment-online" className="tdmd-ca-uti__sibling" href="/ca/genital-herpes-treatment-online/">
                  ...
                  <span className="tdmd-ca-uti__sibling-why">Sexual health conditions that may co-present; STI screening is relevant for sexually active men with ED.</span>
                </a>
              <a key="birth-control-refills-online" className="tdmd-ca-uti__sibling" href="/ca/birth-control-refills-online/">
                  ...
                  <span className="tdmd-ca-uti__sibling-why">Partner reproductive health — commonly discussed concurrently at sexual health visits.</span>
                </a>
              <a key="doxypep-sti-prevention-online" className="tdmd-ca-uti__sibling" href="/ca/doxypep-sti-prevention-online/">
                  ...
                  <span className="tdmd-ca-uti__sibling-why">STI prevention is relevant for sexually active men evaluated for ED.</span>
                </a>
              <a key="chlamydia-treatment-online" className="tdmd-ca-uti__sibling" href="/ca/chlamydia-treatment-online/">
                  ...
                  <span className="tdmd-ca-uti__sibling-why">STI screening is important for sexually active men; chlamydia co-evaluation is appropriate.</span>
                </a>
            </div>
          </div>
        </section>
        ...
        <section className="tdmd-section" id={`${pid}-related`}>
          <div className="tdmd-container">
            ...
            <p>This page sits at the intersection of the <a href="/ca/">California state hub</a> and the <a href="/erectile-dysfunction-treatment-online/">Erectile Dysfunction (ED) national condition page</a>. Use the links below to explore insurance details, book a visit, or review other conditions.</p>
            <div className="tdmd-ca-cond__related-links" aria-label="Related resources">
              <a href="/">Home</a>
              <a href="/ca/">California (state pillar)</a>
              <a href="/erectile-dysfunction-treatment-online/">National Erectile Dysfunction (ED) page</a>
              <a href="/health-guides/">Erectile Dysfunction (ED) health guides</a>
        ...
        <WhatDoesThisCostBlock conditionSlug="erectile-dysfunction-treatment-online" conditionName="Erectile Dysfunction Treatment" stateName="California" />
        <CompareTeleDirectMDLinkRow conditionSlug="erectile-dysfunction-treatment-online" />
        <CommonSymptomsBlock conditionSlug="erectile-dysfunction-treatment-online" conditionName="Erectile Dysfunction Treatment" />
      </div>
    </>
  );
}
