...
function buildSchemas() {
  const medicalWebPage = {
    ...
    name: PAGE_TITLE,
    url: PAGE_URL,
    description: 'Get seasonal allergy treatment online in California. Board-certified Family Medicine MD. CA telehealth law compliant. Aetna in-network. Self pay $49. AAAAI/ACAAI + ARIA-EAACI 2026 guidelines. Antihistamines, nasal steroids, immunotherapy referral.',
  ...
  const howTo = {
    ...
    step: [
      { '@type': 'HowToStep', position: 1, name: 'Book your video visit', text: 'Visit teledirectmd.com and select California Seasonal Allergies Treatment. No referral needed. Self pay $49. Many visits available same day.', url: 'https://teledirectmd.com/book-online' },
            ...
            <div className="tdmd-hero-grid">
              <div className="tdmd-hero-copy">
                ...
                <p className="tdmd-hero-sub" data-speakable="true">
                  California adults 18+ · Secure video visit · Self pay $49 · Aetna in-network · UHC Commercial approved · MD-only · CA B&amp;P §2290.5 compliant · AAAAI/ACAAI + ARIA-EAACI 2026
                </p>
                <p>
          ...
          <div className="tdmd-container">
            <div className="tdmd-ca-uti__cta-strip" role="complementary">
              <div>
                ...
                <small>Self pay $49 · Aetna in-network · UHC Commercial approved May 2026 · Seasonal Allergies Treatment</small>
              </div>
