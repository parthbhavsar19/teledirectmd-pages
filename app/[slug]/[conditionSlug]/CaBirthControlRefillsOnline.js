...
const FAQ_ITEMS = [
  ...
  { question: 'Is Aetna in-network with TeleDirectMD in California for birth control refills?', answer: (<p>Aetna became in-network for TeleDirectMD in California effective April 30, 2026. Aetna commercial plan members may be able to use in-network benefits. Always verify plan eligibility with Aetna before your visit. Self pay ($49) is available regardless of insurance. See <a href='/insurance'>all insurance options</a>.</p>) },
