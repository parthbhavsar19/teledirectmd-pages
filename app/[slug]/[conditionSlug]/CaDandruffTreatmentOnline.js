/**
 * CaDandruffTreatmentOnline.js — production California × Dandruff / Seborrheic Dermatitis condition page (v3)
 *
 * Rendered by app/[slug]/[conditionSlug]/page.js when slug === 'ca' and
 * conditionSlug === 'dandruff-treatment-online'.
 *
 ...
 * Guideline: AAD Seborrheic Dermatitis Treatment Guidelines
 *
...
const PAGE_URL = 'https://teledirectmd.com/ca/dandruff-treatment-online/';
const PAGE_TITLE = 'Dandruff Treatment (Seborrheic Dermatitis) Online in California | TeleDirectMD';
...
const FAQ_ITEMS = [
  {
    id: 'ca-dandruff-treatment-online-faq-0',
    question: 'Can I get dandruff treatment online in California?',
    answer: (
      <p>
  ...
  {
    id: 'ca-dandruff-treatment-online-faq-1',
    question: 'What is the difference between dandruff and seborrheic dermatitis?',
    answer: (
      <p>
  ...
  {
    id: 'ca-dandruff-treatment-online-faq-2',
    question: 'What dandruff medications can a California telehealth doctor prescribe?',
    answer: (
      <p>
  ...
  {
    id: 'ca-dandruff-treatment-online-faq-3',
    question: 'Does California require an in-person visit before dandruff telehealth?',
    answer: (
      <p>
  ...
  {
    id: 'ca-dandruff-treatment-online-faq-4',
    question: 'When does dandruff or seborrheic dermatitis require in-person care?',
    answer: (
      <p>
  ...
  {
    id: 'ca-dandruff-treatment-online-faq-5',
    question: 'Is Aetna in-network for dandruff treatment at TeleDirectMD in California?',
    answer: (
      <p>
  ...
  {
    id: 'ca-dandruff-treatment-online-faq-6',
    question: 'What is the cost of dandruff treatment in California?',
    answer: (
      <p>
  ...
  {
    id: 'ca-dandruff-treatment-online-faq-7',
    question: 'Does California\'s AB 744 parity law cover dandruff/seborrheic dermatitis telehealth?',
    answer: (
      <p>
  ...
  {
    id: 'ca-dandruff-treatment-online-faq-8',
    question: 'Why does dandruff keep coming back?',
    answer: (
      <p>
  ...
  {
    id: 'ca-dandruff-treatment-online-faq-9',
    question: 'Can stress worsen dandruff in California?',
    answer: (
      <p>
  ...
  {
    id: 'ca-dandruff-treatment-online-faq-10',
    question: 'Will my dandruff prescription be sent electronically to a California pharmacy?',
    answer: (
      <p>
  ...
  {
    id: 'ca-dandruff-treatment-online-faq-11',
    question: 'What over-the-counter dandruff shampoos work best?',
    answer: (
      <p>
...
const SCHEMAS = [{"@context": "https://schema.org", "@type": "MedicalWebPage", "name": "Dandruff Treatment (Seborrheic Dermatitis) Online in California | TeleDirectMD", "url": "https://teledirectmd.com/ca/dandruff-treatment-online/", "description": "Dandruff and seborrheic dermatitis treatment online for California adults. Board-certified MD. AAD guideline-based care. Prescription ketoconazole, selenium sulfide, topical steroids. Self pay $79. Aetna in-network.", "datePublished": "2026-05-20", "dateModified": "2026-05-20", "inLanguage": "en-US", "about": {"@type": "MedicalCondition", "name": "Dandruff / Seborrheic Dermatitis", "code": {"@type": "MedicalCode", "code": "L21.0", "codingSystem": "ICD-10-CM"}}, "medicalAudience": {"@type": "MedicalAudience", "audienceType": "Patient", "geographicArea": {"@type": "AdministrativeArea", "name": "California"}}, "reviewedBy": {"@type": "Physician", "@id": "https://teledirectmd.com/about/#physician-parth-bhavsar", "name": "Parth Bhavsar, MD", "identifier": {"@type": "PropertyValue", "propertyID": "NPI", "value": "1104323203"}, "medicalSpecialty": "Family Medicine", "hasCredential": [{"@type": "EducationalOccupationalCredential", "credentialCategory": "degree", "name": "Doctor of Medicine (MD)"}, {"@type": "EducationalOccupationalCredential", "credentialCategory": "certification", "name": "Board Certification \u2014 American Board of Family Medicine"}], "licensedIn": "California", "worksFor": {"@type": "MedicalOrganization", "name": "TeleDirectMD", "url": "https://teledirectmd.com"}, "sameAs": ["https://npiregistry.cms.hhs.gov/provider-view/1104323203", "https://teledirectmd.com/about/"]}, "speakable": {"@type": "SpeakableSpecification", "cssSelector": ["#ca-dandruff-treatment-online-opening", "#ca-dandruff-treatment-online-opening p", ".tdmd-ca-dandruff-treatment-online__byline", "#ca-dandruff-treatment-online-faq"]}}, {"@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [{"@type": "Question", "name": "Can I get dandruff treatment online in California?", "acceptedAnswer": {"@type": "Answer", "text": "Yes. California Business and Professions Code Section 2290.5 permits California-licensed physicians to evaluate and treat dandruff (seborrheic dermatitis) by secure video visit. TeleDirectMD physicians follow AAD seborrheic dermatitis treatment guidelines, prescribing ketoconazole 2% shampoo/cream, selenium sulfide 2.5% shampoo, and scalp topical corticosteroids. Adults 18+ in California can book same-day. Self pay is $79. Aetna is in-network as of April 30, 2026."}}, {"@type": "Question", "name": "What is the difference between dandruff and seborrheic dermatitis?", "acceptedAnswer": {"@type": "Answer", "text": "Dandruff (pityriasis capitis) is the mildest form of seborrheic dermatitis \u2014 characterized by white or gray scalp flaking without significant redness or inflammation. Seborrheic dermatitis is a broader condition affecting the scalp, face (nasolabial folds, eyebrows, ear canals), chest, and back \u2014 with greasy yellowish scales and erythema. Both are caused by inflammatory response to Malassezia yeast overgrowth and both respond to antifungal therapy per AAD guidelines."}}, {"@type": "Question", "name": "What dandruff medications can a California telehealth doctor prescribe?", "acceptedAnswer": {"@type": "Answer", "text": "A California-licensed telehealth physician can prescribe: ketoconazole 2% shampoo (prescription-strength, approximately $15\u2013$35 with GoodRx), selenium sulfide 2.5% shampoo (approximately $10\u2013$20 with GoodRx), ciclopirox 1% shampoo (approximately $25\u2013$50), fluocinolone 0.01% scalp shampoo, betamethasone valerate 0.05% lotion for scalp inflammation, and ketoconazole 2% cream for facial seborrhea. OTC options (ketoconazole 1% Nizoral A-D, pyrithione zinc, coal tar) are recommended alongside prescription therapy."}}, {"@type": "Question", "name": "Does California require an in-person visit before dandruff telehealth?", "acceptedAnswer": {"@type": "Answer", "text": "No. California B&P Code \u00a72290.5 does not require a prior in-person visit. Dandruff and mild-to-moderate seborrheic dermatitis with classic presentation \u2014 scalp flaking, facial seborrhea, nasolabial fold involvement \u2014 are appropriately evaluated and treated by video visit. Persistent, unusual, or rapidly worsening presentations warrant in-person dermatology."}}, {"@type": "Question", "name": "When does dandruff or seborrheic dermatitis require in-person care?", "acceptedAnswer": {"@type": "Answer", "text": "Seek in-person evaluation if: seborrheic dermatitis is widespread and worsening rapidly \u2014 immunocompromising conditions such as HIV or Parkinson's disease should be evaluated; eyelid involvement (seborrheic blepharitis) requires ophthalmology evaluation; suspected scalp psoriasis with thick silvery plaques, nail pitting, or joint symptoms warrants in-person dermatology. TeleDirectMD treats adults 18+ \u2014 pediatric cradle cap requires a pediatrician."}}, {"@type": "Question", "name": "Is Aetna in-network for dandruff treatment at TeleDirectMD in California?", "acceptedAnswer": {"@type": "Answer", "text": "Yes. Aetna became an active in-network payor for TeleDirectMD in California effective April 30, 2026. UnitedHealthcare Commercial is approved effective May 29, 2026. Self pay is $79 for patients paying out-of-pocket."}}, {"@type": "Question", "name": "What is the cost of dandruff treatment in California?", "acceptedAnswer": {"@type": "Answer", "text": "TeleDirectMD charges $79 self-pay for a complete MD video visit. Prescription ketoconazole 2% shampoo costs approximately $15\u2013$35, selenium sulfide 2.5% approximately $10\u2013$20, and fluocinolone scalp oil approximately $15\u2013$40 with GoodRx. OTC ketoconazole 1% (Nizoral A-D) is approximately $10\u2013$15 at California pharmacies. Prescription costs are separate from the $79 visit fee."}}, {"@type": "Question", "name": "Does California's AB 744 parity law cover dandruff/seborrheic dermatitis telehealth?", "acceptedAnswer": {"@type": "Answer", "text": "Yes, for in-network commercial plans. California Insurance Code \u00a710123.85 (AB 744, 2019) requires commercial health plans to reimburse telehealth on the same basis as in-person services. Aetna (active April 30, 2026) and UHC Commercial (approved May 29, 2026) are in-network for TeleDirectMD in California."}}, {"@type": "Question", "name": "Why does dandruff keep coming back?", "acceptedAnswer": {"@type": "Answer", "text": "Seborrheic dermatitis is a chronic relapsing condition. Malassezia yeast \u2014 normally present on skin \u2014 overgrows in sebaceous (oily) skin areas, triggering an inflammatory response. Antifungal treatment reduces yeast burden but does not permanently eliminate it. Most patients require long-term maintenance therapy \u2014 ketoconazole shampoo 1\u20132\u00d7 weekly or pyrithione zinc shampoos \u2014 to prevent recurrence. TeleDirectMD physicians counsel on maintenance strategies at every visit."}}, {"@type": "Question", "name": "Can stress worsen dandruff in California?", "acceptedAnswer": {"@type": "Answer", "text": "Yes. Psychosocial stress is a well-established trigger for seborrheic dermatitis flares per AAD data. California's high-stress urban environments and wildfire-related climate stress may contribute to increased seborrheic dermatitis flares. Other California-specific triggers include seasonal humidity changes \u2014 dry Santa Ana winds, coastal marine layer shifts \u2014 and UV exposure affecting the scalp."}}, {"@type": "Question", "name": "Will my dandruff prescription be sent electronically to a California pharmacy?", "acceptedAnswer": {"@type": "Answer", "text": "Yes. California AB 2789 (effective January 1, 2022) requires all prescriptions to be issued electronically. TeleDirectMD sends e-prescriptions to your chosen California pharmacy \u2014 CVS, Walgreens, Rite Aid, Walmart, Safeway \u2014 during or after your visit. Dandruff medications are not controlled substances."}}, {"@type": "Question", "name": "What over-the-counter dandruff shampoos work best?", "acceptedAnswer": {"@type": "Answer", "text": "AAD recommends rotating OTC antifungal and anti-inflammatory shampoos for better long-term control: ketoconazole 1% (Nizoral A-D), pyrithione zinc (Head & Shoulders, Selsun Blue), selenium sulfide 1% (Selsun Blue Extra Strength), and coal tar shampoos. Rotating 2\u20133 products prevents adaptation and maintains efficacy. When OTC products fail, prescription ketoconazole 2% and selenium sulfide 2.5% are more potent options available through TeleDirectMD."}}]}, {"@context": "https://schema.org", "@type": "HowTo", "name": "How to Get Dandruff Treatment (Seborrheic Dermatitis) Online in California", "description": "Three steps to receive dandruff treatment (seborrheic dermatitis) evaluation and, if appropriate, a prescription from a California-licensed board-certified physician.", "totalTime": "PT30M", "estimatedCost": {"@type": "MonetaryAmount", "currency": "USD", "value": "79"}, "step": [{"@type": "HowToStep", "position": 1, "name": "Book your video visit", "text": "Visit teledirectmd.com and select California Dandruff / Seborrheic Dermatitis treatment. No referral needed. Self pay $79. Many visits available same day.", "url": "https://teledirectmd.com/book-online"}, {"@type": "HowToStep", "position": 2, "name": "See a California-licensed MD by secure video", "text": "Connect with a board-certified Family Medicine physician licensed in California. The physician reviews your symptoms, history, and red-flag screening. Consent per CA B&P Section 2290.5 confirmed.", "url": "https://teledirectmd.com/ca/dandruff-treatment-online/"}, {"@type": "HowToStep", "position": 3, "name": "Receive your treatment plan and e-prescription", "text": "If medication is appropriate, a California-compliant e-prescription is sent to your chosen pharmacy during or after the visit.", "url": "https://teledirectmd.com/ca/dandruff-treatment-online/"}]}, {"@context": "https://schema.org", "@type": "BreadcrumbList", "itemListElement": [{"@type": "ListItem", "position": 1, "name": "TeleDirectMD", "item": "https://teledirectmd.com"}, {"@type": "ListItem", "position": 2, "name": "California", "item": "https://teledirectmd.com/ca/"}, {"@type": "ListItem", "position": 3, "name": "Dandruff Treatment (Seborrheic Dermatitis) Online in California", "item": "https://teledirectmd.com/ca/dandruff-treatment-online/"}]}];
...
export default function CaDandruffTreatmentOnline() {
  const pid = 'ca-dandruff-treatment-online';
      ...
      <div className="tdmd-ca-cond">
        ...
        <nav className="tdmd-breadcrumbs" aria-label="Breadcrumb">
          <div className="tdmd-container" style={{ paddingTop: '0.5rem', paddingBottom: 0 }}>
            ...
            <span className="tdmd-bc-sep" aria-hidden="true">/</span>
            <span aria-current="page">Dandruff Treatment (Seborrheic Dermatitis) Online</span>
          </div>
        </nav>
          ...
          <div className="tdmd-container">
            <div className="tdmd-hero-grid">
              <div className="tdmd-hero-copy">
                <h1 data-speakable="true">Dandruff Treatment Online in California</h1>
                ...
                <p className="tdmd-icd"><strong>ICD-10 commonly used:</strong> L21.0 (Seborrhea capitis; actual code assigned at visit)</p>
              </div>

              <div className="tdmd-hero-side">
                <div className="tdmd-hero-card">
                  <h2>Online MD-Only Dandruff / Seborrheic Dermatitis Care in California</h2>
                  <ul>
                    <li>Fast evaluation for dandruff treatment (seborrheic dermatitis) symptoms</li>
        ...
        <section className="tdmd-section" id={`${pid}-eligibility`}>
          <div className="tdmd-container">
            <h2>Dandruff Treatment (Seborrheic Dermatitis) Telehealth Eligibility Checklist for California</h2>
            ...
            <div className="tdmd-ca-cond__dual">
              <div className="tdmd-ca-cond__dual-card tdmd-ca-cond__dual-card--good">
                ...
                <ul>
                  ...
                  <li>Mild-to-moderate scalp seborrhea (dandruff) with classic presentation</li>
                  <li>Facial seborrheic dermatitis (nasolabial folds, eyebrows, ear canals)</li>
                  <li>Known seborrheic dermatitis requiring prescription shampoo or topical antifungal refill</li>
                  <li>Seborrhea with secondary erythema requiring combination antifungal and low-potency steroid</li>
                  <li>No eyelid involvement, systemic illness, or features suggesting scalp psoriasis</li>
                </ul>
              </div>
              <div className="tdmd-ca-cond__dual-card tdmd-ca-cond__dual-card--alert">
                <h3>&#10007; Seek In-Person or Emergency Care If</h3>
                <ul>
                  <li>Widespread and rapidly worsening seborrheic dermatitis — possible underlying HIV, Parkinson's disease, or other immunocompromising condition requiring systemic evaluation</li>
                  <li>Seborrheic blepharitis (eyelid redness, crusting, photophobia) — ophthalmology evaluation required</li>
                  <li>Suspected scalp psoriasis — thick silvery plaques, nail pitting, or joint symptoms — in-person dermatology for differentiation and biologics discussion</li>
                  <li>Seborrheic dermatitis not responding to two antifungal treatments — in-person dermatology evaluation</li>
                  <li>Infant cradle cap — TeleDirectMD treats adults 18+ only; pediatric care is required</li>
                </ul>
        ...
        <section className="tdmd-section tdmd-section-highlight" id={`${pid}-ca-law`}>
          <div className="tdmd-container">
            <h2>California Telehealth Law and Your Dandruff Treatment (Seborrheic Dermatitis) Visit</h2>
            ...
            <h3>Are dandruff treatment (seborrheic dermatitis) medications controlled substances under California law?</h3>
            <p>
        ...
        <section className="tdmd-section" id={`${pid}-how-it-works`} itemScope itemType="https://schema.org/HowTo">
          <div className="tdmd-container">
            <h2 itemProp="name">How Online Dandruff Treatment (Seborrheic Dermatitis) Works in California</h2>
        ...
        <section className="tdmd-section" id={`${pid}-epidemiology`}>
          <div className="tdmd-container">
            <h2>How Common Is Dandruff / Seborrheic Dermatitis in California?</h2>
            <p>
              Seborrheic dermatitis affects approximately 3–5% of the general population and up to 11.3% of adults in the United States per the American Academy of Dermatology. California's diverse population and varied climate — from dry inland valleys to coastal humidity — can both worsen and modulate seborrheic dermatitis. The condition is significantly more common in adults with HIV/AIDS, Parkinson's disease, and other neurologic conditions — all with notable California patient populations tracked by CDPH. — <a href="https://www.aad.org/public/diseases/a-z/seborrheic-dermatitis-symptoms" rel="noopener" target="_blank">AAD — Seborrheic Dermatitis Overview</a>.
            </p>
            <p>
              Clinical guidance for dandruff treatment (seborrheic dermatitis) is provided by <a href="https://www.aad.org/public/diseases/a-z/seborrheic-dermatitis-treatment" rel="noopener" target="_blank">American Academy of Dermatology (AAD)</a> through the AAD Seborrheic Dermatitis Treatment Guidelines. TeleDirectMD follows these guidelines on every patient visit.
            </p>
            <h3>What causes dandruff / seborrheic dermatitis and who is most at risk in California?</h3>
            <p>
        ...
        <section className="tdmd-section tdmd-section-highlight" id={`${pid}-cost`}>
          <div className="tdmd-container">
            <h2>Dandruff Treatment (Seborrheic Dermatitis) Cost &amp; Insurance in California</h2>
            ...
            <div className="tdmd-price-grid">
              ...
              <div className="tdmd-price-chart" role="group" aria-label="Typical Dandruff / Seborrheic Dermatitis cost comparison">
                <h3>Typical Dandruff / Seborrheic Dermatitis Visit Cost in California</h3>
        ...
        <section className="tdmd-section" id={`${pid}-medications`}>
          <div className="tdmd-container">
            <h2>Dandruff Treatment (Seborrheic Dermatitis) Medication Options and Costs in California</h2>
            <p>
              Medications for dandruff treatment (seborrheic dermatitis) are selected based on current guidelines from <a href="https://www.aad.org/public/diseases/a-z/seborrheic-dermatitis-treatment" rel="noopener" target="_blank">American Academy of Dermatology (AAD)</a>, patient history, allergies, and relevant contraindications assessed at the visit. GoodRx-verified pricing is shown below.
            </p>
            <div className="tdmd-table-wrap">
              <table className="tdmd-table" aria-label="Dandruff Treatment (Seborrheic Dermatitis) medication options and GoodRx prices">
                <caption style={{ captionSide: 'bottom', textAlign: 'left', padding: '0.5rem 0', fontSize: '0.85rem', color: 'var(--tdmd-muted)' }}>
                ...
                <tbody>
                  ...
                  <tr className="tdmd-ca-uti__med-firstline">
                    <td><strong>Selenium sulfide 2.5% shampoo</strong> · First-line</td>
                    <td>Apply to scalp 2× weekly, leave on 5–10 minutes before rinsing</td>
                    <td><a href="https://www.goodrx.com/selenium-sulfide" target="_blank" rel="noopener">~$10–$20 / 120 mL with GoodRx</a></td>
                    <td>First-line antifungal shampoo per AAD. Reduces Malassezia density. Prescription 2.5% is more effective than OTC 1%. Can temporarily discolor light-colored or chemically treated hair.</td>
                  </tr>
                  <tr className="tdmd-ca-uti__med-firstline">
        ...
        <section className="tdmd-section" id={`${pid}-dual-path`}>
          <div className="tdmd-container">
            ...
            <p>For most adults with mild to moderate dandruff treatment (seborrheic dermatitis) without red-flag symptoms, a video visit is appropriate and convenient. Some situations require in-person evaluation. Use the comparison below to determine the right care pathway for you.</p>
            <div className="tdmd-ca-cond__dual">
              <div className="tdmd-ca-cond__dual-card tdmd-ca-cond__dual-card--good">
        ...
        <section className="tdmd-section tdmd-faq" id={`${pid}-faq`}>
          <div className="tdmd-container">
            <FaqAccordion
              sectionTitle="Frequently Asked Questions — Dandruff Treatment (Seborrheic Dermatitis) in California"
              items={FAQ_ITEMS}
            />
          ...
          <div className="tdmd-container">
            ...
            <div className="tdmd-ca-cond__sibling-grid">
              <a key="psoriasis-refills-online" className="tdmd-ca-uti__sibling" href="/ca/psoriasis-refills-online/">
                  ...
                  <span className="tdmd-ca-uti__sibling-why">Scalp psoriasis is a key differential from severe seborrheic dermatitis — important to distinguish for management.</span>
                </a>
              <a key="eczema-treatment-online" className="tdmd-ca-uti__sibling" href="/ca/eczema-treatment-online/">
                  ...
                  <span className="tdmd-ca-uti__sibling-why">Facial eczema can appear similar to seborrheic dermatitis in distribution and appearance.</span>
                </a>
              <a key="rosacea-treatment-online" className="tdmd-ca-uti__sibling" href="/ca/rosacea-treatment-online/">
                  ...
                  <span className="tdmd-ca-uti__sibling-why">Facial redness and scaling from rosacea can overlap in distribution with seborrheic dermatitis.</span>
                </a>
              <a key="acne-treatment-online" className="tdmd-ca-uti__sibling" href="/ca/acne-treatment-online/">
                  ...
                  <span className="tdmd-ca-uti__sibling-why">Sebaceous gland disorders often coexist with seborrheic dermatitis — co-evaluation is common at the same visit.</span>
                </a>
              <a key="contact-dermatitis-treatment-online" className="tdmd-ca-uti__sibling" href="/ca/contact-dermatitis-treatment-online/">
                  ...
                  <span className="tdmd-ca-uti__sibling-why">Scalp contact dermatitis from hair dyes and products is a differential from seborrheic dermatitis.</span>
                </a>
            </div>
          </div>
        </section>
        ...
        <section className="tdmd-section" id={`${pid}-related`}>
          <div className="tdmd-container">
            ...
            <p>This page sits at the intersection of the <a href="/ca/">California state hub</a> and the <a href="/dandruff-treatment-online/">Dandruff / Seborrheic Dermatitis national condition page</a>. Use the links below to explore insurance details, book a visit, or review other conditions.</p>
            <div className="tdmd-ca-cond__related-links" aria-label="Related resources">
              <a href="/">Home</a>
              <a href="/ca/">California (state pillar)</a>
              <a href="/dandruff-treatment-online/">National Dandruff / Seborrheic Dermatitis page</a>
              <a href="/health-guides/">Dandruff / Seborrheic Dermatitis health guides</a>
        ...
        <section className="tdmd-section" id={`${pid}-references`}>
          <div className="tdmd-container">
            ...
            <ol className="tdmd-ref-list">
              ...
              <li><a href="https://www.aad.org/public/diseases/a-z/seborrheic-dermatitis-treatment" rel="noopener" target="_blank">AAD — Seborrheic Dermatitis Treatment Guidelines. Retrieved May 2026.</a></li>
        ...
        <WhatDoesThisCostBlock conditionSlug="dandruff-treatment-online" conditionName="Dandruff Treatment (Seborrheic Dermatitis)" stateName="California" />
        <CompareTeleDirectMDLinkRow conditionSlug="dandruff-treatment-online" />
        <CommonSymptomsBlock conditionSlug="dandruff-treatment-online" conditionName="Dandruff Treatment (Seborrheic Dermatitis)" />
      </div>
    </>
  );
}
