...
const FAQ_ITEMS = [
  {
    ...
    answer: <p>Yes. California Business and Professions Code Section 2290.5 permits licensed physicians to prescribe appropriate non-controlled medications via synchronous video telehealth without a prior in-person visit. TeleDirectMD\'s California-licensed board-certified Family Medicine physician reviews your most recent TSH and free T4 lab values, your current levothyroxine dose, and your adherence history before authorizing refills. Levothyroxine is the only thyroid medication TeleDirectMD prescribes for hypothyroidism. Self pay is $49; Aetna is in-network effective April 30, 2026.</p>,
  },
  {
  ...
  },
  {
    ...
    answer: <p>Medi-Cal covers generic levothyroxine at low or no cost-sharing under the Medi-Cal formulary. However, TeleDirectMD is not currently enrolled as a Medi-Cal provider, so Medi-Cal will not pay for TeleDirectMD visits. Medi-Cal members can use TeleDirectMD\'s $49 self-pay rate or seek care from a Medi-Cal-enrolled primary care physician. For Medi-Cal provider directory, visit dhcs.ca.gov.</p>,
  },
  {
  ...
  },
  {
    ...
    answer: <p>Aetna became an active in-network payor for TeleDirectMD in California effective April 30, 2026. If you hold an Aetna commercial plan in California, you may be able to use your in-network benefits for your hypothyroidism refill visit. Always verify current in-network status directly with Aetna before your visit, as eligibility varies by plan type. The TeleDirectMD self-pay rate of $49 is available regardless of insurance status.</p>,
  },
  {
...
function buildSchemas() {
  const medicalWebPage = {
    ...
    name: PAGE_TITLE,
    url: PAGE_URL,
    description: 'Refill levothyroxine for hypothyroidism online in California. Board-certified Family Medicine MD. CA telehealth law compliant. Aetna in-network. Self pay $49. ATA guideline-based. Levothyroxine only — no Armour, no desiccated, no liothyronine.',
  ...
  const howTo = {
    ...
    step: [
      { '@type': 'HowToStep', position: 1, name: 'Book your video visit', text: 'Visit teledirectmd.com and select California Hypothyroidism Refills. No referral needed. Self pay $49. Many visits available same day.', url: 'https://teledirectmd.com/book-online' },
            ...
            <div className="tdmd-hero-grid">
              <div className="tdmd-hero-copy">
                ...
                <p className="tdmd-hero-sub" data-speakable="true">
                  California adults 18+ · Secure video visit · Self pay $49 · Aetna in-network · UHC Commercial approved · MD-only · CA B&amp;P §2290.5 compliant · ATA Guidelines
                </p>
                <p>
          ...
          <div className="tdmd-container">
            <div className="tdmd-ca-uti__cta-strip" role="complementary">
              <div>
                ...
                <small>Self pay $49 · Aetna in-network · UHC Commercial approved May 2026 · Hypothyroidism Refills</small>
              </div>
