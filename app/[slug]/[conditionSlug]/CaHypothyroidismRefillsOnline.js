/**
 * CaHypothyroidismRefillsOnline.js — California × Hypothyroidism Refills condition page (v3)
 *
 * URL: /ca/hypothyroidism-refills-online/
 * Authority: ATA Guidelines
 * Rendered by app/[slug]/[conditionSlug]/page.js when slug === 'ca'
 * and conditionSlug === 'hypothyroidism-refills-online'.
 *
...
const PAGE_URL = 'https://teledirectmd.com/ca/hypothyroidism-refills-online/';
const PAGE_TITLE = 'Hypothyroidism Refills Online in California | TeleDirectMD';
...
const FAQ_ITEMS = [
  {
    id: 'hypothyroidism-refills-online-faq-0',
    question: "Can I refill my levothyroxine for hypothyroidism online in California?",
    answer: <p>Yes. California Business and Professions Code Section 2290.5 permits licensed physicians to prescribe appropriate non-controlled medications via synchronous video telehealth without a prior in-person visit. TeleDirectMD\'s California-licensed board-certified Family Medicine physician reviews your most recent TSH and free T4 lab values, your current levothyroxine dose, and your adherence history before authorizing refills. Levothyroxine is the only thyroid medication TeleDirectMD prescribes for hypothyroidism. Self pay is $79; Aetna is in-network effective April 30, 2026.</p>,
  },
  {
    id: 'hypothyroidism-refills-online-faq-1',
    question: "Does TeleDirectMD prescribe Armour Thyroid, NP Thyroid, or liothyronine (T3)?",
    answer: <p>No. TeleDirectMD prescribes levothyroxine only for hypothyroidism. Desiccated thyroid extract products (Armour Thyroid, NP Thyroid, WP Thyroid) and liothyronine (Cytomel, generic T3) are outside the scope of this service. The American Thyroid Association (ATA) 2014 guidelines establish levothyroxine monotherapy as the standard of care. Patients seeking DTE or T3 therapy should consult an endocrinologist who can evaluate their specific clinical situation.</p>,
  },
  {
    id: 'hypothyroidism-refills-online-faq-2',
    question: "What TSH level should I have before getting my levothyroxine refilled?",
    answer: <p>The physician requires a TSH result within the past 12 months before authorizing a levothyroxine refill. The ATA guideline TSH target for most treated hypothyroid adults is 0.5–2.5 mIU/L. For adults over 70, a slightly higher TSH (1–4 mIU/L) may be appropriate to avoid the risks of over-treatment including atrial fibrillation and bone loss. If your TSH is significantly out of range, the physician will recommend dose adjustment and a repeat TSH in 6–8 weeks before authorizing a full refill.</p>,
  },
  {
    id: 'hypothyroidism-refills-online-faq-3',
    question: "How common is hypothyroidism in California?",
    answer: <p>Hypothyroidism affects approximately 4.6% of the U.S. population per NHANES data cited by the American Thyroid Association — extrapolating to California\'s 39 million residents, roughly 1.7 million Californians have thyroid insufficiency requiring monitoring or treatment. Autoimmune (Hashimoto\'s) thyroiditis is the leading cause of hypothyroidism in California. Women are 5–8× more likely than men to develop hypothyroidism, and prevalence increases with age.</p>,
  },
  {
    id: 'hypothyroidism-refills-online-faq-4',
    question: "What drugs reduce levothyroxine absorption that I should tell my doctor about?",
    answer: <p>Several commonly used medications significantly reduce levothyroxine absorption if taken at the same time: calcium carbonate (antacids, TUMS), ferrous sulfate (iron supplements), proton pump inhibitors (omeprazole, pantoprazole), aluminum/magnesium antacids, sucralfate, and cholestyramine (bile acid sequestrants). The TeleDirectMD physician reviews your complete medication and supplement list for these interactions. Levothyroxine should be taken on an empty stomach 30–60 minutes before food and at least 4 hours apart from these medications.</p>,
  },
  {
    id: 'hypothyroidism-refills-online-faq-5',
    question: "How much does levothyroxine cost in California with GoodRx?",
    answer: <p>Generic levothyroxine is one of the most affordable prescription medications with GoodRx coupons at California pharmacies. Generic levothyroxine: approximately $8–$20 per month depending on dose and quantity with a GoodRx coupon. Brand-name Synthroid: approximately $35–$80 per month with GoodRx. Prices vary by pharmacy — CVS, Walgreens, Walmart Pharmacy, Costco, and Safeway all carry levothyroxine in California.</p>,
  },
  {
    id: 'hypothyroidism-refills-online-faq-6',
    question: "Does California Medi-Cal cover levothyroxine?",
    answer: <p>Medi-Cal covers generic levothyroxine at low or no cost-sharing under the Medi-Cal formulary. However, TeleDirectMD is not currently enrolled as a Medi-Cal provider, so Medi-Cal will not pay for TeleDirectMD visits. Medi-Cal members can use TeleDirectMD\'s $79 self-pay rate or seek care from a Medi-Cal-enrolled primary care physician. For Medi-Cal provider directory, visit dhcs.ca.gov.</p>,
  },
  {
    id: 'hypothyroidism-refills-online-faq-7',
    question: "What symptoms indicate my levothyroxine dose needs adjustment?",
    answer: <p>Symptoms of undertreated hypothyroidism include persistent fatigue, weight gain, cold intolerance, constipation, dry skin, hair thinning, depression, cognitive slowing, and elevated cholesterol. Symptoms of over-treatment (hyperthyroidism) include palpitations, heat intolerance, anxiety, insomnia, weight loss, increased frequency of bowel movements, and hand tremor. The physician reviews your symptoms alongside TSH and free T4 values to determine whether dose adjustment is needed.</p>,
  },
  {
    id: 'hypothyroidism-refills-online-faq-8',
    question: "Is TeleDirectMD appropriate for newly diagnosed hypothyroidism in California?",
    answer: <p>A new hypothyroidism diagnosis confirmed by TSH and free T4 — particularly primary hypothyroidism without secondary or tertiary cause — can be evaluated via video visit in California. The physician discusses the diagnosis, initiates levothyroxine at an appropriate starting dose, and orders a TSH recheck in 6–8 weeks. For new diagnoses, the physician will recommend baseline labs (TSH, free T4, complete metabolic panel, lipid panel) if not recently done. Secondary hypothyroidism (low TSH with low T4, suggesting pituitary cause) requires specialist endocrinology referral.</p>,
  },
  {
    id: 'hypothyroidism-refills-online-faq-9',
    question: "Will Aetna cover my hypothyroidism refill visit in California?",
    answer: <p>Aetna became an active in-network payor for TeleDirectMD in California effective April 30, 2026. If you hold an Aetna commercial plan in California, you may be able to use your in-network benefits for your hypothyroidism refill visit. Always verify current in-network status directly with Aetna before your visit, as eligibility varies by plan type. The TeleDirectMD self-pay rate of $79 is available regardless of insurance status.</p>,
  },
  {
    id: 'hypothyroidism-refills-online-faq-10',
    question: "What is the correct way to take levothyroxine for maximum effectiveness?",
    answer: <p>Levothyroxine is most effective when taken consistently: on an empty stomach (fasting), 30–60 minutes before eating breakfast; at the same time each day; well separated (at least 4 hours) from calcium, iron, antacids, and PPIs. Consistency between generic and brand formulations is important — FDA considers all approved levothyroxine products bioequivalent, but switching between manufacturers can cause small TSH fluctuations. The physician discusses optimal timing and drug interactions at every refill visit.</p>,
  },
  {
    id: 'hypothyroidism-refills-online-faq-11',
    question: "Does California telehealth law allow hypothyroidism prescribing without an in-person visit?",
    answer: <p>Yes. California Business and Professions Code Section 2290.5 does not require a prior in-person visit for telehealth prescribing of non-controlled medications. Levothyroxine is not a controlled substance and can be prescribed via a California video visit. The Medical Board of California requires that the same standard of care applies to telehealth as to in-person care — which TeleDirectMD satisfies by requiring recent TSH results before authorizing refills.</p>,
  }
];

const CA_SIBLINGS = [
  { slug: 'hypertension-refills-online', label: "Hypertension Refills in CA", why: "Hypothyroidism can cause secondary hypertension — often co-managed." },
  { slug: 'hyperlipidemia-refills-online', label: "Hyperlipidemia Refills in CA", why: "Hypothyroidism causes secondary hypercholesterolemia — treating thyroid often improves lipids." },
...
function buildSchemas() {
  const medicalWebPage = {
    ...
    name: PAGE_TITLE,
    url: PAGE_URL,
    description: 'Refill levothyroxine for hypothyroidism online in California. Board-certified Family Medicine MD. CA telehealth law compliant. Aetna in-network. Self pay $79. ATA guideline-based. Levothyroxine only — no Armour, no desiccated, no liothyronine.',
    ...
    speakable: {
      ...
      cssSelector: ['#hypothyroidism-refills-online-opening', '#hypothyroidism-refills-online-opening p', '.tdmd-hypothyroidism-refills-online-byline', '#hypothyroidism-refills-online-faq'],
    },
  };
  ...
  const howTo = {
    '@context': 'https://schema.org',
    '@type': 'HowTo',
    name: 'How to Get Refills for Hypothyroidism Refills Online in California',
    description: 'Three steps to receive hypothyroidism refills evaluation and prescription from a California-licensed board-certified physician.',
    totalTime: 'PT30M',
    estimatedCost: { '@type': 'MonetaryAmount', currency: 'USD', value: '79' },
    step: [
      { '@type': 'HowToStep', position: 1, name: 'Book your video visit', text: 'Visit teledirectmd.com and select California Hypothyroidism Refills. No referral needed. Self pay $79. Many visits available same day.', url: 'https://teledirectmd.com/book-online' },
...
export default function CaHypothyroidismRefillsOnline() {
  const schemas = buildSchemas();
  const pid = 'ca-hypothyroidism-refills-online';
      ...
      <div className="tdmd-ca-uti">
        ...
        <nav className="tdmd-breadcrumbs" aria-label="Breadcrumb">
          <div className="tdmd-container" style={{ paddingTop: '0.5rem', paddingBottom: 0 }}>
            ...
            <span className="tdmd-bc-sep" aria-hidden="true">/</span>
            <span aria-current="page">Hypothyroidism Refills</span>
          </div>
        </nav>
          ...
          <div className="tdmd-container">
            <div className="tdmd-hero-grid">
              <div className="tdmd-hero-copy">
                <h1 data-speakable="true">Hypothyroidism Refills</h1>
                <p className="tdmd-hero-sub" data-speakable="true">
                  California adults 18+ · Secure video visit · Self pay $79 · Aetna in-network · UHC Commercial approved · MD-only · CA B&amp;P §2290.5 compliant · ATA Guidelines
                </p>
                <p>
                ...
                <div className="tdmd-ca-uti__byline tdmd-hypothyroidism-refills-online-byline" aria-label="Reviewed by physician">
                ...
                <ul className="tdmd-hero-benefits">
                  ...
                  <li>Evidence-based treatment per ATA Guidelines</li>
                </ul>
                ...
                <p className="tdmd-icd"><strong>ICD-10 commonly used:</strong> E03.9 (Hypothyroidism, unspecified) — final coding per clinical details</p>
              </div>

              <div className="tdmd-hero-side">
                <div className="tdmd-hero-card">
                  <h2>Online Hypothyroidism Refills in California</h2>
                  <ul>
                    <li>Board-certified Family Medicine MD — California-licensed</li>
                    <li>Evidence-based regimen per ATA Guidelines</li>
        ...
        <section className="tdmd-section" id={`${pid}-opening`}>
          <div className="tdmd-container">
            <div className="tdmd-condition-opener" id="hypothyroidism-refills-online-opening">
              <p>
                California adults with established hypothyroidism can refill levothyroxine — the standard of care per American Thyroid Association (ATA) guidelines — by secure video visit through TeleDirectMD, consistent with California Business and Professions Code Section 2290.5. A California-licensed board-certified Family Medicine physician reviews your most recent TSH and free T4 lab values, current levothyroxine dose, adherence, and symptoms before authorizing refills. TeleDirectMD prescribes levothyroxine only. Desiccated thyroid extract (Armour Thyroid, NP Thyroid), liothyronine (T3), and combination T3/T4 therapy are outside the scope of this service. Self pay is $79. Aetna is in-network effective April 30, 2026.
              </p>
        ...
        {/* ─── SCOPE STATEMENT ──────────────────────────────────────────────── */}
        <section className="tdmd-section" id="hypothyroidism-refills-online-scope">
          <div className="tdmd-container">
            <div style={{ background: '#FFF3CD', border: '2px solid #FFC107', borderRadius: 'var(--tdmd-radius,18px)', padding: '1.1rem 1.5rem', marginTop: '1.5rem' }}>
              ...
              <p style={{ color: '#533f03', margin: 0 }}>TeleDirectMD prescribes LEVOTHYROXINE ONLY for hypothyroidism management. This service does NOT prescribe: Armour Thyroid (desiccated thyroid extract, DTE), NP Thyroid (desiccated thyroid extract), liothyronine (Cytomel, generic T3), or any combination T3/T4 therapy. The ATA 2014 guidelines for hypothyroidism management recommend levothyroxine as the standard of care. Patients seeking DTE or liothyronine should consult an endocrinologist.</p>
            </div>
          </div>
        </section>
        ...
        <section className="tdmd-section tdmd-section-highlight" id={`${pid}-ca-law`}>
          <div className="tdmd-container">
            <h2>California Telehealth Law and Your Hypothyroidism Refills Visit</h2>
        ...
        <section className="tdmd-section" id={`${pid}-epidemiology`}>
          <div className="tdmd-container">
            <h2>California Epidemiology: Hypothyroidism Refills</h2>
            <p>Hypothyroidism affects approximately 4.6% of the U.S. population aged 12 and older, with overt hypothyroidism in 0.3% and subclinical hypothyroidism in 4.3%, per NHANES data cited by the ATA. Applied to California's 39 million residents, approximately 1.7 million California adults have thyroid insufficiency requiring monitoring or treatment. Women are 5–8× more likely than men to develop hypothyroidism; prevalence increases with age.</p>
        ...
        <section className="tdmd-section tdmd-section-highlight" id={`${pid}-cost`}>
          <div className="tdmd-container">
            <h2>Hypothyroidism Refills Cost &amp; Insurance in California</h2>
            ...
            <div className="tdmd-price-grid">
              <div className="tdmd-price-card" aria-label="TeleDirectMD pricing">
                ...
                <ul className="tdmd-price-includes">
                  ...
                  <li>Evidence-based hypothyroidism refills management</li>
              ...
              <div className="tdmd-price-chart" role="group" aria-label="Typical cost comparison">
                <h3>Typical Hypothyroidism Refills Visit Cost in California</h3>
        ...
        <section className="tdmd-section" id={`${pid}-medications`}>
          <div className="tdmd-container">
            <h2>Hypothyroidism Refills: Medication Options and CA Pricing</h2>
            <p>
              The table below reflects evidence-based medication options per ATA Guidelines guidelines.
            ...
            <div className="tdmd-table-wrap">
              <table className="tdmd-table" aria-label="Hypothyroidism Refills medication options and GoodRx prices">
                <caption style={{ captionSide: 'bottom', textAlign: 'left', padding: '0.5rem 0', fontSize: '0.85rem', color: 'var(--tdmd-muted)' }}>
                ...
                <tbody>
                  <tr>
                    <td><strong>Levothyroxine sodium 25/50/75/88/100/112/125/137/150/175/200 mcg</strong></td>
                    <td>Once daily on empty stomach, 30–60 min before food; dose individualized by weight and TSH</td>
                    <td><a href="https://www.goodrx.com/levothyroxine" target="_blank" rel="noopener">~$8–$20/month GoodRx (generic)</a></td>
                    <td>Standard of care per ATA guidelines. Consistent brand/generic important — switching brands can alter bioavailability. Multiple manufacturers available.</td>
                  </tr>
                  <tr>
                    <td><strong>Synthroid (brand levothyroxine sodium)</strong></td>
                    <td>Same as generic — once daily on empty stomach</td>
                    <td><a href="https://www.goodrx.com/synthroid" target="_blank" rel="noopener">~$35–$80/month GoodRx (brand)</a></td>
                    <td>Bioequivalent to generic per FDA. Some patients prefer brand consistency. GoodRx coupon significantly reduces cost.</td>
                  </tr>
                </tbody>
              </table>
            </div>
        ...
        <section className="tdmd-section" id={`${pid}-dual-path`}>
          <div className="tdmd-container">
            ...
            <p>For most established hypothyroidism refills cases in stable adults, a video visit is appropriate and convenient. Some situations require in-person evaluation. Use the comparison below.</p>
            <div className="tdmd-ca-uti__dual">
              <div className="tdmd-ca-uti__dual-card tdmd-ca-uti__dual-card--good">
                ...
                <ul>
                  <li>Established hypothyroidism refills with prior diagnosis</li>
          ...
          <div className="tdmd-container">
            <div className="tdmd-ca-uti__cta-strip" role="complementary">
              <div>
                ...
                <small>Self pay $79 · Aetna in-network · UHC Commercial approved May 2026 · Hypothyroidism Refills</small>
              </div>
        ...
        <section className="tdmd-section tdmd-faq" id={`${pid}-faq`}>
          <div className="tdmd-container">
            <FaqAccordion
              sectionTitle="Frequently Asked Questions — Hypothyroidism Refills"
        ...
        <section className="tdmd-section" id={`${pid}-related`}>
          <div className="tdmd-container">
            ...
            <p>This page sits at the intersection of the <a href="/ca/">California state hub</a> and the <a href="/hypothyroidism-refills-online/">Hypothyroidism Refills national condition page</a>.</p>
            <div className="tdmd-ca-uti__related-links" aria-label="Related resources">
              <a href="/">Home</a>
              <a href="/ca/">California (state pillar)</a>
              <a href="/hypothyroidism-refills-online/">Hypothyroidism Refills (national)</a>
