/**
 * CaPinkEyeTreatmentOnline.js — production California × Pink Eye (Conjunctivitis) condition page (v3)
 *
 ...
 * Guideline: American Academy of Ophthalmology Preferred Practice Pattern: Conjunctivitis
 *
...
const PAGE_URL = 'https://teledirectmd.com/ca/pink-eye-treatment-online/';
const PAGE_TITLE = 'Pink Eye Treatment Online in California | TeleDirectMD';
...
const FAQ_ITEMS = [
  {
    id: 'ca-pink-eye-treatment-online-faq-0',
    question: 'Can I get pink eye treatment online in California?',
    answer: (
      <p>
  ...
  {
    id: 'ca-pink-eye-treatment-online-faq-1',
    question: 'How can a doctor determine if my pink eye is bacterial, viral, or allergic?',
    answer: (
      <p>
  ...
  {
    id: 'ca-pink-eye-treatment-online-faq-2',
    question: 'What antibiotic eye drops are used for pink eye, and what do they cost in California?',
    answer: (
      <p>
  ...
  {
    id: 'ca-pink-eye-treatment-online-faq-3',
  ...
  {
    id: 'ca-pink-eye-treatment-online-faq-4',
  ...
  {
    id: 'ca-pink-eye-treatment-online-faq-5',
    question: 'When is pink eye dangerous and when should I go to the ER in California?',
    answer: (
      <p>
  ...
  {
    id: 'ca-pink-eye-treatment-online-faq-6',
  ...
  {
    id: 'ca-pink-eye-treatment-online-faq-7',
    question: 'Will Medi-Cal cover my TeleDirectMD visit for pink eye?',
    answer: (
      <p>
  ...
  {
    id: 'ca-pink-eye-treatment-online-faq-8',
    question: 'How contagious is pink eye and can I go to work in California?',
    answer: (
      <p>
  ...
  {
    id: 'ca-pink-eye-treatment-online-faq-9',
    question: 'Does California\'s AB 744 telehealth parity law apply to pink eye visits?',
    answer: (
      <p>
  ...
  {
    id: 'ca-pink-eye-treatment-online-faq-10',
    question: 'How quickly will my eye drop prescription reach a California pharmacy?',
    answer: (
      <p>
  ...
  {
    id: 'ca-pink-eye-treatment-online-faq-11',
    question: 'Should I stop wearing contact lenses if I have pink eye?',
    answer: (
      <p>
...
const SCHEMAS = [{"@context": "https://schema.org", "@type": "MedicalWebPage", "name": "Pink Eye Treatment Online in California | TeleDirectMD", "url": "https://teledirectmd.com/ca/pink-eye-treatment-online/", "description": "Pink eye treatment online for California adults. Conjunctivitis evaluation \u2014 viral, bacterial, allergic. Board-certified Family Medicine MD. Self pay $49. Aetna in-network. Same-day video visits.", "datePublished": "2026-05-20", "dateModified": "2026-05-20", "inLanguage": "en-US", "about": {"@type": "MedicalCondition", "name": "Pink Eye (Conjunctivitis)", "code": {"@type": "MedicalCode", "code": "H10.9", "codingSystem": "ICD-10-CM"}}, "medicalAudience": {"@type": "MedicalAudience", "audienceType": "Patient", "geographicArea": {"@type": "AdministrativeArea", "name": "California"}}, "reviewedBy": {"@type": "Physician", "@id": "https://teledirectmd.com/about/#physician-parth-bhavsar", "name": "Parth Bhavsar, MD", "identifier": {"@type": "PropertyValue", "propertyID": "NPI", "value": "1104323203"}, "medicalSpecialty": "Family Medicine", "hasCredential": [{"@type": "EducationalOccupationalCredential", "credentialCategory": "degree", "name": "Doctor of Medicine (MD)"}, {"@type": "EducationalOccupationalCredential", "credentialCategory": "certification", "name": "Board Certification \u2014 American Board of Family Medicine"}], "licensedIn": "California", "worksFor": {"@type": "MedicalOrganization", "name": "TeleDirectMD", "url": "https://teledirectmd.com"}, "sameAs": ["https://npiregistry.cms.hhs.gov/provider-view/1104323203", "https://teledirectmd.com/about/"]}, "speakable": {"@type": "SpeakableSpecification", "cssSelector": ["#ca-pink-eye-treatment-online-opening", "#ca-pink-eye-treatment-online-opening p", ".tdmd-ca-pink-eye-treatment-online__byline", "#ca-pink-eye-treatment-online-faq"]}}, {"@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [{"@type": "Question", "name": "Can I get pink eye treatment online in California?", "acceptedAnswer": {"@type": "Answer", "text": "Yes. California Business and Professions Code Section 2290.5 permits California-licensed physicians to deliver care via synchronous video telehealth without a prior in-person visit. TeleDirectMD physicians are licensed in California. Adults 18+ in California with pink eye symptoms \u2014 redness, discharge, irritation \u2014 can book a same-day video visit. If your history suggests bacterial conjunctivitis without red-flag symptoms, antibiotic eye drops may be appropriate. Self pay is $49; Aetna is in-network as of April 30, 2026."}}, {"@type": "Question", "name": "How can a doctor determine if my pink eye is bacterial, viral, or allergic?", "acceptedAnswer": {"@type": "Answer", "text": "The history and symptom pattern guide differentiation. Bacterial conjunctivitis: often unilateral onset spreading to both eyes, purulent (thick yellow/green) discharge, eyelids stuck together upon waking. Viral conjunctivitis: often bilateral from the start, watery discharge, accompanying cold or sore throat, highly contagious. Allergic conjunctivitis: bilateral, prominent itching, seasonal or exposure-triggered, often with other allergy symptoms. A physician evaluates your history at your TeleDirectMD visit to guide the appropriate treatment."}}, {"@type": "Question", "name": "What antibiotic eye drops are used for pink eye, and what do they cost in California?", "acceptedAnswer": {"@type": "Answer", "text": "For bacterial conjunctivitis, common options include ofloxacin ophthalmic 0.3% (generic ~$12\u2013$20 with GoodRx) or polymyxin B/trimethoprim (Polytrim, generic ~$10\u2013$18 with GoodRx). These are prescription eye drops sent electronically to your California pharmacy. Prescription costs at pharmacy are separate from the TeleDirectMD visit fee ($49). OTC ketotifen drops (Zaditor, ~$10\u2013$15) treat allergic conjunctivitis without a prescription."}}, {"@type": "Question", "name": "Does California require an in-person visit before telehealth?", "acceptedAnswer": {"@type": "Answer", "text": "No. California B&P Code \u00a72290.5 does not require a prior in-person visit. A California-licensed physician can evaluate your eye symptoms through a synchronous video visit. Note that a telehealth visit cannot perform slit-lamp examination; if visual acuity concerns or serious complications arise, the physician will direct you to urgent ophthalmologic care."}}, {"@type": "Question", "name": "Is my Aetna plan in California in-network with TeleDirectMD?", "acceptedAnswer": {"@type": "Answer", "text": "Aetna became an active in-network payor for TeleDirectMD in California effective April 30, 2026. If you hold an Aetna commercial plan in California, you may be able to use your in-network benefits. Verify current in-network status directly with Aetna before your visit."}}, {"@type": "Question", "name": "When is pink eye dangerous and when should I go to the ER in California?", "acceptedAnswer": {"@type": "Answer", "text": "Seek emergency eye care immediately if you have severe eye pain, sudden vision loss, photophobia with pain, a visible white spot on the cornea, or chemical exposure. Contact lens wearers with severe redness and pain should be evaluated urgently \u2014 possible corneal ulcer. A sudden onset of very thick purulent discharge in a sexually active person may indicate gonorrheal conjunctivitis, which requires same-day emergency treatment. TeleDirectMD is not appropriate for these presentations."}}, {"@type": "Question", "name": "Is UnitedHealthcare in-network with TeleDirectMD in California?", "acceptedAnswer": {"@type": "Answer", "text": "UnitedHealthcare Commercial was approved for California effective May 29, 2026, covering commercial plans and Medicare Advantage. Excludes Medi-Cal, Individual Exchange, and Navigate/Charter/Core plan types. Verify your specific plan eligibility with UHC before booking."}}, {"@type": "Question", "name": "Will Medi-Cal cover my TeleDirectMD visit for pink eye?", "acceptedAnswer": {"@type": "Answer", "text": "TeleDirectMD is not currently enrolled as a Medi-Cal provider. If you have Medi-Cal, you can use the $49 self-pay rate or find a Medi-Cal-enrolled telehealth provider through your managed care plan or California DHCS at dhcs.ca.gov."}}, {"@type": "Question", "name": "How contagious is pink eye and can I go to work in California?", "acceptedAnswer": {"@type": "Answer", "text": "Viral and bacterial conjunctivitis are highly contagious. The CDC recommends staying home until eye discharge has resolved or until 24 hours after starting antibiotic drops for confirmed bacterial cases. Avoid touching your eyes, practice frequent handwashing, do not share towels or pillowcases, and discard contact lenses used during the illness. California does not have a specific statewide conjunctivitis workplace exclusion policy, but your employer may have specific protocols."}}, {"@type": "Question", "name": "Does California's AB 744 telehealth parity law apply to pink eye visits?", "acceptedAnswer": {"@type": "Answer", "text": "California AB 744 (2019) requires commercial health plans to reimburse telehealth services on the same basis as in-person services. Parity applies when the provider is already in-network with your specific plan. Currently, Aetna (active April 30, 2026) and UnitedHealthcare Commercial (active May 29, 2026) are in-network in California for TeleDirectMD."}}, {"@type": "Question", "name": "How quickly will my eye drop prescription reach a California pharmacy?", "acceptedAnswer": {"@type": "Answer", "text": "California requires all prescriptions to be issued electronically under Assembly Bill 2789 (effective January 1, 2022). If antibiotic eye drops are appropriate, TeleDirectMD sends an e-prescription electronically to your chosen California pharmacy during or after your visit. Most California pharmacies fill within one to four hours."}}, {"@type": "Question", "name": "Should I stop wearing contact lenses if I have pink eye?", "acceptedAnswer": {"@type": "Answer", "text": "Yes. Per American Academy of Ophthalmology guidance, contact lens wearers with suspected conjunctivitis should discontinue contact lens use until the infection has fully resolved. Do not use the contact lenses worn during the illness again; discard them and use a new pair once the eye has healed. Follow up with your eye care provider if symptoms do not resolve within 5\u20137 days or if vision is affected."}}]}, {"@context": "https://schema.org", "@type": "HowTo", "name": "How to Get Pink Eye Treatment Online in California", "description": "Three steps to receive pink eye treatment evaluation and, if appropriate, a prescription from a California-licensed board-certified physician.", "totalTime": "PT30M", "estimatedCost": {"@type": "MonetaryAmount", "currency": "USD", "value": "49"}, "step": [{"@type": "HowToStep", "position": 1, "name": "Book your video visit", "text": "Visit teledirectmd.com and select California Pink Eye (Conjunctivitis) treatment. No referral needed. Self pay $49. Many visits available same day.", "url": "https://teledirectmd.com/book-online"}, {"@type": "HowToStep", "position": 2, "name": "See a California-licensed MD by secure video", "text": "Connect with a board-certified Family Medicine physician licensed in California. The physician reviews your symptoms, history, and red-flag screening. Consent per CA B&P Section 2290.5 confirmed.", "url": "https://teledirectmd.com/ca/pink-eye-treatment-online/"}, {"@type": "HowToStep", "position": 3, "name": "Receive your treatment plan and e-prescription", "text": "If medication is appropriate, a California-compliant e-prescription is sent to your chosen pharmacy during or after the visit.", "url": "https://teledirectmd.com/ca/pink-eye-treatment-online/"}]}, {"@context": "https://schema.org", "@type": "BreadcrumbList", "itemListElement": [{"@type": "ListItem", "position": 1, "name": "TeleDirectMD", "item": "https://teledirectmd.com"}, {"@type": "ListItem", "position": 2, "name": "California", "item": "https://teledirectmd.com/ca/"}, {"@type": "ListItem", "position": 3, "name": "Pink Eye Treatment Online in California", "item": "https://teledirectmd.com/ca/pink-eye-treatment-online/"}]}];
...
export default function CaPinkEyeTreatmentOnline() {
  const pid = 'ca-pink-eye-treatment-online';
    ...
    <>
      ...
      <div className="tdmd-ca-cond">
          ...
          <div className="tdmd-container">
            <div className="tdmd-hero-grid">
              <div className="tdmd-hero-copy">
                <h1 data-speakable="true">Pink Eye (Conjunctivitis) Treatment Online in California</h1>
                ...
                <p className="tdmd-icd"><strong>ICD-10 commonly used:</strong> H10.9 (Conjunctivitis, unspecified); actual code assigned at visit</p>
              </div>

              <div className="tdmd-hero-side">
                <div className="tdmd-hero-card">
                  <h2>Online MD-Only Pink Eye (Conjunctivitis) Care in California</h2>
                  <ul>
                    <li>Fast evaluation for pink eye treatment symptoms</li>
                    <li>Red-flag screening for serious complications requiring in-person care</li>
                    <li>Guideline-based treatment per American Academy of Ophthalmology (AAO)</li>
        ...
        <section className="tdmd-section" id={`${pid}-eligibility`}>
          <div className="tdmd-container">
            <h2>Pink Eye Treatment Telehealth Eligibility Checklist for California</h2>
            ...
            <div className="tdmd-ca-cond__dual">
              <div className="tdmd-ca-cond__dual-card tdmd-ca-cond__dual-card--good">
                ...
                <ul>
                  ...
                  <li>Red, pink, or irritated eye with discharge (watery, mucoid, or purulent)</li>
                  <li>Mild to moderate itching, burning, or gritty sensation</li>
                  <li>No significant pain, vision loss, or photophobia</li>
                  <li>Not a contact lens wearer with severe symptoms</li>
                  <li>Able to open the eye and describe symptoms clearly</li>
                </ul>
              </div>
              <div className="tdmd-ca-cond__dual-card tdmd-ca-cond__dual-card--alert">
                <h3>&#10007; Seek In-Person or Emergency Care If</h3>
                <ul>
                  <li>Severe eye pain (not just irritation)</li>
                  <li>Sudden vision loss or significantly blurry vision not cleared by blinking</li>
                  <li>Photophobia (light sensitivity) with severe pain</li>
                  <li>Corneal opacity or whitish spot on the cornea visible to you</li>
                  <li>History of contact lens wear with severe pain (possible corneal ulcer)</li>
                  <li>Chemical exposure to the eye</li>
                  <li>Injury to the eye</li>
                  <li>Eye symptoms after gonococcal STI exposure (hyperacute purulent discharge)</li>
                </ul>
        ...
        <section className="tdmd-section tdmd-section-highlight" id={`${pid}-ca-law`}>
          <div className="tdmd-container">
            <h2>California Telehealth Law and Your Pink Eye Treatment Visit</h2>
            ...
            <h3>Are pink eye treatment medications controlled substances under California law?</h3>
            <p>
        ...
        <section className="tdmd-section" id={`${pid}-how-it-works`} itemScope itemType="https://schema.org/HowTo">
          <div className="tdmd-container">
            <h2 itemProp="name">How Online Pink Eye Treatment Works in California</h2>
            <div className="tdmd-decision-flow">
              <div className="tdmd-decision-step tdmd-decision-step-check">
                <div className="tdmd-decision-number">1</div>
                <div className="tdmd-decision-content">
                  <h3>Book your video visit</h3>
                  <p>No referral needed. Self pay $49. Many visits available same day. Note your symptom onset, prior episodes, allergies, and current medications before the visit.</p>
                </div>
              </div>
              <div className="tdmd-decision-step tdmd-decision-step-check">
        ...
        <section className="tdmd-section" id={`${pid}-epidemiology`}>
          <div className="tdmd-container">
            <h2>How Common Is Pink Eye (Conjunctivitis) in California?</h2>
            <p>
              Conjunctivitis (pink eye) is one of the most common eye conditions, with an estimated 6 million cases annually in the United States. The California Department of Public Health notes that adenoviral conjunctivitis is the most common cause of infectious conjunctivitis outbreaks in California schools, workplaces, and healthcare settings, with periodic statewide alerts during community outbreak events. — <a href="https://www.cdc.gov/conjunctivitis/about/index.html" rel="noopener" target="_blank">CDC — About Conjunctivitis (Pink Eye)</a>.
            </p>
            <p>
              Clinical guidance for pink eye treatment is provided by <a href="https://www.aao.org/eyenet/article/managing-conjunctivitis" rel="noopener" target="_blank">American Academy of Ophthalmology (AAO)</a> through the American Academy of Ophthalmology Preferred Practice Pattern: Conjunctivitis. TeleDirectMD follows these guidelines on every patient visit.
            </p>
            <h3>What causes pink eye (conjunctivitis) and who is most at risk in California?</h3>
            <p>
        ...
        <section className="tdmd-section tdmd-section-highlight" id={`${pid}-cost`}>
          <div className="tdmd-container">
            <h2>Pink Eye Treatment Cost &amp; Insurance in California</h2>
            <p>TeleDirectMD&apos;s self-pay rate is <strong>$49</strong> for a complete MD video visit, including evaluation, treatment plan, and e-prescription. Patients with in-network insurance pay their plan&apos;s telehealth copay instead. The table below reflects current TeleDirectMD payor enrollment for California.</p>
            ...
            <div className="tdmd-price-grid">
              ...
              <div className="tdmd-price-chart" role="group" aria-label="Typical Pink Eye (Conjunctivitis) cost comparison">
                <h3>Typical Pink Eye (Conjunctivitis) Visit Cost in California</h3>
            ...
            <p style={{ marginTop: '1rem' }}>
              View all <a href="/insurance">insurance options</a> or <a href="/book-online">book a $49 self-pay visit</a>.
            </p>
          </div>
        </section>
        ...
        <section className="tdmd-section" id={`${pid}-medications`}>
          <div className="tdmd-container">
            <h2>Pink Eye Treatment Medication Options and Costs in California</h2>
            <p>
              Medications for pink eye treatment are selected based on current guidelines from <a href="https://www.aao.org/eyenet/article/managing-conjunctivitis" rel="noopener" target="_blank">American Academy of Ophthalmology (AAO)</a>, patient history, allergies, and relevant contraindications assessed at the visit. GoodRx-verified pricing is shown below.
            </p>
            <div className="tdmd-table-wrap">
              <table className="tdmd-table" aria-label="Pink Eye Treatment medication options and GoodRx prices">
                <caption style={{ captionSide: 'bottom', textAlign: 'left', padding: '0.5rem 0', fontSize: '0.85rem', color: 'var(--tdmd-muted)' }}>
                ...
                <tbody>
                  ...
                  <tr>
                    <td><strong>Ketotifen eye drops (Zaditor/Alaway) — OTC</strong></td>
                    <td>1 drop in affected eye(s) twice daily as needed</td>
                    <td>Available OTC ~$10–$15</td>
                    <td>For allergic conjunctivitis with itching. Antihistamine/mast cell stabilizer. Available OTC. Not for bacterial infection.</td>
                  </tr>
                </tbody>
              </table>
            </div>
        ...
        <section className="tdmd-section" id={`${pid}-dual-path`}>
          <div className="tdmd-container">
            ...
            <p>For most adults with mild to moderate pink eye treatment without red-flag symptoms, a video visit is appropriate and convenient. Some situations require in-person evaluation. Use the comparison below to determine the right care pathway for you.</p>
            <div className="tdmd-ca-cond__dual">
              <div className="tdmd-ca-cond__dual-card tdmd-ca-cond__dual-card--good">
          ...
          <div className="tdmd-container">
            <div className="tdmd-ca-cond__cta-strip" role="complementary">
              <div>
                ...
                <small>Self pay $49 &middot; Aetna in-network &middot; UHC Commercial approved May 2026 &middot; No ER wait</small>
              </div>
        ...
        <section className="tdmd-section tdmd-faq" id={`${pid}-faq`}>
          <div className="tdmd-container">
            <FaqAccordion
              sectionTitle="Frequently Asked Questions — Pink Eye Treatment in California"
              items={FAQ_ITEMS}
            />
            <div className="tdmd-bottom-cta" role="region" aria-label="Book a visit call to action">
              <div className="tdmd-bottom-cta-copy">
                <h3>Ready to see a California-licensed MD?</h3>
                <p>Book a same-day video visit. Self pay $49 &middot; Aetna in-network &middot; UHC Commercial approved.</p>
              </div>
          ...
          <div className="tdmd-container">
            ...
            <div className="tdmd-ca-cond__sibling-grid">
              <a key="sore-throat-treatment-online" className="tdmd-ca-uti__sibling" href="/ca/sore-throat-treatment-online/">
                  ...
                  <span className="tdmd-ca-uti__sibling-why">Adenoviral conjunctivitis often occurs with pharyngitis (pharyngoconjunctival fever).</span>
                </a>
              <a key="common-cold-treatment-online" className="tdmd-ca-uti__sibling" href="/ca/common-cold-treatment-online/">
                  ...
                  <span className="tdmd-ca-uti__sibling-why">Viral conjunctivitis commonly accompanies a cold.</span>
                </a>
              <a key="ear-pain-treatment-online" className="tdmd-ca-uti__sibling" href="/ca/ear-pain-treatment-online/">
                  ...
                  <span className="tdmd-ca-uti__sibling-why">Upper respiratory infections can affect eyes and ears simultaneously.</span>
                </a>
              <a key="cellulitis-treatment-online" className="tdmd-ca-uti__sibling" href="/ca/cellulitis-treatment-online/">
                  ...
                  <span className="tdmd-ca-uti__sibling-why">Periorbital (preseptal) cellulitis presents with eyelid swelling — must distinguish from conjunctivitis.</span>
                </a>
        ...
        <section className="tdmd-section" id={`${pid}-related`}>
          <div className="tdmd-container">
            ...
            <p>This page sits at the intersection of the <a href="/ca/">California state hub</a> and the <a href="/pink-eye-treatment-online/">Pink Eye (Conjunctivitis) national condition page</a>. Use the links below to explore insurance details, book a visit, or review other conditions.</p>
            <div className="tdmd-ca-cond__related-links" aria-label="Related resources">
              <a href="/">Home</a>
              <a href="/ca/">California (state pillar)</a>
              <a href="/pink-eye-treatment-online/">National Pink Eye (Conjunctivitis) page</a>
              <a href="/health-guides/">Pink Eye (Conjunctivitis) health guides</a>
        ...
        <WhatDoesThisCostBlock conditionSlug="pink-eye-treatment-online" conditionName="Pink Eye Treatment" stateName="California" />
