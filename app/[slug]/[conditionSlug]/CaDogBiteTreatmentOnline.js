/**
 * CaDogBiteTreatmentOnline.js — production California × Dog Bite condition page (v3)
 *
 * Rendered by app/[slug]/[conditionSlug]/page.js when slug === 'ca' and
 * conditionSlug === 'dog-bite-treatment-online'.
 *
...
const PAGE_URL = 'https://teledirectmd.com/ca/dog-bite-treatment-online/';
const PAGE_TITLE = 'Dog Bite (Infection Prevention and Wound Care) Online in California | TeleDirectMD';
...
const FAQ_ITEMS = [
  {
    id: 'ca-dog-bite-treatment-online-faq-0',
    question: 'Can I get dog bite treatment online in California?',
    answer: (
      <p>
  ...
  {
    id: 'ca-dog-bite-treatment-online-faq-1',
    question: 'What is the first-line antibiotic for dog bite wounds?',
    answer: (
      <p>
  ...
  {
    id: 'ca-dog-bite-treatment-online-faq-2',
    question: 'When does a dog bite require emergency care in California?',
    answer: (
      <p>
  ...
  {
    id: 'ca-dog-bite-treatment-online-faq-3',
    question: 'How common are dog bites in California?',
    answer: (
      <p>
  ...
  {
    id: 'ca-dog-bite-treatment-online-faq-4',
    question: 'Does a dog bite always require antibiotics?',
    answer: (
      <p>
  ...
  {
    id: 'ca-dog-bite-treatment-online-faq-5',
    question: 'What is the rabies risk from dog bites in California?',
    answer: (
      <p>
  ...
  {
    id: 'ca-dog-bite-treatment-online-faq-6',
    question: 'Is Aetna in-network for dog bite treatment at TeleDirectMD in California?',
    answer: (
      <p>
  ...
  {
    id: 'ca-dog-bite-treatment-online-faq-7',
    question: 'What is the cost of dog bite treatment in California?',
    answer: (
      <p>
  ...
  {
    id: 'ca-dog-bite-treatment-online-faq-8',
    question: 'Does California\'s AB 744 parity law cover dog bite telehealth?',
    answer: (
      <p>
  ...
  {
    id: 'ca-dog-bite-treatment-online-faq-9',
  ...
  {
    id: 'ca-dog-bite-treatment-online-faq-10',
    question: 'Do I need a tetanus shot after a dog bite?',
    answer: (
      <p>
  ...
  {
    id: 'ca-dog-bite-treatment-online-faq-11',
    question: 'Will my dog bite antibiotic prescription be sent electronically to a California pharmacy?',
    answer: (
      <p>
...
const SCHEMAS = [{"@context": "https://schema.org", "@type": "MedicalWebPage", "name": "Dog Bite (Infection Prevention and Wound Care) Online in California | TeleDirectMD", "url": "https://teledirectmd.com/ca/dog-bite-treatment-online/", "description": "Dog bite antibiotic prophylaxis online for California adults. Board-certified Family Medicine MD. CDC + IDSA guideline-based. Self pay $79. Aetna in-network. Same-day video visits. Amoxicillin-clavulanate.", "datePublished": "2026-05-20", "dateModified": "2026-05-20", "inLanguage": "en-US", "about": {"@type": "MedicalCondition", "name": "Dog Bite", "code": {"@type": "MedicalCode", "code": "W54.0XXA", "codingSystem": "ICD-10-CM"}}, "medicalAudience": {"@type": "MedicalAudience", "audienceType": "Patient", "geographicArea": {"@type": "AdministrativeArea", "name": "California"}}, "reviewedBy": {"@type": "Physician", "@id": "https://teledirectmd.com/about/#physician-parth-bhavsar", "name": "Parth Bhavsar, MD", "identifier": {"@type": "PropertyValue", "propertyID": "NPI", "value": "1104323203"}, "medicalSpecialty": "Family Medicine", "hasCredential": [{"@type": "EducationalOccupationalCredential", "credentialCategory": "degree", "name": "Doctor of Medicine (MD)"}, {"@type": "EducationalOccupationalCredential", "credentialCategory": "certification", "name": "Board Certification \u2014 American Board of Family Medicine"}], "licensedIn": "California", "worksFor": {"@type": "MedicalOrganization", "name": "TeleDirectMD", "url": "https://teledirectmd.com"}, "sameAs": ["https://npiregistry.cms.hhs.gov/provider-view/1104323203", "https://teledirectmd.com/about/"]}, "speakable": {"@type": "SpeakableSpecification", "cssSelector": ["#ca-dog-bite-treatment-online-opening", "#ca-dog-bite-treatment-online-opening p", ".tdmd-ca-dog-bite-treatment-online__byline", "#ca-dog-bite-treatment-online-faq"]}}, {"@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [{"@type": "Question", "name": "Can I get dog bite treatment online in California?", "acceptedAnswer": {"@type": "Answer", "text": "Yes \u2014 for telehealth-appropriate presentations. California Business and Professions Code Section 2290.5 permits California-licensed physicians to evaluate dog bite wounds and prescribe prophylactic antibiotics via secure video visit. TeleDirectMD physicians follow CDC and IDSA guidelines, prescribing amoxicillin-clavulanate (Augmentin) as first-line prophylaxis and evaluating tetanus and rabies PEP status. Go to the ED for: deep wounds, facial bites, hand bites, suspected rabies exposure, or signs of established infection. Self pay is $79."}}, {"@type": "Question", "name": "What is the first-line antibiotic for dog bite wounds?", "acceptedAnswer": {"@type": "Answer", "text": "Amoxicillin-clavulanate (Augmentin) 875/125 mg twice daily for 5 days is the first-line prophylactic antibiotic for dog bite wounds per IDSA guidelines. It provides coverage for the polymicrobial flora of dog bites \u2014 including Pasteurella multocida, Capnocytophaga canimorsus, anaerobes, streptococci, and staphylococci. Prophylaxis should begin within 8\u201312 hours of the bite to be effective. For penicillin-allergic patients, alternatives include doxycycline + metronidazole."}}, {"@type": "Question", "name": "When does a dog bite require emergency care in California?", "acceptedAnswer": {"@type": "Answer", "text": "Go to the ED immediately for: deep puncture wounds or wounds requiring suturing, facial bites (especially in children), hand bites with tendon involvement, suspected rabies exposure (stray or unvaccinated dog, wild animal), immunocompromised patient with any dog bite (Capnocytophaga sepsis risk), or signs of established infection (spreading redness, fever, purulent discharge, systemic illness). Rabies post-exposure prophylaxis (immunoglobulin + vaccine) cannot be started by telehealth \u2014 go to the ED immediately."}}, {"@type": "Question", "name": "How common are dog bites in California?", "acceptedAnswer": {"@type": "Answer", "text": "California averages approximately 14,000\u201316,000 reported dog bites annually per CDPH data, with actual incidence significantly higher due to underreporting. The CDC estimates 4.5 million dog bites occur in the United States each year, with about 800,000 requiring medical attention. California law requires reporting of animal bites when rabies risk is suspected to local health departments."}}, {"@type": "Question", "name": "Does a dog bite always require antibiotics?", "acceptedAnswer": {"@type": "Answer", "text": "Not always. IDSA guidelines recommend antibiotic prophylaxis for dog bites with: puncture wounds (especially from large dogs), wounds involving hands, feet, or face, bites in immunocompromised patients, bites requiring suturing, or wounds where debridement is incomplete. Minor superficial dog bite abrasions without puncture in healthy non-immunocompromised adults may not require prophylaxis if wound care is thorough. TeleDirectMD physicians apply IDSA criteria at the visit."}}, {"@type": "Question", "name": "What is the rabies risk from dog bites in California?", "acceptedAnswer": {"@type": "Answer", "text": "The CDPH Rabies Surveillance Program tracks California animal bites. California has not had a human rabies case from a domestic dog in decades \u2014 the primary rabies reservoir in California is bats, followed by skunks and foxes. A dog bite from a known, vaccinated dog has extremely low rabies risk. Bites from stray, unvaccinated, or wild animals require rabies post-exposure prophylaxis (PEP) evaluation \u2014 go to the ED immediately."}}, {"@type": "Question", "name": "Is Aetna in-network for dog bite treatment at TeleDirectMD in California?", "acceptedAnswer": {"@type": "Answer", "text": "Yes. Aetna became an active in-network payor for TeleDirectMD in California effective April 30, 2026. UnitedHealthcare Commercial is approved effective May 29, 2026. Self pay is $79."}}, {"@type": "Question", "name": "What is the cost of dog bite treatment in California?", "acceptedAnswer": {"@type": "Answer", "text": "TeleDirectMD charges $79 self-pay for a complete MD video visit. Generic amoxicillin-clavulanate 875/125 mg costs ~$15\u2013$35 for 5 days with GoodRx. ED dog bite visits in California typically cost $500\u2013$3,000+ before insurance, depending on wound complexity, suturing, and imaging."}}, {"@type": "Question", "name": "Does California's AB 744 parity law cover dog bite telehealth?", "acceptedAnswer": {"@type": "Answer", "text": "Yes, for in-network commercial plans. California AB 744 (2019) requires commercial health plans to reimburse telehealth on the same basis as in-person services. Aetna and UHC Commercial are in-network for TeleDirectMD in California."}}, {"@type": "Question", "name": "What should I do immediately after a dog bite?", "acceptedAnswer": {"@type": "Answer", "text": "Immediate steps per CDC: wash the wound thoroughly with soap and water for at least 5 minutes; apply gentle pressure to stop bleeding; cover with a clean bandage. Then: assess the wound severity, identify the dog and its vaccination status, call California animal control if the dog is stray. Seek in-person care for deep wounds, facial bites, or suspected rabies exposure. Telehealth is appropriate for minor bite wounds in healthy adults once first-aid is complete."}}, {"@type": "Question", "name": "Do I need a tetanus shot after a dog bite?", "acceptedAnswer": {"@type": "Answer", "text": "Tetanus prophylaxis after dog bite follows standard wound care guidelines. If your last tetanus vaccine was more than 5 years ago, a booster (Td or Tdap) is recommended for wounds with significant contamination. If you have never been vaccinated or your vaccination history is unknown, tetanus immunoglobulin (TIG) plus vaccine series may be needed. Tetanus shots require in-person administration \u2014 TeleDirectMD physicians assess tetanus status and direct you to a California pharmacy or urgent care for the booster."}}, {"@type": "Question", "name": "Will my dog bite antibiotic prescription be sent electronically to a California pharmacy?", "acceptedAnswer": {"@type": "Answer", "text": "Yes. California AB 2789 (effective January 1, 2022) requires all prescriptions to be issued electronically. TeleDirectMD sends e-prescriptions to your chosen California pharmacy \u2014 CVS, Walgreens, Rite Aid, Walmart, Safeway \u2014 during or after your visit."}}]}, {"@context": "https://schema.org", "@type": "HowTo", "name": "How to Get Dog Bite (Infection Prevention and Wound Care) Online in California", "description": "Three steps to receive dog bite (infection prevention and wound care) evaluation and, if appropriate, a prescription from a California-licensed board-certified physician.", "totalTime": "PT30M", "estimatedCost": {"@type": "MonetaryAmount", "currency": "USD", "value": "79"}, "step": [{"@type": "HowToStep", "position": 1, "name": "Book your video visit", "text": "Visit teledirectmd.com and select California Dog Bite treatment. No referral needed. Self pay $79. Many visits available same day.", "url": "https://teledirectmd.com/book-online"}, {"@type": "HowToStep", "position": 2, "name": "See a California-licensed MD by secure video", "text": "Connect with a board-certified Family Medicine physician licensed in California. The physician reviews your symptoms, history, and red-flag screening. Consent per CA B&P Section 2290.5 confirmed.", "url": "https://teledirectmd.com/ca/dog-bite-treatment-online/"}, {"@type": "HowToStep", "position": 3, "name": "Receive your treatment plan and e-prescription", "text": "If medication is appropriate, a California-compliant e-prescription is sent to your chosen pharmacy during or after the visit.", "url": "https://teledirectmd.com/ca/dog-bite-treatment-online/"}]}, {"@context": "https://schema.org", "@type": "BreadcrumbList", "itemListElement": [{"@type": "ListItem", "position": 1, "name": "TeleDirectMD", "item": "https://teledirectmd.com"}, {"@type": "ListItem", "position": 2, "name": "California", "item": "https://teledirectmd.com/ca/"}, {"@type": "ListItem", "position": 3, "name": "Dog Bite (Infection Prevention and Wound Care) Online in California", "item": "https://teledirectmd.com/ca/dog-bite-treatment-online/"}]}];
...
export default function CaDogBiteTreatmentOnline() {
  const pid = 'ca-dog-bite-treatment-online';
      ...
      <div className="tdmd-ca-cond">
        ...
        <nav className="tdmd-breadcrumbs" aria-label="Breadcrumb">
          <div className="tdmd-container" style={{ paddingTop: '0.5rem', paddingBottom: 0 }}>
            ...
            <span className="tdmd-bc-sep" aria-hidden="true">/</span>
            <span aria-current="page">Dog Bite (Infection Prevention and Wound Care) Online</span>
          </div>
        </nav>
          ...
          <div className="tdmd-container">
            <div className="tdmd-hero-grid">
              <div className="tdmd-hero-copy">
                <h1 data-speakable="true">Dog Bite Treatment Online in California</h1>
                ...
                <p className="tdmd-icd"><strong>ICD-10 commonly used:</strong> W54.0XXA (Bitten by dog, initial encounter)</p>
              </div>

              <div className="tdmd-hero-side">
                <div className="tdmd-hero-card">
                  <h2>Online MD-Only Dog Bite Care in California</h2>
                  <ul>
        ...
        <section className="tdmd-section" id={`${pid}-eligibility`}>
          <div className="tdmd-container">
            <h2>Dog Bite (Infection Prevention and Wound Care) Telehealth Eligibility Checklist for California</h2>
            ...
            <div className="tdmd-ca-cond__dual">
              <div className="tdmd-ca-cond__dual-card tdmd-ca-cond__dual-card--good">
                ...
                <ul>
                  ...
                  <li>Minor dog bite laceration or puncture — skin only, no deep involvement, wound already cleaned</li>
                  <li>No signs of established infection within first 24–48 hours of bite</li>
                  <li>Dog known and vaccinated (rabies risk assessed as low)</li>
                  <li>Non-immunocompromised adult, wound on limb or trunk (not face or hand)</li>
                  <li>Prophylactic antibiotic prescription when bite meets IDSA prophylaxis criteria</li>
                </ul>
              </div>
              <div className="tdmd-ca-cond__dual-card tdmd-ca-cond__dual-card--alert">
                <h3>&#10007; Seek In-Person or Emergency Care If</h3>
                <ul>
                  <li>Deep puncture wounds, wounds requiring suturing, or wounds with tendon/bone involvement — go to the ED</li>
                  <li>Facial bites, especially in children — go to the ED</li>
                  <li>Suspected rabies exposure — stray, unvaccinated, or wild animal bite — rabies PEP requires immediate ED evaluation and cannot be started by telehealth</li>
                  <li>Immunocompromised patient with any dog bite — Capnocytophaga canimorsus sepsis risk is a medical emergency</li>
                  <li>Signs of established infection — purulent discharge, significant warmth, expanding erythema &gt;2 cm border, fever, systemic illness — go to the ED</li>
                  <li>Tetanus vaccination not current (&gt;5 years since last booster) — tetanus booster or TIG requires in-person administration</li>
                </ul>
        ...
        <section className="tdmd-section tdmd-section-highlight" id={`${pid}-ca-law`}>
          <div className="tdmd-container">
            <h2>California Telehealth Law and Your Dog Bite (Infection Prevention and Wound Care) Visit</h2>
            ...
            <h3>Are dog bite (infection prevention and wound care) medications controlled substances under California law?</h3>
            <p>
        ...
        <section className="tdmd-section" id={`${pid}-how-it-works`} itemScope itemType="https://schema.org/HowTo">
          <div className="tdmd-container">
            <h2 itemProp="name">How Online Dog Bite (Infection Prevention and Wound Care) Works in California</h2>
        ...
        <section className="tdmd-section" id={`${pid}-epidemiology`}>
          <div className="tdmd-container">
            <h2>How Common Is Dog Bite in California?</h2>
            <p>
        ...
        <section className="tdmd-section tdmd-section-highlight" id={`${pid}-cost`}>
          <div className="tdmd-container">
            <h2>Dog Bite (Infection Prevention and Wound Care) Cost &amp; Insurance in California</h2>
            ...
            <div className="tdmd-price-grid">
              ...
              <div className="tdmd-price-chart" role="group" aria-label="Typical Dog Bite cost comparison">
                <h3>Typical Dog Bite Visit Cost in California</h3>
              ...
              <table className="tdmd-table" aria-label="Dog Bite (Infection Prevention and Wound Care) medication options and GoodRx prices">
                ...
                <tbody>
                  <tr className="tdmd-ca-uti__med-firstline">
                    ...
                    <td>875 mg twice daily × 5 days (prophylaxis) or 5–7 days (early infection)</td>
                    <td><a href="https://www.goodrx.com/amoxicillin-clavulanate" target="_blank" rel="noopener">~$15–$35 / 20 tablets</a></td>
                    <td>First-line prophylaxis for dog bite per IDSA. Covers Pasteurella multocida, Capnocytophaga, anaerobes, streptococci, staphylococci. Begin within 8–12 hours of bite for prophylaxis to be effective.</td>
                  </tr>
                  <tr>
                    <td><strong>Doxycycline 100 mg oral (penicillin-allergic alternative)</strong></td>
                    <td>100 mg twice daily × 5–7 days — combine with metronidazole for anaerobic coverage</td>
                    <td><a href="https://www.goodrx.com/doxycycline" target="_blank" rel="noopener">~$12–$25 / 30 tabs</a></td>
                    <td>Second-line for penicillin-allergic patients per IDSA. Add metronidazole 500 mg three times daily for anaerobic coverage. Not for use in pregnancy.</td>
                  </tr>
                  <tr>
                    <td><strong>TMP-SMX DS + metronidazole (penicillin-allergic alternative)</strong></td>
                    <td>TMP-SMX DS twice daily + metronidazole 500 mg three times daily × 5 days</td>
                    <td><a href="https://www.goodrx.com/trimethoprim-sulfamethoxazole" target="_blank" rel="noopener">~$10–$20 combined</a></td>
                    <td>Alternative for penicillin-allergic patients per IDSA. TMP-SMX covers gram-negative aerobes; metronidazole covers anaerobes. Less data than amoxicillin-clavulanate.</td>
                  </tr>
                </tbody>
              </table>
            </div>
        ...
        <section className="tdmd-section" id={`${pid}-dual-path`}>
          <div className="tdmd-container">
            ...
            <p>For most adults with mild to moderate dog bite (infection prevention and wound care) without red-flag symptoms, a video visit is appropriate and convenient. Some situations require in-person evaluation. Use the comparison below to determine the right care pathway for you.</p>
            <div className="tdmd-ca-cond__dual">
              <div className="tdmd-ca-cond__dual-card tdmd-ca-cond__dual-card--good">
        ...
        <section className="tdmd-section tdmd-faq" id={`${pid}-faq`}>
          <div className="tdmd-container">
            <FaqAccordion
              sectionTitle="Frequently Asked Questions — Dog Bite (Infection Prevention and Wound Care) in California"
              items={FAQ_ITEMS}
            />
          ...
          <div className="tdmd-container">
            ...
            <div className="tdmd-ca-cond__sibling-grid">
              <a key="cat-bite-treatment-online" className="tdmd-ca-uti__sibling" href="/ca/cat-bite-treatment-online/">
                  ...
                  <span className="tdmd-ca-uti__sibling-why">Cat bites — higher infection risk than dog bites; similar prophylaxis.</span>
                </a>
              <a key="tick-bite-treatment-online" className="tdmd-ca-uti__sibling" href="/ca/tick-bite-treatment-online/">
                  ...
                  <span className="tdmd-ca-uti__sibling-why">Vector-borne disease risk — outdoor animal exposures.</span>
                </a>
              <a key="cellulitis-treatment-online" className="tdmd-ca-uti__sibling" href="/ca/cellulitis-treatment-online/">
                  ...
                  <span className="tdmd-ca-uti__sibling-why">Dog bite wound infection presenting as cellulitis.</span>
                </a>
              <a key="poison-ivy-oak-treatment-online" className="tdmd-ca-uti__sibling" href="/ca/poison-ivy-oak-treatment-online/">
                  ...
                  <span className="tdmd-ca-uti__sibling-why">Outdoor exposures in California — common co-occurrence.</span>
                </a>
              ...
              <a key="tinea-treatment-online" className="tdmd-ca-uti__sibling" href="/ca/tinea-treatment-online/">
                  ...
                  <span className="tdmd-ca-uti__sibling-why">Animal-transmitted skin infections (ringworm from dogs).</span>
                </a>
            </div>
          </div>
        </section>
        ...
        <section className="tdmd-section" id={`${pid}-related`}>
          <div className="tdmd-container">
            ...
            <p>This page sits at the intersection of the <a href="/ca/">California state hub</a> and the <a href="/dog-bite-treatment-online/">Dog Bite national condition page</a>. Use the links below to explore insurance details, book a visit, or review other conditions.</p>
            <div className="tdmd-ca-cond__related-links" aria-label="Related resources">
              <a href="/">Home</a>
              <a href="/ca/">California (state pillar)</a>
              <a href="/dog-bite-treatment-online/">National Dog Bite page</a>
              <a href="/health-guides/">Dog Bite health guides</a>
        ...
        <WhatDoesThisCostBlock conditionSlug="dog-bite-treatment-online" conditionName="Dog Bite (Infection Prevention and Wound Care)" stateName="California" />
        <CompareTeleDirectMDLinkRow conditionSlug="dog-bite-treatment-online" />
        <CommonSymptomsBlock conditionSlug="dog-bite-treatment-online" conditionName="Dog Bite (Infection Prevention and Wound Care)" />
      </div>
    </>
  );
}
