/**
 * CaPerioralDermatitisTreatmentOnline.js — production California × Perioral Dermatitis condition page (v3)
 *
 * Rendered by app/[slug]/[conditionSlug]/page.js when slug === 'ca' and
 * conditionSlug === 'perioral-dermatitis-treatment-online'.
 *
 ...
 *
 * Authority: AAD
 * Guideline: AAD Perioral Dermatitis Treatment Guidelines
 *
...
const PAGE_URL = 'https://teledirectmd.com/ca/perioral-dermatitis-treatment-online/';
const PAGE_TITLE = 'Perioral Dermatitis Online in California | TeleDirectMD';
...
const FAQ_ITEMS = [
  {
    id: 'ca-perioral-dermatitis-treatment-online-faq-0',
    question: 'Can I get perioral dermatitis treatment online in California?',
    answer: (
      <p>
  ...
  {
    id: 'ca-perioral-dermatitis-treatment-online-faq-1',
    question: 'What causes perioral dermatitis?',
    answer: (
      <p>
  ...
  {
    id: 'ca-perioral-dermatitis-treatment-online-faq-2',
    question: 'What perioral dermatitis medications can a California telehealth doctor prescribe?',
    answer: (
      <p>
  ...
  {
    id: 'ca-perioral-dermatitis-treatment-online-faq-3',
    question: 'Does California require an in-person visit before perioral dermatitis telehealth?',
    answer: (
      <p>
  ...
  {
    id: 'ca-perioral-dermatitis-treatment-online-faq-4',
    question: 'Why does perioral dermatitis get worse before it gets better after stopping steroids?',
    answer: (
      <p>
  ...
  {
    id: 'ca-perioral-dermatitis-treatment-online-faq-5',
    question: 'Is Aetna in-network for perioral dermatitis treatment at TeleDirectMD in California?',
    answer: (
      <p>
  ...
  {
    id: 'ca-perioral-dermatitis-treatment-online-faq-6',
    question: 'What is the cost of perioral dermatitis treatment in California?',
    answer: (
      <p>
  ...
  {
    id: 'ca-perioral-dermatitis-treatment-online-faq-7',
    question: 'Does California\'s AB 744 parity law cover perioral dermatitis telehealth?',
    answer: (
      <p>
  ...
  {
    id: 'ca-perioral-dermatitis-treatment-online-faq-8',
    question: 'How long does perioral dermatitis take to clear?',
    answer: (
      <p>
  ...
  {
    id: 'ca-perioral-dermatitis-treatment-online-faq-9',
    question: 'Can men get perioral dermatitis?',
    answer: (
      <p>
  ...
  {
    id: 'ca-perioral-dermatitis-treatment-online-faq-10',
    question: 'Will my perioral dermatitis prescription be sent electronically to a California pharmacy?',
    answer: (
      <p>
  ...
  {
    id: 'ca-perioral-dermatitis-treatment-online-faq-11',
    question: 'What should I avoid when I have perioral dermatitis?',
    answer: (
      <p>
...
const SCHEMAS = [{"@context": "https://schema.org", "@type": "MedicalWebPage", "name": "Perioral Dermatitis Online in California | TeleDirectMD", "url": "https://teledirectmd.com/ca/perioral-dermatitis-treatment-online/", "description": "Perioral dermatitis treatment online for California adults. Board-certified Family Medicine MD. AAD guideline-based. Self pay $79. Aetna in-network. Same-day video visits. Topical metronidazole, doxycycline.", "datePublished": "2026-05-20", "dateModified": "2026-05-20", "inLanguage": "en-US", "about": {"@type": "MedicalCondition", "name": "Perioral Dermatitis", "code": {"@type": "MedicalCode", "code": "L71.0", "codingSystem": "ICD-10-CM"}}, "medicalAudience": {"@type": "MedicalAudience", "audienceType": "Patient", "geographicArea": {"@type": "AdministrativeArea", "name": "California"}}, "reviewedBy": {"@type": "Physician", "@id": "https://teledirectmd.com/about/#physician-parth-bhavsar", "name": "Parth Bhavsar, MD", "identifier": {"@type": "PropertyValue", "propertyID": "NPI", "value": "1104323203"}, "medicalSpecialty": "Family Medicine", "hasCredential": [{"@type": "EducationalOccupationalCredential", "credentialCategory": "degree", "name": "Doctor of Medicine (MD)"}, {"@type": "EducationalOccupationalCredential", "credentialCategory": "certification", "name": "Board Certification \u2014 American Board of Family Medicine"}], "licensedIn": "California", "worksFor": {"@type": "MedicalOrganization", "name": "TeleDirectMD", "url": "https://teledirectmd.com"}, "sameAs": ["https://npiregistry.cms.hhs.gov/provider-view/1104323203", "https://teledirectmd.com/about/"]}, "speakable": {"@type": "SpeakableSpecification", "cssSelector": ["#ca-perioral-dermatitis-treatment-online-opening", "#ca-perioral-dermatitis-treatment-online-opening p", ".tdmd-ca-perioral-dermatitis-treatment-online__byline", "#ca-perioral-dermatitis-treatment-online-faq"]}}, {"@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [{"@type": "Question", "name": "Can I get perioral dermatitis treatment online in California?", "acceptedAnswer": {"@type": "Answer", "text": "Yes. California Business and Professions Code Section 2290.5 permits California-licensed physicians to evaluate and treat perioral dermatitis by secure video visit. TeleDirectMD physicians follow AAD perioral dermatitis guidelines, prescribing topical metronidazole or erythromycin and oral doxycycline \u2014 along with the most critical step: cessation of facial topical corticosteroids. Adults 18+ in California can book same-day. Self pay is $79."}}, {"@type": "Question", "name": "What causes perioral dermatitis?", "acceptedAnswer": {"@type": "Answer", "text": "Perioral dermatitis is most commonly caused by topical corticosteroid use on the face (including high-potency creams, OTC hydrocortisone used excessively, and inhaled corticosteroid spillage around the mouth). Other triggers include fluorinated toothpaste, heavy cosmetics, and sunscreen applied around the mouth. The most important treatment step is stopping facial topical corticosteroids \u2014 which initially causes an uncomfortable worsening (steroid withdrawal) before the rash improves."}}, {"@type": "Question", "name": "What perioral dermatitis medications can a California telehealth doctor prescribe?", "acceptedAnswer": {"@type": "Answer", "text": "A California-licensed telehealth physician can prescribe: topical metronidazole 0.75%\u20131% gel/cream, topical erythromycin 2% solution, and oral doxycycline 50\u2013100 mg for 6\u201312 weeks for moderate-severe disease. The most critical intervention \u2014 stopping facial topical corticosteroids \u2014 is counseled at the visit. Azelaic acid 15% is an alternative topical for patients who cannot tolerate metronidazole."}}, {"@type": "Question", "name": "Does California require an in-person visit before perioral dermatitis telehealth?", "acceptedAnswer": {"@type": "Answer", "text": "No. California B&P Code \u00a72290.5 does not require a prior in-person visit. Classic perioral dermatitis \u2014 papulopustular erythematous rash around the mouth, nasolabial folds, and nose \u2014 is appropriately evaluated by video. The visual pattern is distinctive and frequently diagnosable without physical examination."}}, {"@type": "Question", "name": "Why does perioral dermatitis get worse before it gets better after stopping steroids?", "acceptedAnswer": {"@type": "Answer", "text": "Topical corticosteroid-induced perioral dermatitis undergoes a rebound phase after steroid withdrawal \u2014 the skin becomes more inflamed before it improves. This is called the steroid discontinuation reaction and typically lasts 1\u20133 weeks. It is expected and does not mean treatment is failing. TeleDirectMD physicians counsel patients on this phenomenon under California B&P \u00a72290.5 standard of care."}}, {"@type": "Question", "name": "Is Aetna in-network for perioral dermatitis treatment at TeleDirectMD in California?", "acceptedAnswer": {"@type": "Answer", "text": "Yes. Aetna became an active in-network payor for TeleDirectMD in California effective April 30, 2026. UnitedHealthcare Commercial is approved effective May 29, 2026. Self pay is $79."}}, {"@type": "Question", "name": "What is the cost of perioral dermatitis treatment in California?", "acceptedAnswer": {"@type": "Answer", "text": "TeleDirectMD charges $79 self-pay. Generic metronidazole topical ~$15\u2013$40, generic doxycycline ~$12\u2013$25, generic erythromycin topical ~$20\u2013$40 with GoodRx. In-person dermatology visits in California typically cost $150\u2013$350+."}}, {"@type": "Question", "name": "Does California's AB 744 parity law cover perioral dermatitis telehealth?", "acceptedAnswer": {"@type": "Answer", "text": "Yes, for in-network commercial plans. California AB 744 (2019) requires commercial health plans to reimburse telehealth on the same basis as in-person services. Aetna and UHC Commercial are in-network for TeleDirectMD in California."}}, {"@type": "Question", "name": "How long does perioral dermatitis take to clear?", "acceptedAnswer": {"@type": "Answer", "text": "Perioral dermatitis often shows initial improvement within 4\u20138 weeks of starting topical therapy and stopping facial steroids. The first 2\u20134 weeks may look worse due to steroid withdrawal \u2014 this is expected. Full resolution typically requires 6\u201312 weeks of consistent treatment. Oral doxycycline for moderate-severe cases typically shows faster initial response (2\u20134 weeks) compared to topical agents alone."}}, {"@type": "Question", "name": "Can men get perioral dermatitis?", "acceptedAnswer": {"@type": "Answer", "text": "Yes, though less commonly than women. Perioral dermatitis predominantly affects women aged 15\u201345, but men can develop it \u2014 particularly after prolonged use of topical facial steroids. In men, the presentation is the same: perioral papulopustular rash. Treatment is identical \u2014 topical metronidazole or erythromycin, cessation of facial steroids, and doxycycline for moderate-severe cases."}}, {"@type": "Question", "name": "Will my perioral dermatitis prescription be sent electronically to a California pharmacy?", "acceptedAnswer": {"@type": "Answer", "text": "Yes. California AB 2789 (effective January 1, 2022) requires all prescriptions to be issued electronically. TeleDirectMD sends e-prescriptions to your chosen California pharmacy \u2014 CVS, Walgreens, Rite Aid, Walmart, Safeway \u2014 during or after your visit."}}, {"@type": "Question", "name": "What should I avoid when I have perioral dermatitis?", "acceptedAnswer": {"@type": "Answer", "text": "AAD recommends avoiding during perioral dermatitis treatment: all topical corticosteroids on the face (even OTC hydrocortisone), fluorinated toothpaste (switch to non-fluoridated or children's toothpaste temporarily), heavy moisturizers and foundations around the mouth, and harsh exfoliants. Gentle non-fragrance cleansers (Vanicream, CeraVe Hydrating Cleanser) and mineral sunscreen are preferred. These measures are counseled at every TeleDirectMD perioral dermatitis visit."}}]}, {"@context": "https://schema.org", "@type": "HowTo", "name": "How to Get Perioral Dermatitis Online in California", "description": "Three steps to receive perioral dermatitis evaluation and, if appropriate, a prescription from a California-licensed board-certified physician.", "totalTime": "PT30M", "estimatedCost": {"@type": "MonetaryAmount", "currency": "USD", "value": "79"}, "step": [{"@type": "HowToStep", "position": 1, "name": "Book your video visit", "text": "Visit teledirectmd.com and select California Perioral Dermatitis treatment. No referral needed. Self pay $79. Many visits available same day.", "url": "https://teledirectmd.com/book-online"}, {"@type": "HowToStep", "position": 2, "name": "See a California-licensed MD by secure video", "text": "Connect with a board-certified Family Medicine physician licensed in California. The physician reviews your symptoms, history, and red-flag screening. Consent per CA B&P Section 2290.5 confirmed.", "url": "https://teledirectmd.com/ca/perioral-dermatitis-treatment-online/"}, {"@type": "HowToStep", "position": 3, "name": "Receive your treatment plan and e-prescription", "text": "If medication is appropriate, a California-compliant e-prescription is sent to your chosen pharmacy during or after the visit.", "url": "https://teledirectmd.com/ca/perioral-dermatitis-treatment-online/"}]}, {"@context": "https://schema.org", "@type": "BreadcrumbList", "itemListElement": [{"@type": "ListItem", "position": 1, "name": "TeleDirectMD", "item": "https://teledirectmd.com"}, {"@type": "ListItem", "position": 2, "name": "California", "item": "https://teledirectmd.com/ca/"}, {"@type": "ListItem", "position": 3, "name": "Perioral Dermatitis Online in California", "item": "https://teledirectmd.com/ca/perioral-dermatitis-treatment-online/"}]}];
...
export default function CaPerioralDermatitisTreatmentOnline() {
  const pid = 'ca-perioral-dermatitis-treatment-online';
      ...
      <div className="tdmd-ca-cond">
        ...
        <nav className="tdmd-breadcrumbs" aria-label="Breadcrumb">
          <div className="tdmd-container" style={{ paddingTop: '0.5rem', paddingBottom: 0 }}>
            ...
            <span className="tdmd-bc-sep" aria-hidden="true">/</span>
            <span aria-current="page">Perioral Dermatitis Online</span>
          </div>
        </nav>
          ...
          <div className="tdmd-container">
            <div className="tdmd-hero-grid">
              <div className="tdmd-hero-copy">
                <h1 data-speakable="true">Perioral Dermatitis Treatment Online in California</h1>
                ...
                <p className="tdmd-icd"><strong>ICD-10 commonly used:</strong> L71.0 (Perioral dermatitis)</p>
              </div>

              <div className="tdmd-hero-side">
                <div className="tdmd-hero-card">
                  <h2>Online MD-Only Perioral Dermatitis Care in California</h2>
                  <ul>
                    <li>Fast evaluation for perioral dermatitis symptoms</li>
        ...
        <section className="tdmd-section" id={`${pid}-eligibility`}>
          <div className="tdmd-container">
            <h2>Perioral Dermatitis Telehealth Eligibility Checklist for California</h2>
            ...
            <div className="tdmd-ca-cond__dual">
              <div className="tdmd-ca-cond__dual-card tdmd-ca-cond__dual-card--good">
                ...
                <ul>
                  ...
                  <li>Classic perioral dermatitis — papulopustular erythematous rash around mouth, nasolabial folds, and nose</li>
                  <li>Perioral dermatitis from topical corticosteroid overuse — cessation counseling + prescription</li>
                  <li>Perioral dermatitis from inhaled corticosteroid spillage</li>
                  <li>Mild-to-moderate perioral dermatitis not requiring in-person biopsy</li>
                  <li>Established perioral dermatitis seeking refill of topical or oral therapy</li>
                </ul>
              </div>
              <div className="tdmd-ca-cond__dual-card tdmd-ca-cond__dual-card--alert">
                <h3>&#10007; Seek In-Person or Emergency Care If</h3>
                <ul>
                  <li>Perioral dermatitis with significant eye involvement (periocular granulomatous dermatitis) — ophthalmology evaluation</li>
                  <li>Granulomatous perioral dermatitis in children — TeleDirectMD treats adults 18+ only; pediatric dermatology needed</li>
                  <li>Failure to respond after 12 weeks of oral doxycycline — in-person dermatology for further evaluation</li>
                  <li>Perioral rash rapidly spreading beyond the perioral distribution — consider alternative diagnoses in-person</li>
                  <li>Superimposed bacterial infection (purulent crusting, fever) — in-person evaluation</li>
                </ul>
        ...
        <section className="tdmd-section tdmd-section-highlight" id={`${pid}-ca-law`}>
          <div className="tdmd-container">
            <h2>California Telehealth Law and Your Perioral Dermatitis Visit</h2>
            ...
            <h3>Are perioral dermatitis medications controlled substances under California law?</h3>
            <p>
        ...
        <section className="tdmd-section" id={`${pid}-how-it-works`} itemScope itemType="https://schema.org/HowTo">
          <div className="tdmd-container">
            <h2 itemProp="name">How Online Perioral Dermatitis Works in California</h2>
        ...
        <section className="tdmd-section tdmd-section-highlight" id={`${pid}-cost`}>
          <div className="tdmd-container">
            <h2>Perioral Dermatitis Cost &amp; Insurance in California</h2>
            ...
            <div className="tdmd-price-grid">
              ...
              <div className="tdmd-price-chart" role="group" aria-label="Typical Perioral Dermatitis cost comparison">
                <h3>Typical Perioral Dermatitis Visit Cost in California</h3>
            ...
            <div className="tdmd-table-wrap">
              <table className="tdmd-table" aria-label="Perioral Dermatitis medication options and GoodRx prices">
                ...
                <tbody>
                  ...
                  <tr>
                    <td><strong>Azelaic acid 15%–20% gel</strong></td>
                    <td>Apply to perioral area twice daily</td>
                    <td><a href="https://www.goodrx.com/azelaic-acid" target="_blank" rel="noopener">~$30–$60 / 50g</a></td>
                    <td>Alternative topical per AAD — anti-inflammatory, well-tolerated, safe in pregnancy (FDA category B). Less data than metronidazole for perioral dermatitis specifically.</td>
                  </tr>
                </tbody>
              </table>
            </div>
        ...
        <section className="tdmd-section" id={`${pid}-dual-path`}>
          <div className="tdmd-container">
            ...
            <p>For most adults with mild to moderate perioral dermatitis without red-flag symptoms, a video visit is appropriate and convenient. Some situations require in-person evaluation. Use the comparison below to determine the right care pathway for you.</p>
            <div className="tdmd-ca-cond__dual">
              <div className="tdmd-ca-cond__dual-card tdmd-ca-cond__dual-card--good">
        ...
        <section className="tdmd-section tdmd-faq" id={`${pid}-faq`}>
          <div className="tdmd-container">
            <FaqAccordion
              sectionTitle="Frequently Asked Questions — Perioral Dermatitis in California"
              items={FAQ_ITEMS}
            />
          ...
          <div className="tdmd-container">
            ...
            <div className="tdmd-ca-cond__sibling-grid">
              <a key="acne-treatment-online" className="tdmd-ca-uti__sibling" href="/ca/acne-treatment-online/">
                  ...
                  <span className="tdmd-ca-uti__sibling-why">Acne vulgaris — perioral dermatitis is frequently misdiagnosed as acne.</span>
                </a>
              <a key="rosacea-treatment-online" className="tdmd-ca-uti__sibling" href="/ca/rosacea-treatment-online/">
                  ...
                  <span className="tdmd-ca-uti__sibling-why">Rosacea — facial papulopustular rash differential.</span>
                </a>
              <a key="eczema-treatment-online" className="tdmd-ca-uti__sibling" href="/ca/eczema-treatment-online/">
                  ...
                  <span className="tdmd-ca-uti__sibling-why">Facial eczema — facial inflammatory skin differential.</span>
                </a>
              <a key="contact-dermatitis-treatment-online" className="tdmd-ca-uti__sibling" href="/ca/contact-dermatitis-treatment-online/">
                  ...
                  <span className="tdmd-ca-uti__sibling-why">Toothpaste or cosmetic contact dermatitis — perioral location.</span>
                </a>
              <a key="melasma-treatment-online" className="tdmd-ca-uti__sibling" href="/ca/melasma-treatment-online/">
                  ...
                  <span className="tdmd-ca-uti__sibling-why">Facial skin condition requiring dermatologic care.</span>
                </a>
              <a key="dandruff-treatment-online" className="tdmd-ca-uti__sibling" href="/ca/dandruff-treatment-online/">
                  ...
                  <span className="tdmd-ca-uti__sibling-why">Seborrheic dermatitis — can coexist with perioral dermatitis.</span>
                </a>
            </div>
          </div>
        </section>
        ...
        <section className="tdmd-section" id={`${pid}-related`}>
          <div className="tdmd-container">
            ...
            <p>This page sits at the intersection of the <a href="/ca/">California state hub</a> and the <a href="/perioral-dermatitis-treatment-online/">Perioral Dermatitis national condition page</a>. Use the links below to explore insurance details, book a visit, or review other conditions.</p>
            <div className="tdmd-ca-cond__related-links" aria-label="Related resources">
              <a href="/">Home</a>
              <a href="/ca/">California (state pillar)</a>
              <a href="/perioral-dermatitis-treatment-online/">National Perioral Dermatitis page</a>
              <a href="/health-guides/">Perioral Dermatitis health guides</a>
        ...
        <WhatDoesThisCostBlock conditionSlug="perioral-dermatitis-treatment-online" conditionName="Perioral Dermatitis" stateName="California" />
        <CompareTeleDirectMDLinkRow conditionSlug="perioral-dermatitis-treatment-online" />
        <CommonSymptomsBlock conditionSlug="perioral-dermatitis-treatment-online" conditionName="Perioral Dermatitis" />
      </div>
    </>
  );
}
