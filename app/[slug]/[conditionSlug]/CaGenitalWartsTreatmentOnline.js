/**
 * CaGenitalWartsTreatmentOnline.js — production California × Genital Warts (HPV) condition page (v3)
 *
 * Rendered by app/[slug]/[conditionSlug]/page.js when slug === 'ca' and
 * conditionSlug === 'genital-warts-treatment-online'.
 *
 ...
 * Guideline: CDC STI Treatment Guidelines 2021 — Anogenital Warts
 *
...
const PAGE_URL = 'https://teledirectmd.com/ca/genital-warts-treatment-online/';
const PAGE_TITLE = 'Genital Warts Treatment (HPV) Online in California | TeleDirectMD';
...
const FAQ_ITEMS = [
  {
    id: 'ca-genital-warts-treatment-online-faq-0',
    question: 'Can I get genital warts treatment online in California?',
    answer: (
      <p>
  ...
  {
    id: 'ca-genital-warts-treatment-online-faq-1',
    question: 'What causes genital warts in California?',
    answer: (
      <p>
  ...
  {
    id: 'ca-genital-warts-treatment-online-faq-2',
    question: 'How common are genital warts in California?',
    answer: (
      <p>
  ...
  {
    id: 'ca-genital-warts-treatment-online-faq-3',
    question: 'What are the treatment options for genital warts in California?',
    answer: (
      <p>
  ...
  {
    id: 'ca-genital-warts-treatment-online-faq-4',
    question: 'When should genital warts require in-person care in California?',
    answer: (
      <p>
  ...
  {
    id: 'ca-genital-warts-treatment-online-faq-5',
    question: 'Is the HPV vaccine available in California?',
    answer: (
      <p>
  ...
  {
    id: 'ca-genital-warts-treatment-online-faq-6',
    question: 'Does California AB 744 parity apply to genital warts treatment visits?',
    answer: (
      <p>
  ...
  {
    id: 'ca-genital-warts-treatment-online-faq-7',
    question: 'Is Aetna in-network with TeleDirectMD in California for genital wart treatment?',
    answer: (
      <p>
  ...
  {
    id: 'ca-genital-warts-treatment-online-faq-8',
    question: 'Will Medi-Cal cover genital wart treatment at TeleDirectMD?',
    answer: (
      <p>
  ...
  {
    id: 'ca-genital-warts-treatment-online-faq-9',
    question: 'Do genital warts go away on their own?',
    answer: (
      <p>
  ...
  {
    id: 'ca-genital-warts-treatment-online-faq-10',
    question: 'Does California require an in-person visit before telehealth for genital wart treatment?',
    answer: (
      <p>
  ...
  {
    id: 'ca-genital-warts-treatment-online-faq-11',
    question: 'How quickly will my genital wart prescription reach a California pharmacy?',
    answer: (
      <p>
...
const SCHEMAS = [{"@context": "https://schema.org", "@type": "MedicalWebPage", "name": "Genital Warts Treatment (HPV) Online in California | TeleDirectMD", "url": "https://teledirectmd.com/ca/genital-warts-treatment-online/", "description": "Genital warts treatment online for California adults. Board-certified MD. Patient-applied topical prescriptions per CDC 2021 guidelines. Self pay $79. Aetna in-network. Same-day video visits. CA telehealth compliant.", "datePublished": "2026-05-20", "dateModified": "2026-05-20", "inLanguage": "en-US", "about": {"@type": "MedicalCondition", "name": "Genital Warts (HPV)", "code": {"@type": "MedicalCode", "code": "A63.0", "codingSystem": "ICD-10-CM"}}, "medicalAudience": {"@type": "MedicalAudience", "audienceType": "Patient", "geographicArea": {"@type": "AdministrativeArea", "name": "California"}}, "reviewedBy": {"@type": "Physician", "@id": "https://teledirectmd.com/about/#physician-parth-bhavsar", "name": "Parth Bhavsar, MD", "identifier": {"@type": "PropertyValue", "propertyID": "NPI", "value": "1104323203"}, "medicalSpecialty": "Family Medicine", "hasCredential": [{"@type": "EducationalOccupationalCredential", "credentialCategory": "degree", "name": "Doctor of Medicine (MD)"}, {"@type": "EducationalOccupationalCredential", "credentialCategory": "certification", "name": "Board Certification \u2014 American Board of Family Medicine"}], "licensedIn": "California", "worksFor": {"@type": "MedicalOrganization", "name": "TeleDirectMD", "url": "https://teledirectmd.com"}, "sameAs": ["https://npiregistry.cms.hhs.gov/provider-view/1104323203", "https://teledirectmd.com/about/"]}, "speakable": {"@type": "SpeakableSpecification", "cssSelector": ["#ca-genital-warts-treatment-online-opening", "#ca-genital-warts-treatment-online-opening p", ".tdmd-ca-genital-warts-treatment-online__byline", "#ca-genital-warts-treatment-online-faq"]}}, {"@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [{"@type": "Question", "name": "Can I get genital warts treatment online in California?", "acceptedAnswer": {"@type": "Answer", "text": "Yes. California Business and Professions Code Section 2290.5 permits California-licensed physicians to prescribe patient-applied topical genital wart treatments by synchronous video visit. Per the CDC STI Treatment Guidelines 2021, imiquimod 5% cream, podofilox 0.5% solution, and sinecatechins 15% ointment are first-line patient-applied therapies for external genital warts. The Medical Board of California holds telehealth physicians to the same standard of care as in-person physicians. Self pay is $79. Aetna is in-network as of April 30, 2026."}}, {"@type": "Question", "name": "What causes genital warts in California?", "acceptedAnswer": {"@type": "Answer", "text": "Genital warts are caused by HPV types 6 and 11 \u2014 \"low-risk\" HPV types not associated with cervical cancer. Per the CDC STI Treatment Guidelines 2021, genital warts are the most common viral STI in the US. HPV is transmitted through skin-to-skin genital contact. The California Department of Public Health recommends Gardasil 9 HPV vaccination for all adolescents and adults through age 26 to prevent HPV types 6, 11, 16, and 18."}}, {"@type": "Question", "name": "How common are genital warts in California?", "acceptedAnswer": {"@type": "Answer", "text": "Genital warts account for an estimated 340,000\u2013360,000 new cases annually in the US per the CDC STI Treatment Guidelines 2021. California, as the most populous state with approximately 39 million residents, accounts for a significant proportion. ACOG and CDPH support HPV vaccination as the primary prevention strategy. California has robust HPV vaccination programs through schools, community health centers, and pharmacy-based programs."}}, {"@type": "Question", "name": "What are the treatment options for genital warts in California?", "acceptedAnswer": {"@type": "Answer", "text": "Per the CDC STI Treatment Guidelines 2021, patient-applied first-line options include: imiquimod 5% cream (3\u00d7 weekly \u00d7 up to 16 weeks); podofilox 0.5% solution (twice daily \u00d7 3 days, then 4 days off, up to 4 cycles); and sinecatechins 15% ointment (3\u00d7 daily \u00d7 up to 16 weeks). Provider-applied treatments \u2014 cryotherapy, trichloroacetic acid (TCA), and surgical excision \u2014 require in-person care. All patient-applied treatments are contraindicated in pregnancy."}}, {"@type": "Question", "name": "When should genital warts require in-person care in California?", "acceptedAnswer": {"@type": "Answer", "text": "Seek in-person evaluation if: you are pregnant (all topical treatments contraindicated); warts are internal \u2014 vaginal, anal canal, or urethral (require provider-applied therapy); warts are not responding to patient-applied therapy after 16 weeks; you need cryotherapy or surgical removal; or you are significantly immunocompromised. Planned Parenthood California provides in-person genital wart evaluation with sliding-scale fees."}}, {"@type": "Question", "name": "Is the HPV vaccine available in California?", "acceptedAnswer": {"@type": "Answer", "text": "Yes. Gardasil 9 (HPV vaccine) is available at California pharmacies, physician offices, and public health clinics. The California Department of Public Health recommends HPV vaccination for preteens and through age 26. Adults aged 27\u201345 may benefit through shared clinical decision-making. HPV vaccination prevents new HPV infections but does not treat existing infections or current warts."}}, {"@type": "Question", "name": "Does California AB 744 parity apply to genital warts treatment visits?", "acceptedAnswer": {"@type": "Answer", "text": "California Insurance Code \u00a710123.85 (AB 744, 2019) requires commercial health plans to reimburse telehealth on the same basis as in-person services when TeleDirectMD is in-network. Aetna (active April 30, 2026) and UnitedHealthcare Commercial (approved May 29, 2026) are in-network in California. Self pay is $79 for patients paying out-of-pocket."}}, {"@type": "Question", "name": "Is Aetna in-network with TeleDirectMD in California for genital wart treatment?", "acceptedAnswer": {"@type": "Answer", "text": "Aetna became in-network for TeleDirectMD in California effective April 30, 2026. Verify plan eligibility before your visit, as eligibility varies by specific plan type. Self pay ($79) is available regardless of insurance. UnitedHealthcare Commercial is also approved effective May 29, 2026."}}, {"@type": "Question", "name": "Will Medi-Cal cover genital wart treatment at TeleDirectMD?", "acceptedAnswer": {"@type": "Answer", "text": "TeleDirectMD is not currently enrolled as a Medi-Cal rendering provider. California DHCS confirms Medi-Cal covers telehealth for enrolled providers. For free or low-cost genital wart evaluation, contact Planned Parenthood California or California Family PACT. TeleDirectMD self-pay is $79."}}, {"@type": "Question", "name": "Do genital warts go away on their own?", "acceptedAnswer": {"@type": "Answer", "text": "Genital warts may resolve spontaneously in some individuals \u2014 approximately 30% of warts clear within 4 months without treatment per CDC data. However, spontaneous clearance is unpredictable and untreated warts may grow or become more numerous. Treatment reduces wart burden and discomfort. HPV itself \u2014 the virus causing warts \u2014 can persist in skin tissues indefinitely even after warts resolve clinically."}}, {"@type": "Question", "name": "Does California require an in-person visit before telehealth for genital wart treatment?", "acceptedAnswer": {"@type": "Answer", "text": "No. California B&P Code \u00a72290.5 does not require a prior in-person visit before telehealth services. For patients with external genital warts who can visually identify them, patient-applied topical treatments can be prescribed by video visit when pregnancy and other contraindications are excluded by the physician."}}, {"@type": "Question", "name": "How quickly will my genital wart prescription reach a California pharmacy?", "acceptedAnswer": {"@type": "Answer", "text": "California requires all prescriptions to be issued electronically under Assembly Bill 2789 (effective January 1, 2022), per the Medical Board of California. If imiquimod, podofilox, or sinecatechins is appropriate, TeleDirectMD sends an e-prescription to your chosen California pharmacy during or after your visit. These medications are not controlled substances. Most California pharmacies fill within one to four hours."}}]}, {"@context": "https://schema.org", "@type": "HowTo", "name": "How to Get Genital Warts Treatment (HPV) Online in California", "description": "Three steps to receive genital warts treatment (hpv) evaluation and, if appropriate, a prescription from a California-licensed board-certified physician.", "totalTime": "PT30M", "estimatedCost": {"@type": "MonetaryAmount", "currency": "USD", "value": "79"}, "step": [{"@type": "HowToStep", "position": 1, "name": "Book your video visit", "text": "Visit teledirectmd.com and select California Genital Warts (HPV) treatment. No referral needed. Self pay $79. Many visits available same day.", "url": "https://teledirectmd.com/book-online"}, {"@type": "HowToStep", "position": 2, "name": "See a California-licensed MD by secure video", "text": "Connect with a board-certified Family Medicine physician licensed in California. The physician reviews your symptoms, history, and red-flag screening. Consent per CA B&P Section 2290.5 confirmed.", "url": "https://teledirectmd.com/ca/genital-warts-treatment-online/"}, {"@type": "HowToStep", "position": 3, "name": "Receive your treatment plan and e-prescription", "text": "If medication is appropriate, a California-compliant e-prescription is sent to your chosen pharmacy during or after the visit.", "url": "https://teledirectmd.com/ca/genital-warts-treatment-online/"}]}, {"@context": "https://schema.org", "@type": "BreadcrumbList", "itemListElement": [{"@type": "ListItem", "position": 1, "name": "TeleDirectMD", "item": "https://teledirectmd.com"}, {"@type": "ListItem", "position": 2, "name": "California", "item": "https://teledirectmd.com/ca/"}, {"@type": "ListItem", "position": 3, "name": "Genital Warts Treatment (HPV) Online in California", "item": "https://teledirectmd.com/ca/genital-warts-treatment-online/"}]}];
...
export default function CaGenitalWartsTreatmentOnline() {
  const pid = 'ca-genital-warts-treatment-online';
      ...
      <div className="tdmd-ca-cond">
        ...
        <nav className="tdmd-breadcrumbs" aria-label="Breadcrumb">
          <div className="tdmd-container" style={{ paddingTop: '0.5rem', paddingBottom: 0 }}>
            ...
            <span className="tdmd-bc-sep" aria-hidden="true">/</span>
            <span aria-current="page">Genital Warts Treatment (HPV) Online</span>
          </div>
        </nav>
          ...
          <div className="tdmd-container">
            <div className="tdmd-hero-grid">
              <div className="tdmd-hero-copy">
                <h1 data-speakable="true">Genital Warts Treatment Online in California (HPV)</h1>
                ...
                <p className="tdmd-icd"><strong>ICD-10 commonly used:</strong> A63.0 (Anogenital warts; actual code assigned at visit)</p>
              </div>

              <div className="tdmd-hero-side">
                <div className="tdmd-hero-card">
                  <h2>Online MD-Only Genital Warts (HPV) Care in California</h2>
                  <ul>
                    <li>Fast evaluation for genital warts treatment (hpv) symptoms</li>
        ...
        <section className="tdmd-section" id={`${pid}-eligibility`}>
          <div className="tdmd-container">
            <h2>Genital Warts Treatment (HPV) Telehealth Eligibility Checklist for California</h2>
            ...
            <div className="tdmd-ca-cond__dual">
              <div className="tdmd-ca-cond__dual-card tdmd-ca-cond__dual-card--good">
                ...
                <ul>
                  ...
                  <li>External genital warts — clearly visible and identifiable by patient without examination</li>
                  <li>Not pregnant</li>
                  <li>No prior topical treatment failures requiring cryotherapy or TCA</li>
                  <li>No significant immunosuppression causing atypical presentations</li>
                  <li>Willing to provide photo documentation during visit if requested by physician</li>
                </ul>
              </div>
              <div className="tdmd-ca-cond__dual-card tdmd-ca-cond__dual-card--alert">
                <h3>&#10007; Seek In-Person or Emergency Care If</h3>
                <ul>
                  <li>Genital warts in pregnancy — all patient-applied treatments are contraindicated; requires in-person OB/GYN management</li>
                  <li>Internal warts (vaginal, anal canal, or urethral) — require provider-applied treatment; not appropriate for telehealth</li>
                  <li>Rapidly growing or bleeding warts — possible condyloma acuminata requiring urgent evaluation</li>
                  <li>Warts in an immunocompromised patient (HIV, chemotherapy) with atypical presentation</li>
                  <li>Warts with ulceration, induration, or firmness suspicious for malignancy — needs biopsy</li>
                  <li>Prior topical treatment failure after 16 weeks — requires in-person cryotherapy or surgical evaluation</li>
                </ul>
        ...
        <section className="tdmd-section tdmd-section-highlight" id={`${pid}-ca-law`}>
          <div className="tdmd-container">
            <h2>California Telehealth Law and Your Genital Warts Treatment (HPV) Visit</h2>
            ...
            <h3>Are genital warts treatment (hpv) medications controlled substances under California law?</h3>
            <p>
        ...
        <section className="tdmd-section" id={`${pid}-how-it-works`} itemScope itemType="https://schema.org/HowTo">
          <div className="tdmd-container">
            <h2 itemProp="name">How Online Genital Warts Treatment (HPV) Works in California</h2>
        ...
        <section className="tdmd-section" id={`${pid}-epidemiology`}>
          <div className="tdmd-container">
            ...
            <h3>What causes genital warts (hpv) and who is most at risk in California?</h3>
            <p>
        ...
        <section className="tdmd-section tdmd-section-highlight" id={`${pid}-cost`}>
          <div className="tdmd-container">
            <h2>Genital Warts Treatment (HPV) Cost &amp; Insurance in California</h2>
            ...
            <div className="tdmd-price-grid">
              ...
              <div className="tdmd-price-chart" role="group" aria-label="Typical Genital Warts (HPV) cost comparison">
                <h3>Typical Genital Warts (HPV) Visit Cost in California</h3>
        ...
        <section className="tdmd-section" id={`${pid}-medications`}>
          <div className="tdmd-container">
            <h2>Genital Warts Treatment (HPV) Medication Options and Costs in California</h2>
            <p>
              Medications for genital warts treatment (hpv) are selected based on current guidelines from <a href="https://www.cdc.gov/std/treatment-guidelines/anogenital-warts.htm" rel="noopener" target="_blank">Centers for Disease Control and Prevention (CDC)</a>, patient history, allergies, and relevant contraindications assessed at the visit. GoodRx-verified pricing is shown below.
            </p>
            <div className="tdmd-table-wrap">
              <table className="tdmd-table" aria-label="Genital Warts Treatment (HPV) medication options and GoodRx prices">
                <caption style={{ captionSide: 'bottom', textAlign: 'left', padding: '0.5rem 0', fontSize: '0.85rem', color: 'var(--tdmd-muted)' }}>
                ...
                <tbody>
                  <tr className="tdmd-ca-uti__med-firstline">
                    <td><strong>Imiquimod 5% cream (Aldara)</strong> · First-line</td>
                    <td>Apply 3× weekly at bedtime, wash off after 6–10 hours × up to 16 weeks</td>
                    <td><a href="https://www.goodrx.com/imiquimod" target="_blank" rel="noopener">~$40–$80 / tube with GoodRx</a></td>
                    <td>Patient-applied immunomodulator — first-line per CDC 2021. Contraindicated in pregnancy. Apply only to external warts. Local reactions (erythema, erosion) are expected.</td>
                  </tr>
                  <tr className="tdmd-ca-uti__med-firstline">
                    <td><strong>Podofilox 0.5% solution (Condylox)</strong> · First-line</td>
                    <td>Apply twice daily × 3 days, then off 4 days; repeat up to 4 cycles</td>
                    <td><a href="https://www.goodrx.com/podofilox" target="_blank" rel="noopener">~$50–$100 / bottle with GoodRx</a></td>
                    <td>Patient-applied anti-mitotic — first-line per CDC 2021. Contraindicated in pregnancy. Avoid mucous membranes. Do not exceed 0.5 mL per day.</td>
                  </tr>
                  <tr className="tdmd-ca-uti__med-firstline">
                    <td><strong>Sinecatechins 15% ointment (Veregen)</strong> · First-line</td>
                    <td>Apply 3× daily for up to 16 weeks</td>
                    <td><a href="https://www.goodrx.com/sinecatechins" target="_blank" rel="noopener">~$150–$250 with GoodRx coupon</a></td>
                    <td>Botanical FDA-approved for external genital warts per CDC 2021. Patient-applied; generally well tolerated. Do not use on mucous membranes. Contraindicated in pregnancy.</td>
                  </tr>
                </tbody>
              </table>
            </div>
        ...
        <section className="tdmd-section" id={`${pid}-dual-path`}>
          <div className="tdmd-container">
            ...
            <p>For most adults with mild to moderate genital warts treatment (hpv) without red-flag symptoms, a video visit is appropriate and convenient. Some situations require in-person evaluation. Use the comparison below to determine the right care pathway for you.</p>
            <div className="tdmd-ca-cond__dual">
              <div className="tdmd-ca-cond__dual-card tdmd-ca-cond__dual-card--good">
        ...
        <section className="tdmd-section tdmd-faq" id={`${pid}-faq`}>
          <div className="tdmd-container">
            <FaqAccordion
              sectionTitle="Frequently Asked Questions — Genital Warts Treatment (HPV) in California"
              items={FAQ_ITEMS}
            />
          ...
          <div className="tdmd-container">
            ...
            <div className="tdmd-ca-cond__sibling-grid">
              <a key="chlamydia-treatment-online" className="tdmd-ca-uti__sibling" href="/ca/chlamydia-treatment-online/">
                  ...
                  <span className="tdmd-ca-uti__sibling-why">STI co-infection with HPV is common — comprehensive STI testing is recommended at the same visit.</span>
                </a>
              <a key="genital-herpes-treatment-online" className="tdmd-ca-uti__sibling" href="/ca/genital-herpes-treatment-online/">
                  ...
                  <span className="tdmd-ca-uti__sibling-why">Herpes lesions are the key differential when genital sores or lesions are present alongside warts.</span>
                </a>
              <a key="birth-control-refills-online" className="tdmd-ca-uti__sibling" href="/ca/birth-control-refills-online/">
                  ...
                  <span className="tdmd-ca-uti__sibling-why">Reproductive health care is commonly evaluated alongside STI management visits.</span>
                </a>
              <a key="doxypep-sti-prevention-online" className="tdmd-ca-uti__sibling" href="/ca/doxypep-sti-prevention-online/">
                  ...
                  <span className="tdmd-ca-uti__sibling-why">STI prevention relevant for high-risk adults who also have HPV infection.</span>
                </a>
              <a key="trichomoniasis-treatment-online" className="tdmd-ca-uti__sibling" href="/ca/trichomoniasis-treatment-online/">
                  ...
                  <span className="tdmd-ca-uti__sibling-why">Trichomoniasis frequently co-occurs with HPV; both warrant evaluation in sexually active adults.</span>
                </a>
            </div>
          </div>
        </section>
        ...
        <section className="tdmd-section" id={`${pid}-related`}>
          <div className="tdmd-container">
            ...
            <p>This page sits at the intersection of the <a href="/ca/">California state hub</a> and the <a href="/genital-warts-treatment-online/">Genital Warts (HPV) national condition page</a>. Use the links below to explore insurance details, book a visit, or review other conditions.</p>
            <div className="tdmd-ca-cond__related-links" aria-label="Related resources">
              <a href="/">Home</a>
              <a href="/ca/">California (state pillar)</a>
              <a href="/genital-warts-treatment-online/">National Genital Warts (HPV) page</a>
              <a href="/health-guides/">Genital Warts (HPV) health guides</a>
        ...
        <WhatDoesThisCostBlock conditionSlug="genital-warts-treatment-online" conditionName="Genital Warts Treatment (HPV)" stateName="California" />
        <CompareTeleDirectMDLinkRow conditionSlug="genital-warts-treatment-online" />
        <CommonSymptomsBlock conditionSlug="genital-warts-treatment-online" conditionName="Genital Warts Treatment (HPV)" />
      </div>
    </>
  );
}
