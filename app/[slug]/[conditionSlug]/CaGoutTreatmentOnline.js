/**
 * CaGoutTreatmentOnline.js — production California × Gout (Gouty Arthritis) condition page (v3)
 *
 * Rendered by app/[slug]/[conditionSlug]/page.js when slug === 'ca' and
 * conditionSlug === 'gout-treatment-online'.
 *
 ...
 *
 * Authority: American College of Rheumatology (ACR)
 * Guideline: ACR Guideline for the Management of Gout (2020, updated 2022)
 *
...
const PAGE_URL = 'https://teledirectmd.com/ca/gout-treatment-online/';
const PAGE_TITLE = 'Gout Treatment Online in California | TeleDirectMD';
...
const FAQ_ITEMS = [
  {
    id: 'ca-gout-treatment-online-faq-0',
    question: 'Can I get gout treatment online in California?',
    answer: (
      <p>
  ...
  {
    id: 'ca-gout-treatment-online-faq-1',
    question: 'What is gout and what causes it?',
    answer: (
      <p>
  ...
  {
    id: 'ca-gout-treatment-online-faq-2',
    question: 'What medications treat a gout flare, and what do they cost in California?',
    answer: (
      <p>
  ...
  {
    id: 'ca-gout-treatment-online-faq-3',
  ...
  {
    id: 'ca-gout-treatment-online-faq-4',
    question: 'When is gout dangerous and when should I go to the ER in California?',
    answer: (
      <p>
  ...
  {
    id: 'ca-gout-treatment-online-faq-5',
  ...
  {
    id: 'ca-gout-treatment-online-faq-6',
  ...
  {
    id: 'ca-gout-treatment-online-faq-7',
    question: 'Will Medi-Cal cover my TeleDirectMD gout visit?',
    answer: (
      <p>
  ...
  {
    id: 'ca-gout-treatment-online-faq-8',
    question: 'What foods should I avoid to prevent gout flares?',
    answer: (
      <p>
  ...
  {
    id: 'ca-gout-treatment-online-faq-9',
    question: 'Should I take urate-lowering therapy (allopurinol) for gout prevention?',
    answer: (
      <p>
  ...
  {
    id: 'ca-gout-treatment-online-faq-10',
    question: 'Does California\'s AB 744 telehealth parity law apply to gout treatment?',
    answer: (
      <p>
  ...
  {
    id: 'ca-gout-treatment-online-faq-11',
    question: 'How quickly will my gout medication prescription reach a California pharmacy?',
    answer: (
      <p>
...
const SCHEMAS = [{"@context": "https://schema.org", "@type": "MedicalWebPage", "name": "Gout Treatment Online in California | TeleDirectMD", "url": "https://teledirectmd.com/ca/gout-treatment-online/", "description": "Gout treatment online for California adults. ACR guideline-based flare management. Board-certified Family Medicine MD. Anti-inflammatory prescriptions. Self pay $79. Aetna in-network. Same-day visits.", "datePublished": "2026-05-20", "dateModified": "2026-05-20", "inLanguage": "en-US", "about": {"@type": "MedicalCondition", "name": "Gout (Gouty Arthritis)", "code": {"@type": "MedicalCode", "code": "M10.9", "codingSystem": "ICD-10-CM"}}, "medicalAudience": {"@type": "MedicalAudience", "audienceType": "Patient", "geographicArea": {"@type": "AdministrativeArea", "name": "California"}}, "reviewedBy": {"@type": "Physician", "@id": "https://teledirectmd.com/about/#physician-parth-bhavsar", "name": "Parth Bhavsar, MD", "identifier": {"@type": "PropertyValue", "propertyID": "NPI", "value": "1104323203"}, "medicalSpecialty": "Family Medicine", "hasCredential": [{"@type": "EducationalOccupationalCredential", "credentialCategory": "degree", "name": "Doctor of Medicine (MD)"}, {"@type": "EducationalOccupationalCredential", "credentialCategory": "certification", "name": "Board Certification \u2014 American Board of Family Medicine"}], "licensedIn": "California", "worksFor": {"@type": "MedicalOrganization", "name": "TeleDirectMD", "url": "https://teledirectmd.com"}, "sameAs": ["https://npiregistry.cms.hhs.gov/provider-view/1104323203", "https://teledirectmd.com/about/"]}, "speakable": {"@type": "SpeakableSpecification", "cssSelector": ["#ca-gout-treatment-online-opening", "#ca-gout-treatment-online-opening p", ".tdmd-ca-gout-treatment-online__byline", "#ca-gout-treatment-online-faq"]}}, {"@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [{"@type": "Question", "name": "Can I get gout treatment online in California?", "acceptedAnswer": {"@type": "Answer", "text": "Yes. California Business and Professions Code Section 2290.5 permits California-licensed physicians to deliver care via synchronous video telehealth. TeleDirectMD physicians are licensed in California and follow ACR 2020 gout guidelines. Adults 18+ in California with a known gout history experiencing a recognized flare can book a same-day video visit for colchicine, NSAID, or short prednisone course prescription. Self pay is $79; Aetna is in-network as of April 30, 2026."}}, {"@type": "Question", "name": "What is gout and what causes it?", "acceptedAnswer": {"@type": "Answer", "text": "Gout is a form of inflammatory arthritis caused by the accumulation of monosodium urate (MSU) crystals in joints and surrounding tissues, resulting from elevated uric acid levels in the blood (hyperuricemia). Uric acid is a byproduct of purine metabolism; purines are found in foods such as red meat, organ meats, shellfish, and alcohol (especially beer and spirits). Gout is the most common inflammatory arthritis in adults, per CDC arthritis data. It disproportionately affects men, older adults, and individuals with metabolic syndrome, chronic kidney disease, or a family history of gout."}}, {"@type": "Question", "name": "What medications treat a gout flare, and what do they cost in California?", "acceptedAnswer": {"@type": "Answer", "text": "Per ACR 2020 guideline, first-line treatments for acute gout flares include: colchicine 1.2 mg at onset then 0.6 mg 1 hour later (generic ~$20\u2013$40 for a supply with GoodRx coupon); naproxen 500 mg twice daily for 5\u20137 days (generic ~$5\u2013$10 with GoodRx); or prednisone 40 mg daily for 3\u20135 days (~$8\u2013$15 with GoodRx) when NSAIDs and colchicine are contraindicated. Prescription costs at pharmacy are separate from the TeleDirectMD visit fee ($79)."}}, {"@type": "Question", "name": "Does California require an in-person visit before telehealth?", "acceptedAnswer": {"@type": "Answer", "text": "No. California B&P Code \u00a72290.5 does not require a prior in-person visit. A California-licensed physician can evaluate your gout flare history and symptoms through a synchronous video visit. For patients with a well-established gout diagnosis and familiar flare pattern, telehealth evaluation is clinically appropriate per ACR guideline."}}, {"@type": "Question", "name": "When is gout dangerous and when should I go to the ER in California?", "acceptedAnswer": {"@type": "Answer", "text": "Seek emergency care immediately if you have severe joint inflammation with fever \u2014 this combination raises concern for septic arthritis, which is a joint infection requiring emergency drainage. First-ever joint inflammation with fever in an immunocompromised patient should also prompt emergency evaluation. Septic arthritis and gout require different treatments; misdiagnosis is dangerous. If you are unsure whether this is a gout flare or an infection, err on the side of in-person evaluation."}}, {"@type": "Question", "name": "Is my Aetna plan in California in-network with TeleDirectMD?", "acceptedAnswer": {"@type": "Answer", "text": "Aetna became an active in-network payor for TeleDirectMD in California effective April 30, 2026. Verify current in-network status directly with Aetna before your visit. Self pay is $79 regardless of insurance status."}}, {"@type": "Question", "name": "Is UnitedHealthcare in-network with TeleDirectMD in California?", "acceptedAnswer": {"@type": "Answer", "text": "UnitedHealthcare Commercial was approved for California effective May 29, 2026, covering commercial plans and Medicare Advantage. Excludes Medi-Cal, Individual Exchange, and Navigate/Charter/Core plan types. Verify your specific plan eligibility with UHC before booking."}}, {"@type": "Question", "name": "Will Medi-Cal cover my TeleDirectMD gout visit?", "acceptedAnswer": {"@type": "Answer", "text": "TeleDirectMD is not currently enrolled as a Medi-Cal provider. If you have Medi-Cal, you can use the $79 self-pay rate or find a Medi-Cal-enrolled telehealth provider through your managed care plan or California DHCS at dhcs.ca.gov."}}, {"@type": "Question", "name": "What foods should I avoid to prevent gout flares?", "acceptedAnswer": {"@type": "Answer", "text": "Per ACR 2020 guideline, dietary modifications with the best evidence for reducing gout risk include: avoiding or limiting organ meats (liver, kidney), shellfish (shrimp, lobster, crab), red meat, and alcohol (especially beer and spirits). High-fructose foods and beverages should be limited. Low-fat dairy products, vitamin C, and coffee have been associated with lower uric acid levels in observational studies. However, dietary changes alone typically reduce serum uric acid by only 1\u20132 mg/dL \u2014 urate-lowering therapy (allopurinol) is usually needed for prevention of recurrent gout."}}, {"@type": "Question", "name": "Should I take urate-lowering therapy (allopurinol) for gout prevention?", "acceptedAnswer": {"@type": "Answer", "text": "For patients with recurrent gout flares (2 or more per year), tophi, chronic kidney disease, or kidney stones, the ACR 2020 guideline recommends urate-lowering therapy (ULT) \u2014 typically allopurinol \u2014 as prophylaxis to prevent flares and joint damage. Allopurinol should not be started during an acute flare. TeleDirectMD can discuss ULT initiation as part of ongoing gout management; referral to a rheumatologist or primary care physician for long-term management is recommended for patients on ULT."}}, {"@type": "Question", "name": "Does California's AB 744 telehealth parity law apply to gout treatment?", "acceptedAnswer": {"@type": "Answer", "text": "California AB 744 (2019) requires commercial health plans to reimburse telehealth services on the same basis as in-person services. Parity applies when the provider is already in-network with your specific plan. Currently, Aetna (active April 30, 2026) and UnitedHealthcare Commercial (active May 29, 2026) are in-network in California for TeleDirectMD."}}, {"@type": "Question", "name": "How quickly will my gout medication prescription reach a California pharmacy?", "acceptedAnswer": {"@type": "Answer", "text": "California requires all prescriptions to be issued electronically under Assembly Bill 2789 (effective January 1, 2022). If medication is appropriate, TeleDirectMD sends an e-prescription electronically to your chosen California pharmacy during or after your visit. Most California pharmacies fill within one to four hours. Starting colchicine within 24\u201336 hours of flare onset improves outcomes \u2014 book promptly."}}]}, {"@context": "https://schema.org", "@type": "HowTo", "name": "How to Get Gout Treatment Online in California", "description": "Three steps to receive gout treatment evaluation and, if appropriate, a prescription from a California-licensed board-certified physician.", "totalTime": "PT30M", "estimatedCost": {"@type": "MonetaryAmount", "currency": "USD", "value": "79"}, "step": [{"@type": "HowToStep", "position": 1, "name": "Book your video visit", "text": "Visit teledirectmd.com and select California Gout (Gouty Arthritis) treatment. No referral needed. Self pay $79. Many visits available same day.", "url": "https://teledirectmd.com/book-online"}, {"@type": "HowToStep", "position": 2, "name": "See a California-licensed MD by secure video", "text": "Connect with a board-certified Family Medicine physician licensed in California. The physician reviews your symptoms, history, and red-flag screening. Consent per CA B&P Section 2290.5 confirmed.", "url": "https://teledirectmd.com/ca/gout-treatment-online/"}, {"@type": "HowToStep", "position": 3, "name": "Receive your treatment plan and e-prescription", "text": "If medication is appropriate, a California-compliant e-prescription is sent to your chosen pharmacy during or after the visit.", "url": "https://teledirectmd.com/ca/gout-treatment-online/"}]}, {"@context": "https://schema.org", "@type": "BreadcrumbList", "itemListElement": [{"@type": "ListItem", "position": 1, "name": "TeleDirectMD", "item": "https://teledirectmd.com"}, {"@type": "ListItem", "position": 2, "name": "California", "item": "https://teledirectmd.com/ca/"}, {"@type": "ListItem", "position": 3, "name": "Gout Treatment Online in California", "item": "https://teledirectmd.com/ca/gout-treatment-online/"}]}];
...
export default function CaGoutTreatmentOnline() {
  const pid = 'ca-gout-treatment-online';
      ...
      <div className="tdmd-ca-cond">
        ...
        <nav className="tdmd-breadcrumbs" aria-label="Breadcrumb">
          <div className="tdmd-container" style={{ paddingTop: '0.5rem', paddingBottom: 0 }}>
            ...
            <span className="tdmd-bc-sep" aria-hidden="true">/</span>
            <span aria-current="page">Gout Treatment Online</span>
          </div>
        </nav>
          ...
          <div className="tdmd-container">
            <div className="tdmd-hero-grid">
              <div className="tdmd-hero-copy">
                <h1 data-speakable="true">Gout Treatment Online in California</h1>
                ...
                <p className="tdmd-icd"><strong>ICD-10 commonly used:</strong> M10.9 (Gout, unspecified); M10.071 (Idiopathic gout, right ankle/foot); actual code assigned at visit</p>
              </div>

              <div className="tdmd-hero-side">
                <div className="tdmd-hero-card">
                  <h2>Online MD-Only Gout (Gouty Arthritis) Care in California</h2>
                  <ul>
                    <li>Fast evaluation for gout treatment symptoms</li>
                    <li>Red-flag screening for serious complications requiring in-person care</li>
                    <li>Guideline-based treatment per American College of Rheumatology (ACR)</li>
        ...
        <section className="tdmd-section" id={`${pid}-eligibility`}>
          <div className="tdmd-container">
            <h2>Gout Treatment Telehealth Eligibility Checklist for California</h2>
            ...
            <div className="tdmd-ca-cond__dual">
              <div className="tdmd-ca-cond__dual-card tdmd-ca-cond__dual-card--good">
                ...
                <ul>
                  ...
                  <li>Known history of gout with a recognized flare pattern</li>
                  <li>Classic acute gout presentation — sudden severe pain, redness, swelling in one joint (often big toe, ankle, knee)</li>
                  <li>No fever, no systemic illness, no drainage from joint</li>
                  <li>Not immunocompromised</li>
                  <li>Seeking acute flare treatment (colchicine, NSAIDs, or short prednisone course)</li>
                </ul>
              </div>
              <div className="tdmd-ca-cond__dual-card tdmd-ca-cond__dual-card--alert">
                <h3>&#10007; Seek In-Person or Emergency Care If</h3>
                <ul>
                  <li>First episode of severe joint inflammation with fever — possible septic arthritis (emergency)</li>
                  <li>Joint redness, warmth, and swelling in a patient who is immunocompromised</li>
                  <li>Multiple joints involved simultaneously with systemic illness (fever, chills)</li>
                  <li>Drainage or open wound at the affected joint</li>
                  <li>Tophaceous gout with skin breakdown or infection overlying a tophus</li>
                  <li>Extremely severe pain with inability to bear any weight and systemic symptoms</li>
                </ul>
        ...
        <section className="tdmd-section tdmd-section-highlight" id={`${pid}-ca-law`}>
          <div className="tdmd-container">
            <h2>California Telehealth Law and Your Gout Treatment Visit</h2>
            ...
            <h3>Are gout treatment medications controlled substances under California law?</h3>
            <p>
        ...
        <section className="tdmd-section" id={`${pid}-how-it-works`} itemScope itemType="https://schema.org/HowTo">
          <div className="tdmd-container">
            <h2 itemProp="name">How Online Gout Treatment Works in California</h2>
        ...
        <section className="tdmd-section" id={`${pid}-epidemiology`}>
          <div className="tdmd-container">
            <h2>How Common Is Gout (Gouty Arthritis) in California?</h2>
            <p>
              Gout is the most common inflammatory arthritis in the United States, affecting approximately 9.2 million adults per CDC NHIS data. California's diverse dietary patterns — including high seafood consumption in coastal areas and high fructose-containing beverage consumption statewide — contribute to gout prevalence. CDC PLACES data for California show uric acid-related conditions at population rates consistent with or above the national average, with higher prevalence in older males, Pacific Islander communities, and individuals with metabolic syndrome. — <a href="https://www.cdc.gov/arthritis/types/gout.html" rel="noopener" target="_blank">CDC — Gout and Arthritis</a>.
            </p>
            <p>
              Clinical guidance for gout treatment is provided by <a href="https://www.rheumatology.org/Practice-Quality/Clinical-Support/Clinical-Practice-Guidelines/Gout" rel="noopener" target="_blank">American College of Rheumatology (ACR)</a> through the ACR Guideline for the Management of Gout (2020, updated 2022). TeleDirectMD follows these guidelines on every patient visit.
            </p>
            <h3>What causes gout (gouty arthritis) and who is most at risk in California?</h3>
            <p>
        ...
        <section className="tdmd-section tdmd-section-highlight" id={`${pid}-cost`}>
          <div className="tdmd-container">
            <h2>Gout Treatment Cost &amp; Insurance in California</h2>
            ...
            <div className="tdmd-price-grid">
              ...
              <div className="tdmd-price-chart" role="group" aria-label="Typical Gout (Gouty Arthritis) cost comparison">
                <h3>Typical Gout (Gouty Arthritis) Visit Cost in California</h3>
        ...
        <section className="tdmd-section" id={`${pid}-medications`}>
          <div className="tdmd-container">
            <h2>Gout Treatment Medication Options and Costs in California</h2>
            <p>
              Medications for gout treatment are selected based on current guidelines from <a href="https://www.rheumatology.org/Practice-Quality/Clinical-Support/Clinical-Practice-Guidelines/Gout" rel="noopener" target="_blank">American College of Rheumatology (ACR)</a>, patient history, allergies, and relevant contraindications assessed at the visit. GoodRx-verified pricing is shown below.
            </p>
            <div className="tdmd-table-wrap">
              <table className="tdmd-table" aria-label="Gout Treatment medication options and GoodRx prices">
                <caption style={{ captionSide: 'bottom', textAlign: 'left', padding: '0.5rem 0', fontSize: '0.85rem', color: 'var(--tdmd-muted)' }}>
                ...
                <tbody>
                  <tr className="tdmd-ca-uti__med-firstline">
                    <td><strong>Colchicine 0.6 mg</strong> · First-line</td>
                    <td>1.2 mg at onset, then 0.6 mg 1 hour later × 1; then 0.6 mg once or twice daily until flare resolves</td>
                    <td><a href="https://www.goodrx.com/colchicine" target="_blank" rel="noopener">~$20–$40 generic with GoodRx</a></td>
                    <td>First-line per ACR 2020 guideline for acute gout. Most effective when started within 24–36 hours of flare onset. Do not use if severe renal or hepatic impairment. Drug interactions with strong CYP3A4 inhibitors.</td>
                  </tr>
                  <tr className="tdmd-ca-uti__med-firstline">
                    <td><strong>Naproxen sodium 500 mg — OTC or Rx</strong> · First-line</td>
                    <td>500 mg twice daily × 5–7 days (with food)</td>
                    <td><a href="https://www.goodrx.com/naproxen" target="_blank" rel="noopener">~$5–$10 OTC or generic Rx with GoodRx</a></td>
                    <td>First-line NSAID per ACR guideline for acute gout flares. Avoid if CKD, peptic ulcer history, or heart failure. Take with food to reduce GI side effects.</td>
                  </tr>
                  <tr>
                    <td><strong>Prednisone 40 mg</strong></td>
                    <td>40 mg daily × 3–5 days (tapering based on response)</td>
                    <td><a href="https://www.goodrx.com/prednisone" target="_blank" rel="noopener">~$8–$15 generic with GoodRx</a></td>
                    <td>First-line alternative per ACR guideline when NSAIDs and colchicine are contraindicated (CKD, anticoagulation). Short course. Blood glucose monitoring needed in diabetics.</td>
                  </tr>
                </tbody>
              </table>
            </div>
        ...
        <section className="tdmd-section" id={`${pid}-dual-path`}>
          <div className="tdmd-container">
            ...
            <p>For most adults with mild to moderate gout treatment without red-flag symptoms, a video visit is appropriate and convenient. Some situations require in-person evaluation. Use the comparison below to determine the right care pathway for you.</p>
            <div className="tdmd-ca-cond__dual">
              <div className="tdmd-ca-cond__dual-card tdmd-ca-cond__dual-card--good">
        ...
        <section className="tdmd-section tdmd-faq" id={`${pid}-faq`}>
          <div className="tdmd-container">
            <FaqAccordion
              sectionTitle="Frequently Asked Questions — Gout Treatment in California"
              items={FAQ_ITEMS}
            />
          ...
          <div className="tdmd-container">
            ...
            <div className="tdmd-ca-cond__sibling-grid">
              <a key="cellulitis-treatment-online" className="tdmd-ca-uti__sibling" href="/ca/cellulitis-treatment-online/">
                  ...
                  <span className="tdmd-ca-uti__sibling-why">Gout flares can mimic cellulitis (red, warm, swollen joint) — critical differentiation to avoid wrong antibiotic.</span>
                </a>
              <a key="shingles-treatment-online" className="tdmd-ca-uti__sibling" href="/ca/shingles-treatment-online/">
                  ...
                  <span className="tdmd-ca-uti__sibling-why">Both cause severe localized pain — shingles may precede its rash presentation.</span>
                </a>
              <a key="impetigo-treatment-online" className="tdmd-ca-uti__sibling" href="/ca/impetigo-treatment-online/">
                  ...
                  <span className="tdmd-ca-uti__sibling-why">Skin infection can occur near a gouty joint — both present with localized inflammation.</span>
                </a>
              <a key="mastitis-treatment-online" className="tdmd-ca-uti__sibling" href="/ca/mastitis-treatment-online/">
                  ...
                  <span className="tdmd-ca-uti__sibling-why">Both are acute inflammatory conditions requiring anti-inflammatory management.</span>
                </a>
              <a key="uti-treatment-online" className="tdmd-ca-uti__sibling" href="/ca/uti-treatment-online/">
                  ...
                  <span className="tdmd-ca-uti__sibling-why">Both are common acute conditions managed in outpatient telehealth settings.</span>
                </a>
            </div>
          </div>
        </section>
        ...
        <section className="tdmd-section" id={`${pid}-related`}>
          <div className="tdmd-container">
            ...
            <p>This page sits at the intersection of the <a href="/ca/">California state hub</a> and the <a href="/gout-treatment-online/">Gout (Gouty Arthritis) national condition page</a>. Use the links below to explore insurance details, book a visit, or review other conditions.</p>
            <div className="tdmd-ca-cond__related-links" aria-label="Related resources">
              <a href="/">Home</a>
              <a href="/ca/">California (state pillar)</a>
              <a href="/gout-treatment-online/">National Gout (Gouty Arthritis) page</a>
              <a href="/health-guides/">Gout (Gouty Arthritis) health guides</a>
        ...
        <WhatDoesThisCostBlock conditionSlug="gout-treatment-online" conditionName="Gout Treatment" stateName="California" />
        <CompareTeleDirectMDLinkRow conditionSlug="gout-treatment-online" />
        <CommonSymptomsBlock conditionSlug="gout-treatment-online" conditionName="Gout Treatment" />
      </div>
    </>
  );
}
