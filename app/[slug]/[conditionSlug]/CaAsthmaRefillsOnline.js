...
const FAQ_ITEMS = [
  {
    ...
    answer: <p>Yes. California Business and Professions Code Section 2290.5 permits licensed physicians to deliver care and prescribe appropriate medications via synchronous video telehealth without a prior in-person visit. TeleDirectMD\'s California-licensed board-certified Family Medicine physician reviews your current asthma regimen — including your ICS, ICS+LABA, rescue inhaler usage, and ACT score — and can authorize refills for stable established asthma. Self pay is $79; Aetna commercial plans are in-network effective April 30, 2026.</p>,
  },
  {
...
function buildSchemas() {
  const medicalWebPage = {
    ...
    name: PAGE_TITLE,
    url: PAGE_URL,
    description: 'Refill your asthma controller medications online in California. Board-certified Family Medicine MD. CA telehealth law compliant. Aetna in-network. Self pay $79. GINA 2024 stepwise approach. ICS, ICS+LABA, biologics referral criteria.',
  ...
  const howTo = {
    ...
    step: [
      { '@type': 'HowToStep', position: 1, name: 'Book your video visit', text: 'Visit teledirectmd.com and select California Asthma Refills. No referral needed. Self pay $79. Many visits available same day.', url: 'https://teledirectmd.com/book-online' },
            ...
            <div className="tdmd-hero-grid">
              <div className="tdmd-hero-copy">
                ...
                <p className="tdmd-hero-sub" data-speakable="true">
                  California adults 18+ · Secure video visit · Self pay $79 · Aetna in-network · UHC Commercial approved · MD-only · CA B&amp;P §2290.5 compliant · GINA 2024 + NAEPP
                </p>
                <p>
          ...
          <div className="tdmd-container">
            <div className="tdmd-ca-uti__cta-strip" role="complementary">
              <div>
                ...
                <small>Self pay $79 · Aetna in-network · UHC Commercial approved May 2026 · Asthma Refills</small>
              </div>
