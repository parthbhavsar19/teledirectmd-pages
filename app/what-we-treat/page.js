  ...
  return {
    ...
    '@graph': [
      ...
      },
      {
        ...
        description: `Complete catalog of ${totalConditions}+ adult conditions treated via secure video visit by board-certified MDs at TeleDirectMD for $79 flat fee.`,
