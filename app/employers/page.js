...
const jsonLd = {
  ...
  '@graph': [
    ...
    },
    {
      ...
      areaServed: ['Alabama', 'Alaska', 'Arizona', 'California', 'Colorado', 'Connecticut', 'Washington, D.C.', 'Delaware', 'Florida', 'Georgia', 'Hawaii', 'Idaho', 'Illinois', 'Indiana', 'Iowa', 'Kansas', 'Kentucky', 'Louisiana', 'Maine', 'Maryland', 'Michigan', 'Minnesota', 'Mississippi', 'Missouri', 'Montana', 'Nebraska', 'Nevada', 'New Hampshire', 'New Jersey', 'North Carolina', 'North Dakota', 'Ohio', 'Oklahoma', 'Pennsylvania', 'South Carolina', 'South Dakota', 'Tennessee', 'Texas', 'Utah', 'Virginia', 'Vermont', 'Washington', 'West Virginia', 'Wisconsin', 'Wyoming'],
    ...
    },
    {
      ...
      mainEntity: [
        ...
        { '@type': 'Question', name: 'What states do you cover?', acceptedAnswer: { '@type': 'Answer', text: '44 states plus the District of Columbia. We do not currently serve Arkansas, Massachusetts, New Mexico, New York, Oregon, or Rhode Island.' } },
        ...
        <section className="tdmd-emp-section tdmd-emp-section--soft">
          <div className="tdmd-emp-container">
            ...
            <div className="tdmd-emp-faq">
              ...
              <details><summary>What states do you cover?</summary><div><p>44 states plus the District of Columbia. We do not currently serve Arkansas, Massachusetts, New Mexico, New York, Oregon, or Rhode Island. <a href="/states-we-serve/" style={{ color: 'var(--tdmd-teal)', fontWeight: 700 }}>See the full coverage map →</a></p></div></details>
