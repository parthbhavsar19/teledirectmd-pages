          ...
          <div className="tdmd-emp-container">
            <div className="tdmd-emp-author" style={{ maxWidth: 820, margin: '0 auto' }}>
              ...
              <p style={{ color: 'var(--tdmd-muted)', fontSize: '1.0625rem' }}>
                Board-Certified Family Medicine Physician. Founder of TeleDirectMD. Residency: University of Mississippi Medical Center (UMMC), 2021. Licensed in 44 states + DC. NPI 1104323203. 5.0&star; across 125 verified reviews on Healthgrades, ZocDoc, WebMD, and Google.
              </p>
      ...
      <section className="tdmd-emp-compliance">
        <div className="tdmd-emp-container">
          ...
          <div className="tdmd-emp-compliance-block">
            ...
            <p>Brief authored by Parth Bhavsar, MD — Board-Certified Family Medicine Physician · NPI 1104323203 · Residency: University of Mississippi Medical Center, 2021 · Licensed in 44 states + DC.</p>
          </div>
        </div>
      </section>
    </>
