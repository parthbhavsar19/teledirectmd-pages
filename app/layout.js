  ...
  return (
    <html lang="en">
      <head>
        ...
        <link href="https://fonts.googleapis.com/css2?family=Almarai:wght@400;700&family=Merriweather:wght@400;700&family=Inter:wght@400;500;600;700&family=Patrick+Hand&family=Space+Mono:wght@400;700&family=Karla:wght@400;700&display=swap" rel="stylesheet" />
        <GlobalStyles />
      </head>
      <body style={{ margin: 0 }}>
