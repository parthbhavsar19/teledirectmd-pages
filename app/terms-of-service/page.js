...
export default function TermsOfService() {
  const s = {
    h2: { fontSize: '1.35rem', fontWeight: 600, marginTop: 36, marginBottom: 12 },
    h3: { fontSize: '1.1rem', fontWeight: 600, marginTop: 24, marginBottom: 8 },
  };
  const link = { color: '#1a7f7f' };
  return (
    <div style={{ maxWidth: 800, margin: '0 auto', padding: '40px 24px 80px' }}>
      <h1 style={{ fontSize: '2rem', fontWeight: 700, color: '#1a1a1a', marginBottom: 8 }}>Terms of Service</h1>
      <p style={{ color: '#666', fontSize: '0.95rem', marginBottom: 24 }}>Effective date: April 16, 2026</p>

      {/* IMPORTANT NOTICES */}
      <div style={{ background: '#fef3cd', border: '1px solid #ffc107', borderRadius: 8, padding: '20px 24px', marginBottom: 32, lineHeight: 1.7, fontSize: '0.95rem' }}>
        <p style={{ fontWeight: 700, marginBottom: 12, color: '#1a1a1a' }}>IMPORTANT NOTICES — PLEASE READ BEFORE USING THIS SITE OR SERVICES:</p>
        <p style={{ marginBottom: 8 }}><strong>ARBITRATION NOTICE:</strong> These Terms contain a mandatory binding arbitration clause and class action waiver (Section 12). By using TeleDirectMD&apos;s services, you agree that disputes will be resolved through individual arbitration, not through jury trial or class action. You have 30 days from first use to opt out. See Section 12 for details.</p>
        <p style={{ marginBottom: 8 }}><strong>CONTROLLED SUBSTANCES:</strong> TeleDirectMD does <strong>not</strong> prescribe controlled substances of any schedule (Schedule II through V), including opioids, benzodiazepines, stimulants, or sleep medications. No exceptions will be made under any circumstances.</p>
      ...
      <p style={{ color: '#666', fontSize: '0.9rem', fontStyle: 'italic', marginBottom: 32 }}>These Terms of Service (&ldquo;Terms&rdquo;) are provided for informational and contractual purposes. TeleDirectMD is not providing legal advice. If you have legal questions about these Terms, please consult your own qualified legal counsel.</p>

      <section style={{ lineHeight: 1.8, color: '#333', fontSize: '1rem' }}>

        {/* 1. ACCEPTANCE */}
        <h2 style={s.h2}>1. Acceptance of Terms</h2>
        <p>By accessing or using the TeleDirectMD website at <strong>teledirectmd.com</strong> (the &ldquo;Site&rdquo;), scheduling or attending a virtual visit, completing an intake form, or otherwise engaging with any service offered by TeleDirectMD (&ldquo;Services&rdquo;), you (&ldquo;Patient,&rdquo; &ldquo;you,&rdquo; or &ldquo;your&rdquo;) agree to be legally bound by these Terms of Service, our <a href="/privacy-policy" style={link}>Privacy Policy</a>, our Notice of Privacy Practices, and any consent forms you execute in connection with your care.</p>
        ...
        <h3 style={s.h3}>2.2 Geographic Location</h3>
        <ul style={{ paddingLeft: 24, marginTop: 8 }}>
        ...
        <p style={{ background: '#fde8e8', border: '1px solid #e74c3c', borderRadius: 8, padding: '16px 20px', fontWeight: 600 }}>If you are experiencing a medical emergency — including chest pain, difficulty breathing, stroke symptoms, severe bleeding, loss of consciousness, or any other potentially life-threatening condition — call 911 or go to your nearest emergency room immediately. Do not use TeleDirectMD.</p>

        <h3 style={s.h3}>3.3 Not a Substitute for In-Person or Primary Care</h3>
        ...
        <h3 style={s.h3}>3.4 Clinical Discretion and Referrals</h3>
        ...
        <h3 style={s.h3}>3.5 Excuse Notes</h3>
        ...
        <h3 style={s.h3}>3.6 No Ongoing Provider-Patient Relationship</h3>
        ...
        <h2 style={s.h2}>4. No Controlled Substances</h2>
        ...
        <h2 style={s.h2}>5. Consent to Telehealth</h2>

        <h3 style={s.h3}>5.1 Informed Consent Form</h3>
        ...
        <h3 style={s.h3}>5.2 Acknowledgment of Telehealth Risks and Limitations</h3>
        ...
        <h3 style={s.h3}>5.3 Right to Refuse or Withdraw Consent</h3>
        ...
        <h2 style={s.h2}>6. Patient Responsibilities</h2>
        <p>As a condition of using TeleDirectMD&apos;s Services, you agree to:</p>

        <h3 style={s.h3}>6.1 Provide Accurate and Complete Information</h3>
        ...
        <h3 style={s.h3}>6.2 Be Physically Present in a Covered State</h3>
        ...
        <h3 style={s.h3}>6.3 Ensure a Suitable Environment</h3>
        ...
        <h3 style={s.h3}>6.4 Maintain Adequate Technology</h3>
        ...
        <h3 style={s.h3}>6.5 Disclose All Medications and Allergies</h3>
        ...
        <h3 style={s.h3}>6.6 Present Valid Identification</h3>
        <p>Be prepared to present valid, government-issued photo identification when requested.</p>

        <h3 style={s.h3}>6.7 Follow Up as Directed</h3>
        ...
        <h3 style={s.h3}>6.8 Not Record Visits</h3>
        ...
        <h2 style={s.h2}>7. Insurance and Payment</h2>

        <h3 style={s.h3}>7.1 Cash Pay</h3>
        ...
        <h3 style={s.h3}>7.2 Accepted Insurance</h3>
        ...
        <h3 style={s.h3}>7.3 Patient Responsibility for Insurance Visits</h3>
        ...
        <h3 style={s.h3}>7.4 Additional Costs Not Included</h3>
        ...
        <h3 style={s.h3}>7.5 Excuse Notes</h3>
        ...
        <h3 style={s.h3}>7.6 Payment Processing</h3>
        ...
        <h2 style={s.h2}>8. Cancellation and Refund Policy</h2>

        <h3 style={s.h3}>8.1 Cancellation and Rescheduling</h3>
        ...
        <p>To cancel or reschedule, contact TeleDirectMD at <a href="mailto:contact@teledirectmd.com" style={link}>contact@teledirectmd.com</a> or <a href="tel:+16789561855" style={link}>(678) 956-1855</a> before the applicable deadline.</p>

        <h3 style={s.h3}>8.2 No-Shows</h3>
        ...
        <h3 style={s.h3}>8.4 Refund Processing</h3>
        ...
        <p style={{ fontWeight: 600 }}>PLEASE READ THIS SECTION CAREFULLY. IT LIMITS TELEDIRECTMD&apos;S LIABILITY TO YOU.</p>

        <h3 style={s.h3}>9.1 Technology and Infrastructure</h3>
        ...
        <h3 style={s.h3}>9.2 Nature of Medicine</h3>
        ...
        <h3 style={s.h3}>9.3 Aggregate Liability Cap</h3>
        ...
        <h3 style={s.h3}>9.4 Exclusion of Certain Damages</h3>
        ...
        <h3 style={s.h3}>9.5 Applicability</h3>
        ...
        <h2 style={s.h2}>12. Dispute Resolution and Arbitration</h2>
        <div style={{ background: '#fef3cd', border: '1px solid #ffc107', borderRadius: 8, padding: '16px 20px', marginBottom: 16, fontWeight: 600, fontSize: '0.95rem' }}>
        ...
        <h3 style={s.h3}>12.1 Informal Resolution First</h3>
        <p>Before initiating formal arbitration, you agree to contact TeleDirectMD at <a href="mailto:contact@teledirectmd.com" style={link}>contact@teledirectmd.com</a> and describe your dispute in writing. TeleDirectMD will attempt to informally resolve the dispute within <strong>30 days</strong> of receipt.</p>

        <h3 style={s.h3}>12.2 Binding Arbitration</h3>
        ...
        <h3 style={s.h3}>12.3 Arbitration Procedures</h3>
        <ul style={{ paddingLeft: 24, marginTop: 8 }}>
        ...
        <h3 style={s.h3}>12.4 Class Action Waiver</h3>
        ...
        <h3 style={s.h3}>12.5 Exceptions</h3>
        ...
        <h3 style={s.h3}>12.6 Opt-Out Right</h3>
        <p>You may <strong>opt out of this arbitration agreement</strong> by sending written notice to <a href="mailto:contact@teledirectmd.com" style={link}>contact@teledirectmd.com</a> within <strong>30 days of your first use of the Services</strong> or your acceptance of these Terms, whichever is earlier. Your opt-out notice must include your name, contact information, and a clear statement that you wish to opt out.</p>

        <h3 style={s.h3}>12.7 Governing Law and Venue</h3>
        ...
        <h2 style={s.h2}>13. Intellectual Property</h2>
        ...
        <h2 style={s.h2}>14. Privacy and HIPAA</h2>
        <p>TeleDirectMD&apos;s collection, use, and protection of your personal information is governed by our <a href="/privacy-policy" style={link}>Privacy Policy</a>, which is incorporated herein by reference. As a covered healthcare entity under HIPAA, TeleDirectMD maintains a Notice of Privacy Practices (NPP) that describes how your protected health information may be used and disclosed.</p>
        ...
        {/* 15. COMMUNICATIONS */}
        <h2 style={s.h2}>15. Communications</h2>
        ...
        <p>TeleDirectMD will not send you marketing or promotional communications without your <strong>separate, affirmative opt-in consent</strong>. You may withdraw marketing consent at any time by following the unsubscribe instructions in any marketing email or by contacting us at <a href="mailto:contact@teledirectmd.com" style={link}>contact@teledirectmd.com</a>.</p>
        ...
        {/* 17. SEVERABILITY */}
        <h2 style={s.h2}>17. Severability</h2>
        ...
        {/* 18. ENTIRE AGREEMENT */}
        <h2 style={s.h2}>18. Entire Agreement</h2>
        <p>These Terms, together with the <a href="/privacy-policy" style={link}>Privacy Policy</a>, Notice of Privacy Practices, <a href="/telehealth-consent" style={link}>Informed Consent to Telehealth</a>, and any other consent forms executed in connection with your care, constitute the entire agreement between you and TeleDirectMD. No verbal representation or prior course of dealing shall modify or supplement these Terms.</p>
        ...
        <p style={{ marginTop: 8 }}>
          ...
          Phone: <a href="tel:+16789561855" style={link}>(678) 956-1855</a><br />
          Email: <a href="mailto:contact@teledirectmd.com" style={link}>contact@teledirectmd.com</a><br />
          Website: <a href="https://teledirectmd.com" style={link}>teledirectmd.com</a>
        </p>
        <p style={{ background: '#fde8e8', border: '1px solid #e74c3c', borderRadius: 8, padding: '12px 20px', fontWeight: 600, marginTop: 20 }}>For medical emergencies, do not contact us — call 911 or go to your nearest emergency room.</p>

        <p style={{ color: '#666', fontSize: '0.9rem', fontStyle: 'italic', marginTop: 32 }}>These Terms of Service were last updated on April 16, 2026. TeleDirectMD recommends that patients review these Terms periodically for changes. Your continued use of the Site or Services constitutes acceptance of the Terms as currently posted.</p>
        <p style={{ color: '#666', fontSize: '0.9rem', fontStyle: 'italic' }}>This document does not constitute legal advice. If you have questions about your rights or obligations under these Terms, please consult a qualified attorney.</p>
      </section>
    </div>
  );
}
