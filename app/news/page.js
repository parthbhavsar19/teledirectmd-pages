...
const FAQS = [
  ...
  },
  {
    ...
    answer:
      'Yes. TeleDirectMD is actively pursuing additional state medical licenses and insurance contracts. The practice currently serves 44 states + Washington DC. Expansions to additional states will be announced on this news page when they are completed. Patients in currently unserved states (AR, MA, NM, NY, OR, RI) can check back periodically or contact the practice directly for an update on their state.',
  },
  {
