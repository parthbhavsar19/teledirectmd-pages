...
const FAQS = [
  ...
  },
  {
    ...
    answer:
      'Yes. TeleDirectMD is actively pursuing additional state medical licenses and insurance contracts. The practice currently serves 44 states + Washington DC. Expansions to additional states will be announced on this news page when they are completed. Patients in currently unserved states (AK, HI, NY, MA, RI, NM, OR, AR) can check back periodically or contact the practice directly for an update on their state.',
  },
  {
        ...
        <section className="nws-section" aria-labelledby="timeline-heading">
          ...
          <div className="nws-timeline">
            {[
              ...
              { date: 'Spring 2026', title: '44 states + DC covered', desc: 'Telehealth licensure expands to 44 states and Washington DC, making TeleDirectMD available to a majority of US adults. Select insurance now accepted in multiple states.' },
