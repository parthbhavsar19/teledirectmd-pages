...
const CONDITION_ICONS = {
  ...
  // ===== TRAVEL MEDICINE =====
  'Altitude Sickness': `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M3 20h18"/><path d="M5 20l5-12 3 6 2-4 4 10"/><path d="M8.5 11l1.5-1 1.5 2"/></svg>`,

  'Travel Medicine': `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M10 3l4 7 6 1.5-4.5 3 1 6L12 17l-4.5 3.5 1-6L4 11.5 10 10z" opacity="0"/><path d="M2 12l8-1 4-7 1.5.5-2 6.5 5 .5-1.5 2-3.5-.5-3 4.5-1.5-.5 1.5-3-5-.5z"/></svg>`,

  'Malaria Prophylaxis': `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M5 11c3-4 7-4 10-1s3 7-1 10"/><path d="M4 20l3-3"/><path d="M9 7l1 1"/><path d="M13 9l1 1"/><ellipse cx="10" cy="10" rx="5" ry="3" transform="rotate(-45 10 10)"/></svg>`,

  "Traveler's Diarrhea": `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M8 3h8l-1 6H9z"/><path d="M7 9h10l-1 11H8z"/><path d="M10 13v3"/><path d="M14 13v3"/></svg>`,
};
