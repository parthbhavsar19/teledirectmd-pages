...
.tdm-hero{padding:60px 0 50px;text-align:center;background:linear-gradient(180deg,#FDFBF9 0%,#F5F2EE 100%);border-bottom:1px solid #F0EBE6;width:100%;overflow:hidden;position:relative}
...
/* ── Urgent Care canary: compact grid + progressive disclosure (scoped, wwtc-*) ── */
.tdm-page .wwtc{margin-bottom:32px}
.tdm-page .wwtc-header{display:flex;align-items:center;gap:16px;padding:20px 24px;background:#FFF;border:1px solid #E5E0DB;border-radius:12px 12px 0 0;width:100%}
.tdm-page .wwtc-header-icon{width:60px;height:60px;flex-shrink:0;display:flex;align-items:center;justify-content:center}
.tdm-page .wwtc-header-icon img{width:100%;height:100%;object-fit:contain;display:block}
.tdm-page .wwtc-header-text{flex:1;min-width:0}
.tdm-page .wwtc-title{font-family:'Fraunces',Georgia,serif;font-size:clamp(18px,3vw,22px);font-weight:600;color:#143938;margin-bottom:4px}
.tdm-page .wwtc-subtitle{font-size:14px;color:#5A5A5A}
.tdm-page .wwtc-chip{flex-shrink:0;display:inline-flex;align-items:center;padding:6px 12px;background:#F0F5F4;border:1px solid rgba(20,57,56,.12);border-radius:100px;font-size:12px;font-weight:600;color:#1B4D4C;white-space:nowrap}
.tdm-page .wwtc-grid{display:grid;grid-template-columns:repeat(auto-fill,minmax(200px,1fr));gap:12px;padding:20px;background:#F5F2EE;border:1px solid #E5E0DB;border-top:none;border-radius:0 0 12px 12px;width:100%}
.tdm-page .wwtc-tile{background:#FFF;border:1px solid #E5E0DB;border-radius:12px;min-width:0;transition:border-color .2s ease,box-shadow .2s ease,transform .2s ease}
.tdm-page .wwtc-tile:hover{border-color:#2A6B6A;box-shadow:0 4px 12px rgba(27,77,76,.1);transform:translateY(-2px)}
.tdm-page .wwtc-tile.open{grid-column:1/-1;transform:none;border-color:#2A6B6A;box-shadow:0 4px 14px rgba(27,77,76,.12)}
.tdm-page .wwtc-tile-btn{display:flex;align-items:center;gap:12px;width:100%;padding:12px 16px;background:transparent;border:none;border-radius:12px;cursor:pointer;text-align:left;font-family:inherit;color:#143938}
.tdm-page .wwtc-tile-btn:focus-visible{outline:3px solid #2A6B6A;outline-offset:2px}
.tdm-page .wwtc-tile-icon{width:44px;height:44px;flex-shrink:0;display:flex;align-items:center;justify-content:center}
.tdm-page .wwtc-tile-icon img{width:100%;height:100%;object-fit:contain;display:block}
.tdm-page .wwtc-tile-name{flex:1;min-width:0;font-family:'Fraunces',Georgia,serif;font-size:16px;font-weight:600;color:#143938;line-height:1.25;word-break:normal;overflow-wrap:normal;-webkit-hyphens:auto;hyphens:auto}
.tdm-page .wwtc-tile-chevron{width:18px;height:18px;flex-shrink:0;color:#5A5A5A;transition:transform .2s ease}
.tdm-page .wwtc-tile.open .wwtc-tile-chevron{transform:rotate(180deg)}
.tdm-page .wwtc-panel{padding:0 16px 16px}
.tdm-page .wwtc-panel-desc{font-size:14px;color:#4A4A4A;line-height:1.6;margin:0 0 16px}
.tdm-page .wwtc-panel-actions{display:flex;gap:10px;flex-wrap:wrap}
.tdm-page .wwtc-section-cta{display:flex;justify-content:center;padding:20px 0 4px}
.tdm-page .wwtc-section-cta-btn{padding:14px 28px;font-size:15px}
@media(max-width:600px){
.tdm-page .wwtc-header{padding:16px;flex-wrap:wrap}
.tdm-page .wwtc-chip{order:3;width:100%}
.tdm-page .wwtc-grid{grid-template-columns:1fr 1fr;padding:12px;gap:10px}
.tdm-page .wwtc-tile-btn{padding:10px 12px;gap:10px}
.tdm-page .wwtc-tile-icon{width:40px;height:40px}
.tdm-page .wwtc-tile-name{font-size:.95em;font-size:clamp(13px,3.6vw,15px)}
}
@media(max-width:380px){
.tdm-page .wwtc-tile-name{font-size:13px}
.tdm-page .wwtc-tile-icon{width:36px;height:36px}
}
@media(prefers-reduced-motion:reduce){
.tdm-page .wwtc-tile,.tdm-page .wwtc-tile-chevron{transition:none}
.tdm-page .wwtc-tile:hover{transform:none}
}
@media(max-width:380px){
...
/* ── Dark-mode toggle button (reuses health-guide markup: .tdmd-dark-toggle, icon swap) ── */
.tdm-page .tdmd-dark-toggle{position:absolute;top:16px;right:16px;z-index:5;display:flex;align-items:center;justify-content:center;width:40px;height:40px;border:1.5px solid #E5E0DB;border-radius:10px;background:#FFF;cursor:pointer;transition:background .2s,border-color .2s;padding:0}
.tdm-page .tdmd-dark-toggle:hover{background:#F5F2EE;border-color:#1B4D4C}
.tdm-page .tdmd-dark-toggle:focus-visible{outline:3px solid #2A6B6A;outline-offset:2px}
.tdm-page .tdmd-dark-toggle svg{width:20px;height:20px;stroke:#1B4D4C;fill:none;stroke-width:2}
.tdm-page .tdmd-dark-toggle .tdmd-icon-moon{display:block}
.tdm-page .tdmd-dark-toggle .tdmd-icon-sun{display:none}
html.tdmd-dark .tdm-page .tdmd-dark-toggle .tdmd-icon-moon{display:none}
html.tdmd-dark .tdm-page .tdmd-dark-toggle .tdmd-icon-sun{display:block}
@media(max-width:600px){.tdm-page .tdmd-dark-toggle{top:12px;right:12px;width:36px;height:36px}}

/* ── Dark mode — palette derived from health-guide dark-mode.css ──
   Surfaces #121c24/#0f1a22/#1a2733/#162028/#1e2a35, borders #2a3a45,
   text #e0e8eb / headings #f0f4f6 / muted #9bb0b8, teal #7ecde0/#5bbfc9, accent #ff7a5c. */
html.tdmd-dark .tdm-page{background:#121c24;color:#e0e8eb}
html.tdmd-dark .tdm-page .tdmd-dark-toggle{background:#1a2733;border-color:#2a3a45}
html.tdmd-dark .tdm-page .tdmd-dark-toggle:hover{background:#1e2a35;border-color:#5bbfc9}
html.tdmd-dark .tdm-page .tdmd-dark-toggle svg{stroke:#e0e8eb}
html.tdmd-dark .tdm-page .tdm-hero{background:linear-gradient(180deg,#0f1a22 0%,#121c24 100%);border-bottom-color:#2a3a45}
html.tdmd-dark .tdm-page .tdm-hero h1{color:#f0f4f6}
html.tdmd-dark .tdm-page .tdm-hero-sub{color:#9bb0b8}
html.tdmd-dark .tdm-page .tdm-search{background:#1a2733;border-color:#2a3a45;color:#e0e8eb;box-shadow:none}
html.tdmd-dark .tdm-page .tdm-search::placeholder{color:#9bb0b8}
html.tdmd-dark .tdm-page .tdm-search:focus{border-color:#5bbfc9;box-shadow:0 0 0 4px rgba(91,191,201,.15)}
html.tdmd-dark .tdm-page .tdm-search-icon{color:#9bb0b8}
html.tdmd-dark .tdm-page .tdm-results{background:#1a2733;border-color:#2a3a45;box-shadow:0 8px 30px rgba(0,0,0,.5)}
html.tdmd-dark .tdm-page .tdm-result{border-bottom-color:#2a3a45}
html.tdmd-dark .tdm-page .tdm-result:hover{background:#1e2a35}
html.tdmd-dark .tdm-page .tdm-result strong{color:#7ecde0}
html.tdmd-dark .tdm-page .tdm-result span{color:#9bb0b8}
html.tdmd-dark .tdm-page .tdm-pill{background:#1a2733;border-color:#2a3a45;color:#e0e8eb}
html.tdmd-dark .tdm-page .tdm-pill:hover{background:#1B4D4C;border-color:#5bbfc9;color:#fff}
html.tdmd-dark .tdm-page .tdm-trust{color:#9bb0b8}
html.tdmd-dark .tdm-page .tdm-trust-item svg{color:#5bbfc9}
html.tdmd-dark .tdm-page .tdm-sidebar-nav{background:#1a2733;border-color:#2a3a45}
html.tdmd-dark .tdm-page .tdm-sidebar-title{color:#f0f4f6;border-bottom-color:#2a3a45}
html.tdmd-dark .tdm-page .tdm-sidebar-link{color:#9bb0b8}
html.tdmd-dark .tdm-page .tdm-sidebar-link:hover{background:#1e2a35;color:#7ecde0}
html.tdmd-dark .tdm-page .tdm-sidebar-link.active{background:#1B4D4C;color:#fff}
html.tdmd-dark .tdm-page .tdm-sidebar-cta{background:#ff7a5c;color:#1a1a2e}
html.tdmd-dark .tdm-page .tdm-sidebar-cta:hover{background:#ff8f75}
/* old-card category sections */
html.tdmd-dark .tdm-page .tdm-header{background:#1a2733;border-color:#2a3a45}
html.tdmd-dark .tdm-page .tdm-header:hover{background:#1e2a35}
html.tdmd-dark .tdm-page .tdm-title{color:#f0f4f6}
html.tdmd-dark .tdm-page .tdm-subtitle{color:#9bb0b8}
html.tdmd-dark .tdm-page .tdm-toggle{color:#9bb0b8}
html.tdmd-dark .tdm-page .tdm-grid{background:#162028;border-color:#2a3a45}
html.tdmd-dark .tdm-page .tdm-card{background:#1a2733;border-color:#2a3a45}
html.tdmd-dark .tdm-page .tdm-card:hover{border-color:#5bbfc9;box-shadow:0 4px 12px rgba(0,0,0,.4)}
html.tdmd-dark .tdm-page .tdm-card-name{color:#f0f4f6}
html.tdmd-dark .tdm-page .tdm-card-desc{color:#9bb0b8}
html.tdmd-dark .tdm-page .tdm-btn-primary{background:#ff7a5c;color:#1a1a2e}
html.tdmd-dark .tdm-page .tdm-btn-primary:hover{background:#ff8f75}
html.tdmd-dark .tdm-page .tdm-btn-secondary{color:#7ecde0;border-color:#2a3a45}
html.tdmd-dark .tdm-page .tdm-btn-secondary:hover{background:#1B4D4C;color:#fff;border-color:#5bbfc9}
html.tdmd-dark .tdm-page .tdm-mobile-cta{background:#0f1a22;border-top-color:#2a3a45}
html.tdmd-dark .tdm-page .tdm-mobile-cta a{background:#ff7a5c;color:#1a1a2e}
/* canary section (wwtc-*) */
html.tdmd-dark .tdm-page .wwtc-header{background:#1a2733;border-color:#2a3a45}
html.tdmd-dark .tdm-page .wwtc-title{color:#f0f4f6}
html.tdmd-dark .tdm-page .wwtc-subtitle{color:#9bb0b8}
html.tdmd-dark .tdm-page .wwtc-chip{background:rgba(91,191,201,.15);border-color:rgba(91,191,201,.3);color:#7ecde0}
html.tdmd-dark .tdm-page .wwtc-grid{background:#162028;border-color:#2a3a45}
html.tdmd-dark .tdm-page .wwtc-tile{background:#1a2733;border-color:#2a3a45}
html.tdmd-dark .tdm-page .wwtc-tile:hover{border-color:#5bbfc9;box-shadow:0 4px 12px rgba(0,0,0,.4)}
html.tdmd-dark .tdm-page .wwtc-tile.open{border-color:#5bbfc9;box-shadow:0 4px 14px rgba(0,0,0,.45)}
html.tdmd-dark .tdm-page .wwtc-tile-btn{color:#f0f4f6}
html.tdmd-dark .tdm-page .wwtc-tile-name{color:#f0f4f6}
html.tdmd-dark .tdm-page .wwtc-tile-chevron{color:#9bb0b8}
html.tdmd-dark .tdm-page .wwtc-panel-desc{color:#c9d4d8}
/* ceramic icons: neutral light chip in dark so soft shadows never read as a halo */
html.tdmd-dark .tdm-page .wwtc-tile-icon,
html.tdmd-dark .tdm-page .wwtc-header-icon{background:#eef2f4;border-radius:12px;box-shadow:inset 0 0 0 1px rgba(255,255,255,.04)}
/* insurance section — inline-styled, overridden with !important (see PR notes) */
html.tdmd-dark .tdm-page + .tdm-insurance,html.tdmd-dark .tdm-insurance{background:#0f1a22 !important;border-top-color:#2a3a45 !important}
html.tdmd-dark .tdm-insurance h2{color:#f0f4f6 !important}
html.tdmd-dark .tdm-insurance>.tdm-container>p{color:#9bb0b8 !important}
html.tdmd-dark .tdm-insurance a[href^="/insurance/"]{background:#1a2733 !important;border-color:#2a3a45 !important}
html.tdmd-dark .tdm-insurance a[href^="/insurance/"]>div:first-child{color:#f0f4f6 !important}
html.tdmd-dark .tdm-insurance>.tdm-container>p:last-child a{color:#7ecde0 !important}
/* smooth theme transition (guarded by reduced-motion below) */
.tdm-page,.tdm-page .tdm-hero,.tdm-page .tdm-search,.tdm-page .tdm-card,.tdm-page .tdm-header,.tdm-page .tdm-grid,.tdm-page .wwtc-tile,.tdm-page .wwtc-header,.tdm-page .wwtc-grid,.tdm-page .tdm-sidebar-nav{transition:background-color .3s ease,color .3s ease,border-color .3s ease}
@media(prefers-reduced-motion:reduce){
.tdm-page,.tdm-page .tdm-hero,.tdm-page .tdm-search,.tdm-page .tdm-card,.tdm-page .tdm-header,.tdm-page .tdm-grid,.tdm-page .wwtc-tile,.tdm-page .wwtc-header,.tdm-page .wwtc-grid,.tdm-page .tdm-sidebar-nav,.tdm-page .tdmd-dark-toggle{transition:none}
}
`;
