/* ── Dark theme rules for the What We Treat page ──
   Driven by the SAME site-wide mechanism SiteHeader uses:
   html[data-theme="dark"] (explicit) and the prefers-color-scheme
   system default. There is intentionally NO page-local toggle —
   the shared header toggle is the single source of truth.
   `scope` is the html-level selector for each dark condition. */
const wwtDark = (scope) => `
${scope} .tdm-page{background:#121c24;color:#e0e8eb}
${scope} .tdm-page .tdm-hero{background:linear-gradient(180deg,#0f1a22 0%,#121c24 100%);border-bottom-color:#2a3a45}
${scope} .tdm-page .tdm-hero h1{color:#f0f4f6}
${scope} .tdm-page .tdm-hero-sub{color:#9bb0b8}
${scope} .tdm-page .tdm-search{background:#1a2733;border-color:#2a3a45;color:#e0e8eb;box-shadow:none}
${scope} .tdm-page .tdm-search::placeholder{color:#9bb0b8}
${scope} .tdm-page .tdm-search:focus{border-color:#5bbfc9;box-shadow:0 0 0 4px rgba(91,191,201,.15)}
${scope} .tdm-page .tdm-search-icon{color:#9bb0b8}
${scope} .tdm-page .tdm-results{background:#1a2733;border-color:#2a3a45;box-shadow:0 8px 30px rgba(0,0,0,.5)}
${scope} .tdm-page .tdm-result{border-bottom-color:#2a3a45}
${scope} .tdm-page .tdm-result:hover{background:#1e2a35}
${scope} .tdm-page .tdm-result strong{color:#7ecde0}
${scope} .tdm-page .tdm-result span{color:#9bb0b8}
${scope} .tdm-page .tdm-pill{background:#1a2733;border-color:#2a3a45;color:#e0e8eb}
${scope} .tdm-page .tdm-pill:hover{background:#1B4D4C;border-color:#5bbfc9;color:#fff}
${scope} .tdm-page .tdm-trust{color:#9bb0b8}
${scope} .tdm-page .tdm-trust-item svg{color:#5bbfc9}
${scope} .tdm-page .tdm-sidebar-nav{background:#1a2733;border-color:#2a3a45}
${scope} .tdm-page .tdm-sidebar-title{color:#f0f4f6;border-bottom-color:#2a3a45}
${scope} .tdm-page .tdm-sidebar-link{color:#9bb0b8}
${scope} .tdm-page .tdm-sidebar-link:hover{background:#1e2a35;color:#7ecde0}
${scope} .tdm-page .tdm-sidebar-link.active{background:#1B4D4C;color:#fff}
${scope} .tdm-page .tdm-sidebar-cta{background:#ff7a5c;color:#1a1a2e}
${scope} .tdm-page .tdm-sidebar-cta:hover{background:#ff8f75}
${scope} .tdm-page .tdm-header{background:#1a2733;border-color:#2a3a45}
${scope} .tdm-page .tdm-header:hover{background:#1e2a35}
${scope} .tdm-page .tdm-title{color:#f0f4f6}
${scope} .tdm-page .tdm-subtitle{color:#9bb0b8}
${scope} .tdm-page .tdm-toggle{color:#9bb0b8}
${scope} .tdm-page .tdm-grid{background:#162028;border-color:#2a3a45}
${scope} .tdm-page .tdm-card{background:#1a2733;border-color:#2a3a45}
${scope} .tdm-page .tdm-card:hover{border-color:#5bbfc9;box-shadow:0 4px 12px rgba(0,0,0,.4)}
${scope} .tdm-page .tdm-card-name{color:#f0f4f6}
${scope} .tdm-page .tdm-card-desc{color:#9bb0b8}
${scope} .tdm-page .tdm-btn-primary{background:#ff7a5c;color:#1a1a2e}
${scope} .tdm-page .tdm-btn-primary:hover{background:#ff8f75}
${scope} .tdm-page .tdm-btn-secondary{color:#7ecde0;border-color:#2a3a45}
${scope} .tdm-page .tdm-btn-secondary:hover{background:#1B4D4C;color:#fff;border-color:#5bbfc9}
${scope} .tdm-page .tdm-mobile-cta{background:#0f1a22;border-top-color:#2a3a45}
${scope} .tdm-page .tdm-mobile-cta a{background:#ff7a5c;color:#1a1a2e}
${scope} .tdm-page .wwtc-header{background:#1a2733;border-color:#2a3a45}
${scope} .tdm-page .wwtc-title{color:#f0f4f6}
${scope} .tdm-page .wwtc-subtitle{color:#9bb0b8}
${scope} .tdm-page .wwtc-chip{background:rgba(91,191,201,.15);border-color:rgba(91,191,201,.3);color:#7ecde0}
${scope} .tdm-page .wwtc-grid{background:#162028;border-color:#2a3a45}
${scope} .tdm-page .wwtc-tile{background:#1a2733;border-color:#2a3a45}
${scope} .tdm-page .wwtc-tile:hover{border-color:#5bbfc9;box-shadow:0 4px 12px rgba(0,0,0,.4)}
${scope} .tdm-page .wwtc-tile.open{border-color:#5bbfc9;box-shadow:0 4px 14px rgba(0,0,0,.45)}
${scope} .tdm-page .wwtc-tile-btn{color:#f0f4f6}
${scope} .tdm-page .wwtc-tile-name{color:#f0f4f6}
${scope} .tdm-page .wwtc-tile-chevron{color:#9bb0b8}
${scope} .tdm-page .wwtc-panel-desc{color:#c9d4d8}
${scope} .tdm-page .wwtc-panel-note{color:#8798a0}
${scope} .tdm-page .wwtc-tile-icon,${scope} .tdm-page .wwtc-header-icon{background:#eef2f4;border-radius:12px;box-shadow:inset 0 0 0 1px rgba(255,255,255,.04)}
${scope} .tdm-page .tdm-insurance{background:#0f1a22 !important;border-top-color:#2a3a45 !important}
${scope} .tdm-page .tdm-insurance h2{color:#f0f4f6 !important}
${scope} .tdm-page .tdm-insurance>.tdm-container>p{color:#9bb0b8 !important}
${scope} .tdm-page .tdm-insurance a[href^="/insurance/"]{background:#1a2733 !important;border-color:#2a3a45 !important}
${scope} .tdm-page .tdm-insurance a[href^="/insurance/"]>div:first-child{color:#f0f4f6 !important}
${scope} .tdm-page .tdm-insurance>.tdm-container>p:last-child a{color:#7ecde0 !important}
`;
...
.tdm-page .wwtc-panel-desc{font-size:14px;color:#4A4A4A;line-height:1.6;margin:0 0 12px}
.tdm-page .wwtc-panel-note{font-size:12.5px;color:#6A7A7E;line-height:1.4;margin:0 0 14px}
...
.tdm-page .wwtc-tile-btn{padding:9px 9px;gap:8px}
.tdm-page .wwtc-tile-icon{width:34px;height:34px}
.tdm-page .wwtc-tile-chevron{width:15px;height:15px}
.tdm-page .wwtc-tile-name{font-size:clamp(12px,3.4vw,15px)}
}
@media(max-width:380px){
.tdm-page .wwtc-tile-btn{padding:8px 8px;gap:7px}
.tdm-page .wwtc-tile-name{font-size:12px}
.tdm-page .wwtc-tile-icon{width:30px;height:30px}
.tdm-page .wwtc-tile-chevron{width:14px;height:14px}
}
...
/* ── Dark theme — single source of truth is the site-wide toggle ──
   Applies under both the explicit [data-theme="dark"] attribute and the
   prefers-color-scheme system default, exactly mirroring lib/tdmd-styles.js
   so the outer body and this page's content are always in the same mode. */
${wwtDark('html[data-theme="dark"]')}
@media (prefers-color-scheme: dark){
${wwtDark('html:not([data-theme="light"])')}
}
...
@media(prefers-reduced-motion:reduce){
.tdm-page,.tdm-page .tdm-hero,.tdm-page .tdm-search,.tdm-page .tdm-card,.tdm-page .tdm-header,.tdm-page .tdm-grid,.tdm-page .wwtc-tile,.tdm-page .wwtc-header,.tdm-page .wwtc-grid,.tdm-page .tdm-sidebar-nav{transition:none}
}
`;
