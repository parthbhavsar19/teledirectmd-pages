...
.tdm-page .wwtc-header-icon{width:44px;height:44px;flex-shrink:0;display:flex;align-items:center;justify-content:center;background:#F0F5F4;border:1px solid rgba(20,57,56,.12);border-radius:10px;color:#1B4D4C}
.tdm-page .wwtc-header-icon svg{width:24px;height:24px}
...
.tdm-page .wwtc-tile-btn{display:flex;align-items:center;gap:12px;width:100%;padding:16px;background:transparent;border:none;border-radius:12px;cursor:pointer;text-align:left;font-family:inherit;color:#143938}
.tdm-page .wwtc-tile-btn:focus-visible{outline:3px solid #2A6B6A;outline-offset:2px}
.tdm-page .wwtc-tile-icon{width:36px;height:36px;flex-shrink:0;display:flex;align-items:center;justify-content:center;background:#F0F5F4;border-radius:8px;color:#1B4D4C}
.tdm-page .wwtc-tile-icon svg{width:20px;height:20px}
...
.tdm-page .wwtc-tile-btn{padding:12px;gap:10px}
.tdm-page .wwtc-tile-icon{width:32px;height:32px}
.tdm-page .wwtc-tile-name{font-size:.95em;font-size:clamp(13px,3.6vw,15px)}
}
@media(max-width:380px){
.tdm-page .wwtc-tile-name{font-size:13px}
.tdm-page .wwtc-tile-icon{width:28px;height:28px}
.tdm-page .wwtc-tile-icon svg{width:16px;height:16px}
}
