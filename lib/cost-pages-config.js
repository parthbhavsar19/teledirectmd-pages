...
export const COST_PAGES = {
  ...
  'online-doctor-visit-cost': {
    ...
    scenarios: [
      { name: 'Maya, freelance designer (FL)', story: 'No employer insurance. Suspects a UTI. Books a $49 visit at 8pm Tuesday, sees Dr. Bhavsar at 8:20pm, picks up nitrofurantoin ($8) at the 24-hour CVS down the block. Total: $57.', save: 'Saved ~$1,500 vs. ER ($2,715 avg) and ~$210 vs. urgent care + antibiotic.' },
      { name: 'Carlos, contractor (TX)', story: 'High-deductible plan, deductible unmet. Sinus pressure for five days. Cash-paying $49 at TeleDirectMD beats his $185 in-network primary care visit before deductible.', save: 'Saved ~$135 by paying cash instead of using insurance.' },
      { name: 'Priya, retiree (NC)', story: 'Needs a routine refill of lisinopril and atorvastatin. $49 visit + $4 + $8 GoodRx generics = $61 total. Her old PCP visit ran $170 plus drive time.', save: 'Saved ~$110 and a 90-minute commute.' },
    ],
    faqs: [
  ...
  'uti-treatment-cost': {
    ...
    scenarios: [
      { name: 'Sarah, 27, no insurance (GA)', story: 'Burning, frequency since lunchtime. Books a 7pm TeleDirectMD visit, sees Dr. Bhavsar at 7:15pm, picks up nitrofurantoin ($8) at Walgreens by 8pm.', save: 'Total $57 vs. $235 average urgent care total (~$178 saved).' },
      { name: 'Mei, 34, high-deductible plan (CA)', story: 'Classic symptoms. Telehealth visit + Bactrim. Pays $49 cash because her deductible is unmet and the in-network rate would still cost more.', save: 'Total $58 vs. ~$190 in-person primary care.' },
      { name: 'Diana, 45, recurrent UTI (TX)', story: 'Third UTI in three months. Books TeleDirectMD for empirical treatment, then schedules primary care follow-up for cultures.', save: '$58 today + planned in-person workup; vs. ER ($2,000+) for symptom relief.' },
    ],
    faqs: [
  ...
  'sinus-infection-treatment-cost': {
    ...
    scenarios: [
      { name: 'James, 38, freelance (TX)', story: 'Sinus pressure for 12 days, worse this morning. Books a $49 visit; Dr. Bhavsar prescribes amoxicillin. Picks it up for $9 at Walmart pharmacy.', save: 'Total $58 vs. $215 average urgent care total.' },
      { name: 'Anita, 45, traveling (FL)', story: 'Caught sinusitis on a beach vacation. Books TeleDirectMD from her resort, fills augmentin ($18) at the local Walgreens.', save: 'Total $67; saved a day of vacation and ~$200.' },
      { name: 'Tom, 52, BCBS in-network (PA)', story: 'Aetna in-network in PA. $20 telehealth co-pay through TeleDirectMD covers the entire visit. Amoxicillin $9.', save: 'Total $29 with insurance; would have been $40 co-pay + $9 in person.' },
    ],
    faqs: [
  ...
  'sore-throat-treatment-cost': {
    ...
    scenarios: [
      { name: 'Lila, 25, no insurance (NC)', story: 'Sore throat + 102°F fever + tonsillar exudate. Books TeleDirectMD; Dr. Bhavsar treats empirically (high Centor score). Amoxicillin $9 at Walgreens.', save: 'Total $58 vs. ~$235 urgent care.' },
      { name: 'Marcus, 31, ambiguous (PA)', story: 'Mid-range symptoms. Visit + at-home rapid strep kit ($30, Amazon). Test positive, prescription waiting at pharmacy.', save: 'Total $88 vs. ~$200 urgent care.' },
      { name: 'Sofia, 28, insurance (GA)', story: 'Aetna telehealth co-pay: $20. Total visit + $9 amoxicillin = $29.', save: 'Saved a half-day; in-person was a 4-hour round trip.' },
    ],
    faqs: [
  ...
  'online-prescription-cost': {
    ...
    scenarios: [
      { name: 'Robert, 58, BP refill (OH)', story: 'On lisinopril for 3 years. Books a $49 visit; refill sent to Walmart. Pays $4 for 30-day generic.', save: 'Total $53 vs. ~$185 in-person primary care.' },
      { name: 'Diana, 41, asthma (CA)', story: 'Stable asthma on albuterol PRN. $49 visit + $22 inhaler = $71. PCP cash visit was $200 last time.', save: 'Saved ~$130 plus a 90-minute commute.' },
      { name: 'Tomás, 49, HDP (TX)', story: 'High-deductible plan. Pays $49 cash for refill instead of $135 in-network rate before deductible.', save: 'Saved $86 by paying cash.' },
    ],
    faqs: [
