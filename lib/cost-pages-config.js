...
export const COST_PAGES = {
  ...
  'strep-throat-cost': {
    ...
    heroCardItems: [
      ...
      "Available in 44 states, same-day, evenings & weekends",
    ],
    heroBenefits: [
