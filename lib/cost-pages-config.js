...
export const COST_RELATED_LINKS = {
  ...
  'pink-eye-cost': {
    relatedCost: ["ear-infection-cost","sore-throat-treatment-cost","sinus-infection-treatment-cost"],
    relatedCompare: ["teledirectmd-vs-teladoc","teledirectmd-vs-mdlive"],
  },
  'ear-infection-cost': {
    relatedCost: ["pink-eye-cost","sore-throat-treatment-cost","sinus-infection-treatment-cost"],
...
export const COST_PAGES = {
  ...
  'online-doctor-visit-cost': {
    ...
    metaTitle: "Online Doctor Visit Cost 2026: $79 vs. $150+ Urgent Care",
    metaDescription: "A $79 video visit with a board-certified MD, not an NP or PA. See 2026 cash-pay prices: TeleDirectMD $79, urgent care $150–$280, ER ~$2,715. Same-day, no insurance required, HSA/FSA accepted.",
    // 2026-08-11: metaDescription (only) rewritten to lead with the MD-only
    // differentiator instead of price. Title kept unchanged, still matching the
    // H1 word-for-word, so this is a single-variable CTR test. Live SERP check
    // (DataForSEO) shows CVS, Amazon One Medical, Walgreens, GoodRx, Sesame, and
    // UHC all headlining $19-$54 starting prices for this exact query, so "$79"
    // alone reads as expensive next to them even though $79 beats urgent care/ER.
    // "Board-certified MD only, not a mixed NP/PA pool" is the one claim in the
    // platform-comparison table below that none of those six can make. AI
    // Overview is confirmed present on this query, so being the answer the
    // overview cites (see citableSummary) matters more here than winning a rich
    // snippet slot, which no longer exists for FAQ content sitewide anyway
    ...
    whoWeHelp: {
      ...
      groups: [
        ...
        },
        {
          ...
          desc: "No need to find a new provider. One physician, all 44 states.",
        },
        {
    ...
    costPlus: {
      drug: "most common generics",
      price: "$5–$8/month",
      note: "manufacturer cost + 15% + $5 fee, no insurance required",
    },
    medicationsTable: {
    ...
    citableSummary: "According to TeleDirectMD's 2026 cost analysis, an online doctor visit costs $79 flat for a board-certified MD video visit, compared to a national telehealth average of $40–$100 (median ~$82) per <a href=\"https://www.goodrx.com/health-topic/emergency-care/how-much-is-urgent-care-without-insurance\">GoodRx (2024)</a>; unlike most telehealth apps in that average, which route patients to a mixed pool of MDs, NPs, and PAs, every TeleDirectMD visit is seen by the same board-certified physician. A 2024 Penn Medicine / JAMA Network Open study of 160,000+ episodes found telemedicine averaged $96 per episode versus $509 in-person, roughly 5× cheaper (<a href=\"https://www.pennmedicine.org/news/study-finds-telemedicine-visits-cost-far-less-than-office-visits\">Penn Medicine, 2024</a>). By comparison, urgent care averages $150–$280 (<a href=\"https://www.talktomira.com/post/how-much-does-urgent-care-cost-without-insurance\">Mira Health, 2025</a>), CVS MinuteClinic runs $99–$139 (<a href=\"https://www.cvs.com/minuteclinic/services/price-lists\">CVS 2024 price list</a>), primary care cash-pay totals $100–$200 (<a href=\"https://www.talktomira.com/post/how-much-does-primary-care-cost-without-insurance\">Mira Health, 2025</a>), and the average uninsured ER visit is ~$2,715 (<a href=\"https://www.talktomira.com/post/how-much-does-an-er-visit-cost\">Mira Health, Feb 2025</a>). With 26.7 million uninsured Americans under 65 (<a href=\"https://www.kff.org/uninsured/key-facts-about-the-uninsured-population/\">KFF, April 2026</a>), telehealth is appropriate for UTI, sinus infection, strep throat, pink eye, and stable prescription refills.",
    // costComparisonOffers powers buildCostComparisonAggregateOffer() in
    // cost-compare-schema.js. That function has existed since the schema layer
    // was built but was wired to zero of the 22 cost pages (grep count: 0) until
    // this pilot. FAQPage rich results are fully retired sitewide as of
    // 2026-05-07, so AggregateOffer is the one still-functional structured-data
    // surface left to test on this page. Values mirror costTable.rows above.
    costComparisonOffers: [
      { providerName: "TeleDirectMD", providerUrl: "https://teledirectmd.com", lowPrice: 79, highPrice: 79, description: "Board-certified MD video visit + e-prescription", availability: "https://schema.org/InStock" },
      { providerName: "Telehealth (national average)", providerUrl: "https://www.goodrx.com/health-topic/emergency-care/how-much-is-urgent-care-without-insurance", lowPrice: 40, highPrice: 100, description: "Video or phone visit; provider type varies (MD, NP, PA)" },
      { providerName: "CVS MinuteClinic", providerUrl: "https://www.cvs.com/minuteclinic/services/price-lists", lowPrice: 99, highPrice: 139, description: "In-person visit with NP or PA" },
      { providerName: "Primary care (cash-pay)", providerUrl: "https://www.talktomira.com/post/how-much-does-primary-care-cost-without-insurance", lowPrice: 100, highPrice: 200, description: "In-person visit with PCP; labs/imaging billed separately" },
      { providerName: "Urgent care (in-person)", providerUrl: "https://www.talktomira.com/post/how-much-does-urgent-care-cost-without-insurance", lowPrice: 150, highPrice: 280, description: "In-person walk-in visit; labs/X-rays add $250–$600+" },
      { providerName: "Emergency room (uninsured)", providerUrl: "https://www.talktomira.com/post/how-much-does-an-er-visit-cost", lowPrice: 1500, highPrice: 3000, description: "ED visit; chargemaster pricing, non-life-threatening range" },
    ],
  },
  ...
  'uti-treatment-cost': {
    ...
    metaTitle: "UTI Treatment Cost 2026: $85–$93 Online vs. $150+ Urgent Care",
    ...
    // costComparisonOffers powers buildCostComparisonAggregateOffer() in
    // cost-compare-schema.js. Values mirror costTable.rows above.
    costComparisonOffers: [
      { providerName: "TeleDirectMD", providerUrl: "https://teledirectmd.com", lowPrice: 85, highPrice: 93, description: "$79 visit + nitrofurantoin ($6–$14), no urinalysis required" },
      { providerName: "Telehealth (national average)", providerUrl: "https://www.goodrx.com/health-topic/emergency-care/how-much-is-urgent-care-without-insurance", lowPrice: 85, highPrice: 93, description: "Visit ($40–$100) + antibiotic ($6–$14)" },
      { providerName: "Primary care (cash-pay)", providerUrl: "https://www.talktomira.com/post/how-much-does-primary-care-cost-without-insurance", lowPrice: 110, highPrice: 265, description: "In-person visit ($100–$250) + antibiotic ($6–$14); urinalysis usually included" },
      { providerName: "Urgent care (in-person)", providerUrl: "https://www.talktomira.com/post/how-much-does-urgent-care-cost-without-insurance", lowPrice: 150, highPrice: 450, description: "Walk-in visit ($150–$430) + antibiotic ($6–$14); urinalysis often bundled" },
      { providerName: "CVS MinuteClinic", providerUrl: "https://www.cvs.com/minuteclinic/services/price-lists", lowPrice: 105, highPrice: 153, description: "NP visit ($99–$139) + antibiotic ($6–$14)" },
      { providerName: "Emergency room (uninsured)", providerUrl: "https://bettercare.com/costs/er-visit-cost", lowPrice: 1200, highPrice: 3000, description: "ED visit + labs + antibiotic; chargemaster pricing" },
    ],
    costTable: {
    ...
    decisionGuide: {
      ...
      steps: [
        ...
        },
        {
          ...
          body: "Book a $79 telehealth visit. Total cost will likely be $85–$93. Antibiotic at your pharmacy in 30 minutes.",
          good: true,
        },
        {
          num: 3,
    ...
    costPlus: {
      drug: "nitrofurantoin",
      price: "$5–$8",
      note: "cost + 15% + $5 fee, no insurance required",
    },
    medicationsTable: {
  ...
  'uti-antibiotics-cost': {
    ...
    metaTitle: "UTI Antibiotics Cost 2026: $5–$25 Generic + $79 Visit",
    ...
    faqs: [
      ...
      { question: "Can I get UTI antibiotics online same-day?", answer: "Yes. A $79 TeleDirectMD video visit typically results in an antibiotic at your pharmacy within an hour -- same-day visits available evenings and weekends in 44 states." },
  ...
  'sinus-infection-treatment-cost': {
    ...
    metaTitle: "Sinus Infection Cost 2026: $88–$99 Online vs. $160+ Urgent Care",
    ...
    heroCardItems: [
      ...
      "Same-day appointments, 44 states",
      "No insurance required",
      "Receipt for HSA/FSA",
    ],
    heroBenefits: [
    ...
    // cost-compare-schema.js. Values mirror costTable.rows above.
    costComparisonOffers: [
      { providerName: "TeleDirectMD", providerUrl: "https://teledirectmd.com", lowPrice: 88, highPrice: 99, description: "$79 visit + amoxicillin ($9–$20) when indicated" },
      { providerName: "Telehealth (national average)", providerUrl: "https://www.goodrx.com/healthcare-access/telehealth/how-much-does-telehealth-cost", lowPrice: 88, highPrice: 99, description: "Visit ($40–$90) + antibiotic ($9–$20)" },
      { providerName: "Primary care (cash-pay)", providerUrl: "https://www.talktomira.com/post/how-much-does-primary-care-cost-without-insurance", lowPrice: 110, highPrice: 270, description: "In-person visit ($100–$250) + antibiotic ($9–$20)" },
      { providerName: "Urgent care (in-person)", providerUrl: "https://www.talktomira.com/post/how-much-does-urgent-care-cost-without-insurance", lowPrice: 160, highPrice: 320, description: "Visit ($150–$300) + antibiotic; sinus X-ray adds $100+" },
      { providerName: "CVS MinuteClinic", providerUrl: "https://www.cvs.com/minuteclinic/services/price-lists", lowPrice: 108, highPrice: 159, description: "NP visit ($99–$139) + antibiotic ($9–$20)" },
      { providerName: "Emergency room (uninsured)", providerUrl: "https://www.talktomira.com/post/how-much-does-an-er-visit-cost", lowPrice: 1200, highPrice: 3000, description: "ED visit; never appropriate for routine sinus infection" },
    ],
    costTable: {
  ...
  'sore-throat-treatment-cost': {
    ...
    metaTitle: "Strep & Sore Throat Cost 2026: $88–$144 Online vs. $185+ Urgent Care",
    ...
    heroCardItems: [
      ...
      "44 states, same-day, evenings & weekends",
      "No insurance required",
      "HSA/FSA accepted",
    ],
    heroBenefits: [
    ...
    // cost-compare-schema.js. Values mirror costTable.rows above.
    costComparisonOffers: [
      { providerName: "TeleDirectMD", providerUrl: "https://teledirectmd.com", lowPrice: 88, highPrice: 144, description: "$79 visit + amoxicillin ($9–$15) ± at-home strep kit ($25–$50)" },
      { providerName: "Telehealth (national average)", providerUrl: "https://bettercare.com/costs/strep-test-cost", lowPrice: 88, highPrice: 144, description: "Visit ($40–$90) + antibiotic ($9–$15) ± at-home strep ($25–$50)" },
      { providerName: "CVS MinuteClinic", providerUrl: "https://www.cvs.com/minuteclinic/services/price-lists", lowPrice: 108, highPrice: 154, description: "NP visit ($99–$139) + strep test bundled + antibiotic ($9–$15)" },
      { providerName: "Primary care (cash-pay)", providerUrl: "https://www.talktomira.com/post/how-much-does-primary-care-cost-without-insurance", lowPrice: 135, highPrice: 315, description: "Visit ($100–$250) + strep ($25–$50) + antibiotic" },
      { providerName: "Urgent care (in-person)", providerUrl: "https://www.talktomira.com/post/how-much-does-a-strep-test-cost-at-urgent-care", lowPrice: 185, highPrice: 345, description: "Visit ($150–$280) + rapid strep ($25–$50) + antibiotic ($9–$15)" },
      { providerName: "Emergency room (uninsured)", providerUrl: "https://bettercare.com/costs/er-visit-cost", lowPrice: 500, highPrice: 2700, description: "Rarely appropriate for sore throat alone" },
    ],
    costTable: {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer: "TeleDirectMD is in-network with Aetna, BCBS, and UnitedHealthcare in select states. Self-pay $79 is available in all 44 states.",
      },
    ],
    references: [
      {
  ...
  'online-prescription-cost': {
    ...
    metaTitle: "Online Prescription Cost 2026: $83–$109 Total (Visit + Rx)",
    ...
    heroCardItems: [
      ...
      "44 states; no insurance required",
      "HSA/FSA accepted",
    ...
    // cost-compare-schema.js. Values mirror costTable.rows above.
    costComparisonOffers: [
      { providerName: "TeleDirectMD", providerUrl: "https://teledirectmd.com", lowPrice: 83, highPrice: 109, description: "$79 visit + lisinopril/atorvastatin/etc. ($4–$30)" },
      { providerName: "Telehealth (national average)", providerUrl: "https://www.venteur.com/blog/how-much-does-an-urgent-care-visit-cost-guide", lowPrice: 83, highPrice: 109, description: "Visit ($40–$90) + generic Rx ($4–$30)" },
      { providerName: "CVS MinuteClinic", providerUrl: "https://www.cvs.com/minuteclinic/services/price-lists", lowPrice: 103, highPrice: 169, description: "NP visit ($99–$139) + Rx ($4–$30)" },
      { providerName: "Primary care (cash-pay)", providerUrl: "https://www.talktomira.com/post/how-much-does-primary-care-cost-without-insurance", lowPrice: 104, highPrice: 280, description: "In-person visit ($100–$250) + Rx ($4–$30)" },
      { providerName: "Urgent care (in-person)", providerUrl: "https://www.talktomira.com/post/how-much-does-urgent-care-cost-without-insurance", lowPrice: 154, highPrice: 310, description: "Walk-in visit ($150–$280) + Rx ($4–$30)" },
      { providerName: "Without GoodRx (cash retail)", providerUrl: "https://pmc.ncbi.nlm.nih.gov/articles/PMC7859140/", lowPrice: 42, highPrice: 42, description: "Cardiovascular generics retail cash without discount" },
    ],
    costTable: {
  ...
  'pink-eye-cost': {
    ...
    metaTitle: "Pink Eye Treatment Cost 2026: $90 Online vs. $150+ Urgent Care",
    ...
    // cost-compare-schema.js. Values mirror costTable.rows above.
    costComparisonOffers: [
      { providerName: "TeleDirectMD", providerUrl: "https://teledirectmd.com", lowPrice: 90, highPrice: 91, description: "$79 visit + erythromycin ointment ($11–$12) if bacterial, no antibiotic needed for viral" },
      { providerName: "Telehealth (national average)", providerUrl: "https://www.goodrx.com/conditions/eye-infection/drugs", lowPrice: 79, highPrice: 115, description: "Visit ($40–$100) + antibiotic ointment ($11–$22) if indicated" },
      { providerName: "Primary care (cash-pay)", providerUrl: "https://www.talktomira.com/post/how-much-does-primary-care-cost-without-insurance", lowPrice: 150, highPrice: 265, description: "In-person visit ($140–$250) + ointment ($11–$12)" },
      { providerName: "Urgent care (in-person)", providerUrl: "https://bettercare.com/costs/urgent-care-vs-emergency-room-visit-cost", lowPrice: 150, highPrice: 280, description: "Walk-in visit ($140–$260) + antibiotic ointment ($11–$22)" },
      { providerName: "CVS MinuteClinic", providerUrl: "https://www.cvs.com/minuteclinic/services/price-lists", lowPrice: 110, highPrice: 151, description: "NP visit ($99–$139) + ointment ($11–$12)" },
      { providerName: "Emergency room (uninsured)", providerUrl: "https://bettercare.com/costs/urgent-care-vs-emergency-room-visit-cost", lowPrice: 300, highPrice: 400, description: "ED visit + exam; chargemaster pricing for a non-emergent condition" },
    ],
    costTable: {
  ...
  'ear-infection-cost': {
    ...
    metaTitle: "Ear Infection Cost 2026: $88–$98 Online vs. $150+ Urgent Care",
    ...
    // cost-compare-schema.js. Values mirror costTable.rows above.
    costComparisonOffers: [
      { providerName: "TeleDirectMD", providerUrl: "https://teledirectmd.com", lowPrice: 88, highPrice: 98, description: "$79 visit + amoxicillin 500mg ($9–$19), no otoscope required for otitis externa" },
      { providerName: "Telehealth (national average)", providerUrl: "https://www.goodrx.com/conditions/ear-infection/drugs", lowPrice: 55, highPrice: 120, description: "Visit ($40–$100) + antibiotic ($9–$23)" },
      { providerName: "Primary care (cash-pay)", providerUrl: "https://www.talktomira.com/post/how-much-does-primary-care-cost-without-insurance", lowPrice: 150, highPrice: 265, description: "In-person visit ($140–$250) + antibiotic ($9–$23)" },
      { providerName: "Urgent care (in-person)", providerUrl: "https://bettercare.com/costs/urgent-care-vs-emergency-room-visit-cost", lowPrice: 150, highPrice: 280, description: "Walk-in visit ($140–$260) + antibiotic ($9–$23); otoscope exam included" },
      { providerName: "CVS MinuteClinic", providerUrl: "https://www.cvs.com/minuteclinic/services/price-lists", lowPrice: 110, highPrice: 162, description: "NP visit ($99–$139) + antibiotic ($9–$23)" },
      { providerName: "Emergency room (uninsured)", providerUrl: "https://bettercare.com/costs/er-visit-cost", lowPrice: 1500, highPrice: 3000, description: "ED visit + labs + antibiotic; chargemaster pricing" },
    ],
    costTable: {
  ...
  'yeast-infection-cost': {
    ...
    metaTitle: "Yeast Infection Cost 2026: $91 Online vs. $150+ Urgent Care",
    ...
    // cost-compare-schema.js. Values mirror costTable.rows above.
    costComparisonOffers: [
      { providerName: "TeleDirectMD", providerUrl: "https://teledirectmd.com", lowPrice: 61, highPrice: 61, description: "$79 visit + fluconazole 150mg single dose ($11–$12)" },
      { providerName: "OTC miconazole/clotrimazole (self-treat)", providerUrl: "https://www.goodrx.com/conditions/vaginal-yeast-infection/drugs", lowPrice: 10, highPrice: 20, description: "7-day cream or 3-day suppository; no visit required for confirmed recurrent VVC" },
      { providerName: "Telehealth (national average)", providerUrl: "https://www.goodrx.com/fluconazole", lowPrice: 55, highPrice: 115, description: "Visit ($40–$100) + fluconazole ($11–$12)" },
      { providerName: "Primary care (cash-pay)", providerUrl: "https://www.talktomira.com/post/how-much-does-primary-care-cost-without-insurance", lowPrice: 150, highPrice: 265, description: "In-person visit ($140–$250) + fluconazole ($11–$12)" },
      { providerName: "Urgent care (in-person)", providerUrl: "https://bettercare.com/costs/urgent-care-vs-emergency-room-visit-cost", lowPrice: 150, highPrice: 280, description: "Walk-in visit ($140–$260) + fluconazole ($11–$12)" },
      { providerName: "CVS MinuteClinic", providerUrl: "https://www.cvs.com/minuteclinic/services/price-lists", lowPrice: 110, highPrice: 151, description: "NP visit ($99–$139) + fluconazole ($11–$12)" },
      { providerName: "Emergency room (uninsured)", providerUrl: "https://bettercare.com/costs/er-visit-cost", lowPrice: 1500, highPrice: 3000, description: "ED visit + exam + prescription; always the wrong setting for uncomplicated VVC" },
    ],
    costTable: {
  ...
  'bv-treatment-cost': {
    ...
    metaTitle: "BV Treatment Cost 2026: $91 Online vs. $150+ Urgent Care",
    ...
    // cost-compare-schema.js. Values mirror costTable.rows above.
    costComparisonOffers: [
      { providerName: "TeleDirectMD", providerUrl: "https://teledirectmd.com", lowPrice: 91, highPrice: 91, description: "$79 visit + metronidazole 500mg 14 tabs ($12)" },
      { providerName: "Telehealth (national average)", providerUrl: "https://www.goodrx.com/metronidazole", lowPrice: 55, highPrice: 115, description: "Visit ($40–$100) + metronidazole ($12)" },
      { providerName: "Primary care (cash-pay)", providerUrl: "https://www.talktomira.com/post/how-much-does-primary-care-cost-without-insurance", lowPrice: 150, highPrice: 265, description: "In-person visit ($140–$250) + metronidazole ($12); wet prep may be ordered" },
      { providerName: "Urgent care (in-person)", providerUrl: "https://bettercare.com/costs/urgent-care-vs-emergency-room-visit-cost", lowPrice: 150, highPrice: 280, description: "Walk-in visit ($140–$260) + metronidazole ($12); wet prep often included" },
      { providerName: "CVS MinuteClinic", providerUrl: "https://www.cvs.com/minuteclinic/services/price-lists", lowPrice: 110, highPrice: 151, description: "NP visit ($99–$139) + metronidazole ($12)" },
      { providerName: "Emergency room (uninsured)", providerUrl: "https://bettercare.com/costs/er-visit-cost", lowPrice: 1500, highPrice: 3000, description: "ED visit + pelvic exam + labs; almost never necessary for uncomplicated BV" },
    ],
    costTable: {
  ...
  'cold-sore-cost': {
    ...
    metaTitle: "Cold Sore Cost 2026: $93–$106 Online vs. $150+ Urgent Care",
    ...
    // cost-compare-schema.js. Values mirror costTable.rows above.
    costComparisonOffers: [
      { providerName: "TeleDirectMD", providerUrl: "https://teledirectmd.com", lowPrice: 93, highPrice: 106, description: "$79 visit + valacyclovir 1g (episodic 1-day course: $14; 5-day: ~$27)" },
      { providerName: "Telehealth (national average)", providerUrl: "https://www.goodrx.com/conditions/cold-sores/drugs", lowPrice: 55, highPrice: 120, description: "Visit ($40–$100) + antiviral ($14–$35)" },
      { providerName: "Primary care (cash-pay)", providerUrl: "https://www.talktomira.com/post/how-much-does-primary-care-cost-without-insurance", lowPrice: 150, highPrice: 265, description: "In-person visit ($140–$250) + antiviral ($14–$35)" },
      { providerName: "Urgent care (in-person)", providerUrl: "https://bettercare.com/costs/urgent-care-vs-emergency-room-visit-cost", lowPrice: 150, highPrice: 280, description: "Walk-in visit ($140–$260) + antiviral ($14–$35)" },
      { providerName: "CVS MinuteClinic", providerUrl: "https://www.cvs.com/minuteclinic/services/price-lists", lowPrice: 110, highPrice: 186, description: "NP visit ($99–$139) + antiviral ($14–$47)" },
      { providerName: "Emergency room (uninsured)", providerUrl: "https://bettercare.com/costs/er-visit-cost", lowPrice: 1500, highPrice: 3000, description: "ED visit; almost never appropriate for routine herpes labialis" },
    ],
    costTable: {
  ...
  'shingles-cost': {
    ...
    metaTitle: "Shingles Cost 2026: $100–$129 Online vs. $150+ Urgent Care",
    ...
    // cost-compare-schema.js. Values mirror costTable.rows above.
    costComparisonOffers: [
      { providerName: "TeleDirectMD", providerUrl: "https://teledirectmd.com", lowPrice: 100, highPrice: 129, description: "$79 visit + valacyclovir 1g 21 tabs ($21) or famciclovir 500mg 21 tabs ($28–$30)" },
      { providerName: "Telehealth (national average)", providerUrl: "https://www.goodrx.com/valacyclovir", lowPrice: 65, highPrice: 150, description: "Visit ($40–$100) + antiviral ($21–$50)" },
      { providerName: "Primary care (cash-pay)", providerUrl: "https://www.talktomira.com/post/how-much-does-primary-care-cost-without-insurance", lowPrice: 150, highPrice: 265, description: "In-person visit ($140–$250) + antiviral ($21–$50)" },
      { providerName: "Urgent care (in-person)", providerUrl: "https://bettercare.com/costs/urgent-care-vs-emergency-room-visit-cost", lowPrice: 150, highPrice: 280, description: "Walk-in visit ($140–$260) + antiviral ($21–$50)" },
      { providerName: "CVS MinuteClinic", providerUrl: "https://www.cvs.com/minuteclinic/services/price-lists", lowPrice: 120, highPrice: 189, description: "NP visit ($99–$139) + antiviral ($21–$50)" },
      { providerName: "Emergency room (uninsured)", providerUrl: "https://bettercare.com/costs/er-visit-cost", lowPrice: 1500, highPrice: 3000, description: "ED visit + exam; appropriate only for ophthalmic zoster or severe complications" },
    ],
    costTable: {
  ...
  'migraine-treatment-cost': {
    ...
    metaTitle: "Migraine Cost 2026: $95–$110 Online vs. $175+ Urgent Care",
    ...
    // cost-compare-schema.js. Values mirror costTable.rows above.
    costComparisonOffers: [
      { providerName: "TeleDirectMD", providerUrl: "https://teledirectmd.com", lowPrice: 95, highPrice: 110, description: "$79 visit + sumatriptan 50mg 9-tab ($15–$17), no imaging required" },
      { providerName: "Telehealth (national average)", providerUrl: "https://bettercare.com/costs/er-visit-cost", lowPrice: 50, highPrice: 120, description: "Visit ($40–$100) + generic triptan ($15–$25)" },
      { providerName: "Primary care (cash-pay)", providerUrl: "https://www.talktomira.com/post/how-much-does-primary-care-cost-without-insurance", lowPrice: 110, highPrice: 265, description: "In-person visit ($100–$250) + generic triptan ($15–$25)" },
      { providerName: "Urgent care (in-person)", providerUrl: "https://bettercare.com/costs/er-visit-cost", lowPrice: 175, highPrice: 350, description: "Walk-in visit ($150–$325) + triptan; anti-nausea injection may add cost" },
      { providerName: "CVS MinuteClinic", providerUrl: "https://www.cvs.com/minuteclinic/services/price-lists", lowPrice: 105, highPrice: 153, description: "NP visit ($99–$139) + generic triptan ($15–$17)" },
      { providerName: "Emergency room (uninsured)", providerUrl: "https://bettercare.com/costs/er-visit-cost", lowPrice: 1500, highPrice: 4000, description: "ED visit, IV antiemetics, possible imaging, discharge medications, chargemaster pricing" },
    ],
    costTable: {
    ...
    whoWeHelp: {
      ...
      groups: [
        ...
        {
          label: "Travelers and remote workers",
          desc: "Migraine onset while traveling? Book a visit from anywhere in 44 states, route the triptan to the nearest pharmacy.",
        },
      ],
    },
    appropriateBlock: {
  ...
  'birth-control-refills-cost': {
    ...
    // cost-compare-schema.js. Values mirror costTable.rows above.
    costComparisonOffers: [
      { providerName: "TeleDirectMD", providerUrl: "https://teledirectmd.com", lowPrice: 90, highPrice: 100, description: "$79 visit + generic OCP ($11–$21), no pelvic exam required" },
      { providerName: "Telehealth (national average)", providerUrl: "https://bettercare.com/costs/er-visit-cost", lowPrice: 50, highPrice: 120, description: "Visit ($40–$100) + generic OCP ($11–$21)" },
      { providerName: "Primary care / OB-GYN (cash-pay)", providerUrl: "https://www.talktomira.com/post/how-much-does-primary-care-cost-without-insurance", lowPrice: 150, highPrice: 300, description: "In-person visit ($135–$280) + OCP ($11–$21); Pap or pelvic may add cost" },
      { providerName: "Urgent care (in-person)", providerUrl: "https://bettercare.com/costs/er-visit-cost", lowPrice: 175, highPrice: 350, description: "Walk-in visit ($150–$325) + OCP refill" },
      { providerName: "CVS MinuteClinic", providerUrl: "https://www.cvs.com/minuteclinic/services/price-lists", lowPrice: 105, highPrice: 153, description: "NP visit ($99–$139) + OCP ($11–$21)" },
      { providerName: "Emergency room (uninsured)", providerUrl: "https://bettercare.com/costs/er-visit-cost", lowPrice: 800, highPrice: 2500, description: "ED visit + prescription; never the appropriate setting for an OCP refill" },
    ],
    costTable: {
    ...
    whoWeHelp: {
      ...
      groups: [
        ...
        },
        {
          ...
          desc: "Running out of pills while traveling or between providers during a move? Telehealth handles refills in any of 44 states.",
        },
      ],
    },
    appropriateBlock: {
      ...
      steps: [
        {
          ...
          body: "Book a $79 telehealth visit. Total cost with generic pill: about $90–$100. Same-day prescription sent to your pharmacy.",
          good: true,
        },
        {
          num: 2,
  ...
  'erectile-dysfunction-cost': {
    ...
    metaTitle: "ED Treatment Cost 2026: $90–$100 Online vs. $200+ Urologist",
    ...
    heroCardItems: [
      ...
      "44 states, evenings & weekends, discreet, private",
      "HSA/FSA accepted, no insurance required",
    ],
    heroBenefits: [
    ...
    // cost-compare-schema.js. Values mirror costTable.rows above.
    costComparisonOffers: [
      { providerName: "TeleDirectMD", providerUrl: "https://teledirectmd.com", lowPrice: 90, highPrice: 95, description: "$79 visit + generic sildenafil 100mg 10-tab ($10–$14)" },
      { providerName: "Telehealth (national average)", providerUrl: "https://bettercare.com/costs/er-visit-cost", lowPrice: 50, highPrice: 130, description: "Visit ($40–$100) + generic sildenafil or tadalafil ($10–$30)" },
      { providerName: "Primary care (cash-pay)", providerUrl: "https://www.talktomira.com/post/how-much-does-primary-care-cost-without-insurance", lowPrice: 120, highPrice: 280, description: "In-person visit ($110–$265) + generic PDE5 inhibitor ($10–$30)" },
      { providerName: "Urgent care (in-person)", providerUrl: "https://bettercare.com/costs/er-visit-cost", lowPrice: 185, highPrice: 380, description: "Walk-in visit ($175–$350) + generic medication ($10–$30)" },
      { providerName: "CVS MinuteClinic", providerUrl: "https://www.cvs.com/minuteclinic/services/price-lists", lowPrice: 109, highPrice: 160, description: "NP visit ($99–$139) + prescription, not all clinics prescribe ED medications" },
      { providerName: "Urology office (cash-pay)", providerUrl: "https://bettercare.com/costs/er-visit-cost", lowPrice: 200, highPrice: 450, description: "Specialist visit + possible labs; 4–8 week wait typical in many markets" },
    ],
    costTable: {
  ...
  'hair-loss-treatment-cost': {
    ...
    metaTitle: "Hair Loss Treatment Cost 2026: $64/Month Online vs. $200+ Derm",
    ...
    heroSub: "Generic finasteride 1mg is $14.93/month. Minoxidil 5% foam is $9.98/month. The $79 telehealth visit handles the evaluation and prescription, total combination therapy about $25/month, which is what the evidence supports.",
    ...
    // cost-compare-schema.js. Values mirror costTable.rows above.
    costComparisonOffers: [
      { providerName: "TeleDirectMD", providerUrl: "https://teledirectmd.com", lowPrice: 74, highPrice: 74, description: "$79 visit (first month) + finasteride $14.93 + minoxidil foam $9.98" },
      { providerName: "Telehealth (national average)", providerUrl: "https://bettercare.com/costs/er-visit-cost", lowPrice: 65, highPrice: 130, description: "Visit ($40–$100) + finasteride + minoxidil ($25/month ongoing)" },
      { providerName: "Primary care (cash-pay)", providerUrl: "https://www.talktomira.com/post/how-much-does-primary-care-cost-without-insurance", lowPrice: 135, highPrice: 290, description: "In-person visit ($110–$265) + generics ($25/month ongoing)" },
      { providerName: "Urgent care (in-person)", providerUrl: "https://bettercare.com/costs/er-visit-cost", lowPrice: 200, highPrice: 375, description: "Walk-in visit, most urgent care clinics do not prescribe finasteride; referral typical" },
      { providerName: "CVS MinuteClinic", providerUrl: "https://www.cvs.com/minuteclinic/services/price-lists", lowPrice: 105, highPrice: 153, description: "NP visit, MinuteClinic may not prescribe finasteride; topical minoxidil OTC always available" },
      { providerName: "Dermatology (cash-pay)", providerUrl: "https://bettercare.com/costs/er-visit-cost", lowPrice: 200, highPrice: 500, description: "Specialist visit + possible scalp biopsy; medications extra, often 6–12 week wait" },
    ],
    costTable: {
  ...
  'weight-loss-glp1-cost': {
    ...
    metaTitle: "GLP-1 Cost 2026: Wegovy $1,350/Mo, Zepbound $1,271 + Cheaper",
    ...
    heroCardItems: [
      ...
      "HSA/FSA accepted, 44 states, same-day availability",
    ],
    heroBenefits: [
    ...
    // cost-compare-schema.js. Values mirror costTable.rows above.
    costComparisonOffers: [
      { providerName: "TeleDirectMD", providerUrl: "https://teledirectmd.com", lowPrice: 79, highPrice: 79, description: "Obesity evaluation, PA navigation, lifestyle counseling, metformin Rx if appropriate, GLP-1 drug cost separate" },
      { providerName: "Wegovy (semaglutide), cash-pay", providerUrl: "https://www.goodrx.com/wegovy", lowPrice: 1350, highPrice: 1640, description: "Retail list price; GoodRx savings program: $199–$349/month (introductory/ongoing)" },
      { providerName: "Zepbound (tirzepatide), cash-pay", providerUrl: "https://www.goodrx.com/zepbound", lowPrice: 1271, highPrice: 1271, description: "Retail list price; GoodRx: ~$995/month with coupon" },
      { providerName: "Metformin (ADA first-line alternative)", providerUrl: "https://www.goodrx.com/metformin", lowPrice: 5.75, highPrice: 9, description: "Generic 500mg–1000mg, 60–180 tablets, first-line ADA 2026 therapy for T2DM + weight management" },
      { providerName: "Primary care weight management (cash-pay)", providerUrl: "https://www.talktomira.com/post/how-much-does-primary-care-cost-without-insurance", lowPrice: 110, highPrice: 265, description: "In-person consultation; GLP-1 Rx requires PA regardless of visit type" },
      { providerName: "Emergency room (obesity complication)", providerUrl: "https://bettercare.com/costs/er-visit-cost", lowPrice: 1500, highPrice: 5000, description: "Not applicable for routine weight management, listed as context for complications" },
    ],
    costTable: {
    ...
    costPlus: {
      drug: "Wegovy / Zepbound",
      price: null,
      note: "not carried — brand-only GLP-1",
    },
    medicationsTable: {
  ...
  'diabetes-refills-cost': {
    ...
    metaTitle: "Diabetes Refill Cost 2026: Metformin $5.75/Month + $79 Visit",
    ...
    heroCardItems: [
      ...
      "HSA/FSA accepted, 44 states, evenings & weekends",
    ],
    heroBenefits: [
    ...
    // cost-compare-schema.js. Values mirror costTable.rows above.
    costComparisonOffers: [
      { providerName: "TeleDirectMD", providerUrl: "https://teledirectmd.com", lowPrice: 55, highPrice: 64, description: "$79 visit + metformin ($5.75–$9), SGLT-2 inhibitor refill at same visit if applicable" },
      { providerName: "Telehealth (national average)", providerUrl: "https://bettercare.com/costs/er-visit-cost", lowPrice: 85, highPrice: 93, description: "Visit ($40–$100) + metformin ($5.75–$9)" },
      { providerName: "Primary care (cash-pay)", providerUrl: "https://www.talktomira.com/post/how-much-does-primary-care-cost-without-insurance", lowPrice: 115, highPrice: 275, description: "In-person visit ($110–$265) + metformin ($5.75–$9); A1C lab may add $20–$50" },
      { providerName: "Urgent care (in-person)", providerUrl: "https://bettercare.com/costs/er-visit-cost", lowPrice: 180, highPrice: 360, description: "Not the appropriate setting for stable diabetes refills; listed for context" },
      { providerName: "CVS MinuteClinic", providerUrl: "https://www.cvs.com/minuteclinic/services/price-lists", lowPrice: 105, highPrice: 153, description: "NP visit; MinuteClinic handles simple refills including diabetes medications" },
      { providerName: "Endocrinologist (cash-pay)", providerUrl: "https://bettercare.com/costs/er-visit-cost", lowPrice: 200, highPrice: 400, description: "Specialist visit; typically 6–12 week wait; medications cost same regardless of prescriber" },
    ],
    costTable: {
    ...
    costPlus: {
      ...
      price: "$5–$7 / 90 days",
      note: "cost + 15% + $5 fee, no insurance required (Jardiance and insulin not carried)",
    },
    medicationsTable: {
    ...
    faqs: [
      {
        ...
        answer: "It depends sharply on which medication. Generic metformin, the ADA's 2026 first-line recommendation, costs as little as $5.75–$9/month via GoodRx (April 2026). A telehealth refill visit is $79, total about $85–$88. SGLT-2 inhibitors are more expensive: Jardiance 10mg runs ~$355/month and Farxiga 10mg ~$288/month with GoodRx coupons. Civica Rx biosimilar insulin is now available at ≤$30/vial as of January 2026.",
      },
      {
  ...
  'acne-treatment-cost': {
    ...
    metaTitle: "Acne Treatment Cost 2026: $90–$108 Online vs. $150+ Derm",
    ...
    // cost-compare-schema.js. Values mirror costTable.rows above.
    costComparisonOffers: [
      { providerName: "TeleDirectMD", providerUrl: "https://teledirectmd.com", lowPrice: 89, highPrice: 145, description: "$79 visit + adapalene ($10.75) or tretinoin ($29) ± doxycycline ($13–$17)" },
      { providerName: "Telehealth (national average)", providerUrl: "https://www.goodrx.com/conditions/acne/drugs", lowPrice: 55, highPrice: 150, description: "Visit ($40–$100) + topical retinoid or antibiotic ($10–$50)" },
      { providerName: "Primary care (cash-pay)", providerUrl: "https://www.talktomira.com/post/how-much-does-primary-care-cost-without-insurance", lowPrice: 110, highPrice: 280, description: "In-person visit ($100–$250) + generic topical Rx ($10–$30)" },
      { providerName: "Urgent care (in-person)", providerUrl: "https://bettercare.com/costs/er-visit-cost", lowPrice: 160, highPrice: 340, description: "Walk-in visit ($150–$320) + antibiotic ($10–$20); limited derm scope" },
      { providerName: "CVS MinuteClinic", providerUrl: "https://www.cvs.com/minuteclinic/services/price-lists", lowPrice: 110, highPrice: 165, description: "NP visit ($99–$139) + generic topical ($10–$25)" },
      { providerName: "Emergency room (uninsured)", providerUrl: "https://bettercare.com/costs/er-visit-cost", lowPrice: 900, highPrice: 2500, description: "ED visit; acne is not an emergency, avoid unless severe systemic reaction" },
    ],
    costTable: {
    ...
    decisionGuide: {
      ...
      steps: [
        ...
        },
        {
          ...
          body: "Book a $79 telehealth visit. You'll likely leave with an adapalene or tretinoin prescription plus a benzoyl peroxide regimen, AAD first-line therapy, for about $90–$108 total.",
          good: true,
        },
        {
          num: 3,
  ...
  'eczema-treatment-cost': {
    ...
    metaTitle: "Eczema Treatment Cost 2026: $88–$99 Online vs. $150+ Derm",
    ...
    // cost-compare-schema.js. Values mirror costTable.rows above.
    costComparisonOffers: [
      { providerName: "TeleDirectMD", providerUrl: "https://teledirectmd.com", lowPrice: 88, highPrice: 167, description: "$79 visit + triamcinolone ($9.19) or hydrocortisone ($10.71) or tacrolimus ($35–$88)" },
      { providerName: "Telehealth (national average)", providerUrl: "https://www.goodrx.com/conditions/atopic-dermatitis/drugs", lowPrice: 55, highPrice: 150, description: "Visit ($40–$100) + topical corticosteroid ($9–$30)" },
      { providerName: "Primary care (cash-pay)", providerUrl: "https://www.talktomira.com/post/how-much-does-primary-care-cost-without-insurance", lowPrice: 110, highPrice: 280, description: "In-person visit ($100–$250) + generic topical Rx ($9–$30)" },
      { providerName: "Urgent care (in-person)", providerUrl: "https://bettercare.com/costs/er-visit-cost", lowPrice: 160, highPrice: 340, description: "Walk-in visit ($150–$320) + topical steroid ($9–$30); limited derm expertise" },
      { providerName: "CVS MinuteClinic", providerUrl: "https://www.cvs.com/minuteclinic/services/price-lists", lowPrice: 108, highPrice: 169, description: "NP visit ($99–$139) + topical steroid ($9–$30)" },
      { providerName: "Emergency room (uninsured)", providerUrl: "https://bettercare.com/costs/er-visit-cost", lowPrice: 900, highPrice: 2500, description: "ED visit; appropriate only for severe infection (cellulitis), not routine eczema flares" },
    ],
    costTable: {
  ...
  'seasonal-allergies-cost': {
    ...
    metaTitle: "Seasonal Allergies Cost 2026: $94 Online vs. $150+ Urgent Care",
    ...
    // cost-compare-schema.js. Values mirror costTable.rows above.
    costComparisonOffers: [
      { providerName: "TeleDirectMD", providerUrl: "https://teledirectmd.com", lowPrice: 63, highPrice: 80, description: "$79 visit + prescription fluticasone ($14.67) or nasal steroid/antihistamine combo" },
      { providerName: "OTC self-treatment (no visit)", providerUrl: "https://www.goodrx.com/loratadine", lowPrice: 5, highPrice: 30, description: "Loratadine $4.97/30 tabs, cetirizine $8.70/30 tabs, Flonase OTC ~$18–$30; no prescription needed" },
      { providerName: "Primary care (cash-pay)", providerUrl: "https://www.talktomira.com/post/how-much-does-primary-care-cost-without-insurance", lowPrice: 120, highPrice: 280, description: "In-person visit ($100–$250) + prescription allergy Rx ($5–$30)" },
      { providerName: "Urgent care (in-person)", providerUrl: "https://bettercare.com/costs/er-visit-cost", lowPrice: 165, highPrice: 350, description: "Walk-in visit ($150–$320) + allergy medication" },
      { providerName: "CVS MinuteClinic", providerUrl: "https://www.cvs.com/minuteclinic/services/price-lists", lowPrice: 104, highPrice: 169, description: "NP visit ($99–$139) + allergy prescription ($5–$30)" },
      { providerName: "Allergist / specialist (cash-pay)", providerUrl: "https://bettercare.com/costs/er-visit-cost", lowPrice: 200, highPrice: 400, description: "Consultation + possible allergy testing; immunotherapy ($800–$4,000+/year) separate" },
    ],
    costTable: {
  ...
  'covid-19-treatment-cost': {
    ...
    metaTitle: "Paxlovid Cost 2026: $1,390 Retail, Free via PAXCESS + $79 Visit",
    ...
    // cost-compare-schema.js. Values mirror costTable.rows above.
    costComparisonOffers: [
      { providerName: "TeleDirectMD", providerUrl: "https://teledirectmd.com", lowPrice: 79, highPrice: 79, description: "$79 visit + Paxlovid free via PAXCESS (eligible pts) or $1,390–$1,447 retail" },
      { providerName: "Telehealth (national average)", providerUrl: "https://www.goodrx.com/paxlovid/how-much-paxlovid-costs-without-insurance", lowPrice: 40, highPrice: 100, description: "Visit varies by platform; Paxlovid cost independent of visit channel" },
      { providerName: "Primary care (cash-pay)", providerUrl: "https://www.talktomira.com/post/how-much-does-primary-care-cost-without-insurance", lowPrice: 110, highPrice: 265, description: "In-person evaluation; Paxlovid Rx same cost as above" },
      { providerName: "Urgent care (in-person)", providerUrl: "https://bettercare.com/costs/er-visit-cost", lowPrice: 160, highPrice: 320, description: "Walk-in COVID evaluation; rapid test often bundled" },
      { providerName: "CVS MinuteClinic", providerUrl: "https://www.cvs.com/minuteclinic/services/price-lists", lowPrice: 99, highPrice: 139, description: "NP COVID evaluation; Paxlovid prescription if eligible" },
      { providerName: "Emergency room (uninsured)", providerUrl: "https://bettercare.com/costs/er-visit-cost", lowPrice: 1200, highPrice: 3000, description: "ED visit + testing; appropriate only for severe COVID (hypoxia, respiratory distress)" },
    ],
    costTable: {
    ...
    costPlus: {
      drug: "Paxlovid",
      price: null,
      note: "not carried — brand-only antiviral",
    },
    medicationsTable: {
