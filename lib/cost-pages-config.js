...
export const COST_PAGES = {
  ...
  'online-doctor-visit-cost': {
    ...
    heroSub: "A board-certified MD video visit for $79 flat. No insurance needed. We compared 2026 cash-pay prices across every common care setting — here's what you'll actually pay.",
  ...
  'uti-treatment-cost': {
    ...
    metaDescription: "A telehealth UTI visit + antibiotic costs $85–$93 total. Urgent care runs $160–$320; an ER UTI visit can hit $3,000+. Verified 2026 prices with sources.",
    ...
    faqs: [
      {
        ...
        answer: "Telehealth: $85–$93 total (visit + generic antibiotic). Urgent care in-person: $160–$320. ER: $1,200–$3,000+. The ER is rarely appropriate for a routine UTI.",
      },
      {
  ...
  'sore-throat-treatment-cost': {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer: "TeleDirectMD is in-network with Aetna, BCBS, and UnitedHealthcare in select states. Self-pay $79 is available in all 41 states.",
      },
    ],
    references: [
      {
