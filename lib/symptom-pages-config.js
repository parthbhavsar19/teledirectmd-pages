...
export const COST_TABLE_ROWS = [
  ...
  { setting: 'TeleDirectMD',                    range: '$79 flat',        note: 'Same-day video visit; meds via GoodRx.' },
];
...
SYMPTOM_PAGES["persistent-cough"] = {
  ...
  metaDescription: `A cough lasting 3+ weeks is most often post-infectious bronchitis, asthma, GERD, or postnasal drip. $79 telehealth visit; same-day evaluation in 43 states.`,
  breadcrumb: `Cough That Won't Go Away`,
  answerLead: `Cough lasting 3+ weeks — what it usually means:`,
  answerBody: `A cough that won't go away is most commonly <strong>post-infectious bronchitis</strong>, <strong>undertreated asthma or cough-variant asthma</strong>, <strong>GERD with reflux cough</strong>, or <strong>upper-airway cough syndrome (postnasal drip)</strong>. Together those four account for the vast majority of subacute and chronic cough in adult non-smokers per <a href="https://www.aafp.org/pubs/afp/issues/2017/1101/p575.html">AAFP guidance</a>. A $79 TeleDirectMD video visit with a board-certified family-medicine MD distinguishes among them in 10–15 minutes; most patients receive a treatment plan and prescription same day.`,
  symptomDef: {
    altNames: [
      `Chronic cough`,
      `Subacute cough`,
  ...
  eligibility: [
    `You are 18 or older and located in one of TeleDirectMD's 43 licensed states at the time of the visit`,
  ...
  faqs: [
    ...
    },
    {
      ...
      answer: `Yes. Asthma and cough-variant asthma are within scope. Albuterol prescriptions, inhaled steroid trials, and step-up therapy are all available through a $79 video visit. Patients with frequent exacerbations or hospitalizations need in-person pulmonology.`
    },
    {
    ...
    },
    {
      ...
      answer: `$79 flat at TeleDirectMD. Compare to $150–$280 cash-pay urgent care or roughly $2,715 average uninsured ER visit per Mira Health 2025 data. Inhaler costs vary by formulation; see medication table.`
    },
    {
    ...
    },
    {
      ...
      answer: `Yes. Same-day refills of albuterol, fluticasone, budesonide-formoterol (Symbicort), and tiotropium (Spiriva) for stable asthma or chronic cough are routine $79 visits. New asthma diagnoses with frequent exacerbations need in-person evaluation.`
    },
    {
...
SYMPTOM_PAGES["sore-throat"] = {
  ...
  metaDescription: `Sore throat lasting 5+ days is often viral pharyngitis, strep, mononucleosis, or postnasal drip. $79 video visit; amoxicillin prescribed if strep. 43 states.`,
  breadcrumb: `Sore Throat That Won't Go Away`,
  answerLead: `Sore throat lasting 5+ days — what it usually is:`,
  answerBody: `A persistent sore throat is most often <strong>viral pharyngitis</strong> (70–85% of adult cases), <strong>group A streptococcal pharyngitis</strong> (5–15% of adult cases per <a href="https://www.idsociety.org/practice-guideline/strep-throat/">IDSA guidelines</a>), or <strong>infectious mononucleosis</strong>. A $79 TeleDirectMD video visit applies the modified Centor criteria, looks at the throat, and decides who needs amoxicillin (~ (see medication table)) and who needs supportive care alone.`,
  symptomDef: {
    altNames: [
      `Pharyngitis`,
      `Tonsillitis`,
  ...
  eligibility: [
    `Adult age 18 or older located in one of the 43 licensed states at the time of the visit`,
  ...
  faqs: [
    ...
    },
    {
      ...
      answer: `$79 at TeleDirectMD; antibiotic (see medication table); total $58–$64. Compare to $185–$345 at urgent care including the strep test, or $99–$139 at CVS MinuteClinic per their public price list.`
    },
    {
      question: `Can I just take leftover antibiotics from a previous infection?`,
      answer: `Strongly discouraged. Partial courses fuel resistance, and the leftover antibiotic may not match the current pathogen. A 10-minute $79 visit gets you the right drug, the right dose, and the right duration.`
    },
    {
...
SYMPTOM_PAGES["acne-breakout"] = {
  ...
  eligibility: [
    `Adult age 18 or older located in one of 43 licensed states`,
  ...
  faqs: [
    ...
    },
    {
      ...
      answer: `Yes. TeleDirectMD's $79 visit covers tretinoin 0.025% to 0.1% for chronic acne. Generic tretinoin runs (see medication table). Brand-name Retin-A, Altreno, or Atralin can run $200+ even with insurance. Most patients use generic cream successfully.`
    },
    {
    ...
    },
    {
      ...
      answer: `$79 for the TeleDirectMD visit. Generic tretinoin: $24–$70/month. Generic doxycycline: $15/month. Spironolactone: $10–$30/month. Most patients on combinations spend (see medication table) — far less than a single in-person derm visit.`
    },
    {
    ...
    },
    {
      ...
      answer: `Yes. Most patients booking before 6 PM get a same-day prescription sent to their pharmacy. Photos uploaded with the booking speed the visit. Refills for stable acne therapy are routine $79 visits.`
    },
    {
...
SYMPTOM_PAGES["burning-urination"] = {
  ...
  eligibility: [
    ...
    `Located in one of the 43 licensed states`,
  ...
  faqs: [
    ...
    },
    {
      ...
      answer: `Yes. For uncomplicated lower UTI in adult, non-pregnant women, antibiotics like nitrofurantoin or Bactrim DS are prescribed empirically after a $79 video visit. Same-day to your pharmacy of choice.`
    },
    {
    ...
    },
    {
      ...
      answer: `Total $80–$145: $79 visit + low-cost generic antibiotics (see medication table). Compare to $160–$320 urgent care and $1,200–$3,000+ ER per BetterCare 2025.`
    },
    {
...
SYMPTOM_PAGES["allergy-symptoms"] = {
  ...
  metaDescription: `Itchy eyes + runny nose without fever is usually allergic rhinitis. Prescription antihistamines, nasal steroids, and eye drops via $79 telehealth visit. 43 states.`,
  breadcrumb: `Itchy Eyes and Runny Nose`,
  answerLead: `Itchy eyes and runny nose — what it usually is:`,
  answerBody: `Itchy eyes plus a clear runny nose without fever is most often <strong>allergic rhinitis</strong> (hay fever) per <a href="https://acaai.org/allergies/allergic-conditions/hay-fever/">ACAAI guidance</a>. Prescription nasal steroids (fluticasone), oral antihistamines (cetirizine, levocetirizine), and prescription antihistamine eye drops resolve symptoms for most patients. <strong>$79 telehealth visit</strong>; generics (see medication table).`,
  symptomDef: {
    altNames: [
      `Allergic rhinitis`,
      `Hay fever`,
  ...
  faqs: [
    ...
    },
    {
      ...
      answer: `Yes. TeleDirectMD's $79 visit covers prescription antihistamines (levocetirizine, fexofenadine), nasal steroids (fluticasone, mometasone, Dymista), and antihistamine eye drops. Most generics are (see medication table).`
    },
    {
    ...
    },
    {
      ...
      answer: `$79 for the visit. Add low-cost generic prescriptions (see medication table); total typically $54–$74. Compare to $150–$280 cash-pay urgent care or $300+ for an allergist visit.`
    },
    {
    ...
    },
    {
      ...
      answer: `Yes. Olopatadine 0.7% (Pataday once-daily) and ketotifen are now OTC. Stronger prescription drops (azelastine, alcaftadine) are still prescription-only and can be sent same-day after a $79 visit.`
    },
    {
...
SYMPTOM_PAGES["strep-throat"] = {
  ...
  faqs: [
    ...
    },
    {
      ...
      answer: `$79 visit + $9 amoxicillin = $58 total. With at-home strep test: ~$88. Compare to $185–$345 urgent care per Mira Health 2025 or $99–$139 at CVS MinuteClinic.`
    },
    {
...
SYMPTOM_PAGES["cystic-acne"] = {
  ...
  metaDescription: `Pimples that don't respond to OTC for 8+ weeks usually need prescription tretinoin, oral antibiotics, or hormonal therapy. $79 telehealth visit.`,
  breadcrumb: `Cystic Acne`,
  answerLead: `Persistent pimples that won't clear — what's likely going on:`,
  answerBody: `Pimples that don't respond to OTC for 8+ weeks are usually <strong>moderate-to-severe inflammatory acne</strong>, <strong>cystic acne</strong>, or <strong>hormonal acne</strong>. Per <a href="https://www.aad.org/member/clinical-quality/guidelines/acne">AAD 2024 acne guidelines</a>, these need prescription topicals (tretinoin, adapalene), oral antibiotics, hormonal therapy, or — for severe scarring — isotretinoin via in-person dermatology. A $79 TeleDirectMD visit grades severity and starts treatment same day.`,
  symptomDef: {
    altNames: [
      `Nodulocystic acne`,
  ...
  eligibility: [
    `Adult age 18+ in one of 43 licensed states`,
    `Mild, moderate, or early-severe acne`,
  ...
  faqs: [
    ...
    },
    {
      ...
      answer: `Most generics are cheaper with GoodRx than insurance copays. Tretinoin: $24–$70. Doxycycline: $15. Spironolactone: $10–$30. Visit: $79 cash or in-network with Aetna/BCBS/UHC.`
    },
    {
...
SYMPTOM_PAGES["sinus-pressure"] = {
  ...
  metaDescription: `Sinus pressure persisting >10 days, worsening after improvement, or with face pain often signals bacterial sinusitis. Same-day $79 telehealth visit.`,
  ...
  eligibility: [
    `Adults 18+ in any of our 43 states`,
  ...
  faqs: [
    ...
    {
      question: `How is the $79 visit cheaper than urgent care?`,
      answer: `Urgent care averages $280 per visit (Mira Health data); ER averages $2,715. Our $79 cash-pay visit covers the consult, prescriptions sent the same day, and a 48-hour follow-up message. No facility fee, no waiting room, no surprise bills.`
    }
  ],
  relatedSymptoms: [
    `sinus-infection`,
...
SYMPTOM_PAGES["bronchitis"] = {
  ...
  metaDescription: `Productive cough lasting 2–3 weeks with chest tightness is usually viral acute bronchitis — antibiotics rarely help. $79 telehealth visit rules out pneumonia and asthma flare.`,
  ...
  faqs: [
    ...
    {
      question: `Why is the $79 telehealth visit cheaper?`,
      answer: `Average urgent care visit: ~$280. Average ER visit: ~$2,715. Average primary care: ~$171 (Mira Health data). Our flat $79 cash-pay visit covers the consult, prescriptions sent same day, and a 48-hour message follow-up. No facility fees, no surprise bills.`
    }
  ],
  relatedSymptoms: [
    `persistent-cough`,
...
SYMPTOM_PAGES["yeast-infection"] = {
  ...
  metaDescription: `Itching, thick white discharge, burning? Most uncomplicated yeast infections treat with one fluconazole pill or 1–7 day topical. $79 telehealth visit, prescription same day.`,
  ...
  faqs: [
    ...
    },
    {
      ...
      answer: `That's reasonable for classic recurrent symptoms you've had before. But about 33% of women who self-diagnose yeast actually have BV, trichomoniasis, or contact dermatitis — those won't respond to Monistat. A $79 telehealth visit lets us confirm and treat correctly the first time.`
    },
    {
    ...
    {
      question: `Can the $79 visit cover prescriptions for both me and my partner?`,
    ...
    },
    {
      ...
      answer: `Urgent care averages $280 (Mira Health). A primary care visit averages $171. Our $79 telehealth visit handles uncomplicated VVC just as effectively — same first-line medication, same 24-hour symptom relief — with no waiting room or facility fee.`
    }
  ],
  relatedSymptoms: [
    `burning-urination`,
...
SYMPTOM_PAGES["erectile-dysfunction"] = {
  ...
  metaDescription: `Trouble getting or keeping an erection? Generic sildenafil from $0.50/pill, tadalafil daily option. $79 telehealth, real doctor, prescription same day in 43 states.`,
  ...
  faqs: [
    ...
    {
      question: `How does the $79 visit compare to other telehealth ED services?`,
      answer: `Many ED-only telehealth services charge $30–$60/visit PLUS expensive bundled medication ($60–$200/month). With us, the $79 visit goes through a real GA-licensed physician, and you fill the prescription at YOUR pharmacy with GoodRx — generic sildenafil at $0.50/pill saves hundreds per year.`
    }
  ],
  relatedSymptoms: [],
  references: [
...
SYMPTOM_PAGES["acid-reflux"] = {
  ...
  metaDescription: `Burning chest pain, regurgitation, sour taste? Most acid reflux responds to lifestyle change + omeprazole/pantoprazole. $79 telehealth, prescription same day in 43 states.`,
  ...
  faqs: [
    ...
    {
      question: `Is the $79 telehealth visit a good fit for ongoing GERD care?`,
...
SYMPTOM_PAGES["pink-eye"] = {
  ...
  metaDescription: `Red, watery, sticky eye? Most pink eye is viral and self-limited; bacterial cases need antibiotic drops. $79 telehealth visit, prescription same day in 43 states.`,
  breadcrumb: `Pink Eye`,
  ...
  eligibility: [
    `Adults and children (with parent) in our 43 states`,
  ...
  faqs: [
    ...
    {
      question: `How does the $79 visit compare to urgent care?`,
      answer: `Urgent care averages $280 (Mira Health). Our $79 telehealth visit handles most uncomplicated conjunctivitis cases — same first-line drops, same school/work note, no waiting room. We escalate to in-person if vision changes or red flags develop.`
    }
  ],
  relatedSymptoms: [
    `allergy-symptoms`,
...
SYMPTOM_PAGES["migraine"] = {
  ...
  metaDescription: `Throbbing one-sided headache with light sensitivity? Most migraines respond to triptans. $79 telehealth visit, sumatriptan or rizatriptan prescription same day in 43 states.`,
  breadcrumb: `Migraine`,
  ...
  faqs: [
    ...
    {
      question: `How does the $79 visit compare to a neurologist?`,
...
SYMPTOM_PAGES["ear-pain"] = {
  ...
  metaDescription: `Adult ear pain, fullness, or hearing change? Get evaluated for middle/outer ear infection or eustachian tube issue. $79 telehealth, prescription same day in 43 states.`,
  breadcrumb: `Ear Pain`,
  ...
  eligibility: [
    `Adults and adolescents in our 43 states`,
  ...
  faqs: [
    ...
    {
      question: `How does the $79 visit compare to urgent care?`,
      answer: `Urgent care averages $280 (Mira Health). Our $79 telehealth visit handles most adult ear pain — same first-line drops or antibiotics, prescriptions sent same day. We escalate to in-person if exam is needed or red flags present.`
    }
  ],
  relatedSymptoms: [
    `sinus-pressure`,
...
SYMPTOM_PAGES["sinus-infection"] = {
  ...
  metaDescription: `Sinus infection lasting 10+ days, double-worsening pattern, or severe symptoms? Same-day antibiotic prescription if criteria met. $79 telehealth, 43 states.`,
  ...
  faqs: [
    ...
    {
      question: `How does the $79 visit compare to urgent care or PCP?`,
      answer: `Urgent care: ~$280; PCP: ~$171; ER: ~$2,715 (Mira Health). Our $79 telehealth visit handles uncomplicated sinusitis efficiently — same first-line antibiotics, prescription same day, no waiting room. We escalate to in-person for red flags or complications.`
    }
  ],
  relatedSymptoms: [
    `sinus-pressure`,
...
SYMPTOM_PAGES["cold-sore"] = {
  ...
  metaDescription: `Tingling lip, blister forming? Antivirals work best within 48 hours. Same-day valacyclovir or acyclovir prescription via $79 telehealth visit in 43 states.`,
  ...
  faqs: [
    ...
    {
      question: `How does the $79 visit save me money?`,
      answer: `Compared to urgent care ($280) or PCP visit ($171), our $79 telehealth visit handles cold sores efficiently — same antiviral options, prescribed within an hour, no waiting room. Generic valacyclovir is (see medication table).`
    }
  ],
  relatedSymptoms: [],
  references: [
...
SYMPTOM_PAGES["birth-control"] = {
  ...
  metaDescription: `Get a same-day birth control prescription via $79 telehealth — pill, patch, or ring. CDC MEC-screened, sent to your pharmacy in 43 states.`,
  ...
  faqs: [
    ...
    {
      question: `How does the $79 visit compare to other birth control services?`,
      answer: `Many telehealth-only contraception services charge $20–$60/visit but tie you to their pharmacy. Our $79 visit goes through a real GA-licensed physician, you fill the prescription at YOUR pharmacy, and generic pills are often $0 with insurance or (see medication table).`
    }
  ],
  relatedSymptoms: [],
  references: [
...
SYMPTOM_PAGES["skin-rash"] = {
  ...
  metaDescription: `Itchy red rash from contact, eczema, allergies, or fungal infection? $79 video visit, photo evaluation, prescription same day in 43 states.`,
  ...
  eligibility: [
    `Adults and children in our 43 states`,
  ...
  faqs: [
    ...
    {
      question: `How does the $79 visit save vs. dermatology?`,
...
SYMPTOM_PAGES["asthma"] = {
  ...
  metaDescription: `Wheezing, chest tightness, or out of asthma inhaler? Same-day refill of albuterol, ICS, or ICS-LABA via $79 telehealth visit in 43 states.`,
  breadcrumb: `Asthma`,
  ...
  eligibility: [
    `Adults and adolescents with established asthma in our 43 states`,
  ...
  faqs: [
    ...
    {
      question: `How does the $79 telehealth visit compare to specialist care?`,
