  ...
  scenarios: [
    {
      ...
      story: `Cough since January despite no fever. $49 visit at 7pm; Dr. Bhavsar identified post-viral hyperreactivity and prescribed albuterol HFA (see medication table). Cough resolved in 10 days.`,
      save: `Total $71 vs. ~$215 in-person urgent care.`
    },
    {
      name: `Diego — reflux cough (FL)`,
      story: `Worse cough at night for 6 weeks; throat clearing; sour taste. Visit identified GERD pattern; started omeprazole (see medication table) plus head-of-bed elevation. Cough gone in 3 weeks.`,
  ...
  scenarios: [
    {
      ...
      save: `Telehealth visit; sildenafil 50 mg trial. Worked at first attempt. Generic price (see medication table). Lifestyle plan added. Avoided in-person urology referral wait time.`
    },
    {
