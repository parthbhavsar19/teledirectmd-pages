...
export function generateNationalJsonLd(condition) {
  ...
  graph.push({
    ...
    "speakable": {
      ...
      "cssSelector": [
        "h1",
        ".tdmd-hero-sub",
        `#${condition.conditionSlug}-quick-answer`,
        `#${condition.conditionSlug}-quick-answer p`,
  ...
  graph.push({
    ...
    "description": `Book a same-day video visit with a licensed MD for ${condition.conditionName} — available in 44 states + DC, no waiting room, starting at $79.`,
    "totalTime": "PT15M",
    ...
    "step": [
      ...
      },
      {
        ...
        "text": "Connect with a board-certified physician through an encrypted video call. Your doctor will review your symptoms, perform a clinical assessment, and discuss your treatment options. TeleDirectMD is available in 44 states plus DC."
      },
      {
        "@type": "HowToStep",
        "position": 4,
