...
// Used by: app/[slug]/StateLandingPage.js  (43 pages)
...
export function summarizeCompare({ competitorName, tdmdPrice = 49, competitorPriceRange, competitorCoverageStates, tdmdCoverageStates = 43 }) {
...
export function summarizeWhoWeServe({ segmentName, segmentDescription }) {
  ...
  const answerHtml =
    ...
    `$79 cash-pay (FSA/HSA eligible) gets a same-day video visit with ${DOCTOR} (NPI: ${NPI}), a board-certified Family Medicine physician licensed in 43 states and Washington, D.C.${desc} ` +
...
export function summarizeStatesWeServe() {
  ...
  const answerHtml =
    ...
    `Not currently served: Alaska, Arkansas, Massachusetts, New Mexico, New York, Oregon, and Rhode Island. ` +
