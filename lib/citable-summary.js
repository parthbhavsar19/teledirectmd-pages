...
// Used by: app/[slug]/[conditionSlug]/page.js  (2,520 pages: 60 conditions × 44 states)
...
export function summarizeUseCase({ useCaseTitle, useCaseDescription, price = 49 }) {
  ...
  const answerHtml =
    `Book a same-day $${price} cash-pay telehealth visit at TeleDirectMD with ${DOCTOR} (NPI: ${NPI}), a board-certified Family Medicine physician licensed in 44 US states. ` +
