...
export const USE_CASE_PAGES = {
  ...
  metaDescription:
    "Get a doctor's note for work or school through a same-day $79 telehealth visit with a board-certified MD. Notes issued when medically appropriate — same day, PDF delivered by email. Available evenings and weekends in 41 states.",
  ...
  answerBody:
    'The visit with <a href="/about">Dr. Parth Bhavsar, MD</a> is <strong>$79 flat</strong>. If the clinical evaluation supports it, a written visit summary suitable as a doctor\'s note is included at no additional charge.<div class="tdmd-answer-stats"><span>$79 flat visit</span><span>Same-day note · evenings &amp; weekends</span><span>41 states · MD-only</span></div> The note confirms the date you were seen, the dates you were or will be unable to work or attend school, and your expected return date. It does <strong>not</strong> disclose your diagnosis — consistent with HIPAA\'s minimum-necessary standard. Telehealth-issued notes are accepted by most employers and schools; the <a href="https://www.dol.gov/agencies/whd/fmla" target="_blank" rel="noopener">U.S. Department of Labor</a> has no rule prohibiting them. Notes are written only when medically appropriate based on your clinical evaluation — back-dated notes and notes for absences without a medical basis are not issued.',

  // ── Hero ──────────────────────────────────────────────────────────────────
  heroSub:
    "Same-day telehealth visit with a board-certified MD. Note delivered as a signed PDF by email.",
  heroIntro:
    'Calling in sick — or keeping a child home from school — often means scrambling to get documentation. A $79 visit with <a href="/about">Dr. Parth Bhavsar, MD</a> gives you a live video consultation with a board-certified Family Medicine physician. If your symptoms and clinical history support it, a signed work or school excuse note is included and delivered by email the same day. Visits are available evenings and weekends in <a href="/states-we-serve/">41 states</a>.',
  ...
  service: {
    name: 'Online medication refill telehealth visit',
    serviceType: 'Telehealth chronic medication refill consultation',
    price: '79',
    priceCurrency: 'USD',
  },
  procedure: {
    name: 'Telehealth chronic medication refill evaluation',
    procedureType: 'NoninvasiveProcedure',
    howPerformed: 'A board-certified MD reviews chronic medication history, confirms the prescription remains appropriate, and sends an e-prescription to the patient’s pharmacy. No controlled substances.',
  },

  h1: 'Online Medication Refills: $79 MD Visit, Same-Day E-Prescription',
  metaTitle: 'Online Medication Refill: $79 MD Visit + Same-Day E-Prescription | TeleDirectMD',
  metaDescription: 'Refill stable chronic medications online — blood pressure, thyroid, cholesterol, asthma, birth control, and more — for a $79 flat MD visit. E-prescription sent same day. No controlled substances. 41 states.',
  breadcrumb: 'Refill Medication Online',

  // ── Answer block (speakable, featured-snippet bait) ──────────────────
  answerLead: 'Yes — you can refill stable, non-controlled chronic medications online for a flat $79 MD visit, with the e-prescription sent the same day.',
  answerBody: 'A licensed physician does a brief video evaluation (required by state telemedicine law), confirms the medication is still appropriate, and sends an e-prescription to your pharmacy of choice the same day. At TeleDirectMD the visit is a flat <strong>$79</strong>.<div class="tdmd-answer-stats"><span>$79 flat MD visit</span><span>Same-day e-prescription</span><span>No controlled substances</span></div> Generic drugs at pharmacy via <a href="https://www.goodrx.com" rel="nofollow noopener" target="_blank">GoodRx</a> add $2–$25 for most common refills — lisinopril from <a href="https://www.goodrx.com/lisinopril" rel="nofollow noopener" target="_blank">$2.00</a>, metformin from <a href="https://www.goodrx.com/metformin" rel="nofollow noopener" target="_blank">$2.75</a>, levothyroxine from <a href="https://www.goodrx.com/levothyroxine" rel="nofollow noopener" target="_blank">$2.00</a>, albuterol HFA from <a href="https://www.goodrx.com/albuterol" rel="nofollow noopener" target="_blank">$19.45</a>. <strong>TeleDirectMD does not prescribe controlled substances</strong> (Adderall, opioids, benzodiazepines, testosterone, or other Schedule II–IV medications).',

  // ── Hero ─────────────────────────────────────────────────────────────
  heroSub: '$79 flat video visit with a board-certified MD. E-prescription to any US pharmacy — same day, evenings, and weekends. 41 states.',
  ...
  heroCardTitle: 'What the $79 Refill Visit Covers',
  heroCardItems: [
  ...
  heroBenefits: [
    '$79 flat — no facility fee, no surprise billing',
  ...
  primaryCta: 'Start My $79 Refill Visit',

  // ── Included / What you get (table with 8 rows) ───────────────────────
  includedTitle: 'What\'s Included in the $79 Refill Visit',
  includedRows: [
    {
    ...
    },
    {
      ...
      detail: 'GoodRx Care charges <strong>$19 (Gold membership) or $79 without</strong> for a refill visit with a non-physician provider.',
      src: 'https://www.goodrx.com/care/services/refill',
    },
    {
      item: 'PlushCare comparison visit',
      detail: 'PlushCare charges <strong>$129 per visit</strong> without insurance (plus optional $19.99/month membership). TeleDirectMD\'s $79 flat fee requires no membership.',
  ...
  fits: {
    ...
    good: [
      ...
      '<strong>Between PCP appointments</strong> — new to an area, switched insurance, or PCP has a months-long wait. A $79 bridge refill keeps you on your medication while you establish care.',
  ...
  faqs: [
    ...
    },
    {
      ...
      answer: 'TeleDirectMD is in-network with Aetna, Blue Cross Blue Shield, and UnitedHealthcare in select states — check <a href="/insurance/">teledirectmd.com/insurance</a>. If your insurer is in-network, your standard telehealth copay applies. If your plan is not in-network or you are uninsured, the $79 self-pay rate is often cheaper than an in-network copay before your deductible is met. The $79 visit fee is HSA- and FSA-eligible. Note that the prescription itself is billed through your pharmacy — separately from the visit.',
    },
    {
  ...
  references: [
    ...
    {
      label: 'GoodRx Care — Online prescription refill service ($19–$79)',
  ...
  metaDescription:
    'Travel prescription online from a board-certified MD for $79 — same-day video visit. Standby azithromycin for traveler\'s diarrhea, motion sickness Rx, malaria prophylaxis (doxycycline / Malarone), and chronic-medication refills before you fly. No vaccines, no controlled substances. e-Rx sent to any U.S. pharmacy.',
