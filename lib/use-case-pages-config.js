...
export const USE_CASE_PAGES = {
  ...
  // ── Disclaimer ────────────────────────────────────────────────────────────
  disclaimer:
    'This page is for informational purposes only and is not medical advice. TeleDirectMD provides telehealth services for non-emergency conditions in adults 18+ physically located in one of our 44 licensed states at the time of the visit. TeleDirectMD is not a CDC-certified Yellow Fever Vaccination Center and does not administer vaccines of any kind. We do not prescribe controlled substances (Schedule II–IV). Travel medicine recommendations are highly destination- and patient-specific; this page describes general capabilities only. If you are experiencing a medical emergency, call 911 immediately. For post-exposure rabies prophylaxis, go to the nearest emergency department without delay.',
