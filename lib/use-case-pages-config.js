...
export const USE_CASE_PAGES = {
  ...
  metaDescription:
    "Get a doctor's note for work or school through a same-day $79 telehealth visit with a board-certified MD. Notes issued when medically appropriate — same day, PDF delivered by email. Available evenings and weekends in 44 states.",
  ...
  answerBody:
    'The visit with <a href="/about">Dr. Parth Bhavsar, MD</a> is <strong>$79 flat</strong>. If the clinical evaluation supports it, a written visit summary suitable as a doctor\'s note is included at no additional charge.<div class="tdmd-answer-stats"><span>$79 flat visit</span><span>Same-day note · evenings &amp; weekends</span><span>44 states · MD-only</span></div> The note confirms the date you were seen, the dates you were or will be unable to work or attend school, and your expected return date. It does <strong>not</strong> disclose your diagnosis — consistent with HIPAA\'s minimum-necessary standard. Telehealth-issued notes are accepted by most employers and schools; the <a href="https://www.dol.gov/agencies/whd/fmla" target="_blank" rel="noopener">U.S. Department of Labor</a> has no rule prohibiting them. Notes are written only when medically appropriate based on your clinical evaluation — back-dated notes and notes for absences without a medical basis are not issued.',

  // ── Hero ──────────────────────────────────────────────────────────────────
  heroSub:
    "Same-day telehealth visit with a board-certified MD. Note delivered as a signed PDF by email.",
  heroIntro:
    'Calling in sick — or keeping a child home from school — often means scrambling to get documentation. A $79 visit with <a href="/about">Dr. Parth Bhavsar, MD</a> gives you a live video consultation with a board-certified Family Medicine physician. If your symptoms and clinical history support it, a signed work or school excuse note is included and delivered by email the same day. Visits are available evenings and weekends in <a href="/states-we-serve/">44 states</a>.',
  ...
  fits: {
    ...
    bad: [
      ...
      "<strong>Controlled-substance-related disability or work-restriction forms</strong> — TeleDirectMD does not prescribe Schedule II–V controlled substances and cannot support work-leave forms tied to controlled substance treatment.",
  ...
  // ── Hero ─────────────────────────────────────────────────────────────────
  heroSub: 'Board-certified MD. Same-day e-Rx. 44 states. No waiting room.',
  heroIntro:
  ...
  heroBenefits: [
    ...
    'Book same-day, evenings, or weekends — available in 44 states',
  ...
  fits: {
    ...
    bad: [
      ...
      '<strong>Controlled substances for travel</strong> — sleeping pills for jet lag (zolpidem, temazepam), benzodiazepines for flight anxiety, or stimulants are Schedule II–V controlled substances; TeleDirectMD does not prescribe these under any circumstance.',
    ],
  },
  ...
  // ── Disclaimer ────────────────────────────────────────────────────────────
  disclaimer:
    'This page is for informational purposes only and is not medical advice. TeleDirectMD provides telehealth services for non-emergency conditions in adults 18+ physically located in one of our 44 licensed states at the time of the visit. TeleDirectMD is not a CDC-certified Yellow Fever Vaccination Center and does not administer vaccines of any kind. We do not prescribe controlled substances (Schedule II–V). Travel medicine recommendations are highly destination- and patient-specific; this page describes general capabilities only. If you are experiencing a medical emergency, call 911 immediately. For post-exposure rabies prophylaxis, go to the nearest emergency department without delay.',
