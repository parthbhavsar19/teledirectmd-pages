...
export const USE_CASE_RELATED = {
  ...
  'refill-medication-online': { useCases: ['travel-prescription'],                              cost: ['online-prescription-cost', 'online-doctor-visit-cost'],          compare: ['teledirectmd-vs-sesame'] },
...
export const USE_CASE_PAGES = {
  ...
  metaDescription: 'Refill stable chronic medications online — blood pressure, thyroid, cholesterol, asthma, birth control, and more — for a $79 flat MD visit. E-prescription sent same day. No controlled substances. 43 states.',
  ...
  // ── Hero ─────────────────────────────────────────────────────────────
  heroSub: '$79 flat video visit with a board-certified MD. E-prescription to any US pharmacy — same day, evenings, and weekends. 43 states.',
  ...
  heroCardItems: [
    ...
    'Available in 43 states — evenings and weekends',
  ...
  fits: {
    ...
    good: [
      ...
      '<strong>Traveling and need a refill</strong> — physically in one of our <a href="/states-we-serve/">43 licensed states</a> at the time of the visit. We route the e-prescription to any nearby pharmacy.',
  ...
  // ── Disclaimer ────────────────────────────────────────────────────────
  disclaimer: 'This page is for informational purposes only and does not constitute medical advice. TeleDirectMD provides telehealth services for stable, non-emergency conditions in adults 18+ physically located in one of our 43 licensed states at the time of the visit. We do not prescribe controlled substances (Schedule II–IV), including Adderall, opioids, benzodiazepines, testosterone, or GLP-1 agonists for weight loss. Prices cited are cash-pay estimates from verified sources as of April 2026 and are subject to change. If you are experiencing a medical emergency, call 911 immediately.',
