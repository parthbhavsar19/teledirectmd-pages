...
export const USE_CASE_PAGES = {
  ...
  answerLead:
    "Yes — a board-certified MD can issue a written work or school excuse note after a $49 telehealth visit, the same day, including evenings and weekends.",
  answerBody:
    'The visit with <a href="/about">Dr. Parth Bhavsar, MD</a> is <strong>$49 flat</strong>. If the clinical evaluation supports it, a written visit summary suitable as a doctor\'s note is included at no additional charge.<div class="tdmd-answer-stats"><span>$49 flat visit</span><span>Same-day note · evenings &amp; weekends</span><span>41 states · MD-only</span></div> The note confirms the date you were seen, the dates you were or will be unable to work or attend school, and your expected return date. It does <strong>not</strong> disclose your diagnosis — consistent with HIPAA\'s minimum-necessary standard. Telehealth-issued notes are accepted by most employers and schools; the <a href="https://www.dol.gov/agencies/whd/fmla" target="_blank" rel="noopener">U.S. Department of Labor</a> has no rule prohibiting them. Notes are written only when medically appropriate based on your clinical evaluation — back-dated notes and notes for absences without a medical basis are not issued.',
  ...
  includedRows: [
    ...
    },
    {
      ...
      detail:
        '<strong>$43.04–$49.22</strong> for 30 tablets with GoodRx coupon (verified 2026-04-26). Generic atovaquone-proguanil is the preferred option for last-minute travelers (starts 1–2 days before travel vs. 1–2 weeks for doxycycline); suitable for regions with chloroquine-resistant <em>Plasmodium falciparum</em>.',
