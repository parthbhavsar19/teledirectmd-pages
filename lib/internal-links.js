...
// ─── Symptom-page back-links (PR for /symptoms/* rollout) ─────────────
// Returns the list of symptom pages that route TO a given condition. Used
// by the "Common symptoms patients ask about" module on every condition
// page (national + state×condition + cost pages).
