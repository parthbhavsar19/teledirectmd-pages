...
//
// 2026-08-26 sync (manual):
//   Added three newly-active payers per the Payor Enrollment Tracking Sheet:
//     - AZ Blue Cross Blue Shield (active 2026-07-01)
//     - MI Blue Cross Blue Shield (active 2026-06-08)
//     - WA Aetna (active 2026-06-17)
//
// Plan-type policy:
...
export const insuranceByState = {
  AZ: [
    ...
    { name: 'Blue Cross Blue Shield of Arizona', displayName: 'BCBS of Arizona',
      plans: 'PPO, HMO, EPO, POS, Medicare Advantage',
      planSummary: 'Commercial + Medicare Advantage',
      status: 'active', effectiveDate: '2026-07-01', anchor: 'bcbs-az-coverage' },
  ],
  CA: [
    { name: 'Aetna', displayName: 'Aetna',
  ...
  MI: [
    ...
    { name: 'UnitedHealthcare', displayName: 'UnitedHealthcare',
      ...
      planSummary: 'Commercial + Medicare Advantage',
      status: 'active', effectiveDate: '2026-03-24', anchor: 'uhc-coverage' },
    { name: 'Blue Cross Blue Shield of Michigan', displayName: 'BCBS of Michigan',
      plans: 'PPO, HMO, EPO, POS, Medicare Advantage',
      planSummary: 'Commercial + Medicare Advantage',
      status: 'active', effectiveDate: '2026-06-08', anchor: 'bcbs-mi-coverage' },
  ],
  MN: [
  ...
  WA: [
    ...
    { name: 'Aetna', displayName: 'Aetna',
      plans: 'PPO, HMO, EPO, POS, Medicare Advantage',
      planSummary: 'Commercial + Medicare Advantage',
      status: 'active', effectiveDate: '2026-06-17', anchor: 'aetna-coverage' },
  ],
};
...
export function isLicensedState(stateAbbr) {
  if (!stateAbbr) return false;
  return Boolean(stateLicensesData.licenses[stateAbbr.toLowerCase()]);
}
