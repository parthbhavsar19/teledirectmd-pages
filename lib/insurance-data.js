...
// 2026-07-26 Curative national expansion:
//   Curative Network Contracting confirmed in writing that the TeleDirectMD provider
//   agreement is national, in-network for Curative members in every state where
//   Dr. Bhavsar holds an active license. Curative rows were therefore added to every
//   state on the enabled roster in data/insurance/insuranceConfig.js CURATIVE_STATES.
//   Not added: MS, WV, WY (license records expired 2026-06-30, no renewal on file) and
//   VT, VA, DE (deliberate cash-pay-only positioning).
...
export function getPayerFamilyStateNames(family) {
  const STATE_NAMES = {
    ...
    DC:'Washington D.C.', FL:'Florida', GA:'Georgia', HI:'Hawaii', IA:'Iowa',
    ID:'Idaho', IL:'Illinois', IN:'Indiana', KS:'Kansas', KY:'Kentucky',
    LA:'Louisiana', MD:'Maryland', ME:'Maine', MI:'Michigan', MN:'Minnesota',
    MO:'Missouri', MT:'Montana', NC:'North Carolina', ND:'North Dakota',
    NE:'Nebraska', NH:'New Hampshire', NJ:'New Jersey', NV:'Nevada', OH:'Ohio',
    OK:'Oklahoma', PA:'Pennsylvania', SC:'South Carolina', SD:'South Dakota',
    TN:'Tennessee', TX:'Texas', UT:'Utah', WA:'Washington', WI:'Wisconsin',
  };
