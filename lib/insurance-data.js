...
export const insuranceByState = {
  ...
  FL: [
    { name: 'Florida Blue', displayName: 'Florida Blue (BCBS of Florida)', plans: 'Individual and group commercial plans', status: 'active', effectiveDate: '2026-02-01', anchor: 'florida-blue-coverage' },
    { name: 'Aetna', displayName: 'Aetna', plans: 'Commercial plans', status: 'active', effectiveDate: '2026-02-11', anchor: 'aetna-coverage' },
    { name: 'UnitedHealthcare', displayName: 'UnitedHealthcare', plans: '', status: 'pending', anchor: 'uhc-coverage' },
  ],
