...
/* AJC is a stacked vertical wordmark — needs reduced height to match horizontal logos visually */
.hp-marquee-track img[alt="Atlanta Journal-Constitution"] {
  height: 38px;
  padding: 4px 18px;
}
...
/* Viewport hugs its content — cards still fade in on scroll, but no pinned
   dead space below the CTA on desktop (mobile already used this treatment). */
.hp-sticky-viewport {
  position: relative;
  min-height: auto;
  height: auto;
