...
/* --- Font imports --- */
@import url('https://fonts.googleapis.com/css2?family=Fraunces:ital,opsz,wght@0,9..144,400;0,9..144,500;0,9..144,600;0,9..144,700;1,9..144,400&family=DM+Sans:wght@400;500;600;700&family=Patrick+Hand&family=Caveat:wght@400;700&family=Manrope:wght@500;700&family=Space+Mono:wght@400;700&family=Karla:wght@400;700&display=swap');
...
.hp-sticky-scroll-outer {
  min-height: calc(100vh + 880px); /* sticky viewport height + 4 steps × 220px scroll */
  position: relative;
}
.hp-sticky-why-outer {
  min-height: calc(100vh + 900px); /* sticky viewport height + 6 cards scroll zone */
}
