...
export const COMPARE_PAGES = {
  ...
  'teledirectmd-vs-teladoc': {
    ...
    providerDive: {
      ...
      paragraphs: [
        'TeleDirectMD = Dr. Parth Bhavsar, MD only. Board-certified Family Medicine. NPI 1245687134. The same physician you saw last visit is the one you see this visit.',
    ...
    scenarios: [
      { name: 'Sarah switched from Teladoc to TeleDirectMD (GA)',           story: 'Suspected UTI on a Saturday night. Teladoc visit was $89 + $8 antibiotic = $97. Switched to TeleDirectMD: $49 + $8 = $57.', save: 'Saved $40 per visit.' },
      { name: 'David — Teladoc through employer (CO)',                       story: 'Has Teladoc benefit at $0 copay through his job. TeleDirectMD would cost $49 cash.', save: 'Use Teladoc — it\'s already paid for.' },
      { name: 'Marisa — needs therapy (NY)',                                 story: 'NY isn\'t a TeleDirectMD state, and she needs therapy. Teladoc covers both at $119/therapy visit.', save: 'Teladoc is the right call.' },
    ],
    faqs: [
  ...
  'teledirectmd-vs-mdlive': {
    ...
    providerDive: {
      title: 'Provider Quality Deep-Dive',
      paragraphs: [
        'TeleDirectMD: MD only — Dr. Parth Bhavsar, board-certified Family Medicine, NPI 1245687134.',
    ...
    scenarios: [
      { name: 'Marcus — sinus infection (FL)',     story: 'TeleDirectMD: $49 visit + $9 amoxicillin = $58. MDLIVE: $85 + $9 = $94.',                                            save: 'TeleDirectMD saves $36.' },
      { name: 'Lara switched from MDLIVE — eczema (CA)', story: 'Initially used MDLIVE for derm. Now uses TeleDirectMD for primary care and stays on MDLIVE for derm follow-ups.', save: 'Best of both — $49 for primary, MDLIVE for derm-specific.' },
      { name: 'Aaron — Cigna-insured (TX)',         story: 'Cigna is not in-network with TeleDirectMD. MDLIVE is. He uses MDLIVE for in-network rate; TeleDirectMD\'s $49 cash is still an option if his deductible is unmet.', save: 'Compare both — depends on plan benefits.' },
    ],
    faqs: [
  ...
  'teledirectmd-vs-amwell': {
    ...
    scenarios: [
      { name: 'Janet — Aetna in-network (PA)',                              story: 'Has Aetna, lives in PA — both Amwell and TeleDirectMD accept Aetna. TeleDirectMD\'s $20 telehealth copay beats Amwell\'s.', save: 'Compare specific plan copays; TeleDirectMD often wins.' },
      { name: 'Cyrus — Beacon Health (NY)',                                  story: 'Beacon is on Amwell\'s plan list, not TeleDirectMD\'s. NY also isn\'t a TeleDirectMD state.',                                                save: 'Use Amwell.' },
      { name: 'Lena switched from Amwell — uninsured (TX)',                  story: 'Amwell\'s $79 cash visit became $49 at TeleDirectMD.',                                                                                  save: 'Saved $30 per visit.' },
    ],
    faqs: [
  ...
  'teledirectmd-vs-doctor-on-demand': {
    ...
    scenarios: [
      { name: 'Beth — Medicare beneficiary (FL)',                                  story: 'TeleDirectMD doesn\'t accept Medicare. Doctor on Demand does.',                                                                              save: 'Use Doctor on Demand.' },
      { name: 'Eli switched from Doctor on Demand — uninsured (NV)',               story: 'Was paying $99 at Doctor on Demand. Switched to TeleDirectMD: $49.',                                                                       save: 'Saved $50 per visit.' },
      { name: 'Hannah — needs psychiatry (NJ)',                                     story: 'NJ not on TeleDirectMD\'s list and she needs psychiatry. Doctor on Demand covers both.',                                                  save: 'Use Doctor on Demand.' },
    ],
    faqs: [
  ...
  'teledirectmd-vs-sesame': {
    ...
    scenarios: [
      { name: 'Tariq — uninsured (TX)',                                                  story: 'Local Sesame providers showing $32 for an acute visit; TeleDirectMD is $49. Provider type and credentials vary on Sesame.', save: 'Sesame may save $17 today; trade-off is provider variability.' },
      { name: 'Hema switched from Sesame — Aetna in-network (PA)',                        story: 'Was paying full cash on Sesame. TeleDirectMD accepts Aetna in PA; Sesame doesn\'t. With insurance, TeleDirectMD\'s copay is far below Sesame\'s cash rate.', save: 'TeleDirectMD via Aetna copay.' },
      { name: 'Anika — needs derm (CA)',                                                  story: 'Acne with mild scarring. TeleDirectMD doesn\'t do dermatology; Sesame has board-certified dermatologists.', save: 'Use Sesame.' },
    ],
    faqs: [
  ...
  'teledirectmd-vs-k-health': {
    ...
    scenarios: [
      { name: 'Diego — occasional UTI (FL)',                                       story: 'TeleDirectMD: $49 once, live video, prescription same day. K Health: $35, but text-based with ~1 hour clinician matchmaking.', save: 'Both work for one-off use; TeleDirectMD is a faster live visit at a small premium.' },
      { name: 'Naomi — frequent anxiety + Rx (NJ)',                                 story: 'Wants weekly check-ins and mental health support. K Health $49/month covers both; TeleDirectMD doesn\'t do mental health.', save: 'Use K Health.' },
      { name: 'Vince switched from K Health — Aetna-insured (GA)',                  story: 'Was paying $35 cash on K Health. With Aetna at TeleDirectMD, his telehealth copay is $20 — and he gets a live MD video visit.', save: 'TeleDirectMD via Aetna copay.' },
    ],
    faqs: [
