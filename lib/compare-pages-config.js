...
export function getCompareTableRows(slug) {
  ...
  return [
    { dim: 'Cash-pay urgent care visit',         tdmd: '$79 flat',                                       comp: c.urgentCare,    compSrc: c.urgentCareSrc },
    ...
    { dim: 'States covered',                     tdmd: '44 + DC',                                         comp: c.states,        compSrc: c.statesSrc },
...
export const COMPARE_PAGES = {
  ...
  'teledirectmd-vs-teladoc': {
    ...
    heroBenefits: [
      '$79 vs. $89 — TeleDirectMD is about 11% cheaper for cash-pay urgent care',
    ...
    tdmdWins: [
      { headline: 'About 11% cheaper cash-pay', detail: '$79 flat vs. <a href="https://www.teladochealth.com/start/no-insurance">$89/visit at Teladoc</a>.' },
      ...
      { headline: 'Predictable pricing',          detail: 'Flat $79 — no per-feature pricing tiers.' },
    ],
    competitorWins: [
      { headline: 'All 50 states',                detail: 'Teladoc covers <a href="https://www.teladochealth.com/organizations/employers/24-7-care">all 50 states 24/7</a>; TeleDirectMD is in 44. AR, MA, NM, NY, OR, RI are gaps.' },
    ...
    pricingDive: {
      ...
      paragraphs: [
        'Cash-pay urgent care: TeleDirectMD <strong>$79 flat</strong>; Teladoc <strong>$89/visit</strong> per <a href="https://www.teladochealth.com/start/no-insurance">Teladoc.com</a>.',
    ...
    whoFor: {
      tdmd: ['You\'re uninsured or have a high-deductible plan and want the lowest cash-pay rate', 'You want a single named MD on every visit', 'You\'re in one of the 44 TeleDirectMD states', 'You don\'t need overnight or mental health services'],
      competitor: ['You need 24/7 overnight access', 'You\'re in AR, MA, NM, NY, OR, RI (TeleDirectMD coverage gaps)', 'You need therapy or psychiatry alongside urgent care', 'Teladoc is included in your employer benefits at low/no cost'],
    },
    decisionGuide: {
      ...
      steps: [
        ...
        { num: 2, head: 'In one of TeleDirectMD\'s 44 states and paying cash?', body: 'TeleDirectMD\'s $79 beats Teladoc\'s $89 by about 11%.', good: true },
    ...
    faqs: [
      { question: 'Is TeleDirectMD cheaper than Teladoc?',                                        answer: 'Yes for cash-pay. TeleDirectMD is $79 flat; Teladoc is $89 per visit per Teladoc\'s no-insurance pricing page. That\'s about 11% less at TeleDirectMD.' },
      ...
      { question: 'Does Teladoc cover all 50 states?',                                             answer: 'Yes — all 50 states 24/7 per Teladoc\'s employer page. TeleDirectMD is in 44 states with same-day, evenings, and weekends.' },
  ...
  'teledirectmd-vs-mdlive': {
    ...
    heroCardTitle: 'Quick Answer',
    heroCardItems: [
      'Cheaper urgent care: TeleDirectMD ($79 vs. $85)',
      'Bigger reach: MDLIVE (50 + PR vs. 44 states)',
    ...
    heroBenefits: [
      '$79 vs. $85 — TeleDirectMD is about 7% cheaper cash-pay',
    ...
    tdmdWins: [
      { headline: 'About 7% cheaper cash-pay',      detail: '$79 flat vs. <a href="https://www.healthline.com/health/mdlive-reviews">$85 at MDLIVE</a>.' },
    ...
    competitorWins: [
      { headline: '50 states + Puerto Rico',        detail: 'MDLIVE covers <a href="https://www.mdlive.com/frequently-asked-questions/where-mdlive-available">all 50 states + Puerto Rico</a>; TeleDirectMD covers 44 states plus Washington, D.C.' },
    ...
    pricingDive: {
      title: 'Pricing Deep-Dive: What Each Visit Actually Costs',
      paragraphs: [
        'Cash-pay urgent care: TeleDirectMD <strong>$79 flat</strong>; MDLIVE <strong>$85/visit</strong> per <a href="https://www.healthline.com/health/mdlive-reviews">Healthline</a> (Mira Health reports $89). Difference: ~$36 per visit.',
    ...
    whoFor: {
      tdmd: ['You want the lowest cash-pay rate from a board-certified MD', 'You\'re in one of the 44 states', 'You only need adult primary/urgent care', 'You value seeing the same physician every visit'],
      competitor: ['You need dermatology, therapy, or psychiatry', 'You\'re in Puerto Rico or one of the six states TeleDirectMD does not serve: Arkansas, Massachusetts, New Mexico, New York, Oregon, or Rhode Island', 'You need overnight 24/7 access', 'Your insurer is Cigna or Humana (not currently TeleDirectMD-supported)'],
    },
    decisionGuide: {
      title: 'Which One Fits Your Situation?',
      steps: [
        ...
        { num: 3, head: 'Live in one of the 44 TeleDirectMD states?',          body: 'Cash-pay $79 beats MDLIVE\'s $85 by about 7%.', good: true },
    ...
    faqs: [
      { question: 'Is TeleDirectMD cheaper than MDLIVE?',                          answer: 'Yes for cash-pay urgent care: $79 vs. $85 per Healthline\'s MDLIVE review. That\'s about 7% less at TeleDirectMD.' },
      ...
      { question: 'Does MDLIVE cover all 50 states?',                                answer: 'Yes — all 50 states plus Puerto Rico per MDLIVE\'s FAQ. TeleDirectMD covers 44 states.' },
      { question: 'Can I switch from MDLIVE to TeleDirectMD?',                       answer: 'Yes. TeleDirectMD is a separate platform; bring your medication list and any recent labs to your first visit. Book at teledirectmd.com/book-online for a $79 flat-rate visit.' },
  ...
  'teledirectmd-vs-amwell': {
    ...
    metaDescription: 'TeleDirectMD ($79 flat, 44 states, MD-only) vs. Amwell ($79 cash-pay, 50 states, 55+ insurers, mental health). Verified 2026 prices with sources.',
    breadcrumb: 'TeleDirectMD vs. Amwell',
    answerLead: 'TeleDirectMD vs. Amwell — short answer:',
    answerBody: 'TeleDirectMD is <strong>$79 flat</strong> with a single named board-certified MD; Amwell is <strong>$79/visit</strong> cash-pay (<a href="https://psychcentral.com/health/amwell-reviews">PsychCentral</a>). Amwell has the broadest insurer network reviewed — <strong>55+ commercial plans</strong> including Aetna, BCBS, UHC, Beacon, and Emblem (<a href="https://www.choosingtherapy.com/amwell-review/">ChoosingTherapy</a>) — and serves all 50 states with mental health. Both are HIPAA-compliant. <strong>TeleDirectMD matches Amwell on cash-pay price ($79 vs. $79) and wins on the named-MD-only model.</strong> <strong>Amwell wins on insurance breadth, mental health, and 50-state reach.</strong>',
    heroSub: 'Amwell is the broadest insurer-network telehealth platform; TeleDirectMD matches its $79 cash-pay and adds a named-MD guarantee.',
    heroIntro: 'Amwell\'s big advantage is its insurer footprint — over 55 commercial plans including Aetna, BCBS, UHC, Beacon, and Emblem per <a href="https://www.choosingtherapy.com/amwell-review/">ChoosingTherapy</a>. If you\'re using insurance, Amwell may be in-network where TeleDirectMD is not. If you\'re paying cash, both are $79 flat — the tie-breaker is provider type (TeleDirectMD guarantees a single named MD) and service line (Amwell adds mental health).',
    heroCardTitle: 'Quick Answer',
    heroCardItems: [
      'Same cash-pay urgent care: TeleDirectMD $79 flat vs. Amwell $79',
      'Bigger reach: Amwell (50 vs. 44 states)',
    ...
    heroBenefits: [
      'Same $79 cash-pay — tie-breaker is provider type and service breadth',
    ...
    tdmdWins: [
      { headline: 'Same cash-pay price, named MD',  detail: '$79 flat at both. TeleDirectMD guarantees a single named board-certified MD; Amwell rotates through its provider network per <a href="https://psychcentral.com/health/amwell-reviews">PsychCentral</a>.' },
    ...
    competitorWins: [
      ...
      { headline: 'All 50 states',                 detail: 'Amwell covers <a href="https://www.choosingtherapy.com/amwell-review/">all 50 states</a>; TeleDirectMD covers 44 states plus Washington, D.C.' },
    ...
    pricingDive: {
      title: 'Pricing Deep-Dive: What Each Visit Actually Costs',
      paragraphs: [
        'Cash-pay urgent care: TeleDirectMD <strong>$79 flat</strong>; Amwell <strong>$79/visit</strong> per <a href="https://psychcentral.com/health/amwell-reviews">PsychCentral</a>. Difference: $30 per visit.',
    ...
    whoFor: {
      tdmd: ['You\'re paying cash and want the lowest published rate', 'You\'re in one of the 44 states', 'You only need adult primary/urgent care', 'You value continuity with a named physician'],
      competitor: ['Your insurance is one of Amwell\'s 55+ plans (Aetna, BCBS, UHC, Beacon, Emblem, etc.)', 'You need therapy or psychiatry', 'You\'re in or another state TeleDirectMD doesn\'t cover', 'You want a sub-10-minute wait promise'],
    },
    decisionGuide: {
      title: 'Which One Fits Your Situation?',
      steps: [
        ...
        { num: 3, head: 'In one of the 44 TeleDirectMD states and paying cash?',                              body: 'Same $79 as Amwell — pick TeleDirectMD if you want a single named MD, or Amwell if you want mental health included.', good: true },
        { num: 4, head: 'Insurance is Aetna, BCBS, or UHC?',                                                  body: 'Both platforms accept all three. Compare specific plan copays.', good: true },
      ],
    },
    faqs: [
      { question: 'Is TeleDirectMD cheaper than Amwell?',                              answer: 'No — cash-pay is $79 at both per PsychCentral\'s Amwell review. Pick TeleDirectMD if you want a single named MD; pick Amwell if you also need mental health or want the broadest commercial-insurance network.' },
      ...
      { question: 'Is Amwell available in all 50 states?',                              answer: 'Yes per ChoosingTherapy. TeleDirectMD is in 44 states.' },
      ...
      { question: 'Can I switch from Amwell to TeleDirectMD?',                          answer: 'Yes. Bring your medication list and any recent labs to your first visit. Book at teledirectmd.com/book-online for the $79 flat rate.' },
  ...
  'teledirectmd-vs-doctor-on-demand': {
    ...
    metaDescription: 'TeleDirectMD ($79 flat, 44 states, MD-only) vs. Doctor on Demand ($99 cash-pay, 50 states, Medicare Part B, mental health). Verified 2026 prices with sources.',
    breadcrumb: 'TeleDirectMD vs. Doctor on Demand',
    answerLead: 'TeleDirectMD vs. Doctor on Demand — short answer:',
    answerBody: 'TeleDirectMD is <strong>$79 flat</strong>. Doctor on Demand charges <strong>$99 per urgent care visit</strong> cash-pay (<a href="https://doctorondemand.com/about-us/cost-insurance/">Doctor on Demand</a>) and offers therapy at $134 (25 min) and psychiatry at $299 initial. Doctor on Demand accepts <strong>Medicare Part B</strong> (<a href="https://doctorondemand.com/">DoD</a>) plus a broad commercial network. Both are HIPAA-compliant. <strong>TeleDirectMD wins on cash-pay price (about 20% cheaper).</strong> <strong>Doctor on Demand wins on Medicare, mental health, and 50-state reach.</strong>',
    heroSub: 'Doctor on Demand is one of the few major telehealth platforms accepting Medicare Part B. TeleDirectMD is about 20% cheaper cash-pay with a named-MD guarantee.',
    heroIntro: 'Doctor on Demand is built around 24/7 availability across all 50 states with under-5-minute wait times per <a href="https://softwarefinder.com/emr-software/doctor-on-demand/pricing">Software Finder</a>, plus Medicare Part B acceptance — a meaningful differentiator for older adults. TeleDirectMD\'s pitch is the opposite: a single named MD, $79 flat, one of the lowest published cash-pay rates for a live-video MD visit.',
    heroCardTitle: 'Quick Answer',
    heroCardItems: [
      'Cheaper urgent care: TeleDirectMD ($79 vs. $99)',
      'Bigger reach: Doctor on Demand (50 vs. 44 states)',
    ...
    heroBenefits: [
      '$79 vs. $99 — TeleDirectMD is about 20% cheaper cash-pay',
    ...
    tdmdWins: [
      { headline: 'About 20% cheaper cash-pay',   detail: '$79 flat vs. <a href="https://doctorondemand.com/about-us/cost-insurance/">$99 at Doctor on Demand</a>.' },
      ...
      { headline: 'Predictable pricing',          detail: 'Flat $79 vs. tiered per-service pricing.' },
    ],
    competitorWins: [
      ...
      { headline: 'All 50 states',                detail: 'Doctor on Demand is <a href="https://www.helloklarity.com/post/sesame-care-alternatives/">in all 50 states</a>; TeleDirectMD covers 44 states plus Washington, D.C.' },
    ...
    pricingDive: {
      title: 'Pricing Deep-Dive: What Each Visit Actually Costs',
      paragraphs: [
        'Cash-pay urgent care: TeleDirectMD <strong>$79 flat</strong>; Doctor on Demand <strong>$99/visit</strong> per <a href="https://doctorondemand.com/about-us/cost-insurance/">Doctor on Demand</a>. Difference: $50 per visit.',
    ...
    whoFor: {
      tdmd: ['You\'re cash-paying or have a high-deductible plan', 'You\'re in one of the 44 states', 'You want continuity with a single named MD', 'You only need adult primary or urgent care'],
      competitor: ['You\'re on Medicare Part B', 'You need mental health (therapy or psychiatry)', 'You need overnight 24/7 care', 'You\'re in one of the six states TeleDirectMD doesn\'t cover: Arkansas, Massachusetts, New Mexico, New York, Oregon, or Rhode Island'],
    },
    decisionGuide: {
      title: 'Which One Fits Your Situation?',
      steps: [
        ...
        { num: 3, head: 'Cash-paying in one of the 44 TeleDirectMD states?',     body: '$79 flat beats $99 by about 20%.', good: true },
    ...
    faqs: [
      { question: 'Is TeleDirectMD cheaper than Doctor on Demand?',                                answer: 'Yes for cash-pay urgent care: $79 vs. $99 per Doctor on Demand. That\'s about 20% less at TeleDirectMD.' },
      ...
      { question: 'Does Doctor on Demand cover all 50 states?',                                    answer: 'Yes per industry comparison sources. TeleDirectMD covers 44 states.' },
      { question: 'Can I switch from Doctor on Demand to TeleDirectMD?',                            answer: 'Yes. Bring your medication list and recent labs. Book at teledirectmd.com/book-online for the $79 flat rate. No paperwork carries over from Doctor on Demand.' },
  ...
  'teledirectmd-vs-sesame': {
    ...
    metaDescription: 'TeleDirectMD ($79 flat, MD-only, insurance accepted) vs. Sesame ($29–$37+ provider-set, no insurance, mixed credentials). Verified 2026 prices.',
    breadcrumb: 'TeleDirectMD vs. Sesame',
    answerLead: 'TeleDirectMD vs. Sesame Care — short answer:',
    answerBody: 'TeleDirectMD is <strong>$79 flat</strong> with a single named MD across 44 states. Sesame is a marketplace where independent providers set their own rates — acute care can start as low as <strong>$29–$37</strong> per <a href="https://www.healthline.com/health/sesame-care">Healthline</a> but varies widely by location and provider; provider type is mixed (<a href="https://www.choosingtherapy.com/sesame-care-review/">ChoosingTherapy</a>). Sesame <strong>does not accept insurance</strong>. Both are HIPAA-compliant. <strong>TeleDirectMD wins on predictability, MD-only credentials, and insurance acceptance.</strong> <strong>Sesame wins on potential floor price and breadth of specialist types.</strong>',
    ...
    heroCardItems: [
      ...
      'Predictable price: TeleDirectMD ($79 flat)',
      'Named MD on every visit: TeleDirectMD only',
    ...
    heroBenefits: [
      'Flat $79 vs. variable $29–$37+ at Sesame',
      ...
      'Sesame can undercut $79 in some markets; not in all',
    ...
    tdmdWins: [
      { headline: 'Predictable, flat pricing',     detail: '$79 every time — vs. provider-set rates that vary by city and clinic at <a href="https://sesamecare.com/">Sesame</a>.' },
    ...
    competitorWins: [
      { headline: 'Lower floor price',             detail: 'Acute care can start at <a href="https://www.healthline.com/health/sesame-care">$29–$37</a> in some markets — below $79.' },
      { headline: 'All 50 states',                  detail: 'Sesame has providers in <a href="https://www.choosingtherapy.com/sesame-care-review/">all 50 states</a>; TeleDirectMD covers 44 states plus Washington, D.C.' },
    ...
    pricingDive: {
      title: 'Pricing Deep-Dive: What Each Visit Actually Costs',
      paragraphs: [
        'Cash-pay urgent care: TeleDirectMD <strong>$79 flat</strong>. Sesame: starts at <a href="https://www.healthline.com/health/sesame-care">$29–$37</a> in some markets but varies sharply. Major metros tend to have higher prices; smaller markets sometimes have lower floors.',
    ...
    whoFor: {
      tdmd: ['You want one named physician, every visit', 'Predictable pricing matters', 'You want to use Aetna, BCBS, or UHC insurance', 'You\'re in one of the 44 states'],
      competitor: ['You want the lowest possible cash price (and your local market has it)', 'You need a specialist type TeleDirectMD doesn\'t cover (dermatology, weight loss, etc.)', 'You\'re in or another state TeleDirectMD doesn\'t cover', 'You don\'t mind shopping providers'],
    },
    decisionGuide: {
      title: 'Which One Fits Your Situation?',
      steps: [
        ...
        { num: 3, head: 'Have time to shop providers and want the lowest possible price?',            body: 'Sesame can undercut $79 in some markets — but rates vary widely.', good: false },
        { num: 4, head: 'Want a single named MD and predictable pricing?',                            body: 'TeleDirectMD\'s $79 flat with Dr. Bhavsar is the cleanest option.', good: true },
      ],
    },
    faqs: [
      { question: 'Is TeleDirectMD cheaper than Sesame?',                              answer: 'Sometimes. Sesame\'s acute care can start at $29–$37 per Healthline below TeleDirectMD\'s $79. But Sesame rates vary by city and provider; TeleDirectMD is $79 flat in all 44 states.' },
      ...
      { question: 'Does Sesame cover all 50 states?',                                   answer: 'Yes per ChoosingTherapy, though provider density varies by market. TeleDirectMD is in 44 states.' },
      { question: 'Can I switch from Sesame to TeleDirectMD?',                          answer: 'Yes. TeleDirectMD is a separate platform; bring your medication list and any recent labs. Book at teledirectmd.com/book-online for the $79 flat rate.' },
  ...
  'teledirectmd-vs-k-health': {
    ...
    competitor: {
      urgentCare: '$35 one-time or $79/mo membership',                                  urgentCareSrc:    'https://www.choosingtherapy.com/k-health-review/',
      mentalHealth: '$79/mo (primary + mental health membership)',                      mentalHealthSrc:  'https://www.choosingtherapy.com/k-health-review/',
      ...
      membership: 'Yes — $79/mo or $73/visit one-time',                                    membershipSrc:    'https://www.choosingtherapy.com/k-health-review/',
    ...
    competitorWins: [
      { headline: 'Lowest one-time price',         detail: '$35 per text-based visit at K Health vs. $79 video at TeleDirectMD.' },
      ...
      { headline: 'Unlimited subscription value',  detail: '$79/month for unlimited primary + mental health (<a href="https://www.choosingtherapy.com/k-health-review/">ChoosingTherapy</a>) — best for high-frequency users.' },
    ...
    pricingDive: {
      title: 'Pricing Deep-Dive: What Each Visit Actually Costs',
      paragraphs: [
        'Cash-pay one-time: K Health <strong>$35</strong>; TeleDirectMD <strong>$79</strong>. K Health is cheaper for a single text-based interaction.',
        'Subscription: K Health <a href="https://www.choosingtherapy.com/k-health-review/">$79/month for unlimited primary + mental health</a>. Break-even vs. TeleDirectMD\'s $79 per-visit pricing is ~1.5 visits/month.',
    ...
    decisionGuide: {
      ...
      steps: [
        ...
        { num: 2, head: 'Need mental health support?',                         body: 'K Health\'s $79/month includes mental health; TeleDirectMD does not offer it.', good: false },
    ...
    faqs: [
      { question: 'Is TeleDirectMD cheaper than K Health?',                            answer: 'For a one-time visit, K Health is $35 vs. TeleDirectMD\'s $79 per ChoosingTherapy. But K Health is text-based, not live video, and accepts no insurance. With Aetna/BCBS/UHC, TeleDirectMD is often cheaper.' },
      ...
      { question: 'What states does K Health cover?',                                  answer: 'K Health is in 48 continental states — excludes Alaska and Hawaii per K Health\'s site. TeleDirectMD is in 44 states.' },
      { question: 'Can I switch from K Health to TeleDirectMD?',                       answer: 'Yes. Bring your medication list and any recent labs. Book at teledirectmd.com/book-online for the $79 flat rate. K Health\'s text history does not carry over.' },
      { question: 'Does K Health have a membership?',                                 answer: 'Yes — $79/month for unlimited primary + mental health, or $73 per one-time visit, per ChoosingTherapy. TeleDirectMD has no membership.' },
      { question: 'Is HSA/FSA accepted at K Health?',                                  answer: 'Partially — one-time visits qualify; subscriptions do not per ChoosingTherapy. TeleDirectMD is fully HSA/FSA-eligible at $79 flat.' },
    ],
    references: [
  ...
  metaDescription: 'TeleDirectMD ($79 flat, MD-only, 44 states) vs. HealthTap ($129 cash-pay or $44 with $15/mo membership, 50 states). Sourced 2026 comparison.',
  breadcrumb: 'TeleDirectMD vs. HealthTap',

  answerLead: 'Yes — TeleDirectMD is about 39% cheaper than HealthTap cash-pay ($79 flat vs $129) and includes a guaranteed board-certified MD with no membership required.',
  answerBody: 'TeleDirectMD charges <strong>$79 flat</strong> per visit with no membership required and always connects you with the same board-certified MD (Dr. Parth Bhavsar). <a href="https://www.healthtap.com">HealthTap</a> charges <strong>$129 cash-pay</strong> per visit without a subscription, or <strong>$44 per primary-care visit / $59 per urgent-care visit</strong> with a membership ($15/month billed annually, per <a href="https://support.healthtap.com/hc/en-us/articles/360041886651-How-much-does-HealthTap-cost">HealthTap Help Center</a>). HealthTap covers all 50 states and D.C. and offers primary-care-led behavioral health; TeleDirectMD covers 44 states and does not offer mental health. <strong>TeleDirectMD wins on predictable, no-membership pricing.</strong> <strong>HealthTap wins on 50-state reach, primary-care continuity, and basic behavioral health support.</strong><div class="tdmd-answer-stats"><span>$79 vs $129 cash-pay</span><span>~39% cheaper</span><span>No subscription required</span></div>',

  heroSub: 'Flat $79 at TeleDirectMD vs. $129 cash-pay (or $44 with a $15/mo membership) at HealthTap. Sourced side-by-side.',
  heroIntro: '<a href="https://www.healthtap.com">HealthTap</a> is a virtual primary-care platform where you pick a board-certified physician and build an ongoing relationship — available in all 50 states and D.C., with 365-day urgent care access per <a href="https://www.businesswire.com/news/home/20251028482980/en/Samsung-Health-and-HealthTap-Expand-Access-to-Virtual-Primary-Care-to-Millions">BusinessWire (Oct 2025)</a>. TeleDirectMD is the leaner alternative: a single named MD, a flat $79 visit, and no subscription required. This page is an honest, sourced comparison of the two services across price, provider type, states, prescriptions, mental health, and insurance.',

  heroCardTitle: 'Quick Answer',
  heroCardItems: [
    'Cheapest cash visit: TeleDirectMD ($79 flat vs. $129 at HealthTap without membership)',
    'No membership required: TeleDirectMD — HealthTap costs $15/mo for lower per-visit rates',
    'Bigger geographic reach: HealthTap (all 50 states vs. TeleDirectMD\'s 44)',
  ...
  heroBenefits: [
    '$79 flat vs. $129 cash-pay at HealthTap — TeleDirectMD is about 39% cheaper without a subscription',
  ...
  tdmdWins: [
    {
      headline: 'About 39% cheaper cash-pay (no membership needed)',
      detail: 'TeleDirectMD is <strong>$79 flat</strong> with no subscription. HealthTap is <a href="https://support.healthtap.com/hc/en-us/articles/360041886651-How-much-does-HealthTap-cost">$129/visit</a> cash-pay without a membership — roughly 1.6× the TeleDirectMD price.',
    },
    {
      headline: 'No membership required, ever',
      detail: 'HealthTap\'s lowest per-visit rate ($44) requires a <a href="https://support.healthtap.com/hc/en-us/articles/360041886651-How-much-does-HealthTap-cost">$15/month membership</a> ($180/year billed annually). TeleDirectMD charges $79 per visit with zero ongoing fees.',
    },
    {
  ...
  competitorWins: [
    {
      ...
      detail: 'HealthTap is available in <a href="https://www.businesswire.com/news/home/20251028482980/en/Samsung-Health-and-HealthTap-Expand-Access-to-Virtual-Primary-Care-to-Millions">all 50 states and D.C.</a> TeleDirectMD covers 44 states plus Washington, D.C. — it is not available in Arkansas, Massachusetts, New Mexico, New York, Oregon, or Rhode Island. See <a href="/states-we-serve/">states we serve</a>.',
    },
    {
  ...
  pricingDive: {
    title: 'Pricing Deep-Dive: What Each Visit Actually Costs',
    paragraphs: [
      '<strong>TeleDirectMD: $79 flat, no membership.</strong> Every visit — regardless of condition — is $79 cash-pay across all 44 states. If you have Aetna, BCBS, or UHC in a qualifying state, you pay your copay instead. HSA and FSA cards are accepted. No subscription, no annual commitment, no surprise billing.',
      ...
      '<strong>Breaking even on HealthTap membership:</strong> At the $15/month membership rate (annual billing), a patient would need to make at least two visits per month to break even compared to TeleDirectMD\'s $79 flat rate (HealthTap member cost: $15 + $44 = $59/visit for the first visit, dropping on subsequent visits within the month). For occasional-use patients — one or two acute visits per year — TeleDirectMD\'s $79 is almost always the lower total cost.',
  ...
  whoFor: {
    tdmd: [
      ...
      'You\'re in one of TeleDirectMD\'s 44 covered states for an acute condition (UTI, sinus, strep, pink eye, refill)',
      'You prefer a flat-rate, no-tier pricing model with zero monthly commitment',
    ],
    competitor: [
      'You\'re in AR, MA, NM, NY, OR, RI or another state TeleDirectMD doesn\'t serve — HealthTap covers all 50',
  ...
  decisionGuide: {
    ...
    steps: [
      ...
      },
      {
        ...
        body: 'TeleDirectMD\'s $79 flat is the straightforward choice — no membership needed, no price tiers, just a visit. HealthTap costs $129 cash-pay for the same visit without a subscription.',
        good: true,
      },
      {
        num: 3,
        head: 'In a state TeleDirectMD doesn\'t cover?',
        body: 'HealthTap covers all 50 states and D.C. If you\'re in AR, MA, NM, NY, OR, RI, or another gap state, HealthTap is the better fit. Check <a href="/states-we-serve/">TeleDirectMD\'s covered states</a>.',
        good: false,
      },
      {
        num: 4,
  ...
  faqs: [
    {
      ...
      answer: 'Yes, for cash-pay without a subscription. TeleDirectMD charges $79 flat per visit. HealthTap charges $129 per visit without a membership, or $44 (primary care) / $59 (urgent care) per visit with a $15/month membership billed annually — per the <a href="https://support.healthtap.com/hc/en-us/articles/360041886651-How-much-does-HealthTap-cost">HealthTap Help Center</a>. Even the member rate at HealthTap requires a $180/year annual commitment on top of visit fees.',
    },
    {
    ...
    },
    {
      ...
      answer: 'HealthTap is available in all 50 U.S. states and Washington D.C. per a <a href="https://www.businesswire.com/news/home/20251028482980/en/Samsung-Health-and-HealthTap-Expand-Access-to-Virtual-Primary-Care-to-Millions">BusinessWire press release (October 2025)</a>. TeleDirectMD is available in 44 states plus Washington, D.C.; it does not currently serve AR, MA, NM, NY, OR, or RI. See <a href="/states-we-serve/">TeleDirectMD\'s full state list</a>.',
    },
    {
    ...
    },
    {
      ...
      answer: 'Yes, HealthTap doctors can refill appropriate maintenance medications. Prescriptions are sent to your preferred pharmacy. However, HealthTap cannot refill controlled substances, certain psychiatric drugs, or lifestyle medications per its <a href="https://support.healthtap.com/hc/en-us/articles/360061654312-What-kind-of-care-does-HealthTap-provide-What-we-treat">care scope page</a>. TeleDirectMD can also handle appropriate medication refills as part of a regular $79 MD visit — see <a href="/what-we-treat/">what we treat</a>.',
    },
    {
      question: 'Which is better for a UTI, sinus infection, or strep?',
      answer: 'Both platforms treat these conditions. For cash-pay patients, TeleDirectMD at $79 is far cheaper than HealthTap at $129 without a membership (or $44–$59 with one). For insured patients, the cost depends on your copay at each platform. TeleDirectMD visit details: <a href="/cost/uti-treatment-cost/">UTI</a>, <a href="/cost/sinus-infection-treatment-cost/">sinus infection</a>, <a href="/cost/sore-throat-treatment-cost/">strep throat</a>.',
    },
    {
    ...
    },
    {
      ...
      answer: 'HealthTap allows you to set up profiles for children at no additional cost under a subscription per the <a href="https://apps.apple.com/us/app/healthtap-primary-care-doctors/id466079030">App Store listing</a>. TeleDirectMD does not have a family plan; each patient books and pays per visit at $79.',
    },
  ],
  ...
  'teledirectmd-vs-walgreens-virtual': {
    ...
    service: {
      name: 'TeleDirectMD $79 telehealth visit (vs Walgreens Virtual)',
    ...
    metaDescription: 'Honest 2026 comparison: TeleDirectMD ($79 flat, 44 states, named MD) vs. Walgreens Virtual Healthcare ($79 urgent care, 30 states, MD/NP mix, no insurance). Verified prices with sources.',
    breadcrumb: 'TeleDirectMD vs. Walgreens Virtual Healthcare',

    answerLead: 'TeleDirectMD and Walgreens Virtual Healthcare are both $79 for a general urgent-care video visit. TeleDirectMD guarantees a single named board-certified MD instead of a rotating MD/NP panel and covers 44 states vs. Walgreens\' 30.',
    answerBody: 'TeleDirectMD charges <strong>$79 per visit</strong> and connects you with a single named board-certified MD — Dr. Parth Bhavsar — every time. <a href="https://www.walgreens.com/topic/virtual-healthcare.jsp">Walgreens Virtual Healthcare</a> charges <strong>$79 for an urgent care video visit</strong> and matches you with a rotating panel of "doctors and nurse practitioners" without patient selection. <strong>Neither platform accepts health insurance for the visit itself</strong> — Walgreens explicitly states <a href="https://www.walgreens.com/topic/virtual-healthcare.jsp">"Insurance is currently not accepted for virtual care visits"</a> — and both accept HSA/FSA. <strong>Walgreens wins on pharmacy integration</strong>: prescriptions flow directly into Walgreens\' own chain for same-day fills or delivery. <strong>TeleDirectMD wins on the named-MD guarantee</strong>, on hours (evenings and weekends vs. 8am–midnight EST), and on state coverage (44 vs. 30 states). Walgreens matches TeleDirectMD’s $79 general urgent-care price but has cheaper condition-specific menus ($33–$39 for UTI, pink eye, cold sores, birth control).<div class="tdmd-answer-stats"><span>Both $79 general urgent care</span><span>Named MD · not a rotating panel</span><span>44 vs. 30 states</span></div>',

    heroSub: 'Side-by-side with sources. Both are $79 for general urgent care; TeleDirectMD adds a named-MD guarantee and 44-state coverage. Walgreens wins on tight pharmacy integration and cheaper condition-specific menus.',
    heroIntro: '<a href="https://www.walgreens.com/topic/virtual-healthcare.jsp">Walgreens Virtual Healthcare</a> launched in 2023 and has grown to 30 states, offering asynchronous chat and live video visits for common conditions — all at flat cash prices ranging from $33 to $79. Its biggest selling point is the direct link to Walgreens\' pharmacy network. TeleDirectMD charges $79 flat and guarantees every visit is with Dr. Parth Bhavsar, a board-certified Family Medicine physician licensed across 44 states. This page lays out every meaningful difference with sources, so you can choose the right service without guessing.',
    heroCardTitle: 'Quick Answer',
    heroCardItems: [
      'Same $79 general urgent care at both — different provider model',
      'More states: TeleDirectMD (44 vs. 30)',
      'Named MD every visit: TeleDirectMD only',
    ...
    heroBenefits: [
      'Both $79 for a general urgent-care video visit — same price, different provider model',
      'Single named board-certified MD vs. rotating MD/NP panel at Walgreens',
      '44 states covered vs. 30 at Walgreens — 11 extra states with TeleDirectMD',
    ...
    tdmdWins: [
      {
        headline: 'Named MD at the same $79',
        detail: '$79 flat at TeleDirectMD vs. <a href="https://www.walgreens.com/topic/virtual-healthcare.jsp">$79 per urgent care video visit at Walgreens Virtual Healthcare</a>. Both are cash-pay only for the visit fee; neither accepts insurance toward that cost.',
      },
      {
      ...
      {
        headline: '14 more states covered',
        detail: 'TeleDirectMD operates in <a href="/states-we-serve/">44 states</a>. <a href="https://www.walgreens.com/topic/help/virtualhealthcare.jsp">Walgreens Virtual Healthcare is available in 30 states</a> as of 2026 (AL, AZ, CA, CO, CT, FL, GA, IL, IN, KS, KY, LA, MA, MD, MI, MN, MO, NC, NJ, NV, NY, OH, OK, PA, SC, TN, TX, VA, WA, WI).',
      },
      {
    ...
    competitorWins: [
      ...
      },
      {
        ...
        detail: 'Walgreens offers condition-specific pricing: pink eye is <a href="https://www.walgreens.com/topic/virtual-healthcare.jsp">$39</a>, UTI $39, birth control $33, cold sore $33. For those specific narrow-scope visits, Walgreens costs less than TeleDirectMD\'s $79 flat rate.',
      },
      {
        headline: 'Weight management and specialty programs (2026)',
        detail: 'Walgreens launched <a href="https://corporate.walgreens.com/news-and-stories/press-releases/2026/virtual-healthcare-adds-weight-management-services/">GLP-1 weight management visits in February 2026</a> at $79/visit in select states. TeleDirectMD does not offer a dedicated weight management program.',
      },
      {
    ...
    pricingDive: {
      title: 'Pricing Deep-Dive: What Each Visit Actually Costs',
      paragraphs: [
        '<strong>Urgent care visits:</strong> TeleDirectMD is <strong>$79 flat</strong> for all acute conditions. <a href="https://www.walgreens.com/topic/virtual-healthcare.jsp">Walgreens Virtual Healthcare</a> charges <strong>$79</strong> for its general urgent care video visit. Condition-specific Walgreens visits can be cheaper — UTI, pink eye, flu, and COVID chat visits run $39; birth control, cold sores, acne, and men\'s hair loss run $33. If your need matches a narrow Walgreens category, you may pay less than $79. If you have a general acute illness (sore throat, fever, cough), you will pay $79 at Walgreens vs. $79 at TeleDirectMD.',
    ...
    rxDive: {
      ...
      paragraphs: [
        ...
        '<strong>Key limitation at both platforms:</strong> Neither TeleDirectMD nor Walgreens Virtual Healthcare prescribes controlled substances (Schedule II–V). This includes opioids, stimulants (Adderall, Ritalin), benzodiazepines (Xanax, Valium), and sleep medications. For acute non-controlled conditions — antibiotics, antivirals, antihistamines, blood pressure refills, asthma inhalers — both platforms prescribe effectively and the prescription reaches your pharmacy the same day.',
      ],
    },

    whoFor: {
      tdmd: [
        'You have a general acute illness (fever, sore throat, cough, UTI, sinus infection) and are paying cash — $79 beats $79',
        'You want the same named board-certified MD on every visit, not a rotating anonymous clinician',
        'You are in one of TeleDirectMD\'s 44 states (including states Walgreens does not cover)',
      ...
      competitor: [
        ...
        'Your condition is on Walgreens\' condition-specific menu at $33–$39 (birth control, pink eye, UTI, cold sores) — cheaper than TeleDirectMD\'s $79',
        'You are in one of the 30 Walgreens Virtual Healthcare states but not in TeleDirectMD\'s 44-state network',
      ...
      steps: [
        {
          ...
          body: 'Walgreens charges less than $79 for pink eye ($39), UTI ($39), birth control ($33), cold sores ($33), and a few others. If your exact condition matches a Walgreens narrow-category visit, Walgreens may be the cheaper option.',
          good: false,
        },
        {
          num: 2,
          head: 'Is your need a general urgent care visit — fever, sore throat, cough, or an unlisted acute condition?',
          body: 'TeleDirectMD and Walgreens both charge $79 for a general urgent-care video visit. Walgreens is cheaper ($33–$39) for a small menu of condition-specific visits (UTI, pink eye, cold sores, birth control). For everything outside that menu, both platforms charge the same $79 — TeleDirectMD\'s edge is the named MD and 44-state coverage.',
          good: true,
        },
        {
          num: 3,
    ...
    faqs: [
      ...
      },
      {
        ...
        answer: '<a href="https://www.walgreens.com/topic/help/virtualhealthcare.jsp">Walgreens Virtual Healthcare</a> is available in 30 states: AL, AZ, CA, CO, CT, FL, GA, IL, IN, KS, KY, LA, MA, MD, MI, MN, MO, NC, NJ, NV, NY, OH, OK, PA, SC, TN, TX, VA, WA, and WI. TeleDirectMD covers <a href="/states-we-serve/">44 states</a>, including several not on the Walgreens list. Verify your state on both platforms before booking.',
      },
      {
        question: 'What states does TeleDirectMD cover that Walgreens does not?',
        answer: 'TeleDirectMD covers 44 states; Walgreens covers 30. States where TeleDirectMD operates but Walgreens Virtual Healthcare does not include states outside Walgreens\' current 30-state footprint. TeleDirectMD\'s known gaps are AR, MA, NM, NY, OR, and RI — but Walgreens\' gaps are different and often larger. See <a href="/states-we-serve/">teledirectmd.com/states-we-serve/</a> and <a href="https://www.walgreens.com/topic/help/virtualhealthcare.jsp">walgreens.com</a> for current state lists.',
      },
      {
