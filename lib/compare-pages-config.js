...
export const COMPARE_PAGES = {
  ...
  'teledirectmd-vs-teladoc': {
    ...
    metaDescription: 'Honest comparison: TeleDirectMD ($79 flat, 41 states, MD-only) vs. Teladoc ($89 cash-pay, 50 states, MD/NP mixed, mental health). Verified 2026 prices with sources.',
    ...
    decisionGuide: {
      ...
      steps: [
        ...
        { num: 2, head: 'In one of TeleDirectMD\'s 41 states and paying cash?', body: 'TeleDirectMD\'s $79 beats Teladoc\'s $89 by 44%.', good: true },
  ...
  'teledirectmd-vs-amwell': {
    ...
    metaDescription: 'TeleDirectMD ($79 flat, 41 states, MD-only) vs. Amwell ($79 cash-pay, 50 states, 55+ insurers, mental health). Verified 2026 prices with sources.',
  ...
  'teledirectmd-vs-doctor-on-demand': {
    ...
    metaDescription: 'TeleDirectMD ($79 flat, 41 states, MD-only) vs. Doctor on Demand ($99 cash-pay, 50 states, Medicare Part B, mental health). Verified 2026 prices with sources.',
  ...
  'teledirectmd-vs-sesame': {
    ...
    answerBody: 'TeleDirectMD is <strong>$79 flat</strong> with a single named MD across 41 states. Sesame is a marketplace where independent providers set their own rates — acute care can start as low as <strong>$29–$37</strong> per <a href="https://www.healthline.com/health/sesame-care">Healthline</a> but varies widely by location and provider; provider type is mixed (<a href="https://www.choosingtherapy.com/sesame-care-review/">ChoosingTherapy</a>). Sesame <strong>does not accept insurance</strong>. Both are HIPAA-compliant. <strong>TeleDirectMD wins on predictability, MD-only credentials, and insurance acceptance.</strong> <strong>Sesame wins on potential floor price and breadth of specialist types.</strong>',
    ...
    faqs: [
      { question: 'Is TeleDirectMD cheaper than Sesame?',                              answer: 'Sometimes. Sesame\'s acute care can start at $29–$37 per Healthline below TeleDirectMD\'s $79. But Sesame rates vary by city and provider; TeleDirectMD is $79 flat in all 41 states.' },
  ...
  metaDescription: 'TeleDirectMD ($79 flat, MD-only, 41 states) vs. HealthTap ($129 cash-pay or $44 with $15/mo membership, 50 states). Sourced 2026 comparison.',
  ...
  pricingDive: {
    title: 'Pricing Deep-Dive: What Each Visit Actually Costs',
    paragraphs: [
      '<strong>TeleDirectMD: $79 flat, no membership.</strong> Every visit — regardless of condition — is $79 cash-pay across all 41 states. If you have Aetna, BCBS, or UHC in a qualifying state, you pay your copay instead. HSA and FSA cards are accepted. No subscription, no annual commitment, no surprise billing.',
  ...
  'teledirectmd-vs-walgreens-virtual': {
    ...
    metaDescription: 'Honest 2026 comparison: TeleDirectMD ($79 flat, 41 states, named MD) vs. Walgreens Virtual Healthcare ($79 urgent care, 30 states, MD/NP mix, no insurance). Verified prices with sources.',
