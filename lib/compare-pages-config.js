...
export const COMPARE_PAGES = {
  ...
  'teledirectmd-vs-teladoc': {
    ...
    metaDescription: 'Honest comparison: TeleDirectMD ($79 flat, 43 states, MD-only) vs. Teladoc ($89 cash-pay, 50 states, MD/NP mixed, mental health). Verified 2026 prices with sources.',
    ...
    decisionGuide: {
      ...
      steps: [
        ...
        { num: 2, head: 'In one of TeleDirectMD\'s 43 states and paying cash?', body: 'TeleDirectMD\'s $79 beats Teladoc\'s $89 by 44%.', good: true },
    ...
    faqs: [
      ...
      { question: 'Does Teladoc cover all 50 states?',                                             answer: 'Yes — all 50 states 24/7 per Teladoc\'s employer page. TeleDirectMD is in 43 states with same-day, evenings, and weekends.' },
  ...
  'teledirectmd-vs-mdlive': {
    ...
    heroCardItems: [
      ...
      'Bigger reach: MDLIVE (50 + PR vs. 43 states)',
    ...
    whoFor: {
      tdmd: ['You want the lowest cash-pay rate from a board-certified MD', 'You\'re in one of the 43 states', 'You only need adult primary/urgent care', 'You value seeing the same physician every visit'],
    ...
    decisionGuide: {
      ...
      steps: [
        ...
        { num: 3, head: 'Live in one of the 43 TeleDirectMD states?',          body: 'Cash-pay $79 beats MDLIVE\'s $85 by ~42%.', good: true },
    ...
    faqs: [
      ...
      { question: 'Does MDLIVE cover all 50 states?',                                answer: 'Yes — all 50 states plus Puerto Rico per MDLIVE\'s FAQ. TeleDirectMD covers 43 states.' },
  ...
  'teledirectmd-vs-amwell': {
    ...
    metaDescription: 'TeleDirectMD ($79 flat, 43 states, MD-only) vs. Amwell ($79 cash-pay, 50 states, 55+ insurers, mental health). Verified 2026 prices with sources.',
    ...
    heroCardItems: [
      ...
      'Bigger reach: Amwell (50 vs. 43 states)',
    ...
    whoFor: {
      tdmd: ['You\'re paying cash and want the lowest published rate', 'You\'re in one of the 43 states', 'You only need adult primary/urgent care', 'You value continuity with a named physician'],
    ...
    faqs: [
      ...
      { question: 'Is Amwell available in all 50 states?',                              answer: 'Yes per ChoosingTherapy. TeleDirectMD is in 43 states.' },
  ...
  'teledirectmd-vs-doctor-on-demand': {
    ...
    metaDescription: 'TeleDirectMD ($79 flat, 43 states, MD-only) vs. Doctor on Demand ($99 cash-pay, 50 states, Medicare Part B, mental health). Verified 2026 prices with sources.',
    ...
    heroCardItems: [
      ...
      'Bigger reach: Doctor on Demand (50 vs. 43 states)',
    ...
    whoFor: {
      tdmd: ['You\'re cash-paying or have a high-deductible plan', 'You\'re in one of the 43 states', 'You want continuity with a single named MD', 'You only need adult primary or urgent care'],
    ...
    faqs: [
      ...
      { question: 'Does Doctor on Demand cover all 50 states?',                                    answer: 'Yes per industry comparison sources. TeleDirectMD covers 43 states.' },
  ...
  'teledirectmd-vs-sesame': {
    ...
    answerBody: 'TeleDirectMD is <strong>$79 flat</strong> with a single named MD across 43 states. Sesame is a marketplace where independent providers set their own rates — acute care can start as low as <strong>$29–$37</strong> per <a href="https://www.healthline.com/health/sesame-care">Healthline</a> but varies widely by location and provider; provider type is mixed (<a href="https://www.choosingtherapy.com/sesame-care-review/">ChoosingTherapy</a>). Sesame <strong>does not accept insurance</strong>. Both are HIPAA-compliant. <strong>TeleDirectMD wins on predictability, MD-only credentials, and insurance acceptance.</strong> <strong>Sesame wins on potential floor price and breadth of specialist types.</strong>',
    ...
    whoFor: {
      tdmd: ['You want one named physician, every visit', 'Predictable pricing matters', 'You want to use Aetna, BCBS, or UHC insurance', 'You\'re in one of the 43 states'],
    ...
    faqs: [
      { question: 'Is TeleDirectMD cheaper than Sesame?',                              answer: 'Sometimes. Sesame\'s acute care can start at $29–$37 per Healthline below TeleDirectMD\'s $79. But Sesame rates vary by city and provider; TeleDirectMD is $79 flat in all 43 states.' },
      ...
      { question: 'Does Sesame cover all 50 states?',                                   answer: 'Yes per ChoosingTherapy, though provider density varies by market. TeleDirectMD is in 43 states.' },
  ...
  'teledirectmd-vs-k-health': {
    ...
    faqs: [
      ...
      { question: 'What states does K Health cover?',                                  answer: 'K Health is in 48 continental states — excludes Alaska and Hawaii per K Health\'s site. TeleDirectMD is in 43 states.' },
  ...
  metaDescription: 'TeleDirectMD ($79 flat, MD-only, 43 states) vs. HealthTap ($129 cash-pay or $44 with $15/mo membership, 50 states). Sourced 2026 comparison.',
  ...
  competitorWins: [
    {
      ...
      detail: 'HealthTap is available in <a href="https://www.businesswire.com/news/home/20251028482980/en/Samsung-Health-and-HealthTap-Expand-Access-to-Virtual-Primary-Care-to-Millions">all 50 states and D.C.</a> TeleDirectMD covers 43 states — AK, HI, NY, MA, RI, VT, NM, OR, AR and a few others are not available. See <a href="/states-we-serve/">states we serve</a>.',
    },
    {
  ...
  pricingDive: {
    title: 'Pricing Deep-Dive: What Each Visit Actually Costs',
    paragraphs: [
      '<strong>TeleDirectMD: $79 flat, no membership.</strong> Every visit — regardless of condition — is $79 cash-pay across all 43 states. If you have Aetna, BCBS, or UHC in a qualifying state, you pay your copay instead. HSA and FSA cards are accepted. No subscription, no annual commitment, no surprise billing.',
  ...
  faqs: [
    ...
    },
    {
      ...
      answer: 'HealthTap is available in all 50 U.S. states and Washington D.C. per a <a href="https://www.businesswire.com/news/home/20251028482980/en/Samsung-Health-and-HealthTap-Expand-Access-to-Virtual-Primary-Care-to-Millions">BusinessWire press release (October 2025)</a>. TeleDirectMD is available in 43 states — it does not currently serve AK, HI, NY, MA, RI, VT, NM, OR, AR, and a few others. See <a href="/states-we-serve/">TeleDirectMD\'s full state list</a>.',
    },
    {
  ...
  'teledirectmd-vs-walgreens-virtual': {
    ...
    metaDescription: 'Honest 2026 comparison: TeleDirectMD ($79 flat, 43 states, named MD) vs. Walgreens Virtual Healthcare ($79 urgent care, 30 states, MD/NP mix, no insurance). Verified prices with sources.',
    ...
    heroBenefits: [
      ...
      '43 states covered vs. 30 at Walgreens — 11 extra states with TeleDirectMD',
    ...
    tdmdWins: [
      ...
      },
      {
        ...
        detail: 'TeleDirectMD operates in <a href="/states-we-serve/">43 states</a>. <a href="https://www.walgreens.com/topic/help/virtualhealthcare.jsp">Walgreens Virtual Healthcare is available in 30 states</a> as of 2026 (AL, AZ, CA, CO, CT, FL, GA, IL, IN, KS, KY, LA, MA, MD, MI, MN, MO, NC, NJ, NV, NY, OH, OK, PA, SC, TN, TX, VA, WA, WI).',
      },
      {
    ...
    whoFor: {
      tdmd: [
        ...
        'You are in one of TeleDirectMD\'s 43 states (including states Walgreens does not cover)',
