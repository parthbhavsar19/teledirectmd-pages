export const tdmdCSS = `
  ...
  /* ========== SITE HEADER ========== */
  .tdmd-site-header{background:#ffffff;border-bottom:1px solid rgba(0,0,0,0.06);position:relative;z-index:1000;font-family:'Almarai',sans-serif;}
  .tdmd-header-inner{max-width:1200px;margin:0 auto;padding:0.5rem 1.5rem;display:flex;align-items:center;justify-content:space-between;gap:1.5rem;min-height:90px;}
  .tdmd-header-logo{display:flex;align-items:center;flex-shrink:0;}
  .tdmd-header-logo img{height:90px;width:auto;}
  .tdmd-header-nav-desktop{display:flex;align-items:center;gap:1.5rem;}
  .tdmd-header-nav-link{color:#172140;font-family:'Almarai',sans-serif;font-weight:400;font-size:1rem;text-decoration:none;white-space:nowrap;transition:color 0.15s;letter-spacing:0;}
  .tdmd-header-nav-link:hover{color:#536c7c;}
  .tdmd-header-cta-desktop{display:inline-flex;align-items:center;justify-content:center;padding:1.4rem 2rem;border-radius:15px;background:#536c7c;color:#ffffff;font-family:'Almarai',sans-serif;font-weight:400;font-size:1rem;text-decoration:none;white-space:nowrap;transition:background 0.15s;flex-shrink:0;letter-spacing:0;}
  .tdmd-header-cta-desktop:hover{background:#455d6c;}
  .tdmd-hamburger{display:none;background:none;border:none;cursor:pointer;padding:0.5rem;color:#172140;}
  ...
  .tdmd-mobile-nav-link{color:#172140;font-family:'Almarai',sans-serif;font-size:1.75rem;font-weight:400;text-decoration:none;padding:0.25rem 0;}
  .tdmd-mobile-cta{display:flex;align-items:center;justify-content:center;padding:1rem;border-radius:15px;background:#536c7c;color:#ffffff;font-family:'Almarai',sans-serif;font-weight:400;font-size:1.1rem;text-decoration:none;margin-top:auto;margin-bottom:2rem;max-width:360px;}
