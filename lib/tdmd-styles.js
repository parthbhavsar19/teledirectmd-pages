export const tdmdCSS = `
  ...
  /* ========== SITE HEADER ========== */
  .tdmd-site-header{background:#ffffff;border-bottom:none;position:relative;z-index:1000;font-family:'Almarai',sans-serif;}
  .tdmd-header-inner{max-width:1200px;margin:0 auto;padding:0.1vw 1.5rem;display:flex;align-items:center;justify-content:space-between;gap:1.5rem;min-height:80px;}
  .tdmd-header-logo{display:flex;align-items:center;flex-shrink:0;}
  .tdmd-header-logo img{height:76px;width:auto;}
