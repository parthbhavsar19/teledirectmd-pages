export const tdmdCSS = `
  ...
  .tdmd-table th{background:var(--tdmd-bg-soft);font-weight:800;color:var(--tdmd-text);}
  /* Zebra striping must use theme tokens so dark mode stays legible.
     The previous rule had no zebra in light mode and white cells in dark =
     pale text on white. Now stripes are subtle in both modes. */
  .tdmd-table tbody tr:nth-child(even) td{background:var(--tdmd-bg-soft);}
  /* Link contrast inside tables — default link color uses --tdmd-teal which
     reads fine on both backgrounds, but ensure it isn't overridden by
     inherited muted color. */
  .tdmd-table a{color:var(--tdmd-teal);}
  .tdmd-table a:hover{text-decoration:underline;}
  ...
  /* Vertical bar chart variant — used for cost comparisons where height conveys magnitude. */
  .tdmd-vbars{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:1rem;align-items:end;padding:1.5rem 0.5rem 0.5rem;border-bottom:2px solid var(--tdmd-border);min-height:340px;}
  .tdmd-vbar{display:flex;flex-direction:column;align-items:center;justify-content:flex-end;height:300px;position:relative;}
  .tdmd-vbar__value{font-weight:800;color:var(--tdmd-navy);font-size:0.95rem;margin-bottom:0.35rem;text-align:center;line-height:1.2;white-space:nowrap;}
  .tdmd-vbar__fill{width:100%;max-width:120px;border-radius:10px 10px 0 0;background:linear-gradient(180deg, rgba(0,62,82,0.85) 0%, rgba(0,107,115,0.65) 100%);min-height:8px;transition:height .35s ease;}
  .tdmd-vbar__fill--tdmd{background:linear-gradient(180deg, var(--tdmd-accent) 0%, #ff8a6e 100%);box-shadow:0 0 0 3px rgba(255,90,54,0.15);}
  .tdmd-vbar__label{margin-top:0.6rem;padding-top:0.5rem;border-top:1px solid var(--tdmd-border);font-weight:700;color:var(--tdmd-text);font-size:0.88rem;text-align:center;line-height:1.3;width:100%;}
  .tdmd-vbar__label--tdmd{color:var(--tdmd-accent);}
  @media (max-width:640px){
    .tdmd-vbars{grid-template-columns:repeat(4,minmax(0,1fr));gap:0.5rem;padding:1rem 0.25rem 0.5rem;min-height:280px;}
    .tdmd-vbar{height:240px;}
    .tdmd-vbar__value{font-size:0.78rem;}
    .tdmd-vbar__label{font-size:0.72rem;}
  }
  ...
  .tdmd-header-inner{max-width:1280px;margin:0 auto;padding:0.6rem 1.5rem;display:flex;align-items:center;justify-content:space-between;gap:1.25rem;min-height:100px;}
  .tdmd-header-logo{display:flex;align-items:center;flex-shrink:0;}
  .tdmd-header-logo img{height:112px;width:auto;}
  .tdmd-header-nav-desktop{display:flex;align-items:center;gap:1.1rem;}
  ...
  .tdmd-header-cta-desktop{display:inline-flex;align-items:center;justify-content:center;padding:0.85rem 1.75rem;border-radius:999px;background:#536c7c;color:#ffffff;font-family:'Almarai',sans-serif;font-weight:400;font-size:1rem;text-decoration:none;white-space:nowrap;transition:background 0.15s;flex-shrink:0;letter-spacing:0;}
  ...
  .tdmd-footer-inner{max-width:1280px;margin:0 auto;padding:3rem 1.5rem 2rem;display:grid;grid-template-columns:1.5fr 1fr 1fr 1.15fr 1.15fr;gap:2.25rem;}
  ...
  .tdmd-footer-seal{display:inline-flex;align-items:center;line-height:0;}
  .tdmd-footer-seal img{transition:opacity 0.15s;}
  .tdmd-footer-seal:hover img{opacity:0.88;}
  ...
  @media(max-width:768px){
    ...
    .tdmd-sticky-bar-cta{padding:0.65rem 1.5rem;border-radius:999px;background:var(--tdmd-teal, #0B6A63);color:#ffffff;-webkit-text-fill-color:#ffffff;font-weight:700;font-size:0.95rem;text-decoration:none;white-space:nowrap;}
  ...
  @media(max-width:1100px){
    .tdmd-footer-inner{grid-template-columns:1.4fr 1fr 1fr;gap:2rem;}
