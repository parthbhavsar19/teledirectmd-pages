export const tdmdCSS = `
  ...
  .tdmd-header-cta-desktop{display:inline-flex;align-items:center;justify-content:center;padding:1.2rem 2.5rem;border-radius:999px;background:#536c7c;color:#ffffff;font-family:'Almarai',sans-serif;font-weight:400;font-size:1rem;text-decoration:none;white-space:nowrap;transition:background 0.15s;flex-shrink:0;letter-spacing:0;}
