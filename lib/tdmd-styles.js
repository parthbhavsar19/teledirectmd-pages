export const tdmdCSS = `
  ...
  /* Mobile-only Book Now pill — hidden on desktop */
  .tdmd-header-cta-mobile{display:none;}
  ...
  @media(max-width:900px){
    ...
    .tdmd-header-logo img{height:70px;}
    .tdmd-header-inner{min-height:70px;padding:0.4rem 1.25rem;}
    /* Show compact Book Now next to hamburger */
    .tdmd-header-cta-mobile{
      display:inline-flex;align-items:center;justify-content:center;
      padding:0.55rem 1.1rem;border-radius:999px;
      background:#FF5A36;color:#ffffff;
      font-family:'Almarai',sans-serif;font-weight:700;font-size:0.85rem;
      text-decoration:none;white-space:nowrap;flex-shrink:0;
      transition:background 0.15s;
    }
    .tdmd-header-cta-mobile:hover{background:#e04a28;}
  }
  ...
  .tdmd-mobile-cta{display:flex;align-items:center;justify-content:center;padding:1rem;border-radius:999px;background:#536c7c;color:#ffffff;font-family:'Almarai',sans-serif;font-weight:400;font-size:1.1rem;text-decoration:none;margin-top:auto;margin-bottom:2rem;max-width:360px;}
  ...
  .tdmd-footer-desc{font-family:'Fraunces',serif;font-size:0.92rem;line-height:1.55;color:rgba(255,255,255,0.75);margin:0;}
  .tdmd-footer-cta{display:inline-flex;align-items:center;gap:0.3rem;padding:0.65rem 1.6rem;border-radius:999px;background:var(--tdmd-accent);color:#ffffff;font-family:'Fraunces',serif;font-weight:700;font-size:0.95rem;text-decoration:none;align-self:flex-start;transition:background 0.15s;}
  .tdmd-footer-cta:hover{background:#e8492a;}
  .tdmd-footer-col{display:flex;flex-direction:column;gap:0.6rem;}
  .tdmd-footer-heading{font-size:0.78rem;font-family:'Fraunces',serif;font-weight:700;letter-spacing:0.12em;color:rgba(255,255,255,0.70);margin:0 0 0.25rem;}
  .tdmd-footer-col a{color:rgba(255,255,255,0.85);text-decoration:none;font-family:'Fraunces',serif;font-size:0.93rem;transition:color 0.15s;}
